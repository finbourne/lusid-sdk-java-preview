...
public class JSON {
    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                .registerTypeSelector(AtomValue.class, new TypeSelector<AtomValue>() {
                    @Override
                    public Class<? extends AtomValue> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("AtomValue0D", AtomValue0D.class);
                        classByDiscriminatorValue.put("AtomValueDecimal", AtomValueDecimal.class);
                        classByDiscriminatorValue.put("AtomValueInt", AtomValueInt.class);
                        classByDiscriminatorValue.put("AtomValueString", AtomValueString.class);
                        classByDiscriminatorValue.put("AtomValue", AtomValue.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "atomValueType"));
                    }
          })
                .registerTypeSelector(AtomValue0D.class, new TypeSelector<AtomValue0D>() {
                    @Override
                    public Class<? extends AtomValue0D> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("AtomValue0D", AtomValue0D.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "atomValueType"));
                ...
                .registerTypeSelector(AtomValueDecimal.class, new TypeSelector<AtomValueDecimal>() {
                    @Override
                    public Class<? extends AtomValueDecimal> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("AtomValueDecimal", AtomValueDecimal.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "atomValueType"));
                ...
                .registerTypeSelector(AtomValueInt.class, new TypeSelector<AtomValueInt>() {
                    @Override
                    public Class<? extends AtomValueInt> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("AtomValueInt", AtomValueInt.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "atomValueType"));
                ...
                .registerTypeSelector(AtomValueString.class, new TypeSelector<AtomValueString>() {
                    @Override
                    public Class<? extends AtomValueString> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("AtomValueString", AtomValueString.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "atomValueType"));
