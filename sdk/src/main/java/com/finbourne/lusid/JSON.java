        ...
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                ...
                .registerTypeSelector(CashDependency.class, new TypeSelector<CashDependency>() {
                    ...
                    public Class<? extends CashDependency> getClassForElement(JsonElement readElement) {
                        ...
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "economicDependencyType"));
                    }
          })
                ...
                .registerTypeSelector(CouponEvent.class, new TypeSelector<CouponEvent>() {
                    @Override
                    public Class<? extends CouponEvent> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("CouponEvent", CouponEvent.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "instrumentEventType"));
                    }
          })
                ...
                .registerTypeSelector(InstrumentEvent.class, new TypeSelector<InstrumentEvent>() {
                    ...
                    public Class<? extends InstrumentEvent> getClassForElement(JsonElement readElement) {
                        ...
                        classByDiscriminatorValue.put("CloseEvent", CloseEvent.class);
                        classByDiscriminatorValue.put("CouponEvent", CouponEvent.class);
                        classByDiscriminatorValue.put("InternalEvent", InternalEvent.class);
                ...
                .registerTypeSelector(InternalEvent.class, new TypeSelector<InternalEvent>() {
                    @Override
                    public Class<? extends InternalEvent> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("InternalEvent", InternalEvent.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "instrumentEventType"));
                ...
                .registerTypeSelector(PropertyCriterion.class, new TypeSelector<PropertyCriterion>() {
                    @Override
                    public Class<? extends PropertyCriterion> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("StringEqualsCriterion", StringEqualsCriterion.class);
                        classByDiscriminatorValue.put("StringInCriterion", StringInCriterion.class);
                        classByDiscriminatorValue.put("PropertyCriterion", PropertyCriterion.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "criterionOp"));
                    }
          })
                ...
                .registerTypeSelector(StringEqualsCriterion.class, new TypeSelector<StringEqualsCriterion>() {
                    @Override
                    public Class<? extends StringEqualsCriterion> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("StringEqualsCriterion", StringEqualsCriterion.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "criterionOp"));
                ...
                .registerTypeSelector(StringInCriterion.class, new TypeSelector<StringInCriterion>() {
                    @Override
                    public Class<? extends StringInCriterion> getClassForElement(JsonElement readElement) {
                        Map<String, Class> classByDiscriminatorValue = new HashMap<String, Class>();
                        classByDiscriminatorValue.put("StringInCriterion", StringInCriterion.class);
                        return getClassByDiscriminator(classByDiscriminatorValue,
                                getDiscriminatorValue(readElement, "criterionOp"));
