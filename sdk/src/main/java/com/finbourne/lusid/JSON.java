    ...
    public static GsonBuilder createGson() {
        GsonFireBuilder fireBuilder = new GsonFireBuilder()
                ...
                .registerTypeSelector(LusidInstrument.class, new TypeSelector() {
                    ...
                    public Class getClassForElement(JsonElement readElement) {
                        Map classByDiscriminatorValue = new HashMap();
                        classByDiscriminatorValue.put("BondInstrument".toUpperCase(Locale.ROOT), BondInstrument.class);
                        classByDiscriminatorValue.put("CdsInstrument".toUpperCase(Locale.ROOT), CdsInstrument.class);
                        ...
                        classByDiscriminatorValue.put("FxForwardInstrument".toUpperCase(Locale.ROOT), FxForwardInstrument.class);
                        classByDiscriminatorValue.put("FxOption".toUpperCase(Locale.ROOT), FxOption.class);
                        classByDiscriminatorValue.put("InstrumentLeg".toUpperCase(Locale.ROOT), InstrumentLeg.class);
                        classByDiscriminatorValue.put("SwapInstrument".toUpperCase(Locale.ROOT), SwapInstrument.class);
                        classByDiscriminatorValue.put("Swaption".toUpperCase(Locale.ROOT), Swaption.class);
