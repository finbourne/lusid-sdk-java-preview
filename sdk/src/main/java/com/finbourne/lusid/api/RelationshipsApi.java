...
public class RelationshipsApi {
     ...
     * @param effectiveAt The effective datetime or cut label at which the relationship should be effective from. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The newly created relationship. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createRelationshipCall(String scope, String code, CreateRelationshipRequest createRelationshipRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call createRelationshipValidateBeforeCall(String scope, String code, CreateRelationshipRequest createRelationshipRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createRelationshipCall(scope, code, createRelationshipRequest, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public CompleteRelationship createRelationship(String scope, String code, CreateRelationshipRequest createRelationshipRequest, String effectiveAt) throws ApiException {
        ApiResponse<CompleteRelationship> localVarResp = createRelationshipWithHttpInfo(scope, code, createRelationshipRequest, effectiveAt);
     ...
     */
    public ApiResponse<CompleteRelationship> createRelationshipWithHttpInfo(String scope, String code, CreateRelationshipRequest createRelationshipRequest, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = createRelationshipValidateBeforeCall(scope, code, createRelationshipRequest, effectiveAt, null);
     ...
     */
    public okhttp3.Call createRelationshipAsync(String scope, String code, CreateRelationshipRequest createRelationshipRequest, String effectiveAt, final ApiCallback<CompleteRelationship> _callback) throws ApiException {

        okhttp3.Call localVarCall = createRelationshipValidateBeforeCall(scope, code, createRelationshipRequest, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<CompleteRelationship>(){}.getType();
     ...
     * @param effectiveAt The effective datetime or cut label at which the relationship should the deletion be effective from. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call deleteRelationshipCall(String scope, String code, DeleteRelationshipRequest deleteRelationshipRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteRelationshipValidateBeforeCall(String scope, String code, DeleteRelationshipRequest deleteRelationshipRequest, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRelationshipCall(scope, code, deleteRelationshipRequest, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public DeletedEntityResponse deleteRelationship(String scope, String code, DeleteRelationshipRequest deleteRelationshipRequest, String effectiveAt) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteRelationshipWithHttpInfo(scope, code, deleteRelationshipRequest, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeletedEntityResponse> deleteRelationshipWithHttpInfo(String scope, String code, DeleteRelationshipRequest deleteRelationshipRequest, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = deleteRelationshipValidateBeforeCall(scope, code, deleteRelationshipRequest, effectiveAt, null);
     ...
     */
    public okhttp3.Call deleteRelationshipAsync(String scope, String code, DeleteRelationshipRequest deleteRelationshipRequest, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteRelationshipValidateBeforeCall(scope, code, deleteRelationshipRequest, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
