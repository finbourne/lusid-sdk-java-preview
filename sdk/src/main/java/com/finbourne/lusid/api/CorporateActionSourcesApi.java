...
public class CorporateActionSourcesApi {
    ...
    /**
     * [EXPERIMENTAL] DeleteCorporateActions: Delete corporate actions (asynchronously)
     * Delete one or more corporate actions from a particular corporate action source.
     * @param scope The scope of the corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param corporateActionIds The IDs of the corporate actions to delete (required)
    ...
    /**
     * [EXPERIMENTAL] DeleteInstrumentEvents: Delete corporate actions (instrument transition events) from the corporate action source. (asynchronously)
     * Delete one or more corporate actions from a particular corporate action source.
     * @param scope The scope of the corporate action source (required)
     * @param code The code of the corporate action source (required)
     * @param instrumentEventIds The IDs of the instrument events to delete (required)
     ...
     */
    public ResourceListOfInstrumentEventHolder getInstrumentEvents(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter) throws ApiException {
        ApiResponse<ResourceListOfInstrumentEventHolder> localVarResp = getInstrumentEventsWithHttpInfo(scope, code, asAt, limit, page, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfInstrumentEventHolder> getInstrumentEventsWithHttpInfo(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] GetInstrumentEvents: Get extrinsic instrument events out of a given corporate actions source. (asynchronously)
     * Retrieves extrinsic corporate actions out of a corporate actions source
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. (required)
     * @param asAt Optional. The AsAt date of the data. (optional)
     ...
     */
    public okhttp3.Call getInstrumentEventsAsync(String scope, String code, OffsetDateTime asAt, Integer limit, String page, String filter, final ApiCallback<ResourceListOfInstrumentEventHolder> _callback) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] UpsertInstrumentEvents: Upsert instrument events to the provided corporate actions source. (asynchronously)
     * Batch upsert instrument events to corporate action sources.
     * @param scope The scope of the corporate action source. (required)
     * @param code The code of the corporate action source. (required)
     * @param upsertInstrumentEventRequest The instrument event definitions. (optional)
