...
public class CustomEntitiesApi {
     ...
     * @param entityType The type of entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     ...
     * @param effectiveAt The effective datetime or cut label at which to get the CustomEntity. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public okhttp3.Call getCustomEntityCall(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getCustomEntityValidateBeforeCall(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustomEntityCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public CustomEntityResponse getCustomEntity(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt) throws ApiException {
        ApiResponse<CustomEntityResponse> localVarResp = getCustomEntityWithHttpInfo(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt);
     ...
     */
    public ApiResponse<CustomEntityResponse> getCustomEntityWithHttpInfo(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = getCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, null);
        Type localVarReturnType = new TypeToken<CustomEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetCustomEntity: Get CustomEntity (asynchronously)
     * Retrieve a CustomEntity by a specific Id at a point in AsAt time.
     * @param entityType The type of entity to retrieve. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param identifierType An identifier type attached to the CustomEntity. (required)
     * @param identifierValue The identifier value. (required)
     ...
     */
    public okhttp3.Call getCustomEntityAsync(String entityType, String identifierType, String identifierValue, String identifierScope, OffsetDateTime asAt, String effectiveAt, final ApiCallback<CustomEntityResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = getCustomEntityValidateBeforeCall(entityType, identifierType, identifierValue, identifierScope, asAt, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<CustomEntityResponse>(){}.getType();
    ...
    /**
     * [EXPERIMENTAL] GetCustomEntityRelationships: Get Relationships for Custom Entity (asynchronously)
     * Get relationships for the specified Custom Entity.
     * @param entityType The type of entity get relationships for. (required)
     * @param identifierScope The identifier scope. (required)
     * @param identifierType An identifier type attached to the CustomEntity. (required)
    ...
    /**
     * [EXPERIMENTAL] ListCustomEntities: List Custom Entities (asynchronously)
     * List all the Custom Entities matching particular criteria.
     * @param entityType The type of entity to list. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the entities. Defaults to the current LUSID              system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the entities. Defaults to returning the latest version              of each portfolio if not specified. (optional)
     ...
     * @param entityType The type of the CustomEntity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
    ...
    /**
     * [EXPERIMENTAL] UpsertCustomEntity: Upsert a new CustomEntity (asynchronously)
     * Insert the custom entity if it does not exist or update the custom entity with the supplied state if it does exist.
     * @param entityType The type of the CustomEntity to be created. An entityType can be created using the \&quot;CreateCustomEntityDefinition\&quot; endpoint for CustomEntityDefinitions. (required)
     * @param customEntityRequest The CustomEntity to be created. (required)
     * @param _callback The callback to be executed when the API call finishes
