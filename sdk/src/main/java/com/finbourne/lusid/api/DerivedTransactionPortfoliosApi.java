...
public class DerivedTransactionPortfoliosApi {
     ...
     */
    public com.squareup.okhttp.Call createDerivedPortfolioCall(String scope, CreateDerivedTransactionPortfolioRequest portfolio, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createDerivedPortfolioValidateBeforeCall(String scope, CreateDerivedTransactionPortfolioRequest portfolio, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createDerivedPortfolioCall(scope, portfolio, progressListener, progressRequestListener);
        return call;
    ...
    public Portfolio createDerivedPortfolio(String scope, CreateDerivedTransactionPortfolioRequest portfolio) throws ApiException {
        ApiResponse<Portfolio> resp = createDerivedPortfolioWithHttpInfo(scope, portfolio);
        return resp.getData();
    }
    ...
    public ApiResponse<Portfolio> createDerivedPortfolioWithHttpInfo(String scope, CreateDerivedTransactionPortfolioRequest portfolio) throws ApiException {
        com.squareup.okhttp.Call call = createDerivedPortfolioValidateBeforeCall(scope, portfolio, null, null);
        Type localVarReturnType = new TypeToken<Portfolio>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create derived transaction portfolio (asynchronously)
     * Creates a transaction portfolio that derives from an existing transaction portfolio. In a derived portfolio, parts of the portfolio can either be specific to this portfolio, or can be inherited from a \&quot;parent\&quot;. Different parts of the portfolio (e.g. transactions or properties) are combined in different ways. The portfolio details are either overridden in entirety, or not at all. The same is true for properties. Transactions on a derived portfolio are merged with its parent portfolio&#39;s transactions. If the parent portfolio is itself a derived portfolio, transactions from that parent are also merged (and that parent&#39;s portfolio&#39;s, if it is also a derived portfolio, and so on).
     * @param scope The scope into which to create the new derived portfolio (required)
     * @param portfolio The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)
     ...
     */
    public com.squareup.okhttp.Call createDerivedPortfolioAsync(String scope, CreateDerivedTransactionPortfolioRequest portfolio, final ApiCallback<Portfolio> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createDerivedPortfolioValidateBeforeCall(scope, portfolio, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Portfolio>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteDerivedPortfolioDetailsCall(String scope, String code, String effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteDerivedPortfolioDetailsValidateBeforeCall(String scope, String code, String effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteDerivedPortfolioDetailsCall(scope, code, effectiveAt, progressListener, progressRequestListener);
        return call;
    ...
    public DeletedEntityResponse deleteDerivedPortfolioDetails(String scope, String code, String effectiveAt) throws ApiException {
        ApiResponse<DeletedEntityResponse> resp = deleteDerivedPortfolioDetailsWithHttpInfo(scope, code, effectiveAt);
        return resp.getData();
    }
    ...
    public ApiResponse<DeletedEntityResponse> deleteDerivedPortfolioDetailsWithHttpInfo(String scope, String code, String effectiveAt) throws ApiException {
        com.squareup.okhttp.Call call = deleteDerivedPortfolioDetailsValidateBeforeCall(scope, code, effectiveAt, null, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Delete portfolio details (asynchronously)
     * Deletes the portfolio details for the specified derived transaction portfolio
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param effectiveAt The effective date of the change (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteDerivedPortfolioDetailsAsync(String scope, String code, String effectiveAt, final ApiCallback<DeletedEntityResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteDerivedPortfolioDetailsValidateBeforeCall(scope, code, effectiveAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
