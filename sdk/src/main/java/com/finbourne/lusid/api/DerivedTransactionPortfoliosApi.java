...
public class DerivedTransactionPortfoliosApi {
     ...
     * @param createDerivedTransactionPortfolioRequest The root object of the new derived portfolio, containing a populated reference portfolio id and reference scope (optional)
