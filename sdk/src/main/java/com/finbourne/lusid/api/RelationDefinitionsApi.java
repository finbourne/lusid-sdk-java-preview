 ...
 *
 * The version of the OpenAPI document: 1.3.182
...
public class RelationDefinitionsApi {
    ...
    public okhttp3.Call createRelationDefinitionCall(CreateRelationDefinitionRequest createRelationDefinitionRequest, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "1.3.182");
    ...
    private okhttp3.Call deleteRelationDefinitionValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRelationDefinitionCall(scope, code, _callback);
        return localVarCall;
