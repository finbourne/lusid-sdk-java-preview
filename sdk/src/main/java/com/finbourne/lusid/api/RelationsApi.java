...
public class RelationsApi {
     ...
     * @param scope Scope of the relation to create. (required)
     * @param code Code of the relation to create. (required)
     ...
     */
    public Relation createRelation(String scope, String code, CreateRelationRequest createRelationRequest, String effectiveAt) throws ApiException {
        ApiResponse<Relation> localVarResp = createRelationWithHttpInfo(scope, code, createRelationRequest, effectiveAt);
     ...
     */
    public ApiResponse<Relation> createRelationWithHttpInfo(String scope, String code, CreateRelationRequest createRelationRequest, String effectiveAt) throws ApiException {
     ...
     */
    public okhttp3.Call createRelationAsync(String scope, String code, CreateRelationRequest createRelationRequest, String effectiveAt, final ApiCallback<Relation> _callback) throws ApiException {
