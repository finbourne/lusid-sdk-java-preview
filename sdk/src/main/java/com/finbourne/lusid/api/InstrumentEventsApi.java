...
import com.finbourne.lusid.model.ResourceListOfTradeTicket;
...
public class InstrumentEventsApi {
    ...
    private okhttp3.Call queryBucketedCashFlowsValidateBeforeCall(QueryBucketedCashFlowsRequest queryBucketedCashFlowsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = queryBucketedCashFlowsCall(queryBucketedCashFlowsRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call queryCashFlowsValidateBeforeCall(Integer limit, String page, QueryCashFlowsRequest queryCashFlowsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = queryCashFlowsCall(limit, page, queryCashFlowsRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call queryInstrumentEventsValidateBeforeCall(Integer limit, String page, QueryInstrumentEventsRequest queryInstrumentEventsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = queryInstrumentEventsCall(limit, page, queryInstrumentEventsRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call queryTradeTicketsValidateBeforeCall(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = queryTradeTicketsCall(limit, page, queryTradeTicketsRequest, _callback);
        return localVarCall;
     ...
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryTradeTicketsRequest The filter parameters used to retrieve instrument events. (optional)
     * @return ResourceListOfTradeTicket
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ResourceListOfTradeTicket queryTradeTickets(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest) throws ApiException {
        ApiResponse<ResourceListOfTradeTicket> localVarResp = queryTradeTicketsWithHttpInfo(limit, page, queryTradeTicketsRequest);
        return localVarResp.getData();
    }
     ...
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryTradeTicketsRequest The filter parameters used to retrieve instrument events. (optional)
     * @return ApiResponse&lt;ResourceListOfTradeTicket&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResourceListOfTradeTicket> queryTradeTicketsWithHttpInfo(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest) throws ApiException {
        okhttp3.Call localVarCall = queryTradeTicketsValidateBeforeCall(limit, page, queryTradeTicketsRequest, null);
        Type localVarReturnType = new TypeToken<ResourceListOfTradeTicket>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call queryTradeTicketsAsync(Integer limit, String page, QueryTradeTicketsRequest queryTradeTicketsRequest, final ApiCallback<ResourceListOfTradeTicket> _callback) throws ApiException {
