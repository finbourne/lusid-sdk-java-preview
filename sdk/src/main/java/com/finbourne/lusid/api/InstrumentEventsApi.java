...
public class InstrumentEventsApi {
    ...
    /**
     * [EXPERIMENTAL] QueryBucketedCashFlows: Returns a list of instrument events that match the specified query, presented as bucketed cashflows. (asynchronously)
     * Returns a list of instrument events that match the specified query, presented as bucketed cashflows.
     * @param queryBucketedCashFlowsRequest The Query Information. (optional)
    ...
    /**
     * [EXPERIMENTAL] QueryCashFlows: Returns a list of instrument events that match the specified query, presented as Instrument cashflows. (asynchronously)
     * Returns a list of instrument events that match the specified query, presented as Instrument cashflows
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryCashFlowsRequest The filter parameters used to retrieve instrument events. (optional)
    ...
    /**
     * [EXPERIMENTAL] QueryInstrumentEvents: Returns a list of intrinsic and user-upserted instrument events that match the specified query. (asynchronously)
     * Returns a list of intrinsic and user-upserted instrument events that match the specified query.
     * @param limit Optional. When paginating, limit the number of returned results to this many. If not specified, a default  of 1000 is used. (optional, default to 1000)
     * @param page Optional. The pagination token to use to continue listing items from a previous call. Page values are  return from list calls, and must be supplied exactly as returned. Additionally, when specifying this  value, queryBody, and limit must not  be modified. (optional)
     * @param queryInstrumentEventsRequest The filter parameters used to retrieve instrument events. (optional)
