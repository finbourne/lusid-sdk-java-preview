...
public class TransactionConfigurationApi {
    ...
    private okhttp3.Call deleteSideDefinitionValidateBeforeCall(String side, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteSideDefinitionCall(side, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteTransactionTypeValidateBeforeCall(String source, String type, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteTransactionTypeCall(source, type, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deleteTransactionTypeSourceValidateBeforeCall(String source, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteTransactionTypeSourceCall(source, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getSideDefinitionValidateBeforeCall(String side, String scope, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getSideDefinitionCall(side, scope, asAt, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getTransactionTypeValidateBeforeCall(String source, String type, OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTransactionTypeCall(source, type, asAt, scope, _callback);
        return localVarCall;
    ...
    /**
     * Build call for listSidesDefinition
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults to returning the latest versions if not specified. (optional)
     * @param scope The scope in which the side exists. When not supplied the scope is &#39;default&#39;. (optional, default to default)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     */
    public okhttp3.Call listSidesDefinitionCall(OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listSidesDefinitionValidateBeforeCall(OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listSidesDefinitionCall(asAt, scope, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfSideDefinition listSidesDefinition(OffsetDateTime asAt, String scope) throws ApiException {
        ApiResponse<ResourceListOfSideDefinition> localVarResp = listSidesDefinitionWithHttpInfo(asAt, scope);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfSideDefinition> listSidesDefinitionWithHttpInfo(OffsetDateTime asAt, String scope) throws ApiException {
        okhttp3.Call localVarCall = listSidesDefinitionValidateBeforeCall(asAt, scope, null);
        Type localVarReturnType = new TypeToken<ResourceListOfSideDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListSidesDefinition: List the side definitions (asynchronously)
     * List all the side definitions in the given scope
     * @param asAt The asAt datetime at which to retrieve the transaction types. Defaults to returning the latest versions if not specified. (optional)
     * @param scope The scope in which the side exists. When not supplied the scope is &#39;default&#39;. (optional, default to default)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call listSidesDefinitionAsync(OffsetDateTime asAt, String scope, final ApiCallback<ResourceListOfSideDefinition> _callback) throws ApiException {
        okhttp3.Call localVarCall = listSidesDefinitionValidateBeforeCall(asAt, scope, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfSideDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call listTransactionTypesValidateBeforeCall(OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listTransactionTypesCall(asAt, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setSideDefinitionValidateBeforeCall(String side, SideDefinitionRequest sideDefinitionRequest, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setSideDefinitionCall(side, sideDefinitionRequest, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setSideDefinitionsValidateBeforeCall(List<SidesDefinitionRequest> sidesDefinitionRequest, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setSideDefinitionsCall(sidesDefinitionRequest, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setTransactionTypeValidateBeforeCall(String source, String type, TransactionTypeRequest transactionTypeRequest, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setTransactionTypeCall(source, type, transactionTypeRequest, scope, _callback);
        return localVarCall;
    ...
    private okhttp3.Call setTransactionTypeSourceValidateBeforeCall(String source, List<TransactionTypeRequest> transactionTypeRequest, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setTransactionTypeSourceCall(source, transactionTypeRequest, scope, _callback);
        return localVarCall;
