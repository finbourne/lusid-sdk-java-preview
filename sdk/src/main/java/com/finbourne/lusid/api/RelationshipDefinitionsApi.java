...
public class RelationshipDefinitionsApi {
    ...
    /**
     * [EXPERIMENTAL] CreateRelationshipDefinition: Create Relationship Definition (asynchronously)
     * Create a new relationship definition to be used for creating relationships between entities.
     * @param createRelationshipDefinitionRequest The definition of the new relationship. (required)
    ...
    private okhttp3.Call deleteRelationshipDefinitionValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteRelationshipDefinitionCall(scope, code, _callback);
        return localVarCall;
    ...
    /**
     * [EXPERIMENTAL] DeleteRelationshipDefinition: Delete Relationship Definition (asynchronously)
     * Delete the definition of the specified relationship.
     * @param scope The scope of the relationship definition to be deleted. (required)
     * @param code The code of the relationship definition to be deleted. Together with the domain and scope this uniquely              identifies the relationship. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * [EXPERIMENTAL] GetRelationshipDefinition: Get relationship definition (asynchronously)
     * Retrieve the specified relationship definition
     * @param scope The scope of the specified relationship definition. (required)
     * @param code The code of the specified relationship definition. Together with the domain and scope this uniquely              identifies the relationship definition. (required)
     * @param asAt The asAt datetime at which to retrieve the relationship definition. Defaults to return              the latest version of the definition if not specified. (optional)
     ...
     * @param page The pagination token to use to continue listing relationship definitions from a previous call to list relationship definitions. This  value is returned from the previous call. If a pagination token is provided the filter, asAt field  must not have changed since the original request. (optional)
     ...
     */
    public okhttp3.Call listRelationshipDefinitionsCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listRelationshipDefinitionsValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listRelationshipDefinitionsCall(asAt, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfRelationshipDefinition listRelationshipDefinitions(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        ApiResponse<PagedResourceListOfRelationshipDefinition> localVarResp = listRelationshipDefinitionsWithHttpInfo(asAt, page, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfRelationshipDefinition> listRelationshipDefinitionsWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = listRelationshipDefinitionsValidateBeforeCall(asAt, page, limit, filter, null);
        Type localVarReturnType = new TypeToken<PagedResourceListOfRelationshipDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListRelationshipDefinitions: List relationship definitions (asynchronously)
     * Retrieve one or more specified relationship definitions.
     * @param asAt The asAt datetime at which to retrieve the relationship definitions. Defaults to return              the latest version of each definition if not specified. (optional)
     * @param page The pagination token to use to continue listing relationship definitions from a previous call to list relationship definitions. This  value is returned from the previous call. If a pagination token is provided the filter, asAt field  must not have changed since the original request. (optional)
     * @param limit When paginating, limit the number of returned results to this many. Defaults to 100 if not specified. (optional)
     ...
     */
    public okhttp3.Call listRelationshipDefinitionsAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfRelationshipDefinition> _callback) throws ApiException {
        okhttp3.Call localVarCall = listRelationshipDefinitionsValidateBeforeCall(asAt, page, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfRelationshipDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EXPERIMENTAL] UpdateRelationshipDefinition: Update Relationship Definition (asynchronously)
     * Update the definition of a specified existing relationship. Not all elements within a relationship definition  are modifiable due to the potential implications for values already stored against the relationship.
     * @param scope The scope of the relationship definition being updated. (required)
     * @param code The code of the relationship definition being updated. Together with the scope this uniquely              identifies the relationship definition. (required)
     * @param updateRelationshipDefinitionRequest The details of relationship definition to update. (required)
