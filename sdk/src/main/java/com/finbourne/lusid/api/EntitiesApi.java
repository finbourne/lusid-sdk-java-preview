...
public class EntitiesApi {
     ...
     */
    public com.squareup.okhttp.Call getPortfolioChangesCall(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getPortfolioChangesValidateBeforeCall(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioChangesCall(scope, effectiveAt, asAt, progressListener, progressRequestListener);
        return call;
     ...
     */
    public ResourceListOfChange getPortfolioChanges(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt) throws ApiException {
        ApiResponse<ResourceListOfChange> resp = getPortfolioChangesWithHttpInfo(scope, effectiveAt, asAt);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfChange> getPortfolioChangesWithHttpInfo(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt) throws ApiException {
        com.squareup.okhttp.Call call = getPortfolioChangesValidateBeforeCall(scope, effectiveAt, asAt, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfChange>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get the next change to each portfolio in a scope. (asynchronously)
     * Gets the time of the next (earliest effective at) modification (correction and/or amendment) to each portfolio in a scope relative to a point in bitemporal time.  Includes changes from parent portfolios in different scopes.  Excludes changes from subcriptions (e.g corporate actions).
     * @param scope The scope (required)
     * @param effectiveAt The effective date of the origin. (required)
     * @param asAt The as-at date of the origin. (optional)
     ...
     */
    public com.squareup.okhttp.Call getPortfolioChangesAsync(String scope, OffsetDateTime effectiveAt, OffsetDateTime asAt, final ApiCallback<ResourceListOfChange> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getPortfolioChangesValidateBeforeCall(scope, effectiveAt, asAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfChange>(){}.getType();
