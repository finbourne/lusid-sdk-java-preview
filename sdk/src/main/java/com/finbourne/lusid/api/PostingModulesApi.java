...
public class PostingModulesApi {
    ...
    private okhttp3.Call createPostingModuleValidateBeforeCall(String scope, PostingModuleRequest postingModuleRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createPostingModuleCall(scope, postingModuleRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call deletePostingModuleValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deletePostingModuleCall(scope, code, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listPostingModuleRulesValidateBeforeCall(String scope, String code, OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listPostingModuleRulesCall(scope, code, asAt, page, start, limit, filter, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listPostingModulesValidateBeforeCall(OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listPostingModulesCall(asAt, page, start, limit, filter, _callback);
        return localVarCall;
    ...
    /**
     * Build call for updatePostingModuleDetails
     ...
     * @param postingModuleDetails The details to be updated for the posting module. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updatePostingModuleDetailsCall(String scope, String code, PostingModuleDetails postingModuleDetails, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePostingModuleDetailsValidateBeforeCall(String scope, String code, PostingModuleDetails postingModuleDetails, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling updatePostingModuleDetails(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling updatePostingModuleDetails(Async)");
        }
        
        // verify the required parameter 'postingModuleDetails' is set
        if (postingModuleDetails == null) {
            throw new ApiException("Missing the required parameter 'postingModuleDetails' when calling updatePostingModuleDetails(Async)");
        }
        

        okhttp3.Call localVarCall = updatePostingModuleDetailsCall(scope, code, postingModuleDetails, _callback);
        return localVarCall;
     ...
     */
    public PostingModuleResponse updatePostingModuleDetails(String scope, String code, PostingModuleDetails postingModuleDetails) throws ApiException {
        ApiResponse<PostingModuleResponse> localVarResp = updatePostingModuleDetailsWithHttpInfo(scope, code, postingModuleDetails);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PostingModuleResponse> updatePostingModuleDetailsWithHttpInfo(String scope, String code, PostingModuleDetails postingModuleDetails) throws ApiException {
        okhttp3.Call localVarCall = updatePostingModuleDetailsValidateBeforeCall(scope, code, postingModuleDetails, null);
        Type localVarReturnType = new TypeToken<PostingModuleResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpdatePostingModuleDetails: Update a Posting Module details (asynchronously)
     * Update the given Posting Module details.
     * @param scope The scope of the Posting Module to be updated. (required)
     * @param code The code of the Posting Module to be updated. Together with the scope this uniquely identifies the Posting Module. (required)
     * @param postingModuleDetails The details to be updated for the posting module. (required)
     ...
     */
    public okhttp3.Call updatePostingModuleDetailsAsync(String scope, String code, PostingModuleDetails postingModuleDetails, final ApiCallback<PostingModuleResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = updatePostingModuleDetailsValidateBeforeCall(scope, code, postingModuleDetails, _callback);
        Type localVarReturnType = new TypeToken<PostingModuleResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for updatePostingModuleRules
     * @param scope The scope of the Posting Module to be updated. (required)
     * @param code The code of the Posting Module to be updated. Together with the scope this uniquely identifies the Posting Module. (required)
     * @param postingModuleRule The new rule set to be updated for the posting module. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call updatePostingModuleRulesCall(String scope, String code, List<PostingModuleRule> postingModuleRule, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call updatePostingModuleRulesValidateBeforeCall(String scope, String code, List<PostingModuleRule> postingModuleRule, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling updatePostingModuleRules(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling updatePostingModuleRules(Async)");
        }
        
        // verify the required parameter 'postingModuleRule' is set
        if (postingModuleRule == null) {
            throw new ApiException("Missing the required parameter 'postingModuleRule' when calling updatePostingModuleRules(Async)");
        }
        

        okhttp3.Call localVarCall = updatePostingModuleRulesCall(scope, code, postingModuleRule, _callback);
        return localVarCall;
     ...
     */
    public PostingModuleRulesUpdatedResponse updatePostingModuleRules(String scope, String code, List<PostingModuleRule> postingModuleRule) throws ApiException {
        ApiResponse<PostingModuleRulesUpdatedResponse> localVarResp = updatePostingModuleRulesWithHttpInfo(scope, code, postingModuleRule);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PostingModuleRulesUpdatedResponse> updatePostingModuleRulesWithHttpInfo(String scope, String code, List<PostingModuleRule> postingModuleRule) throws ApiException {
        okhttp3.Call localVarCall = updatePostingModuleRulesValidateBeforeCall(scope, code, postingModuleRule, null);
        Type localVarReturnType = new TypeToken<PostingModuleRulesUpdatedResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] UpdatePostingModuleRules: Update a Posting Modules rules (asynchronously)
     * Update the given Posting Modules rules, this will replace the existing set of rules for the posting module.
     * @param scope The scope of the Posting Module to be updated. (required)
     * @param code The code of the Posting Module to be updated. Together with the scope this uniquely identifies the Posting Module. (required)
     * @param postingModuleRule The new rule set to be updated for the posting module. (required)
     ...
     */
    public okhttp3.Call updatePostingModuleRulesAsync(String scope, String code, List<PostingModuleRule> postingModuleRule, final ApiCallback<PostingModuleRulesUpdatedResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = updatePostingModuleRulesValidateBeforeCall(scope, code, postingModuleRule, _callback);
        Type localVarReturnType = new TypeToken<PostingModuleRulesUpdatedResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
