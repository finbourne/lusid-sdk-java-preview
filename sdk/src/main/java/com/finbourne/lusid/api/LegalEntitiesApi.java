...
public class LegalEntitiesApi {
     ...
     */
    public okhttp3.Call patchLegalEntityAccessMetadataCall(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchLegalEntityAccessMetadataValidateBeforeCall(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchLegalEntityAccessMetadataCall(idTypeScope, idTypeCode, code, operation, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public Map<String, List<AccessMetadataValue>> patchLegalEntityAccessMetadata(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt) throws ApiException {
        ApiResponse<Map<String, List<AccessMetadataValue>>> localVarResp = patchLegalEntityAccessMetadataWithHttpInfo(idTypeScope, idTypeCode, code, operation, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, List<AccessMetadataValue>>> patchLegalEntityAccessMetadataWithHttpInfo(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = patchLegalEntityAccessMetadataValidateBeforeCall(idTypeScope, idTypeCode, code, operation, effectiveAt, null);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchLegalEntityAccessMetadataAsync(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
        okhttp3.Call localVarCall = patchLegalEntityAccessMetadataValidateBeforeCall(idTypeScope, idTypeCode, code, operation, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
