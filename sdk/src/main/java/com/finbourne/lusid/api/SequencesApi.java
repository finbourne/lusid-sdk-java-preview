...
public class SequencesApi {
     ...
     * @param createSequenceRequest Request to create sequence definition. (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> Successful creation of the sequence </td><td>  -  </td></tr>
    ...
    /**
     * Build call for getSequenceDefinition
     * @param scope Scope of the sequence definition. (required)
     ...
     */
    public okhttp3.Call getSequenceDefinitionCall(String scope, String code, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getSequenceDefinitionValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getSequenceDefinition(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getSequenceDefinition(Async)");
        }
        

        okhttp3.Call localVarCall = getSequenceDefinitionCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public SequenceDefinition getSequenceDefinition(String scope, String code) throws ApiException {
        ApiResponse<SequenceDefinition> localVarResp = getSequenceDefinitionWithHttpInfo(scope, code);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<SequenceDefinition> getSequenceDefinitionWithHttpInfo(String scope, String code) throws ApiException {
        okhttp3.Call localVarCall = getSequenceDefinitionValidateBeforeCall(scope, code, null);
        Type localVarReturnType = new TypeToken<SequenceDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Return the definition of a sequence (asynchronously)
     * Return the detailed definition of a sequence
     * @param scope Scope of the sequence definition. (required)
     * @param code Code of the sequence definition. This together with stated scope uniquely              identifies the sequence definition. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call getSequenceDefinitionAsync(String scope, String code, final ApiCallback<SequenceDefinition> _callback) throws ApiException {
        okhttp3.Call localVarCall = getSequenceDefinitionValidateBeforeCall(scope, code, _callback);
        Type localVarReturnType = new TypeToken<SequenceDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param scope Scope of the sequence definition. (required)
     * @param code Code of the sequence definition. This together with stated scope uniquely              identifies the sequence definition. (required)
     * @param batch Number of sequences items to return for the specified sequence definition. (optional, default to 1)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Gets the next set of values for the sequence </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * [EXPERIMENTAL] Get the next set of values from the sequence (asynchronously)
     * Get the next set of values from the sequence
     * @param scope Scope of the sequence definition. (required)
     * @param code Code of the sequence definition. This together with stated scope uniquely              identifies the sequence definition. (required)
     * @param batch Number of sequences items to return for the specified sequence definition. (optional, default to 1)
