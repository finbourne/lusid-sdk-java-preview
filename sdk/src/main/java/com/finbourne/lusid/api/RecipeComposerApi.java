...
public class RecipeComposerApi {
     ...
     */
    public okhttp3.Call getRecipeComposerResolvedInlineCall(UpsertRecipeComposerRequest upsertRecipeComposerRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getRecipeComposerResolvedInlineValidateBeforeCall(UpsertRecipeComposerRequest upsertRecipeComposerRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getRecipeComposerResolvedInlineCall(upsertRecipeComposerRequest, _callback);
        return localVarCall;
     ...
     */
    public GetRecipeResponse getRecipeComposerResolvedInline(UpsertRecipeComposerRequest upsertRecipeComposerRequest) throws ApiException {
     ...
     */
    public ApiResponse<GetRecipeResponse> getRecipeComposerResolvedInlineWithHttpInfo(UpsertRecipeComposerRequest upsertRecipeComposerRequest) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] GetRecipeComposerResolvedInline: Given a Recipe Composer, this endpoint shows what configuration recipe it would resolve to, able to access the already upserted configuration recipes as well as plain inline string inputs. (asynchronously)
     * Resolves an inline recipe composer into a ConfigurationRecipe.
     * @param upsertRecipeComposerRequest Recipe composer used to resolve into the Configuration Recipe. (required)
     ...
     */
    public okhttp3.Call getRecipeComposerResolvedInlineAsync(UpsertRecipeComposerRequest upsertRecipeComposerRequest, final ApiCallback<GetRecipeResponse> _callback) throws ApiException {
