...
public class ReferencePortfolioApi {
     ...
     * @param referencePortfolio The portfolio creation request object (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createReferencePortfolioCall(String scope, CreateReferencePortfolioRequest referencePortfolio, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call createReferencePortfolioValidateBeforeCall(String scope, CreateReferencePortfolioRequest referencePortfolio, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createReferencePortfolioCall(scope, referencePortfolio, progressListener, progressRequestListener);
        return call;
    ...
    public Portfolio createReferencePortfolio(String scope, CreateReferencePortfolioRequest referencePortfolio) throws ApiException {
        ApiResponse<Portfolio> resp = createReferencePortfolioWithHttpInfo(scope, referencePortfolio);
        return resp.getData();
    }
    ...
    public ApiResponse<Portfolio> createReferencePortfolioWithHttpInfo(String scope, CreateReferencePortfolioRequest referencePortfolio) throws ApiException {
        com.squareup.okhttp.Call call = createReferencePortfolioValidateBeforeCall(scope, referencePortfolio, null, null);
     ...
     */
    public com.squareup.okhttp.Call createReferencePortfolioAsync(String scope, CreateReferencePortfolioRequest referencePortfolio, final ApiCallback<Portfolio> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createReferencePortfolioValidateBeforeCall(scope, referencePortfolio, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Portfolio>(){}.getType();
     ...
     * @param effectiveAt Optional. The effective date of the constituents to retrieve (optional)
     ...
     * @param instrumentPropertyKeys Optional. The Properties of the constituents (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getReferencePortfolioConstituentsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getReferencePortfolioConstituentsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getReferencePortfolioConstituentsCall(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GetReferencePortfolioConstituentsResponse getReferencePortfolioConstituents(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<GetReferencePortfolioConstituentsResponse> resp = getReferencePortfolioConstituentsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GetReferencePortfolioConstituentsResponse> getReferencePortfolioConstituentsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys) throws ApiException {
        com.squareup.okhttp.Call call = getReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getReferencePortfolioConstituentsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys, final ApiCallback<GetReferencePortfolioConstituentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GetReferencePortfolioConstituentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param fromEffectiveAt Events between this time (inclusive) and the toEffectiveAt are returned. (optional)
     * @param toEffectiveAt Events between this time (inclusive) and the fromEffectiveAt are returned. (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listConstituentsAdjustmentsCall(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAtTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        if (asAtTime != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("asAtTime", asAtTime));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listConstituentsAdjustmentsValidateBeforeCall(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAtTime, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listConstituentsAdjustmentsCall(scope, code, fromEffectiveAt, toEffectiveAt, asAtTime, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfConstituentsAdjustmentHeader listConstituentsAdjustments(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAtTime) throws ApiException {
        ApiResponse<ResourceListOfConstituentsAdjustmentHeader> resp = listConstituentsAdjustmentsWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAtTime);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfConstituentsAdjustmentHeader> listConstituentsAdjustmentsWithHttpInfo(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAtTime) throws ApiException {
        com.squareup.okhttp.Call call = listConstituentsAdjustmentsValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAtTime, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfConstituentsAdjustmentHeader>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Gets constituents adjustments in an interval of effective time. (asynchronously)
     * Specify a time period in which you&#39;d like to see the list of times that adjustments where made to this portfolio
     * @param scope The scope of the portfolio (required)
     * @param code Code for the portfolio (required)
     * @param fromEffectiveAt Events between this time (inclusive) and the toEffectiveAt are returned. (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listConstituentsAdjustmentsAsync(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAtTime, final ApiCallback<ResourceListOfConstituentsAdjustmentHeader> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listConstituentsAdjustmentsValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAtTime, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfConstituentsAdjustmentHeader>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param constituents The constituents to upload to the portfolio (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertReferencePortfolioConstituentsCall(String scope, String code, UpsertReferencePortfolioConstituentsRequest constituents, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertReferencePortfolioConstituentsValidateBeforeCall(String scope, String code, UpsertReferencePortfolioConstituentsRequest constituents, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertReferencePortfolioConstituentsCall(scope, code, constituents, progressListener, progressRequestListener);
        return call;
    ...
    public UpsertReferencePortfolioConstituentsResponse upsertReferencePortfolioConstituents(String scope, String code, UpsertReferencePortfolioConstituentsRequest constituents) throws ApiException {
        ApiResponse<UpsertReferencePortfolioConstituentsResponse> resp = upsertReferencePortfolioConstituentsWithHttpInfo(scope, code, constituents);
        return resp.getData();
    }
    ...
    public ApiResponse<UpsertReferencePortfolioConstituentsResponse> upsertReferencePortfolioConstituentsWithHttpInfo(String scope, String code, UpsertReferencePortfolioConstituentsRequest constituents) throws ApiException {
        com.squareup.okhttp.Call call = upsertReferencePortfolioConstituentsValidateBeforeCall(scope, code, constituents, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertReferencePortfolioConstituentsAsync(String scope, String code, UpsertReferencePortfolioConstituentsRequest constituents, final ApiCallback<UpsertReferencePortfolioConstituentsResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertReferencePortfolioConstituentsValidateBeforeCall(scope, code, constituents, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<UpsertReferencePortfolioConstituentsResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
