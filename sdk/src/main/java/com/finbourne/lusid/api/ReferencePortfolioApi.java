...
public class ReferencePortfolioApi {
     ...
     * @param createReferencePortfolioRequest The portfolio creation request object (required)
     ...
     * @param upsertReferencePortfolioConstituentsRequest The constituents to upload to the portfolio (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
