...
public class ReferencePortfolioApi {
    ...
    /**
     * [EARLY ACCESS] Create reference portfolio (asynchronously)
     * Create a new reference portfolio.
     * @param scope The intended scope of the portfolio (required)
     * @param referencePortfolio The portfolio creation request object (optional)
     ...
     */
    public okhttp3.Call getReferencePortfolioConstituentsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getReferencePortfolioConstituentsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getReferencePortfolioConstituentsCall(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys, _callback);
        return localVarCall;
    ...
    public GetReferencePortfolioConstituentsResponse getReferencePortfolioConstituents(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys) throws ApiException {
        ApiResponse<GetReferencePortfolioConstituentsResponse> localVarResp = getReferencePortfolioConstituentsWithHttpInfo(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<GetReferencePortfolioConstituentsResponse> getReferencePortfolioConstituentsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys) throws ApiException {
        okhttp3.Call localVarCall = getReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys, null);
        Type localVarReturnType = new TypeToken<GetReferencePortfolioConstituentsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EARLY ACCESS] Get constituents (asynchronously)
     * Get all the constituents in the specified reference portfolio
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param effectiveAt Optional. The effective date of the constituents to retrieve (optional)
     ...
     */
    public okhttp3.Call getReferencePortfolioConstituentsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, List<String> instrumentPropertyKeys, final ApiCallback<GetReferencePortfolioConstituentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getReferencePortfolioConstituentsValidateBeforeCall(scope, code, effectiveAt, asAt, sortBy, start, limit, instrumentPropertyKeys, _callback);
        Type localVarReturnType = new TypeToken<GetReferencePortfolioConstituentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EARLY ACCESS] Gets constituents adjustments in an interval of effective time. (asynchronously)
     * Specify a time period in which you&#39;d like to see the list of times that adjustments where made to this portfolio
     * @param scope The scope of the portfolio (required)
     * @param code Code for the portfolio (required)
     * @param fromEffectiveAt Events between this time (inclusive) and the toEffectiveAt are returned. (optional)
    ...
    /**
     * [EARLY ACCESS] Add constituents (asynchronously)
     * Add constituents to the specified reference portfolio.
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param constituents The constituents to upload to the portfolio (optional)
