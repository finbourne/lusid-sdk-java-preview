...
public class InstrumentEventTypesApi {
     ...
     */
    public okhttp3.Call createTransactionTemplateCall(String instrumentEventType, String instrumentType, String scope, TransactionTemplateRequest transactionTemplateRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/instrumenteventtypes/{instrumentEventType}/transactiontemplates/{instrumentType}/{scope}"
            .replaceAll("\\{" + "instrumentEventType" + "\\}", localVarApiClient.escapeString(instrumentEventType.toString()))
    ...
    private okhttp3.Call createTransactionTemplateValidateBeforeCall(String instrumentEventType, String instrumentType, String scope, TransactionTemplateRequest transactionTemplateRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createTransactionTemplateCall(instrumentEventType, instrumentType, scope, transactionTemplateRequest, _callback);
        return localVarCall;
     ...
     */
    public TransactionTemplateResponse createTransactionTemplate(String instrumentEventType, String instrumentType, String scope, TransactionTemplateRequest transactionTemplateRequest) throws ApiException {
     ...
     */
    public ApiResponse<TransactionTemplateResponse> createTransactionTemplateWithHttpInfo(String instrumentEventType, String instrumentType, String scope, TransactionTemplateRequest transactionTemplateRequest) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] CreateTransactionTemplate: Create Transaction Template (asynchronously)
     * Create a transaction template for a particular instrument event type in a scope.
     * @param instrumentEventType The type of instrument events that the template is applied to. (required)
     * @param instrumentType The template is applied to events which originate from instruments of this type (required)
     * @param scope The scope in which the template lies. (required)
     ...
     */
    public okhttp3.Call createTransactionTemplateAsync(String instrumentEventType, String instrumentType, String scope, TransactionTemplateRequest transactionTemplateRequest, final ApiCallback<TransactionTemplateResponse> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getTransactionTemplateSpecificationCall(String instrumentEventType, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call getTransactionTemplateSpecificationValidateBeforeCall(String instrumentEventType, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTransactionTemplateSpecificationCall(instrumentEventType, _callback);
        return localVarCall;
     ...
     */
    public TransactionTemplateSpecification getTransactionTemplateSpecification(String instrumentEventType) throws ApiException {
     ...
     */
    public ApiResponse<TransactionTemplateSpecification> getTransactionTemplateSpecificationWithHttpInfo(String instrumentEventType) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] GetTransactionTemplateSpecification: Get Transaction Template Specification. (asynchronously)
     * Retrieve the transaction template specification for a particular event type.
     * @param instrumentEventType The requested instrument event type. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call getTransactionTemplateSpecificationAsync(String instrumentEventType, final ApiCallback<TransactionTemplateSpecification> _callback) throws ApiException {
