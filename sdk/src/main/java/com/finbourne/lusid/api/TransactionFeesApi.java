...
public class TransactionFeesApi {
     ...
     */
    public okhttp3.Call deleteFeeRuleCall(String code, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteFeeRuleValidateBeforeCall(String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deleteFeeRule(Async)");
        }
        

        okhttp3.Call localVarCall = deleteFeeRuleCall(code, _callback);
        return localVarCall;
     ...
     */
    public DeletedEntityResponse deleteFeeRule(String code) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteFeeRuleWithHttpInfo(code);
     ...
     */
    public ApiResponse<DeletedEntityResponse> deleteFeeRuleWithHttpInfo(String code) throws ApiException {
        okhttp3.Call localVarCall = deleteFeeRuleValidateBeforeCall(code, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] DeleteFeeRule: Deletes a fee rule. (asynchronously)
     * &lt;br&gt;              Deletes the rule for all effective time.                &lt;br&gt;              The rule will remain viewable at previous as at times, but it will no longer be considered by              GetApplicableFees.                &lt;br&gt;              This cannot be undone.              
     * @param code The fee rule code. (required)
     ...
     */
    public okhttp3.Call deleteFeeRuleAsync(String code, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = deleteFeeRuleValidateBeforeCall(code, _callback);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
    ...
    private okhttp3.Call getApplicableTransactionFeesValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String instrumentIdentifierType, String instrumentIdentifier, String portfolioScope, String portfolioCode, Map<String, String> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getApplicableTransactionFeesCall(effectiveAt, asAt, instrumentIdentifierType, instrumentIdentifier, portfolioScope, portfolioCode, requestBody, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getTransactionFeeRuleValidateBeforeCall(String code, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTransactionFeeRuleCall(code, effectiveAt, asAt, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listTransactionFeeRulesValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listTransactionFeeRulesCall(effectiveAt, asAt, limit, filter, page, _callback);
        return localVarCall;
    ...
    private okhttp3.Call upsertTransactionFeeRulesValidateBeforeCall(Map<String, FeeRuleUpsertRequest> requestBody, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertTransactionFeeRulesCall(requestBody, effectiveAt, _callback);
        return localVarCall;
