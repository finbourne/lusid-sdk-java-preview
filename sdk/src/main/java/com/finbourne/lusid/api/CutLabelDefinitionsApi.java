...
public class CutLabelDefinitionsApi {
     ...
     */
    public okhttp3.Call listCutLabelDefinitionsCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listCutLabelDefinitionsValidateBeforeCall(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listCutLabelDefinitionsCall(asAt, sortBy, limit, filter, page, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfCutLabelDefinition listCutLabelDefinitions(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page) throws ApiException {
     ...
     */
    public ApiResponse<PagedResourceListOfCutLabelDefinition> listCutLabelDefinitionsWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page) throws ApiException {
     ...
     */
    public okhttp3.Call listCutLabelDefinitionsAsync(OffsetDateTime asAt, List<String> sortBy, Integer limit, String filter, String page, final ApiCallback<PagedResourceListOfCutLabelDefinition> _callback) throws ApiException {
