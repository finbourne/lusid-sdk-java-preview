...
public class OrderGraphApi {
     ...
     */
    public okhttp3.Call listOrderGraphBlocksCall(OffsetDateTime asAt, String paginationToken, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listOrderGraphBlocksValidateBeforeCall(OffsetDateTime asAt, String paginationToken, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listOrderGraphBlocksCall(asAt, paginationToken, sortBy, limit, filter, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfOrderGraphBlock listOrderGraphBlocks(OffsetDateTime asAt, String paginationToken, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        ApiResponse<PagedResourceListOfOrderGraphBlock> localVarResp = listOrderGraphBlocksWithHttpInfo(asAt, paginationToken, sortBy, limit, filter, propertyKeys);
     ...
     */
    public ApiResponse<PagedResourceListOfOrderGraphBlock> listOrderGraphBlocksWithHttpInfo(OffsetDateTime asAt, String paginationToken, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = listOrderGraphBlocksValidateBeforeCall(asAt, paginationToken, sortBy, limit, filter, propertyKeys, null);
     ...
     */
    public okhttp3.Call listOrderGraphBlocksAsync(OffsetDateTime asAt, String paginationToken, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfOrderGraphBlock> _callback) throws ApiException {
        okhttp3.Call localVarCall = listOrderGraphBlocksValidateBeforeCall(asAt, paginationToken, sortBy, limit, filter, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfOrderGraphBlock>(){}.getType();
    ...
    private okhttp3.Call listOrderGraphPlacementsValidateBeforeCall(OffsetDateTime asAt, String paginationToken, List<String> sortBy, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listOrderGraphPlacementsCall(asAt, paginationToken, sortBy, limit, filter, propertyKeys, _callback);
        return localVarCall;
