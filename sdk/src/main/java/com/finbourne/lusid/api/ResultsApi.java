...
public class ResultsApi {
    ...
    public okhttp3.Call getResultsCall(String entityScope, String entityCode, String calculationScope, String calculationCode, OffsetDateTime effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.11.1527");
     ...
     * @param createResults The details of what to upsert (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertResultsCall(CreateResults createResults, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = createResults;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertResultsValidateBeforeCall(CreateResults createResults, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = upsertResultsCall(createResults, _callback);
        return localVarCall;
     ...
     */
    public Results upsertResults(CreateResults createResults) throws ApiException {
        ApiResponse<Results> localVarResp = upsertResultsWithHttpInfo(createResults);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Results> upsertResultsWithHttpInfo(CreateResults createResults) throws ApiException {
        okhttp3.Call localVarCall = upsertResultsValidateBeforeCall(createResults, null);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call upsertResultsAsync(CreateResults createResults, final ApiCallback<Results> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertResultsValidateBeforeCall(createResults, _callback);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
