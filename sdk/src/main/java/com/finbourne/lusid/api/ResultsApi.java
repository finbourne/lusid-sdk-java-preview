...
public class ResultsApi {
     ...
     */
    public com.squareup.okhttp.Call getResultsCall(String entityScope, String entityCode, String calculationScope, String calculationCode, OffsetDateTime effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/results/{entityScope}/{entityCode}/{calculationScope}/{calculationCode}/{effectiveAt}"
            .replaceAll("\\{" + "entityScope" + "\\}", apiClient.escapeString(entityScope.toString()))
            .replaceAll("\\{" + "entityCode" + "\\}", apiClient.escapeString(entityCode.toString()))
            .replaceAll("\\{" + "calculationScope" + "\\}", apiClient.escapeString(calculationScope.toString()))
            .replaceAll("\\{" + "calculationCode" + "\\}", apiClient.escapeString(calculationCode.toString()))
    ...
    private com.squareup.okhttp.Call getResultsValidateBeforeCall(String entityScope, String entityCode, String calculationScope, String calculationCode, OffsetDateTime effectiveAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getResultsCall(entityScope, entityCode, calculationScope, calculationCode, effectiveAt, progressListener, progressRequestListener);
        return call;
    ...
    public Results getResults(String entityScope, String entityCode, String calculationScope, String calculationCode, OffsetDateTime effectiveAt) throws ApiException {
        ApiResponse<Results> resp = getResultsWithHttpInfo(entityScope, entityCode, calculationScope, calculationCode, effectiveAt);
        return resp.getData();
    }
    ...
    public ApiResponse<Results> getResultsWithHttpInfo(String entityScope, String entityCode, String calculationScope, String calculationCode, OffsetDateTime effectiveAt) throws ApiException {
        com.squareup.okhttp.Call call = getResultsValidateBeforeCall(entityScope, entityCode, calculationScope, calculationCode, effectiveAt, null, null);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Retrieve a page of results all keyed by the provided parameters. The result store is not bi-temporal; a single date  addressed the market effectiveAt. (asynchronously)
     * Retrieve pre-calculated results that have been stored in LUSID.
     * @param entityScope The scope of the data or entity being stored (required)
     * @param entityCode The identifier for the data or results entity being stored (required)
     * @param calculationScope The identifying scope for the calculation that produced the result (required)
     ...
     */
    public com.squareup.okhttp.Call getResultsAsync(String entityScope, String entityCode, String calculationScope, String calculationCode, OffsetDateTime effectiveAt, final ApiCallback<Results> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getResultsValidateBeforeCall(entityScope, entityCode, calculationScope, calculationCode, effectiveAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call upsertResultsCall(CreateResults request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call upsertResultsValidateBeforeCall(CreateResults request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = upsertResultsCall(request, progressListener, progressRequestListener);
        return call;
    ...
    public Results upsertResults(CreateResults request) throws ApiException {
        ApiResponse<Results> resp = upsertResultsWithHttpInfo(request);
        return resp.getData();
    }
    ...
    public ApiResponse<Results> upsertResultsWithHttpInfo(CreateResults request) throws ApiException {
        com.squareup.okhttp.Call call = upsertResultsValidateBeforeCall(request, null, null);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Upsert results (asynchronously)
     * Upsert pre-calculated results against a specified combination of key parameters defined in the CreateResults request.
     * @param request The details of what to upsert (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call upsertResultsAsync(CreateResults request, final ApiCallback<Results> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = upsertResultsValidateBeforeCall(request, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Results>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
