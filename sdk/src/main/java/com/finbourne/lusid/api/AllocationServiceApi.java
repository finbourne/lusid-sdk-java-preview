...
import com.finbourne.lusid.model.AllocationServiceRunResult;
...
public class AllocationServiceApi {
    private ApiClient localVarApiClient;
    public AllocationServiceApi() {
        this(Configuration.getDefaultApiClient());
    }

    public AllocationServiceApi(ApiClient apiClient) {
    ...
    public okhttp3.Call runAllocationServiceCall(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/allocationservice/allocate";
    ...
    private okhttp3.Call runAllocationServiceValidateBeforeCall(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = runAllocationServiceCall(resourceId, allocationAlgorithm, _callback);
        return localVarCall;
     ...
     * @param resourceId The List of Placement IDs for which you wish to allocate executions. (required)
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)
     * @return AllocationServiceRunResult
     ...
     */
    public AllocationServiceRunResult runAllocationService(List<ResourceId> resourceId, String allocationAlgorithm) throws ApiException {
        ApiResponse<AllocationServiceRunResult> localVarResp = runAllocationServiceWithHttpInfo(resourceId, allocationAlgorithm);
     ...
     * @param resourceId The List of Placement IDs for which you wish to allocate executions. (required)
     * @param allocationAlgorithm A string representation of the allocation algorithm you would like to use to allocate shares from executions e.g. \&quot;PR-FIFO\&quot;.  This defaults to \&quot;PR-FIFO\&quot;. (optional)
     * @return ApiResponse&lt;AllocationServiceRunResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AllocationServiceRunResult> runAllocationServiceWithHttpInfo(List<ResourceId> resourceId, String allocationAlgorithm) throws ApiException {
        okhttp3.Call localVarCall = runAllocationServiceValidateBeforeCall(resourceId, allocationAlgorithm, null);
        Type localVarReturnType = new TypeToken<AllocationServiceRunResult>(){}.getType();
     ...
     */
    public okhttp3.Call runAllocationServiceAsync(List<ResourceId> resourceId, String allocationAlgorithm, final ApiCallback<AllocationServiceRunResult> _callback) throws ApiException {
