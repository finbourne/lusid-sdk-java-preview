...
public class TransactionPortfoliosApi {
     ...
     * @param instrumentIdentifierCollection The dictionary with the instrument identifiers to be updated on the              transaction and holdings. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call resolveInstrumentCall(String scope, String code, String instrumentIdentifierType, String instrumentIdentifierValue, String fromEffectiveAt, Map<String, String> instrumentIdentifierCollection, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = instrumentIdentifierCollection;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call resolveInstrumentValidateBeforeCall(String scope, String code, String instrumentIdentifierType, String instrumentIdentifierValue, String fromEffectiveAt, Map<String, String> instrumentIdentifierCollection, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = resolveInstrumentCall(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection, _callback);
        return localVarCall;
     ...
     */
    public UpsertPortfolioTransactionsResponse resolveInstrument(String scope, String code, String instrumentIdentifierType, String instrumentIdentifierValue, String fromEffectiveAt, Map<String, String> instrumentIdentifierCollection) throws ApiException {
        ApiResponse<UpsertPortfolioTransactionsResponse> localVarResp = resolveInstrumentWithHttpInfo(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertPortfolioTransactionsResponse> resolveInstrumentWithHttpInfo(String scope, String code, String instrumentIdentifierType, String instrumentIdentifierValue, String fromEffectiveAt, Map<String, String> instrumentIdentifierCollection) throws ApiException {
        okhttp3.Call localVarCall = resolveInstrumentValidateBeforeCall(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection, null);
     ...
     */
    public okhttp3.Call resolveInstrumentAsync(String scope, String code, String instrumentIdentifierType, String instrumentIdentifierValue, String fromEffectiveAt, Map<String, String> instrumentIdentifierCollection, final ApiCallback<UpsertPortfolioTransactionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = resolveInstrumentValidateBeforeCall(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection, _callback);
        Type localVarReturnType = new TypeToken<UpsertPortfolioTransactionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
