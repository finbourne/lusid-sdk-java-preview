...
public class TransactionPortfoliosApi {
     ...
     * @param scope The scope of the transaction portfolio. (required)
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
     * @param tradeTicket the trade ticket to upsert (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call createTradeTicketCall(String scope, String code, TradeTicket tradeTicket, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = tradeTicket;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createTradeTicketValidateBeforeCall(String scope, String code, TradeTicket tradeTicket, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = createTradeTicketCall(scope, code, tradeTicket, _callback);
        return localVarCall;
     ...
     */
    public TradeTicket createTradeTicket(String scope, String code, TradeTicket tradeTicket) throws ApiException {
        ApiResponse<TradeTicket> localVarResp = createTradeTicketWithHttpInfo(scope, code, tradeTicket);
        return localVarResp.getData();
    }
     ...
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
     * @param tradeTicket the trade ticket to upsert (optional)
     * @return ApiResponse&lt;TradeTicket&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<TradeTicket> createTradeTicketWithHttpInfo(String scope, String code, TradeTicket tradeTicket) throws ApiException {
        okhttp3.Call localVarCall = createTradeTicketValidateBeforeCall(scope, code, tradeTicket, null);
        Type localVarReturnType = new TypeToken<TradeTicket>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createTradeTicketAsync(String scope, String code, TradeTicket tradeTicket, final ApiCallback<TradeTicket> _callback) throws ApiException {
        okhttp3.Call localVarCall = createTradeTicketValidateBeforeCall(scope, code, tradeTicket, _callback);
        Type localVarReturnType = new TypeToken<TradeTicket>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call lookThroughHoldingsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String filter, List<String> propertyKeys, String quotesScope, String slice, String shareClass, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = lookThroughHoldingsCall(scope, code, effectiveAt, asAt, filter, propertyKeys, quotesScope, slice, shareClass, _callback);
        return localVarCall;
    ...
    private okhttp3.Call lookThroughTransactionsValidateBeforeCall(String scope, String code, String fromTransactionDate, String toTransactionDate, OffsetDateTime asAt, String filter, List<String> propertyKeys, String page, Integer limit, String quotesScope, String slice, String shareClass, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = lookThroughTransactionsCall(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, quotesScope, slice, shareClass, _callback);
        return localVarCall;
     ...
     */
    public VersionedResourceListOfTransaction lookThroughTransactions(String scope, String code, String fromTransactionDate, String toTransactionDate, OffsetDateTime asAt, String filter, List<String> propertyKeys, String page, Integer limit, String quotesScope, String slice, String shareClass) throws ApiException {
        ApiResponse<VersionedResourceListOfTransaction> localVarResp = lookThroughTransactionsWithHttpInfo(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, quotesScope, slice, shareClass);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<VersionedResourceListOfTransaction> lookThroughTransactionsWithHttpInfo(String scope, String code, String fromTransactionDate, String toTransactionDate, OffsetDateTime asAt, String filter, List<String> propertyKeys, String page, Integer limit, String quotesScope, String slice, String shareClass) throws ApiException {
        okhttp3.Call localVarCall = lookThroughTransactionsValidateBeforeCall(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, quotesScope, slice, shareClass, null);
        Type localVarReturnType = new TypeToken<VersionedResourceListOfTransaction>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call lookThroughTransactionsAsync(String scope, String code, String fromTransactionDate, String toTransactionDate, OffsetDateTime asAt, String filter, List<String> propertyKeys, String page, Integer limit, String quotesScope, String slice, String shareClass, final ApiCallback<VersionedResourceListOfTransaction> _callback) throws ApiException {
        okhttp3.Call localVarCall = lookThroughTransactionsValidateBeforeCall(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, quotesScope, slice, shareClass, _callback);
        Type localVarReturnType = new TypeToken<VersionedResourceListOfTransaction>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
