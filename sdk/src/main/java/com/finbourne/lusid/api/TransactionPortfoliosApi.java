...
public class TransactionPortfoliosApi {
     ...
     */
    public okhttp3.Call getBucketedCashFlowsCall(String scope, String code, Boolean excludeUnsettledTrades, BucketedCashFlowRequest bucketedCashFlowRequest, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getBucketedCashFlowsValidateBeforeCall(String scope, String code, Boolean excludeUnsettledTrades, BucketedCashFlowRequest bucketedCashFlowRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getBucketedCashFlowsCall(scope, code, excludeUnsettledTrades, bucketedCashFlowRequest, _callback);
        return localVarCall;
     ...
     */
    public BucketedCashFlowResponse getBucketedCashFlows(String scope, String code, Boolean excludeUnsettledTrades, BucketedCashFlowRequest bucketedCashFlowRequest) throws ApiException {
        ApiResponse<BucketedCashFlowResponse> localVarResp = getBucketedCashFlowsWithHttpInfo(scope, code, excludeUnsettledTrades, bucketedCashFlowRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<BucketedCashFlowResponse> getBucketedCashFlowsWithHttpInfo(String scope, String code, Boolean excludeUnsettledTrades, BucketedCashFlowRequest bucketedCashFlowRequest) throws ApiException {
        okhttp3.Call localVarCall = getBucketedCashFlowsValidateBeforeCall(scope, code, excludeUnsettledTrades, bucketedCashFlowRequest, null);
     ...
     */
    public okhttp3.Call getBucketedCashFlowsAsync(String scope, String code, Boolean excludeUnsettledTrades, BucketedCashFlowRequest bucketedCashFlowRequest, final ApiCallback<BucketedCashFlowResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = getBucketedCashFlowsValidateBeforeCall(scope, code, excludeUnsettledTrades, bucketedCashFlowRequest, _callback);
        Type localVarReturnType = new TypeToken<BucketedCashFlowResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
