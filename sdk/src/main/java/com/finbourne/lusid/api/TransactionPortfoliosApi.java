...
public class TransactionPortfoliosApi {
    ...
    private okhttp3.Call deleteCustodianAccountsValidateBeforeCall(String scope, String code, List<ResourceId> resourceId, String deleteMode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteCustodianAccountsCall(scope, code, resourceId, deleteMode, _callback);
        return localVarCall;
    ...
    public okhttp3.Call getCustodianAccountCall(String scope, String code, String custodianAccountScope, String custodianAccountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/transactionportfolios/{scope}/{code}/custodianaccounts/{custodianAccountScope}/{custodianAccountCode}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()))
            .replaceAll("\\{" + "custodianAccountScope" + "\\}", localVarApiClient.escapeString(custodianAccountScope.toString()))
            .replaceAll("\\{" + "custodianAccountCode" + "\\}", localVarApiClient.escapeString(custodianAccountCode.toString()));
    ...
    private okhttp3.Call getCustodianAccountValidateBeforeCall(String scope, String code, String custodianAccountScope, String custodianAccountCode, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getCustodianAccountCall(scope, code, custodianAccountScope, custodianAccountCode, effectiveAt, asAt, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call getHoldingContributorsCall(String scope, String code, Long holdingId, OffsetDateTime effectiveDate, OffsetDateTime fromTradeDate, OffsetDateTime toTradeDate, Boolean includeHistoric, String taxLotId, Integer limit, OffsetDateTime asAt, String page, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
        ...
        String localVarPath = "/api/transactionportfolios/{scope}/{code}/holdings/{holdingId}/contributors"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()))
            .replaceAll("\\{" + "holdingId" + "\\}", localVarApiClient.escapeString(holdingId.toString()));
    ...
    private okhttp3.Call getHoldingContributorsValidateBeforeCall(String scope, String code, Long holdingId, OffsetDateTime effectiveDate, OffsetDateTime fromTradeDate, OffsetDateTime toTradeDate, Boolean includeHistoric, String taxLotId, Integer limit, OffsetDateTime asAt, String page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getHoldingContributorsCall(scope, code, holdingId, effectiveDate, fromTradeDate, toTradeDate, includeHistoric, taxLotId, limit, asAt, page, _callback);
        return localVarCall;
     ...
     */
    public VersionedResourceListOfHoldingContributor getHoldingContributors(String scope, String code, Long holdingId, OffsetDateTime effectiveDate, OffsetDateTime fromTradeDate, OffsetDateTime toTradeDate, Boolean includeHistoric, String taxLotId, Integer limit, OffsetDateTime asAt, String page) throws ApiException {
     ...
     */
    public ApiResponse<VersionedResourceListOfHoldingContributor> getHoldingContributorsWithHttpInfo(String scope, String code, Long holdingId, OffsetDateTime effectiveDate, OffsetDateTime fromTradeDate, OffsetDateTime toTradeDate, Boolean includeHistoric, String taxLotId, Integer limit, OffsetDateTime asAt, String page) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] GetHoldingContributors: Get Holdings Contributors (asynchronously)
     * Lists all transactions that affect the holdings of a portfolio over a given effective interval. This includes  transactions automatically generated by LUSID such as holding adjustments.
     * @param scope The scope of the transaction portfolio. (required)
     * @param code The code of the transaction portfolio. Together with the scope this uniquely identifies              the transaction portfolio. (required)
     * @param holdingId The unique holding identifier (required)
    ...
    private okhttp3.Call getPortfolioCashFlowsValidateBeforeCall(String scope, String code, String effectiveAt, String windowStart, String windowEnd, OffsetDateTime asAt, String filter, String recipeIdScope, String recipeIdCode, Boolean excludeUnsettledTrades, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getPortfolioCashFlowsCall(scope, code, effectiveAt, windowStart, windowEnd, asAt, filter, recipeIdScope, recipeIdCode, excludeUnsettledTrades, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getTransactionsValidateBeforeCall(String scope, String code, String fromTransactionDate, String toTransactionDate, OffsetDateTime asAt, String filter, List<String> propertyKeys, String page, Integer limit, Boolean showCancelledTransactions, List<String> sortBy, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTransactionsCall(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit, showCancelledTransactions, sortBy, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getUpsertablePortfolioCashFlowsValidateBeforeCall(String scope, String code, String effectiveAt, String windowStart, String windowEnd, OffsetDateTime asAt, String filter, String recipeIdScope, String recipeIdCode, Boolean excludeUnsettledTrades, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getUpsertablePortfolioCashFlowsCall(scope, code, effectiveAt, windowStart, windowEnd, asAt, filter, recipeIdScope, recipeIdCode, excludeUnsettledTrades, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call listCustodianAccountsCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listCustodianAccountsValidateBeforeCall(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listCustodianAccountsCall(scope, code, effectiveAt, asAt, page, limit, filter, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfCustodianAccount listCustodianAccounts(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
     ...
     */
    public ApiResponse<PagedResourceListOfCustodianAccount> listCustodianAccountsWithHttpInfo(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
     ...
     */
    public okhttp3.Call listCustodianAccountsAsync(String scope, String code, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfCustodianAccount> _callback) throws ApiException {
    ...
    private okhttp3.Call upsertCustodianAccountsValidateBeforeCall(String scope, String code, List<CustodianAccountRequest> custodianAccountRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertCustodianAccountsCall(scope, code, custodianAccountRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call upsertCustodianAccountsPropertiesValidateBeforeCall(String scope, String code, String custodianAccountScope, String custodianAccountCode, Map<String, Property> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertCustodianAccountsPropertiesCall(scope, code, custodianAccountScope, custodianAccountCode, requestBody, _callback);
        return localVarCall;
