...
public class TransactionPortfoliosApi {
     ...
     */
    public ResourceListOfPortfolioCashFlow getPortfolioCashFlows(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, String filter, String recipeIdScope, String recipeIdCode) throws ApiException {
        ApiResponse<ResourceListOfPortfolioCashFlow> localVarResp = getPortfolioCashFlowsWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt, filter, recipeIdScope, recipeIdCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioCashFlow> getPortfolioCashFlowsWithHttpInfo(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, String filter, String recipeIdScope, String recipeIdCode) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] Get cashflow for the given portfolio. (asynchronously)
     * Get cashflow for the given portfolio.
     * @param scope The scope of the portfolio to retrieve the cashflow for. (required)
     * @param code The code of the portfolio to retrieve the cashflow for. Together with the scope this              uniquely identifies the portfolio. (required)
     * @param fromEffectiveAt The lower bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no lower bound if this is not specified. (required)
     ...
     */
    public okhttp3.Call getPortfolioCashFlowsAsync(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, String filter, String recipeIdScope, String recipeIdCode, final ApiCallback<ResourceListOfPortfolioCashFlow> _callback) throws ApiException {
