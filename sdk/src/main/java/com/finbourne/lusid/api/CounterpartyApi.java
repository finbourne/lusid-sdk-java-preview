...
public class CounterpartyApi {
     ...
     * @param scope The scope of the Counterparty to delete. (required)
     * @param code The Counterparty to delete. (required)
     ...
     */
    public okhttp3.Call deleteCounterpartyCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/counterparties/counterparties/counterparty/{scope}/{code}"
    ...
    private okhttp3.Call deleteCounterpartyValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deleteCounterparty(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deleteCounterparty(Async)");
        }
        

        okhttp3.Call localVarCall = deleteCounterpartyCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public AnnulSingleStructuredDataResponse deleteCounterparty(String scope, String code) throws ApiException {
        ApiResponse<AnnulSingleStructuredDataResponse> localVarResp = deleteCounterpartyWithHttpInfo(scope, code);
     ...
     */
    public ApiResponse<AnnulSingleStructuredDataResponse> deleteCounterpartyWithHttpInfo(String scope, String code) throws ApiException {
        okhttp3.Call localVarCall = deleteCounterpartyValidateBeforeCall(scope, code, null);
        Type localVarReturnType = new TypeToken<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Delete the Counterparty of given scope and code, assuming that it is present. (asynchronously)
     * Delete the specified Counterparty from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.
     * @param scope The scope of the Counterparty to delete. (required)
     * @param code The Counterparty to delete. (required)
     ...
     */
    public okhttp3.Call deleteCounterpartyAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteCounterpartyValidateBeforeCall(scope, code, _callback);
        Type localVarReturnType = new TypeToken<AnnulSingleStructuredDataResponse>(){}.getType();
     ...
     * @param scope The scope of the CSA to delete. (required)
     * @param code The CSA to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    public okhttp3.Call deleteCreditSupportAnnexCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/counterparties/counterparties/csa/{scope}/{code}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    /**
     * [EXPERIMENTAL] Delete the CSA of given scope and code, assuming that it is present. (asynchronously)
     * Delete the specified CSA from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.
     * @param scope The scope of the CSA to delete. (required)
     * @param code The CSA to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param scope The scope of the Counterparty to retrieve. (required)
     * @param code The name of the Counterparty to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The successfully retrieved counterparty or any failure </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getCounterpartyCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getCounterpartyValidateBeforeCall(String scope, String code, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getCounterparty(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getCounterparty(Async)");
        }
        

        okhttp3.Call localVarCall = getCounterpartyCall(scope, code, asAt, _callback);
        return localVarCall;
     ...
     */
    public GetCounterpartyResponse getCounterparty(String scope, String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<GetCounterpartyResponse> localVarResp = getCounterpartyWithHttpInfo(scope, code, asAt);
        return localVarResp.getData();
    }
     ...
     * @param code The name of the Counterparty to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)
     * @return ApiResponse&lt;GetCounterpartyResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetCounterpartyResponse> getCounterpartyWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getCounterpartyValidateBeforeCall(scope, code, asAt, null);
        Type localVarReturnType = new TypeToken<GetCounterpartyResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get Counterparty (asynchronously)
     * Get a Counterparty from a single scope.  The response will return either the counterparty that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
     * @param scope The scope of the Counterparty to retrieve. (required)
     * @param code The name of the Counterparty to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the counterparty. Defaults to return the latest version if not specified. (optional)
     ...
     */
    public okhttp3.Call getCounterpartyAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetCounterpartyResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getCounterpartyValidateBeforeCall(scope, code, asAt, _callback);
        Type localVarReturnType = new TypeToken<GetCounterpartyResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param scope The scope of the CSA to retrieve. (required)
     * @param code The name of the CSA to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the CSA. Defaults to return the latest version if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * [EXPERIMENTAL] Get CSA (asynchronously)
     * Get a CSA from a single scope.  The response will return either the CSA that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
     * @param scope The scope of the CSA to retrieve. (required)
     * @param code The name of the CSA to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the CSA. Defaults to return the latest version if not specified. (optional)
     ...
     * @param asAt The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The requested counterparties </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listCounterpartiesCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/counterparties/counterparties/counterparty";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listCounterpartiesValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listCounterpartiesCall(asAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfGetCounterpartyResponse listCounterparties(OffsetDateTime asAt) throws ApiException {
        ApiResponse<ResourceListOfGetCounterpartyResponse> localVarResp = listCounterpartiesWithHttpInfo(asAt);
        return localVarResp.getData();
    }
     ...
     * List the set of Counterparties at the specified AsAt date/time
     * @param asAt The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetCounterpartyResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResourceListOfGetCounterpartyResponse> listCounterpartiesWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = listCounterpartiesValidateBeforeCall(asAt, null);
        Type localVarReturnType = new TypeToken<ResourceListOfGetCounterpartyResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] List the set of Counterparties (asynchronously)
     * List the set of Counterparties at the specified AsAt date/time
     * @param asAt The asAt datetime at which to list the counterparty. Defaults to latest if not specified. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call listCounterpartiesAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetCounterpartyResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listCounterpartiesValidateBeforeCall(asAt, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfGetCounterpartyResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param asAt The asAt datetime at which to list the CSAs. Defaults to latest if not specified. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The requested CSAs </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listCreditSupportAnnexesCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/counterparties/counterparties/csa";
    ...
    /**
     * [EXPERIMENTAL] List the set of CSAs (asynchronously)
     * List the set of CSAs at the specified AsAt date/time
     * @param asAt The asAt datetime at which to list the CSAs. Defaults to latest if not specified. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * Build call for upsertCounterparty
     * @param upsertCounterpartyRequest The Counterparty to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertCounterpartyCall(UpsertCounterpartyRequest upsertCounterpartyRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = upsertCounterpartyRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertCounterpartyValidateBeforeCall(UpsertCounterpartyRequest upsertCounterpartyRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'upsertCounterpartyRequest' is set
        if (upsertCounterpartyRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertCounterpartyRequest' when calling upsertCounterparty(Async)");
        }
        

        okhttp3.Call localVarCall = upsertCounterpartyCall(upsertCounterpartyRequest, _callback);
        return localVarCall;
     ...
     */
    public UpsertSingleStructuredDataResponse upsertCounterparty(UpsertCounterpartyRequest upsertCounterpartyRequest) throws ApiException {
        ApiResponse<UpsertSingleStructuredDataResponse> localVarResp = upsertCounterpartyWithHttpInfo(upsertCounterpartyRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertSingleStructuredDataResponse> upsertCounterpartyWithHttpInfo(UpsertCounterpartyRequest upsertCounterpartyRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertCounterpartyValidateBeforeCall(upsertCounterpartyRequest, null);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert Counterparty. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert Counterparty in a single scope. An item will be updated if it already exists and inserted if it does not.                The response will return the successfully updated or inserted Counterparty or failure message if unsuccessful                It is important to always check to verify success (or failure).
     * @param upsertCounterpartyRequest The Counterparty to update or insert (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertCounterpartyAsync(UpsertCounterpartyRequest upsertCounterpartyRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertCounterpartyValidateBeforeCall(upsertCounterpartyRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param upsertCreditSupportAnnexRequest The CSA to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * [EXPERIMENTAL] Upsert CSA. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert CSA in a single scope. An item will be updated if it already exists and inserted if it does not.                The response will return the successfully updated or inserted CSA or failure message if unsuccessful                It is important to always check to verify success (or failure).
     * @param upsertCreditSupportAnnexRequest The CSA to update or insert (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
