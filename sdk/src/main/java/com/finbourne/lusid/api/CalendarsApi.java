...
public class CalendarsApi {
    ...
    public okhttp3.Call addDateToCalendarCall(String scope, String code, CreateDateRequest createDateRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/calendar/generic/{scope}/{code}/dates"
     ...
     */
    public java.util.Date addDateToCalendar(String scope, String code, CreateDateRequest createDateRequest) throws ApiException {
        ApiResponse<java.util.Date> localVarResp = addDateToCalendarWithHttpInfo(scope, code, createDateRequest);
     ...
     * @param code Code of the calendar (required)
     * @param createDateRequest Add date to calendar request (required)
     * @return ApiResponse&lt;java.util.Date&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<java.util.Date> addDateToCalendarWithHttpInfo(String scope, String code, CreateDateRequest createDateRequest) throws ApiException {
        okhttp3.Call localVarCall = addDateToCalendarValidateBeforeCall(scope, code, createDateRequest, null);
        Type localVarReturnType = new TypeToken<java.util.Date>(){}.getType();
     ...
     */
    public okhttp3.Call addDateToCalendarAsync(String scope, String code, CreateDateRequest createDateRequest, final ApiCallback<java.util.Date> _callback) throws ApiException {
    ...
    public okhttp3.Call createCalendarCall(CreateCalendarRequest createCalendarRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/calendar/generic";
    ...
    public okhttp3.Call deleteCalendarCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/calendar/generic/{scope}/{code}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    public okhttp3.Call deleteDateFromCalendarCall(String scope, String code, String dateId, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/calendar/generic/{scope}/{code}/dates/{dateId}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()))
     ...
     */
    public java.util.Date deleteDateFromCalendar(String scope, String code, String dateId) throws ApiException {
        ApiResponse<java.util.Date> localVarResp = deleteDateFromCalendarWithHttpInfo(scope, code, dateId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<java.util.Date> deleteDateFromCalendarWithHttpInfo(String scope, String code, String dateId) throws ApiException {
     ...
     */
    public okhttp3.Call deleteDateFromCalendarAsync(String scope, String code, String dateId, final ApiCallback<java.util.Date> _callback) throws ApiException {
     ...
     */
    public ResourceListOfDate getDates(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> idFilter) throws ApiException {
        ApiResponse<ResourceListOfDate> localVarResp = getDatesWithHttpInfo(scope, code, fromEffectiveAt, toEffectiveAt, asAt, idFilter);
        return localVarResp.getData();
    }
     ...
     * @param asAt AsAt the dates should be retrieved at (optional)
     * @param idFilter An additional filter that will filter dates based on their identifer (optional)
     * @return ApiResponse&lt;ResourceListOfDate&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResourceListOfDate> getDatesWithHttpInfo(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> idFilter) throws ApiException {
        okhttp3.Call localVarCall = getDatesValidateBeforeCall(scope, code, fromEffectiveAt, toEffectiveAt, asAt, idFilter, null);
        Type localVarReturnType = new TypeToken<ResourceListOfDate>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getDatesAsync(String scope, String code, String fromEffectiveAt, String toEffectiveAt, OffsetDateTime asAt, List<String> idFilter, final ApiCallback<ResourceListOfDate> _callback) throws ApiException {
    ...
    public okhttp3.Call updateCalendarCall(String scope, String code, UpdateCalendarRequest updateCalendarRequest, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/calendar/generic/{scope}/{code}/mask"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
