...
public class CalendarsApi {
     ...
     * @param scope Scope of the calendars (optional)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> Get calendars </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listCalendarsCall(String scope, OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listCalendarsValidateBeforeCall(String scope, OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listCalendarsCall(scope, asAt, page, start, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfCalendar listCalendars(String scope, OffsetDateTime asAt, String page, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<PagedResourceListOfCalendar> localVarResp = listCalendarsWithHttpInfo(scope, asAt, page, start, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfCalendar> listCalendarsWithHttpInfo(String scope, OffsetDateTime asAt, String page, Integer start, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = listCalendarsValidateBeforeCall(scope, asAt, page, start, limit, filter, null);
        Type localVarReturnType = new TypeToken<PagedResourceListOfCalendar>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] List all calenders (asynchronously)
     * List calendars within a specific scope and a specific window of effective time, at a point in AsAt time.
     * @param scope Scope of the calendars (optional)
     * @param asAt The AsAt datetime at which to retrieve the calendars (optional)
     * @param page The pagination token to use to continue listing calendars from a previous call to list calendars.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     ...
     */
    public okhttp3.Call listCalendarsAsync(String scope, OffsetDateTime asAt, String page, Integer start, Integer limit, String filter, final ApiCallback<PagedResourceListOfCalendar> _callback) throws ApiException {

        okhttp3.Call localVarCall = listCalendarsValidateBeforeCall(scope, asAt, page, start, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfCalendar>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
