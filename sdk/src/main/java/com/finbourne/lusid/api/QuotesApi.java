...
public class QuotesApi {
     ...
     */
    public okhttp3.Call listQuotesCall(String scope, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listQuotesValidateBeforeCall(String scope, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listQuotesCall(scope, asAt, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfQuote listQuotes(String scope, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public ApiResponse<ResourceListOfQuote> listQuotesWithHttpInfo(String scope, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public okhttp3.Call listQuotesAsync(String scope, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfQuote> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call listQuotesForScopeCall(String scope, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listQuotesForScopeValidateBeforeCall(String scope, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listQuotesForScopeCall(scope, asAt, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfQuote listQuotesForScope(String scope, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public ApiResponse<ResourceListOfQuote> listQuotesForScopeWithHttpInfo(String scope, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public okhttp3.Call listQuotesForScopeAsync(String scope, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfQuote> _callback) throws ApiException {
    ...
    private okhttp3.Call upsertQuoteAccessMetadataRuleValidateBeforeCall(String scope, UpsertQuoteAccessMetadataRuleRequest upsertQuoteAccessMetadataRuleRequest, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertQuoteAccessMetadataRuleCall(scope, upsertQuoteAccessMetadataRuleRequest, effectiveAt, effectiveUntil, _callback);
        return localVarCall;
