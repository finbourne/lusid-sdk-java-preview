...
public class PortfolioGroupsApi {
    ...
    /**
     * [EXPERIMENTAL] GetA2BDataForPortfolioGroup: Get A2B data for a Portfolio Group (asynchronously)
     * Get an A2B report for all Transaction Portfolios within the given portfolio group.
     * @param scope The scope of the group to retrieve the A2B report for. (required)
     * @param code The code of the group to retrieve the A2B report for. Together with the scope this              uniquely identifies the portfolio group. (required)
     * @param fromEffectiveAt The lower bound effective datetime or cut label (inclusive) from which to retrieve the data.              There is no lower bound if this is not specified. (required)
    ...
    /**
     * [EXPERIMENTAL] GetPortfolioGroupRelationships: Get Relationships for Portfolio Group (asynchronously)
     * Get relationships for the specified Portfolio Group
     * @param scope The scope of the portfolio group. (required)
     * @param code The code of the portfolio group. Together with the scope this uniquely identifies              the portfolio group. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relationship. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public okhttp3.Call patchPortfolioGroupAccessMetadataCall(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchPortfolioGroupAccessMetadataValidateBeforeCall(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
        ...
        if (operation == null) {
            throw new ApiException("Missing the required parameter 'operation' when calling patchPortfolioGroupAccessMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = patchPortfolioGroupAccessMetadataCall(scope, code, operation, effectiveAt, effectiveUntil, _callback);
        return localVarCall;
     ...
     */
    public Map<String, List<AccessMetadataValue>> patchPortfolioGroupAccessMetadata(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        ApiResponse<Map<String, List<AccessMetadataValue>>> localVarResp = patchPortfolioGroupAccessMetadataWithHttpInfo(scope, code, operation, effectiveAt, effectiveUntil);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, List<AccessMetadataValue>>> patchPortfolioGroupAccessMetadataWithHttpInfo(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        okhttp3.Call localVarCall = patchPortfolioGroupAccessMetadataValidateBeforeCall(scope, code, operation, effectiveAt, effectiveUntil, null);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] PatchPortfolioGroupAccessMetadata: Patch Access Metadata rules for a Portfolio Group. (asynchronously)
     * Patch Portfolio Group Access Metadata Rules in a single scope.  The behaviour is defined by the JSON Patch specification.                Currently only &#39;add&#39; is a supported operation on the patch document  Currently only valid metadata keys are supported paths on the patch document                The response will return any affected Portfolio Group Access Metadata rules or a failure message if unsuccessful.                It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exist with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched.
     * @param scope The scope of the Portfolio Group (required)
     * @param code The Portfolio Group code (required)
     * @param operation The Json patch document (required)
     ...
     */
    public okhttp3.Call patchPortfolioGroupAccessMetadataAsync(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
        okhttp3.Call localVarCall = patchPortfolioGroupAccessMetadataValidateBeforeCall(scope, code, operation, effectiveAt, effectiveUntil, _callback);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
