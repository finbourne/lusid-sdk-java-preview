...
public class PortfolioGroupsApi {
     ...
     * @param key Key of the Access Metadata entry to delete (required)
     ...
     */
    public okhttp3.Call deleteKeyFromPortfolioGroupAccessMetadataCall(String scope, String code, String key, String effectiveAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/portfoliogroups/{scope}/{code}/metadata/{key}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()))
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteKeyFromPortfolioGroupAccessMetadataValidateBeforeCall(String scope, String code, String key, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling deleteKeyFromPortfolioGroupAccessMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = deleteKeyFromPortfolioGroupAccessMetadataCall(scope, code, key, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public DeletedEntityResponse deleteKeyFromPortfolioGroupAccessMetadata(String scope, String code, String key, String effectiveAt) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteKeyFromPortfolioGroupAccessMetadataWithHttpInfo(scope, code, key, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeletedEntityResponse> deleteKeyFromPortfolioGroupAccessMetadataWithHttpInfo(String scope, String code, String key, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = deleteKeyFromPortfolioGroupAccessMetadataValidateBeforeCall(scope, code, key, effectiveAt, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call deleteKeyFromPortfolioGroupAccessMetadataAsync(String scope, String code, String key, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteKeyFromPortfolioGroupAccessMetadataValidateBeforeCall(scope, code, key, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param scope The scope of the Portfolio Group (required)
     * @param code The Portfolio Group code (required)
     * @param key Key of the metadata entry to retrieve (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The successfully retrieved Portfolio group access metadata filtered by key or any failure. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getPortfolioGroupAccessMetadataByKeyCall(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPortfolioGroupAccessMetadataByKeyValidateBeforeCall(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getPortfolioGroupAccessMetadataByKey(Async)");
        }
        

        okhttp3.Call localVarCall = getPortfolioGroupAccessMetadataByKeyCall(scope, code, key, effectiveAt, asAt, _callback);
        return localVarCall;
     ...
     */
    public List<AccessMetadataValue> getPortfolioGroupAccessMetadataByKey(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        ApiResponse<List<AccessMetadataValue>> localVarResp = getPortfolioGroupAccessMetadataByKeyWithHttpInfo(scope, code, key, effectiveAt, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<AccessMetadataValue>> getPortfolioGroupAccessMetadataByKeyWithHttpInfo(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getPortfolioGroupAccessMetadataByKeyValidateBeforeCall(scope, code, key, effectiveAt, asAt, null);
        Type localVarReturnType = new TypeToken<List<AccessMetadataValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get an entry identified by a key in the Access Metadata of a Portfolio Group (asynchronously)
     * Get a specific Portfolio Group access metadata by specifying the corresponding identifier parts                No matching will be performed through this endpoint. To retrieve a rule, it is necessary to specify, exactly, the identifier of the rule
     * @param scope The scope of the Portfolio Group (required)
     * @param code The Portfolio Group code (required)
     * @param key Key of the metadata entry to retrieve (required)
     ...
     */
    public okhttp3.Call getPortfolioGroupAccessMetadataByKeyAsync(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt, final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPortfolioGroupAccessMetadataByKeyValidateBeforeCall(scope, code, key, effectiveAt, asAt, _callback);
        Type localVarReturnType = new TypeToken<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param scope The scope of the Portfolio Group (required)
     * @param code The Portfolio Group code (required)
     * @param key Key of the access metadata entry to upsert (required)
     * @param request The Portfolio Group Access Metadata rule to upsert (required)
     ...
     */
    public okhttp3.Call upsertPortfolioGroupAccessMetadataCall(String scope, String code, String key, UpsertPortfolioGroupAccessMetadataRequest request, String effectiveAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertPortfolioGroupAccessMetadataValidateBeforeCall(String scope, String code, String key, UpsertPortfolioGroupAccessMetadataRequest request, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling upsertPortfolioGroupAccessMetadata(Async)");
        }
        
        // verify the required parameter 'request' is set
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling upsertPortfolioGroupAccessMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = upsertPortfolioGroupAccessMetadataCall(scope, code, key, request, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfAccessMetadataValueOf upsertPortfolioGroupAccessMetadata(String scope, String code, String key, UpsertPortfolioGroupAccessMetadataRequest request, String effectiveAt) throws ApiException {
        ApiResponse<ResourceListOfAccessMetadataValueOf> localVarResp = upsertPortfolioGroupAccessMetadataWithHttpInfo(scope, code, key, request, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfAccessMetadataValueOf> upsertPortfolioGroupAccessMetadataWithHttpInfo(String scope, String code, String key, UpsertPortfolioGroupAccessMetadataRequest request, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = upsertPortfolioGroupAccessMetadataValidateBeforeCall(scope, code, key, request, effectiveAt, null);
        Type localVarReturnType = new TypeToken<ResourceListOfAccessMetadataValueOf>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert a Portfolio Group Access Metadata entry associated with a specific key. This creates or updates the data in LUSID. (asynchronously)
     * Update or insert one Portfolio Group Access Metadata Entry in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Portfolio Group Access Metadata rule or failure message if unsuccessful.                It is important to always check to verify success (or failure).                Multiple rules for a key can exist with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched.
     * @param scope The scope of the Portfolio Group (required)
     * @param code The Portfolio Group code (required)
     * @param key Key of the access metadata entry to upsert (required)
     ...
     */
    public okhttp3.Call upsertPortfolioGroupAccessMetadataAsync(String scope, String code, String key, UpsertPortfolioGroupAccessMetadataRequest request, String effectiveAt, final ApiCallback<ResourceListOfAccessMetadataValueOf> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertPortfolioGroupAccessMetadataValidateBeforeCall(scope, code, key, request, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfAccessMetadataValueOf>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
