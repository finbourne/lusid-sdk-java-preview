...
public class ConventionsApi {
    ...
    /**
     * [EXPERIMENTAL] Delete the CDS Flow Conventions of given scope and code, assuming that it is present. (asynchronously)
     * Delete the specified CDS Flow Conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.
     * @param scope The scope of the CDS Flow Conventions to delete. (required)
     * @param code The CDS Flow Conventions to delete. (required)
    ...
    /**
     * [EXPERIMENTAL] Delete the Flow Conventions of given scope and code, assuming that it is present. (asynchronously)
     * Delete the specified conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.
     * @param scope The scope of the Flow Conventions to delete. (required)
     * @param code The Flow Conventions to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * [EXPERIMENTAL] Delete the Index Convention of given scope and code, assuming that it is present. (asynchronously)
     * Delete the specified Index Convention from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.
     * @param scope The scope of the Index Convention to delete. (required)
     * @param code The Index Convention to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public GetConventionsResponse getCdsFlowConventions(String scope, String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<GetConventionsResponse> localVarResp = getCdsFlowConventionsWithHttpInfo(scope, code, asAt);
        return localVarResp.getData();
    }
     ...
     * @param code The name of the CDS Flow Conventions to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the CDS Flow Conventions. Defaults to return the latest version if not specified. (optional)
     * @return ApiResponse&lt;GetConventionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetConventionsResponse> getCdsFlowConventionsWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getCdsFlowConventionsValidateBeforeCall(scope, code, asAt, null);
        Type localVarReturnType = new TypeToken<GetConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get CDS Flow Conventions (asynchronously)
     * Get a CDS Flow Conventions from a single scope.  The response will return either the conventions that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
     * @param scope The scope of the CDS Flow Conventions to retrieve. (required)
     * @param code The name of the CDS Flow Conventions to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the CDS Flow Conventions. Defaults to return the latest version if not specified. (optional)
     ...
     */
    public okhttp3.Call getCdsFlowConventionsAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetConventionsResponse> _callback) throws ApiException {
     ...
     */
    public GetConventionsResponse getFlowConventions(String scope, String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<GetConventionsResponse> localVarResp = getFlowConventionsWithHttpInfo(scope, code, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetConventionsResponse> getFlowConventionsWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] Get Flow Conventions (asynchronously)
     * Get a Flow Conventions from a single scope.  The response will return either the conventions that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
     * @param scope The scope of the Flow Conventions to retrieve. (required)
     * @param code The name of the Flow Conventions to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the Flow Conventions. Defaults to return the latest version if not specified. (optional)
     ...
     */
    public okhttp3.Call getFlowConventionsAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetConventionsResponse> _callback) throws ApiException {
     ...
     */
    public GetConventionsResponse getIndexConvention(String scope, String code, OffsetDateTime asAt) throws ApiException {
        ApiResponse<GetConventionsResponse> localVarResp = getIndexConventionWithHttpInfo(scope, code, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetConventionsResponse> getIndexConventionWithHttpInfo(String scope, String code, OffsetDateTime asAt) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] Get Index Convention (asynchronously)
     * Get a Index Convention from a single scope.  The response will return either the conventions that has been stored, or a failure explaining why the request was unsuccessful.  It is important to always check for any unsuccessful requests (failures).
     * @param scope The scope of the Index Convention to retrieve. (required)
     * @param code The name of the Index Convention to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the Index Convention. Defaults to return the latest version if not specified. (optional)
     ...
     */
    public okhttp3.Call getIndexConventionAsync(String scope, String code, OffsetDateTime asAt, final ApiCallback<GetConventionsResponse> _callback) throws ApiException {
    ...
    /**
     * Build call for listConventions
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The requested conventions </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listConventionsCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/conventions";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listConventionsValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listConventionsCall(asAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfGetConventionsResponse listConventions(OffsetDateTime asAt) throws ApiException {
        ApiResponse<ResourceListOfGetConventionsResponse> localVarResp = listConventionsWithHttpInfo(asAt);
        return localVarResp.getData();
    }
     ...
     * List the set of conventions at the specified date/time
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @return ApiResponse&lt;ResourceListOfGetConventionsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResourceListOfGetConventionsResponse> listConventionsWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = listConventionsValidateBeforeCall(asAt, null);
        Type localVarReturnType = new TypeToken<ResourceListOfGetConventionsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] List the set of conventions (asynchronously)
     * List the set of conventions at the specified date/time
     * @param asAt The asAt datetime at which to list the conventions. Defaults to latest if not specified. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call listConventionsAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetConventionsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listConventionsValidateBeforeCall(asAt, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfGetConventionsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param upsertConventionsRequest The CDS Flow Conventions to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertCdsFlowConventionsCall(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = upsertConventionsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertCdsFlowConventionsValidateBeforeCall(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'upsertConventionsRequest' is set
        if (upsertConventionsRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertConventionsRequest' when calling upsertCdsFlowConventions(Async)");
        }
        

        okhttp3.Call localVarCall = upsertCdsFlowConventionsCall(upsertConventionsRequest, _callback);
        return localVarCall;
     ...
     */
    public UpsertSingleStructuredDataResponse upsertCdsFlowConventions(UpsertConventionsRequest upsertConventionsRequest) throws ApiException {
        ApiResponse<UpsertSingleStructuredDataResponse> localVarResp = upsertCdsFlowConventionsWithHttpInfo(upsertConventionsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertSingleStructuredDataResponse> upsertCdsFlowConventionsWithHttpInfo(UpsertConventionsRequest upsertConventionsRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertCdsFlowConventionsValidateBeforeCall(upsertConventionsRequest, null);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert a set of CDS Flow Conventions. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert CDS Flow Conventions in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted CDS Flow Conventions or failure message if unsuccessful                It is important to always check to verify success (or failure).
     * @param upsertConventionsRequest The CDS Flow Conventions to update or insert (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertCdsFlowConventionsAsync(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertCdsFlowConventionsValidateBeforeCall(upsertConventionsRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param upsertConventionsRequest The Flow Conventions to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertFlowConventionsCall(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = upsertConventionsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertFlowConventionsValidateBeforeCall(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'upsertConventionsRequest' is set
        if (upsertConventionsRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertConventionsRequest' when calling upsertFlowConventions(Async)");
        }
        

        okhttp3.Call localVarCall = upsertFlowConventionsCall(upsertConventionsRequest, _callback);
        return localVarCall;
     ...
     */
    public UpsertSingleStructuredDataResponse upsertFlowConventions(UpsertConventionsRequest upsertConventionsRequest) throws ApiException {
        ApiResponse<UpsertSingleStructuredDataResponse> localVarResp = upsertFlowConventionsWithHttpInfo(upsertConventionsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertSingleStructuredDataResponse> upsertFlowConventionsWithHttpInfo(UpsertConventionsRequest upsertConventionsRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertFlowConventionsValidateBeforeCall(upsertConventionsRequest, null);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert a set of Flow Conventions. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert Flow Conventions in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Flow Conventions or failure message if unsuccessful                It is important to always check to verify success (or failure).
     * @param upsertConventionsRequest The Flow Conventions to update or insert (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertFlowConventionsAsync(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertFlowConventionsValidateBeforeCall(upsertConventionsRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param upsertConventionsRequest The Index Conventions to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertIndexConventionCall(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = upsertConventionsRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertIndexConventionValidateBeforeCall(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'upsertConventionsRequest' is set
        if (upsertConventionsRequest == null) {
            throw new ApiException("Missing the required parameter 'upsertConventionsRequest' when calling upsertIndexConvention(Async)");
        }
        

        okhttp3.Call localVarCall = upsertIndexConventionCall(upsertConventionsRequest, _callback);
        return localVarCall;
     ...
     */
    public UpsertSingleStructuredDataResponse upsertIndexConvention(UpsertConventionsRequest upsertConventionsRequest) throws ApiException {
        ApiResponse<UpsertSingleStructuredDataResponse> localVarResp = upsertIndexConventionWithHttpInfo(upsertConventionsRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertSingleStructuredDataResponse> upsertIndexConventionWithHttpInfo(UpsertConventionsRequest upsertConventionsRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertIndexConventionValidateBeforeCall(upsertConventionsRequest, null);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert a set of Index Convention. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert Index Convention in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Index Convention or failure message if unsuccessful                It is important to always check to verify success (or failure).
     * @param upsertConventionsRequest The Index Conventions to update or insert (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertIndexConventionAsync(UpsertConventionsRequest upsertConventionsRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertIndexConventionValidateBeforeCall(upsertConventionsRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
