...
public class ConventionsApi {
    ...
    /**
     * Build call for deleteConventions
     * @param scope The scope of the conventions to delete. (required)
     * @param code The conventions to delete. (required)
     ...
     */
    public okhttp3.Call deleteConventionsCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/conventions/{scope}/{code}"
    ...
    private okhttp3.Call deleteConventionsValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deleteConventions(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling deleteConventions(Async)");
        }
        

        okhttp3.Call localVarCall = deleteConventionsCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public AnnulSingleStructuredDataResponse deleteConventions(String scope, String code) throws ApiException {
        ApiResponse<AnnulSingleStructuredDataResponse> localVarResp = deleteConventionsWithHttpInfo(scope, code);
     ...
     */
    public ApiResponse<AnnulSingleStructuredDataResponse> deleteConventionsWithHttpInfo(String scope, String code) throws ApiException {
        okhttp3.Call localVarCall = deleteConventionsValidateBeforeCall(scope, code, null);
        Type localVarReturnType = new TypeToken<AnnulSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Delete the conventions of given scope and code, assuming that it is present. (asynchronously)
     * Delete the specified conventions from a single scope.  The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.  It is important to always check for any unsuccessful response.
     * @param scope The scope of the conventions to delete. (required)
     * @param code The conventions to delete. (required)
     ...
     */
    public okhttp3.Call deleteConventionsAsync(String scope, String code, final ApiCallback<AnnulSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteConventionsValidateBeforeCall(scope, code, _callback);
        Type localVarReturnType = new TypeToken<AnnulSingleStructuredDataResponse>(){}.getType();
