...
public class ScriptedTranslationApi {
    ...
    public okhttp3.Call getTranslationDialectCall(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/scriptedtranslation/dialects/{scope}/{vendor}/{sourceSystem}/{entityType}/{serialisationFormat}/{version}"
            ...
            .replaceAll("\\{" + "vendor" + "\\}", localVarApiClient.escapeString(vendor.toString()))
            .replaceAll("\\{" + "sourceSystem" + "\\}", localVarApiClient.escapeString(sourceSystem.toString()))
            .replaceAll("\\{" + "entityType" + "\\}", localVarApiClient.escapeString(entityType.toString()))
            .replaceAll("\\{" + "serialisationFormat" + "\\}", localVarApiClient.escapeString(serialisationFormat.toString()))
    ...
    private okhttp3.Call getTranslationDialectValidateBeforeCall(String scope, String vendor, String sourceSystem, String entityType, String serialisationFormat, String version, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTranslationDialectCall(scope, vendor, sourceSystem, entityType, serialisationFormat, version, asAt, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getTranslationScriptValidateBeforeCall(String scope, String code, String version, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getTranslationScriptCall(scope, code, version, asAt, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listDialectIdsValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listDialectIdsCall(asAt, page, limit, filter, _callback);
        return localVarCall;
    ...
    private okhttp3.Call listTranslationScriptIdsValidateBeforeCall(OffsetDateTime asAt, Integer limit, String filter, String page, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listTranslationScriptIdsCall(asAt, limit, filter, page, _callback);
        return localVarCall;
    ...
    private okhttp3.Call translateEntitiesValidateBeforeCall(TranslateEntitiesRequest translateEntitiesRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = translateEntitiesCall(translateEntitiesRequest, _callback);
        return localVarCall;
    ...
    private okhttp3.Call translateEntitiesInlinedValidateBeforeCall(TranslateEntitiesInlinedRequest translateEntitiesInlinedRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = translateEntitiesInlinedCall(translateEntitiesInlinedRequest, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call upsertTranslationDialectCall(UpsertDialectRequest upsertDialectRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call upsertTranslationDialectValidateBeforeCall(UpsertDialectRequest upsertDialectRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertTranslationDialectCall(upsertDialectRequest, _callback);
        return localVarCall;
     ...
     */
    public Dialect upsertTranslationDialect(UpsertDialectRequest upsertDialectRequest) throws ApiException {
     ...
     */
    public ApiResponse<Dialect> upsertTranslationDialectWithHttpInfo(UpsertDialectRequest upsertDialectRequest) throws ApiException {
     ...
     */
    public okhttp3.Call upsertTranslationDialectAsync(UpsertDialectRequest upsertDialectRequest, final ApiCallback<Dialect> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call upsertTranslationScriptCall(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call upsertTranslationScriptValidateBeforeCall(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertTranslationScriptCall(upsertTranslationScriptRequest, _callback);
        return localVarCall;
     ...
     */
    public TranslationScript upsertTranslationScript(UpsertTranslationScriptRequest upsertTranslationScriptRequest) throws ApiException {
     ...
     */
    public ApiResponse<TranslationScript> upsertTranslationScriptWithHttpInfo(UpsertTranslationScriptRequest upsertTranslationScriptRequest) throws ApiException {
     ...
     */
    public okhttp3.Call upsertTranslationScriptAsync(UpsertTranslationScriptRequest upsertTranslationScriptRequest, final ApiCallback<TranslationScript> _callback) throws ApiException {
