...
public class InstrumentsApi {
     ...
     */
    public okhttp3.Call postInstrumentCapabilitiesCall(LusidInstrument lusidInstrument, String model, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postInstrumentCapabilitiesValidateBeforeCall(LusidInstrument lusidInstrument, String model, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postInstrumentCapabilitiesCall(lusidInstrument, model, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public InstrumentCapabilities postInstrumentCapabilities(LusidInstrument lusidInstrument, String model, String effectiveAt) throws ApiException {
        ApiResponse<InstrumentCapabilities> localVarResp = postInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InstrumentCapabilities> postInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, String model, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = postInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, null);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, String model, String effectiveAt, final ApiCallback<InstrumentCapabilities> _callback) throws ApiException {
        okhttp3.Call localVarCall = postInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
