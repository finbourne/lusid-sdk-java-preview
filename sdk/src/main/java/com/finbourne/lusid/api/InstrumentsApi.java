...
public class InstrumentsApi {
    ...
    public okhttp3.Call getAllPossibleFeaturesCall(String instrumentType, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/instruments/{instrumentType}/allfeatures"
            .replaceAll("\\{" + "instrumentType" + "\\}", localVarApiClient.escapeString(instrumentType.toString()));
    ...
    private okhttp3.Call getAllPossibleFeaturesValidateBeforeCall(String instrumentType, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAllPossibleFeaturesCall(instrumentType, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getExistingInstrumentCapabilitiesValidateBeforeCall(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String instrumentScope, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getExistingInstrumentCapabilitiesCall(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call queryInstrumentCapabilitiesCall(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call queryInstrumentCapabilitiesValidateBeforeCall(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = queryInstrumentCapabilitiesCall(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, _callback);
        return localVarCall;
     ...
     */
    public InstrumentCapabilities queryInstrumentCapabilities(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode) throws ApiException {
        ApiResponse<InstrumentCapabilities> localVarResp = queryInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt, recipeScope, recipeCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InstrumentCapabilities> queryInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode) throws ApiException {
        okhttp3.Call localVarCall = queryInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, null);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call queryInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode, final ApiCallback<InstrumentCapabilities> _callback) throws ApiException {
        okhttp3.Call localVarCall = queryInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, _callback);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
