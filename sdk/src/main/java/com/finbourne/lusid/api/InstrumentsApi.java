...
import com.finbourne.lusid.model.GetExpandedInstrumentsResponse;
...
import com.finbourne.lusid.model.LusidInstrumentDefinition;
...
public class InstrumentsApi {
     ...
     * @param requestBody The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied. (required)
     * @param effectiveAt The effective date to delete the properties from. Note that this is only valid to set if the properties being deleted  are defined to be Finbourne.WebApi.Interface.Dto.PropertyLifeTime.TimeVariant, otherwise this value must not be set. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The AsAt time of at which the properties were deleted </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    ...
    /**
     * [EXPERIMENTAL] Delete properties from an instrument (asynchronously)
     * Delete a collection of property values from an instrument, optionally, at the specified effective date, returning a  Finbourne.WebApi.Interface.Dto.Instruments.DeleteInstrumentPropertiesResponse value, containing the AsAtTime at which the operation was completed.
     * @param identifierType The identifier type of the instrument, e.g., \&quot;Figi\&quot; (required)
     * @param identifier The identifier of the instrument to delete properties from. (required)
     * @param requestBody The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied. (required)
    ...
    /**
     * Build call for getLusidInstruments
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;. (required)
     * @param requestBody The values of the identifier for the requested instruments. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to retrieve the instrument definitions.              Defaults to return the latest version of each instrument definition if not specified. (optional)
     ...
     */
    public okhttp3.Call getLusidInstrumentsCall(String identifierType, List<String> requestBody, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = requestBody;

        // create path and map variables
        String localVarPath = "/api/instruments/otc/$get";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getLusidInstrumentsValidateBeforeCall(String identifierType, List<String> requestBody, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'identifierType' is set
        if (identifierType == null) {
            throw new ApiException("Missing the required parameter 'identifierType' when calling getLusidInstruments(Async)");
        }
        
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling getLusidInstruments(Async)");
        }
        

        okhttp3.Call localVarCall = getLusidInstrumentsCall(identifierType, requestBody, effectiveAt, asAt, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public GetExpandedInstrumentsResponse getLusidInstruments(String identifierType, List<String> requestBody, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        ApiResponse<GetExpandedInstrumentsResponse> localVarResp = getLusidInstrumentsWithHttpInfo(identifierType, requestBody, effectiveAt, asAt, propertyKeys);
        return localVarResp.getData();
    }
     ...
     * @param asAt The asAt datetime at which to retrieve the instrument definitions.              Defaults to return the latest version of each instrument definition if not specified. (optional)
     * @param propertyKeys A list of property keys from the \&quot;Instrument\&quot; domain to decorate onto the instrument.              These take the format {domain}/{scope}/{code} e.g. \&quot;Instrument/system/Name\&quot;. (optional)
     * @return ApiResponse&lt;GetExpandedInstrumentsResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<GetExpandedInstrumentsResponse> getLusidInstrumentsWithHttpInfo(String identifierType, List<String> requestBody, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = getLusidInstrumentsValidateBeforeCall(identifierType, requestBody, effectiveAt, asAt, propertyKeys, null);
        Type localVarReturnType = new TypeToken<GetExpandedInstrumentsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get instruments (asynchronously)
     * Get the definition of one or more Lusid (OTC) instruments identified by a collection of unique instrument identifiers.
     * @param identifierType The identifier being supplied e.g. \&quot;Figi\&quot;. (required)
     * @param requestBody The values of the identifier for the requested instruments. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the instrument definitions.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public okhttp3.Call getLusidInstrumentsAsync(String identifierType, List<String> requestBody, String effectiveAt, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<GetExpandedInstrumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getLusidInstrumentsValidateBeforeCall(identifierType, requestBody, effectiveAt, asAt, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<GetExpandedInstrumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Build call for upsertLusidInstruments
     * @param requestBody The definitions of the instruments to update or insert. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call upsertLusidInstrumentsCall(Map<String, LusidInstrumentDefinition> requestBody, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = requestBody;

        // create path and map variables
        String localVarPath = "/api/instruments/otc";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertLusidInstrumentsValidateBeforeCall(Map<String, LusidInstrumentDefinition> requestBody, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'requestBody' is set
        if (requestBody == null) {
            throw new ApiException("Missing the required parameter 'requestBody' when calling upsertLusidInstruments(Async)");
        }
        

        okhttp3.Call localVarCall = upsertLusidInstrumentsCall(requestBody, _callback);
        return localVarCall;
     ...
     */
    public UpsertInstrumentsResponse upsertLusidInstruments(Map<String, LusidInstrumentDefinition> requestBody) throws ApiException {
        ApiResponse<UpsertInstrumentsResponse> localVarResp = upsertLusidInstrumentsWithHttpInfo(requestBody);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertInstrumentsResponse> upsertLusidInstrumentsWithHttpInfo(Map<String, LusidInstrumentDefinition> requestBody) throws ApiException {
        okhttp3.Call localVarCall = upsertLusidInstrumentsValidateBeforeCall(requestBody, null);
        Type localVarReturnType = new TypeToken<UpsertInstrumentsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert instruments (asynchronously)
     * Update or insert one or more instruments into the LUSID instrument master. An instrument will be updated  if it already exists and inserted if it does not.                In the request each instrument definition should be keyed by a unique correlation id. This id is ephemeral  and is not stored by LUSID. It serves only as a way to easily identify each instrument in the response.                The response will return both the collection of successfully updated or inserted instruments, as well as those that failed.  For the failures a reason will be provided explaining why the instrument could not be updated or inserted.                It is important to always check the failed set for any unsuccessful results.
     * @param requestBody The definitions of the instruments to update or insert. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call upsertLusidInstrumentsAsync(Map<String, LusidInstrumentDefinition> requestBody, final ApiCallback<UpsertInstrumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertLusidInstrumentsValidateBeforeCall(requestBody, _callback);
        Type localVarReturnType = new TypeToken<UpsertInstrumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
