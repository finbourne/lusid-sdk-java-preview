...
public class InstrumentsApi {
    ...
    /**
     * [EXPERIMENTAL] DeleteInstrumentProperties: Delete instrument properties (asynchronously)
     * Delete one or more properties from a particular instrument. If the properties are time-variant then an effective datetime from which  to delete properties must be specified. If the properties are perpetual then it is invalid to specify an effective datetime for deletion.
     * @param identifierType The unique identifier type to search, for example &#39;Figi&#39;. (required)
     * @param identifier An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;. (required)
     * @param requestBody A list of property keys from the &#39;Instruments&#39; domain whose properties to delete. (required)
    ...
    /**
     * [EXPERIMENTAL] DeleteInstruments: Soft or hard delete multiple instruments (asynchronously)
     * Deletes a number of instruments identified by LusidInstrumentId.                Soft deletion marks the instrument as inactive so it can no longer be referenced when creating or updating transactions or holdings. You can still query existing transactions and holdings related to the inactive instrument.                In addition to the above behaviour, hard deletion: (i) completely removes all external identifiers from the instrument; (ii) marks the instrument as &#39;Deleted&#39;; (iii) prepends the instrument&#39;s name with &#39;DELETED &#39;; (iv) prevents the instrument from being returned in list instruments queries.                Following hard deletion, an instrument may only be retrieved by making a direct get instrument request for the LusidInstrumentId. Instrument deletion cannot be undone. Please note that currency instruments cannot currently be deleted.  The maximum number of instruments that this method can delete per request is 2,000.
     * @param requestBody The list of lusidInstrumentId&#39;s to delete. (required)
     * @param deleteMode The delete mode to use (defaults to &#39;Soft&#39;). (optional)
     * @param scope The scope in which the instruments lie. When not supplied the scope is &#39;default&#39;. (optional, default to default)
    ...
    /**
     * Build call for getInstrumentCapabilities
     ...
     */
    public okhttp3.Call getInstrumentCapabilitiesCall(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String instrumentScope, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInstrumentCapabilitiesValidateBeforeCall(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String instrumentScope, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'identifier' is set
        if (identifier == null) {
            throw new ApiException("Missing the required parameter 'identifier' when calling getInstrumentCapabilities(Async)");
        }
        

        okhttp3.Call localVarCall = getInstrumentCapabilitiesCall(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode, _callback);
        return localVarCall;
     ...
     */
    public InstrumentCapabilities getInstrumentCapabilities(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String instrumentScope, String recipeScope, String recipeCode) throws ApiException {
        ApiResponse<InstrumentCapabilities> localVarResp = getInstrumentCapabilitiesWithHttpInfo(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InstrumentCapabilities> getInstrumentCapabilitiesWithHttpInfo(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String instrumentScope, String recipeScope, String recipeCode) throws ApiException {
        okhttp3.Call localVarCall = getInstrumentCapabilitiesValidateBeforeCall(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode, null);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetInstrumentCapabilities: Given an lusid instrument id provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies. (asynchronously)
     * Returns instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument e.g. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) e.g. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) e.g. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS
     * @param identifier A lusid instrument id identifying the instrument. (required)
     * @param model A pricing model for the instrument. Defaults to Unknown if not specified. If not specified the SupportedAddresses and EconomicDependencies are not provided. (optional)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public okhttp3.Call getInstrumentCapabilitiesAsync(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String instrumentScope, String recipeScope, String recipeCode, final ApiCallback<InstrumentCapabilities> _callback) throws ApiException {
        okhttp3.Call localVarCall = getInstrumentCapabilitiesValidateBeforeCall(identifier, model, effectiveAt, asAt, instrumentScope, recipeScope, recipeCode, _callback);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    private okhttp3.Call getInstrumentPaymentDiaryValidateBeforeCall(String identifierType, String identifier, String recipeScope, String recipeCode, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInstrumentPaymentDiaryCall(identifierType, identifier, recipeScope, recipeCode, effectiveAt, asAt, scope, _callback);
        return localVarCall;
    ...
    /**
     * [EXPERIMENTAL] GetInstrumentProperties: Get instrument properties (asynchronously)
     * List all the properties of a particular instrument, as identified by a particular unique identifier.
     * @param identifierType The unique identifier type to search, for example &#39;Figi&#39;. (required)
     * @param identifier An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the instrument&#39;s properties.              Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    /**
     * [EXPERIMENTAL] ListInstrumentProperties: Get instrument properties (with Pagination) (asynchronously)
     * List all the properties of a particular instrument, as identified by a particular unique identifier.
     * @param identifierType The unique identifier type to search, for example &#39;Figi&#39;. (required)
     * @param identifier An &lt;i&gt;identifierType&lt;/i&gt; value to use to identify the instrument, for example &#39;BBG000BLNNV0&#39;. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the instrument&#39;s properties.              Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    /**
     * Build call for postInstrumentCapabilities
     ...
     */
    public okhttp3.Call postInstrumentCapabilitiesCall(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postInstrumentCapabilitiesValidateBeforeCall(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'lusidInstrument' is set
        if (lusidInstrument == null) {
            throw new ApiException("Missing the required parameter 'lusidInstrument' when calling postInstrumentCapabilities(Async)");
        }
        

        okhttp3.Call localVarCall = postInstrumentCapabilitiesCall(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, _callback);
        return localVarCall;
     ...
     */
    public InstrumentCapabilities postInstrumentCapabilities(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode) throws ApiException {
        ApiResponse<InstrumentCapabilities> localVarResp = postInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt, recipeScope, recipeCode);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InstrumentCapabilities> postInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode) throws ApiException {
        okhttp3.Call localVarCall = postInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, null);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] PostInstrumentCapabilities: Given an example instrument provides instrument capabilities, outlining features, and, given the model, the capabilities also include supported addresses as well as economic dependencies. (asynchronously)
     * Returns instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument e.g. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) e.g. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) e.g. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS
     * @param lusidInstrument The definition of the instrument. (required)
     * @param model A pricing model for the instrument. Defaults to Unknown if not specified. If not specified the SupportedAddresses and EconomicDependencies are not provided. (optional)
     * @param effectiveAt The effective datetime or cut label at which to retrieve the instrument.              Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public okhttp3.Call postInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, String model, String effectiveAt, String recipeScope, String recipeCode, final ApiCallback<InstrumentCapabilities> _callback) throws ApiException {
        okhttp3.Call localVarCall = postInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, recipeScope, recipeCode, _callback);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
