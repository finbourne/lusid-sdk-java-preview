...
public class InstrumentsApi {
     ...
     */
    public okhttp3.Call getInstrumentCapabilitiesCall(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getInstrumentCapabilitiesValidateBeforeCall(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getInstrumentCapabilitiesCall(identifier, model, effectiveAt, asAt, scope, _callback);
        return localVarCall;
     ...
     */
    public InstrumentCapabilities getInstrumentCapabilities(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String scope) throws ApiException {
        ApiResponse<InstrumentCapabilities> localVarResp = getInstrumentCapabilitiesWithHttpInfo(identifier, model, effectiveAt, asAt, scope);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InstrumentCapabilities> getInstrumentCapabilitiesWithHttpInfo(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String scope) throws ApiException {
        okhttp3.Call localVarCall = getInstrumentCapabilitiesValidateBeforeCall(identifier, model, effectiveAt, asAt, scope, null);
     ...
     */
    public okhttp3.Call getInstrumentCapabilitiesAsync(String identifier, String model, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback<InstrumentCapabilities> _callback) throws ApiException {
        okhttp3.Call localVarCall = getInstrumentCapabilitiesValidateBeforeCall(identifier, model, effectiveAt, asAt, scope, _callback);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call postInstrumentCapabilitiesCall(LusidInstrument lusidInstrument, String model, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call postInstrumentCapabilitiesValidateBeforeCall(LusidInstrument lusidInstrument, String model, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = postInstrumentCapabilitiesCall(lusidInstrument, model, effectiveAt, asAt, scope, _callback);
        return localVarCall;
     ...
     */
    public InstrumentCapabilities postInstrumentCapabilities(LusidInstrument lusidInstrument, String model, String effectiveAt, OffsetDateTime asAt, String scope) throws ApiException {
        ApiResponse<InstrumentCapabilities> localVarResp = postInstrumentCapabilitiesWithHttpInfo(lusidInstrument, model, effectiveAt, asAt, scope);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<InstrumentCapabilities> postInstrumentCapabilitiesWithHttpInfo(LusidInstrument lusidInstrument, String model, String effectiveAt, OffsetDateTime asAt, String scope) throws ApiException {
        okhttp3.Call localVarCall = postInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, asAt, scope, null);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call postInstrumentCapabilitiesAsync(LusidInstrument lusidInstrument, String model, String effectiveAt, OffsetDateTime asAt, String scope, final ApiCallback<InstrumentCapabilities> _callback) throws ApiException {
        okhttp3.Call localVarCall = postInstrumentCapabilitiesValidateBeforeCall(lusidInstrument, model, effectiveAt, asAt, scope, _callback);
        Type localVarReturnType = new TypeToken<InstrumentCapabilities>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
