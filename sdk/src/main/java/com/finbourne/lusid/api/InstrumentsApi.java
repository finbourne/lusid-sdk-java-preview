...
public class InstrumentsApi {
     ...
     * @param propertyKeys The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.Entities.PropertyDomain.Instrument domain can be supplied. (required)
