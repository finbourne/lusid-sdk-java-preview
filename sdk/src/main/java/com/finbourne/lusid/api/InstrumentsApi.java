...
public class InstrumentsApi {
     ...
     * @param deleteMode The delete mode to use, currently only &#39;soft&#39; is supported, if left unspecified, this argument is optional. (optional)
     * @param scope The scope in which the instrument lies. When not supplied the scope is &#39;default&#39;. (optional, default to default)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
    ...
    /**
     * [EXPERIMENTAL] DeleteInstruments: Deletes multiple instruments from a set of specified LusidInstrumentId strings (asynchronously)
     * Deletes a number of specified instruments (limited to 2000), as identified by LusidInstrumentId identifiers.                For soft deletion, once deleted, an instrument is marked as inactive and can no longer be referenced when creating or updating  transactions or holdings. You can still query existing transactions and holdings related to the  deleted instrument.                For Hard delete; with the same behaviour as above, in addition:      (i)     all identifiers are removed      (ii)    the instrument is marked with a state of &#39;Deleted&#39;,      (iii)   the instrument name is pre-pended with &#39;DELETED &#39;      (iv)    the instrument will not be returned by ListInstruments  The maximum number of instruments that this method can delete per request is 2,000.
     * @param requestBody The list of lusidInstrumentId&#39;s to delete. (required)
     * @param deleteMode The delete mode to use, currently only &#39;soft&#39; is supported, if left unspecified, this argument is optional. (optional)
     * @param scope The scope in which the instrument lies. When not supplied the scope is &#39;default&#39;. (optional, default to default)
     ...
     * @param recipeScope The scope of the valuation recipe being used to generate the payment diary (optional)
     * @param recipeCode The code of the valuation recipe being used to generate the payment diary (optional)
    ...
    /**
     * [EXPERIMENTAL] GetInstrumentRelationships: Get Instrument relationships (asynchronously)
     * Get relationships for a particular Instrument.
     * @param identifierType An identifier type attached to the Instrument. (required)
     * @param identifier The identifier value. (required)
     * @param effectiveAt The effective datetime or cut label at which to get relationships. Defaults to the current LUSID system datetime if not specified. (optional)
