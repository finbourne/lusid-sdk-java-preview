...
public class InstrumentsApi {
     ...
     * @param propertyKeys The property keys of the properties to be deleted from the instrument. Only properties in the  Finbourne.WebApi.Interface.Dto.PropertyDomain.Instrument domain can be supplied. (required)
     ...
     */
    public okhttp3.Call deleteInstrumentPropertiesCall(String identifierType, String identifier, List<String> propertyKeys, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteInstrumentPropertiesValidateBeforeCall(String identifierType, String identifier, List<String> propertyKeys, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        if (propertyKeys == null) {
            throw new ApiException("Missing the required parameter 'propertyKeys' when calling deleteInstrumentProperties(Async)");
        }
        

        okhttp3.Call localVarCall = deleteInstrumentPropertiesCall(identifierType, identifier, propertyKeys, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public DeleteInstrumentPropertiesResponse deleteInstrumentProperties(String identifierType, String identifier, List<String> propertyKeys, String effectiveAt) throws ApiException {
        ApiResponse<DeleteInstrumentPropertiesResponse> localVarResp = deleteInstrumentPropertiesWithHttpInfo(identifierType, identifier, propertyKeys, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeleteInstrumentPropertiesResponse> deleteInstrumentPropertiesWithHttpInfo(String identifierType, String identifier, List<String> propertyKeys, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = deleteInstrumentPropertiesValidateBeforeCall(identifierType, identifier, propertyKeys, effectiveAt, null);
     ...
     */
    public okhttp3.Call deleteInstrumentPropertiesAsync(String identifierType, String identifier, List<String> propertyKeys, String effectiveAt, final ApiCallback<DeleteInstrumentPropertiesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteInstrumentPropertiesValidateBeforeCall(identifierType, identifier, propertyKeys, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<DeleteInstrumentPropertiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call upsertLusidInstrumentsCall(Map<String, LusidInstrumentDefinition> instruments, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = instruments;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertLusidInstrumentsValidateBeforeCall(Map<String, LusidInstrumentDefinition> instruments, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'instruments' is set
        if (instruments == null) {
            throw new ApiException("Missing the required parameter 'instruments' when calling upsertLusidInstruments(Async)");
        }
        

        okhttp3.Call localVarCall = upsertLusidInstrumentsCall(instruments, _callback);
        return localVarCall;
     ...
     */
    public UpsertInstrumentsResponse upsertLusidInstruments(Map<String, LusidInstrumentDefinition> instruments) throws ApiException {
        ApiResponse<UpsertInstrumentsResponse> localVarResp = upsertLusidInstrumentsWithHttpInfo(instruments);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertInstrumentsResponse> upsertLusidInstrumentsWithHttpInfo(Map<String, LusidInstrumentDefinition> instruments) throws ApiException {
        okhttp3.Call localVarCall = upsertLusidInstrumentsValidateBeforeCall(instruments, null);
        Type localVarReturnType = new TypeToken<UpsertInstrumentsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call upsertLusidInstrumentsAsync(Map<String, LusidInstrumentDefinition> instruments, final ApiCallback<UpsertInstrumentsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertLusidInstrumentsValidateBeforeCall(instruments, _callback);
        Type localVarReturnType = new TypeToken<UpsertInstrumentsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
