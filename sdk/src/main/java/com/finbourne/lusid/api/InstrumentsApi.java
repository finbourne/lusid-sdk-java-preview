...
public class InstrumentsApi {
     ...
     * @param identifierEffectiveAt The effective datetime at which to list the property history. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     * @param page The pagination token to use to continue listing properties from a previous call to get property timeseries.              This value is returned from the previous call. If a pagination token is provided the filter, effectiveAt, and asAt fields              must not have changed since the original request. (optional)
    ...
    /**
     * [EXPERIMENTAL] Get the time series of an instrument property (asynchronously)
     * List the complete time series of an instrument property, ordered by effective datetime.
     * @param identifierType The identifier type of the instrument, e.g., \&quot;Figi\&quot; (required)
     * @param identifier The identifier of the instrument to delete properties from. (required)
     * @param propertyKey The property key of the property that will have its history shown. (optional)
