...
public class PersonsApi {
     ...
     * @param idTypeCode Code of the person identifier type. (required)
     * @param code Code of the person under specified identifier type&#39;s scope and code. This together with stated identifier type uniquely              identifies the person. (required)
     * @param identifiers Request containing identifiers to set for the person. Identifiers not specified in request will not be changed. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call setPersonIdentifiersCall(String idTypeScope, String idTypeCode, String code, SetPersonIdentifiersRequest identifiers, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setPersonIdentifiersValidateBeforeCall(String idTypeScope, String idTypeCode, String code, SetPersonIdentifiersRequest identifiers, final ApiCallback _callback) throws ApiException {
        ...
        if (identifiers == null) {
            throw new ApiException("Missing the required parameter 'identifiers' when calling setPersonIdentifiers(Async)");
        }
        

        okhttp3.Call localVarCall = setPersonIdentifiersCall(idTypeScope, idTypeCode, code, identifiers, _callback);
        return localVarCall;
     ...
     */
    public Person setPersonIdentifiers(String idTypeScope, String idTypeCode, String code, SetPersonIdentifiersRequest identifiers) throws ApiException {
        ApiResponse<Person> localVarResp = setPersonIdentifiersWithHttpInfo(idTypeScope, idTypeCode, code, identifiers);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Person> setPersonIdentifiersWithHttpInfo(String idTypeScope, String idTypeCode, String code, SetPersonIdentifiersRequest identifiers) throws ApiException {
        okhttp3.Call localVarCall = setPersonIdentifiersValidateBeforeCall(idTypeScope, idTypeCode, code, identifiers, null);
        Type localVarReturnType = new TypeToken<Person>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call setPersonIdentifiersAsync(String idTypeScope, String idTypeCode, String code, SetPersonIdentifiersRequest identifiers, final ApiCallback<Person> _callback) throws ApiException {

        okhttp3.Call localVarCall = setPersonIdentifiersValidateBeforeCall(idTypeScope, idTypeCode, code, identifiers, _callback);
        Type localVarReturnType = new TypeToken<Person>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param idTypeCode Code of the person identifier type. (required)
     * @param code Code of the person under specified identifier type&#39;s scope and code. This together with stated identifier type uniquely              identifies the person. (required)
     * @param properties Request containing properties to set for the person. Properties not specified in request will not be changed. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call setPersonPropertiesCall(String idTypeScope, String idTypeCode, String code, SetPersonPropertiesRequest properties, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setPersonPropertiesValidateBeforeCall(String idTypeScope, String idTypeCode, String code, SetPersonPropertiesRequest properties, final ApiCallback _callback) throws ApiException {
        ...
        if (properties == null) {
            throw new ApiException("Missing the required parameter 'properties' when calling setPersonProperties(Async)");
        }
        

        okhttp3.Call localVarCall = setPersonPropertiesCall(idTypeScope, idTypeCode, code, properties, _callback);
        return localVarCall;
     ...
     */
    public Person setPersonProperties(String idTypeScope, String idTypeCode, String code, SetPersonPropertiesRequest properties) throws ApiException {
        ApiResponse<Person> localVarResp = setPersonPropertiesWithHttpInfo(idTypeScope, idTypeCode, code, properties);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Person> setPersonPropertiesWithHttpInfo(String idTypeScope, String idTypeCode, String code, SetPersonPropertiesRequest properties) throws ApiException {
        okhttp3.Call localVarCall = setPersonPropertiesValidateBeforeCall(idTypeScope, idTypeCode, code, properties, null);
        Type localVarReturnType = new TypeToken<Person>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call setPersonPropertiesAsync(String idTypeScope, String idTypeCode, String code, SetPersonPropertiesRequest properties, final ApiCallback<Person> _callback) throws ApiException {

        okhttp3.Call localVarCall = setPersonPropertiesValidateBeforeCall(idTypeScope, idTypeCode, code, properties, _callback);
        Type localVarReturnType = new TypeToken<Person>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param request Request to create or update a person. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    private okhttp3.Call upsertPersonValidateBeforeCall(UpsertPersonRequest request, final ApiCallback _callback) throws ApiException {
        ...
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling upsertPerson(Async)");
        }
