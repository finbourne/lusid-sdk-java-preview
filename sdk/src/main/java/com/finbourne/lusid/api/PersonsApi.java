...
public class PersonsApi {
     ...
     */
    public okhttp3.Call patchPersonAccessMetadataCall(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchPersonAccessMetadataValidateBeforeCall(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchPersonAccessMetadataCall(idTypeScope, idTypeCode, code, operation, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public Map<String, List<AccessMetadataValue>> patchPersonAccessMetadata(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt) throws ApiException {
        ApiResponse<Map<String, List<AccessMetadataValue>>> localVarResp = patchPersonAccessMetadataWithHttpInfo(idTypeScope, idTypeCode, code, operation, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, List<AccessMetadataValue>>> patchPersonAccessMetadataWithHttpInfo(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = patchPersonAccessMetadataValidateBeforeCall(idTypeScope, idTypeCode, code, operation, effectiveAt, null);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchPersonAccessMetadataAsync(String idTypeScope, String idTypeCode, String code, List<Operation> operation, String effectiveAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
        okhttp3.Call localVarCall = patchPersonAccessMetadataValidateBeforeCall(idTypeScope, idTypeCode, code, operation, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
