...
public class CustomEntityDefinitionsApi {
    ...
    public okhttp3.Call createCustomEntityDefinitionCall(CustomEntityDefinitionRequest customEntityDefinitionRequest, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/customentitydefinitions";
     ...
     * @param customEntityId Id of the CustomEntityDefinition (required)
    ...
    public okhttp3.Call getDefinitionCall(String customEntityId, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/customentitydefinitions/{customEntityId}"
            .replaceAll("\\{" + "customEntityId" + "\\}", localVarApiClient.escapeString(customEntityId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getDefinitionValidateBeforeCall(String customEntityId, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'customEntityId' is set
        if (customEntityId == null) {
            throw new ApiException("Missing the required parameter 'customEntityId' when calling getDefinition(Async)");
        }
        

        okhttp3.Call localVarCall = getDefinitionCall(customEntityId, asAt, _callback);
        return localVarCall;
     ...
     */
    public CustomEntityDefinition getDefinition(String customEntityId, OffsetDateTime asAt) throws ApiException {
        ApiResponse<CustomEntityDefinition> localVarResp = getDefinitionWithHttpInfo(customEntityId, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<CustomEntityDefinition> getDefinitionWithHttpInfo(String customEntityId, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getDefinitionValidateBeforeCall(customEntityId, asAt, null);
        Type localVarReturnType = new TypeToken<CustomEntityDefinition>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
