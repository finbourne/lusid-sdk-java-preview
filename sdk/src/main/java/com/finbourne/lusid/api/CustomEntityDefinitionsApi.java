...
public class CustomEntityDefinitionsApi {
     ...
     * @param customEntityDefinitionRequest The payload containing the description of the custom entityType. (required)
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> The created custom entityType. </td><td>  -  </td></tr>
    ...
    /**
     * [EXPERIMENTAL] CreateCustomEntityDefinition: Define a new custom entityType. (asynchronously)
     * The API will return a Bad Request if the custom entityType already exists.
     * @param customEntityDefinitionRequest The payload containing the description of the custom entityType. (required)
    ...
    /**
     * [EXPERIMENTAL] GetDefinition: Get a custom entityType definition. (asynchronously)
     * Retrieve a CustomEntityDefinition by a specific EntityType at a point in AsAt time
     * @param entityType The identifier for the custom entity type, derived from the \&quot;entityTypeName\&quot; provided on creation. (required)
     * @param asAt The AsAt datetime at which to retrieve the definition. (optional)
     * @param _callback The callback to be executed when the API call finishes
