...
public class CustomEntityDefinitionsApi {
     ...
     * @param customEntityDefinitionRequest The CustomEntityDefinitionRequest (required)
    ...
    /**
     * [EXPERIMENTAL] CreateCustomEntityDefinition: Create a new CustomEntityDefinition (asynchronously)
     * Create a custom entity definition that does not already exist. Will return a Bad Request if the CustomEntityDefinition already exists
     * @param customEntityDefinitionRequest The CustomEntityDefinitionRequest (required)
     ...
     * @param entityType The type of entity for which to retrieve the CustomEntityDefinition. (required)
    ...
    /**
     * [EXPERIMENTAL] GetDefinition: Get CustomEntityDefinition (asynchronously)
     * Retrieve a CustomEntityDefinition by a specific EntityType at a point in AsAt time
     * @param entityType The type of entity for which to retrieve the CustomEntityDefinition. (required)
     * @param asAt The AsAt at which to retrieve the CustomEntityDefinition. (optional)
     * @param _callback The callback to be executed when the API call finishes
