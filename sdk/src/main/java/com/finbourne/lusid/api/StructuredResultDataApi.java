...
public class StructuredResultDataApi {
     ...
     * @param requestBody The structured result data Ids to delete, each keyed by a unique correlation id. (required)
     ...
     */
    public okhttp3.Call getStructuredResultDataCall(String scope, Map<String, StructuredResultDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = requestBody;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStructuredResultDataValidateBeforeCall(String scope, Map<String, StructuredResultDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getStructuredResultDataCall(scope, requestBody, effectiveAt, asAt, maxAge, _callback);
        return localVarCall;
     ...
     */
    public GetStructuredResultDataResponse getStructuredResultData(String scope, Map<String, StructuredResultDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge) throws ApiException {
        ApiResponse<GetStructuredResultDataResponse> localVarResp = getStructuredResultDataWithHttpInfo(scope, requestBody, effectiveAt, asAt, maxAge);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetStructuredResultDataResponse> getStructuredResultDataWithHttpInfo(String scope, Map<String, StructuredResultDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge) throws ApiException {
        okhttp3.Call localVarCall = getStructuredResultDataValidateBeforeCall(scope, requestBody, effectiveAt, asAt, maxAge, null);
     ...
     */
    public okhttp3.Call getStructuredResultDataAsync(String scope, Map<String, StructuredResultDataId> requestBody, String effectiveAt, OffsetDateTime asAt, String maxAge, final ApiCallback<GetStructuredResultDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStructuredResultDataValidateBeforeCall(scope, requestBody, effectiveAt, asAt, maxAge, _callback);
        Type localVarReturnType = new TypeToken<GetStructuredResultDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param requestBody The set of structured result data items to update or insert keyed by a unique correlation id. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
