...
public class StructuredResultDataApi {
    ...
    public okhttp3.Call getAddressKeyDefinitionsForDocumentCall(String scope, String code, String source, String resultType, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/unitresults/virtualdocument/{scope}/{code}/{source}/{resultType}/addresskeydefinitions"
            ...
            .replaceAll("\\{" + "resultType" + "\\}", localVarApiClient.escapeString(resultType.toString()));
    ...
    private okhttp3.Call getAddressKeyDefinitionsForDocumentValidateBeforeCall(String scope, String code, String source, String resultType, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAddressKeyDefinitionsForDocumentCall(scope, code, source, resultType, effectiveAt, asAt, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getVirtualDocumentValidateBeforeCall(String scope, Map<String, StructuredResultDataId> requestBody, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getVirtualDocumentCall(scope, requestBody, asAt, _callback);
        return localVarCall;
    ...
    private okhttp3.Call getVirtualDocumentRowsValidateBeforeCall(String scope, String code, String source, String resultType, String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getVirtualDocumentRowsCall(scope, code, source, resultType, effectiveAt, asAt, page, limit, filter, _callback);
        return localVarCall;
    ...
    private okhttp3.Call upsertResultValueValidateBeforeCall(String scope, Map<String, UpsertResultValuesDataRequest> requestBody, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertResultValueCall(scope, requestBody, _callback);
        return localVarCall;
