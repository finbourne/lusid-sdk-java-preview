...
public class ApplicationMetadataApi {
     ...
     */
    public com.squareup.okhttp.Call getExcelAddinCall(String version, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call getExcelAddinValidateBeforeCall(String version, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getExcelAddinCall(version, progressListener, progressRequestListener);
        return call;
    ...
    public FileResponse getExcelAddin(String version) throws ApiException {
        ApiResponse<FileResponse> resp = getExcelAddinWithHttpInfo(version);
        return resp.getData();
    }
    ...
    public ApiResponse<FileResponse> getExcelAddinWithHttpInfo(String version) throws ApiException {
        com.squareup.okhttp.Call call = getExcelAddinValidateBeforeCall(version, null, null);
        Type localVarReturnType = new TypeToken<FileResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Download Excel Addin (asynchronously)
     * Download the LUSID Excel Addin for Microsoft Excel. Not providing a specific value will return the latest version being returned
     * @param version The requested version of the Excel plugin (optional)
     ...
     */
    public com.squareup.okhttp.Call getExcelAddinAsync(String version, final ApiCallback<FileResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getExcelAddinValidateBeforeCall(version, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<FileResponse>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getLusidVersionsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getLusidVersionsValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = getLusidVersionsCall(progressListener, progressRequestListener);
        return call;
    ...
    public VersionSummaryDto getLusidVersions() throws ApiException {
        ApiResponse<VersionSummaryDto> resp = getLusidVersionsWithHttpInfo();
        return resp.getData();
    }
    ...
    public ApiResponse<VersionSummaryDto> getLusidVersionsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getLusidVersionsValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<VersionSummaryDto>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get LUSID versions (asynchronously)
     * Get the semantic versions associated with LUSID and its ecosystem
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getLusidVersionsAsync(final ApiCallback<VersionSummaryDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLusidVersionsValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<VersionSummaryDto>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listAccessControlledResourcesCall(String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listAccessControlledResourcesValidateBeforeCall(String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listAccessControlledResourcesCall(filter, progressListener, progressRequestListener);
        return call;
    ...
    public ResourceListOfAccessControlledResource listAccessControlledResources(String filter) throws ApiException {
        ApiResponse<ResourceListOfAccessControlledResource> resp = listAccessControlledResourcesWithHttpInfo(filter);
        return resp.getData();
    }
    ...
    public ApiResponse<ResourceListOfAccessControlledResource> listAccessControlledResourcesWithHttpInfo(String filter) throws ApiException {
        com.squareup.okhttp.Call call = listAccessControlledResourcesValidateBeforeCall(filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfAccessControlledResource>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get resources available for access control (asynchronously)
     * Get the comprehensive set of resources that are available for access control
     * @param filter Optional. Expression to filter the result set (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listAccessControlledResourcesAsync(String filter, final ApiCallback<ResourceListOfAccessControlledResource> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listAccessControlledResourcesValidateBeforeCall(filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfAccessControlledResource>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
