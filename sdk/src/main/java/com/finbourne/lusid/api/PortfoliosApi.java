...
public class PortfoliosApi {
     ...
     * @param outputFrequency The type of calculated output: Daily/Monthly/Yearly. (optional)
     ...
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param propertyKey The property key of the property that will have its history shown.              These must be from the &#39;Portfolio&#39; domain and in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (optional)
     ...
     * @param asAt The as-at datetime at which to list the portfolio&#39;s property history. Defaults to return the current datetime if not supplied. (optional)
    ...
    /**
     * [EXPERIMENTAL] Get portfolio property time series (asynchronously)
     * List the complete time series of a portfolio property.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param propertyKey The property key of the property that will have its history shown.              These must be from the &#39;Portfolio&#39; domain and in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (optional)
     ...
     * @param asAt The as-at datetime at which to retrieve relations. Defaults to return the latest LUSID AsAt time if not specified. (optional)
    ...
    /**
     * [EXPERIMENTAL] Get portfolio relations (asynchronously)
     * Get relations for a portfolio .
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relations. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     * @param asAt The as-at datetime at which to retrieve relationships. Defaults to return the latest LUSID AsAt time if not specified. (optional)
    ...
    /**
     * [EXPERIMENTAL] Get portfolio relationships (asynchronously)
     * Get relationships for a portfolio
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relationships. Defaults to the current LUSID system datetime if not specified. (optional)
