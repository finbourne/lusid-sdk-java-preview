...
public class PortfoliosApi {
    ...
    /**
     * [EXPERIMENTAL] Delete a Portfolio Access Metadata Rule (asynchronously)
     * Delete the Portfolio Access Metadata Rule that exactly matches the provided identifier parts
     * @param scope The scope of the Quote Access Metadata Rule to retrieve. (required)
     * @param code Portfolio code (required)
     * @param metadataKey The metadataKey identifying the access metadata entry to delete (required)
     ...
     * @param period the type of the returns used to calculate the aggregation result. (optional)
     * @param outputFrequency The type of calculated output. (optional)
     * @param metrics The period time to calculate the aggregate return. (optional)
    ...
    /**
     * [EXPERIMENTAL] Aggregate Returns (asynchronously)
     * Aggregate Returns which are on the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
    ...
    /**
     * [EXPERIMENTAL] Get access metadata rules for a portfolio (asynchronously)
     * Pass the scope and portfolio code parameters to retrieve the AccessMetadata associated with a portfolio
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code Portfolio code (required)
     * @param effectiveAt The effectiveAt datetime at which to retrieve the access metadata rule. (optional)
     ...
     * @param effectiveAt The effective datetime at which to list the property history. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param asAt The asAt datetime at which to list the portfolio&#39;s property history. Defaults to return the current datetime if not supplied. (optional)
     ...
     */
    public okhttp3.Call getPortfolioPropertyTimeSeriesCall(String scope, String code, String propertyKey, String effectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPortfolioPropertyTimeSeriesValidateBeforeCall(String scope, String code, String propertyKey, String effectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getPortfolioPropertyTimeSeriesCall(scope, code, propertyKey, effectiveAt, asAt, filter, page, limit, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPropertyInterval getPortfolioPropertyTimeSeries(String scope, String code, String propertyKey, String effectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfPropertyInterval> localVarResp = getPortfolioPropertyTimeSeriesWithHttpInfo(scope, code, propertyKey, effectiveAt, asAt, filter, page, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPropertyInterval> getPortfolioPropertyTimeSeriesWithHttpInfo(String scope, String code, String propertyKey, String effectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = getPortfolioPropertyTimeSeriesValidateBeforeCall(scope, code, propertyKey, effectiveAt, asAt, filter, page, limit, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyInterval>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get the time series of a portfolio property (asynchronously)
     * List the complete time series of a portfolio property.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies              the portfolio. (required)
     * @param propertyKey The property key of the property that will have its history shown. (optional)
     ...
     */
    public okhttp3.Call getPortfolioPropertyTimeSeriesAsync(String scope, String code, String propertyKey, String effectiveAt, OffsetDateTime asAt, String filter, String page, Integer limit, final ApiCallback<ResourceListOfPropertyInterval> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPortfolioPropertyTimeSeriesValidateBeforeCall(scope, code, propertyKey, effectiveAt, asAt, filter, page, limit, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyInterval>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EXPERIMENTAL] Get Relations for Portfolio (asynchronously)
     * Get relations for the specified Portfolio
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies              the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relations. Defaults to the current LUSID system datetime if not specified. (optional)
     ...
     */
    public ResourceListOfReturn getPortfolioReturns(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt) throws ApiException {
        ApiResponse<ResourceListOfReturn> localVarResp = getPortfolioReturnsWithHttpInfo(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt);
        return localVarResp.getData();
    }
     ...
     * @param period Show the Returns on a Daily or Monthly period. (optional)
     * @param asAt The asAt datetime at which to retrieve the Returns. Defaults to the latest. (optional)
     * @return ApiResponse&lt;ResourceListOfReturn&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<ResourceListOfReturn> getPortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<ResourceListOfReturn>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get Returns (asynchronously)
     * Get Returns which are on the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     ...
     */
    public okhttp3.Call getPortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, String fromEffectiveAt, String toEffectiveAt, String period, OffsetDateTime asAt, final ApiCallback<ResourceListOfReturn> _callback) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] Get an entry identified by a metadataKey in the access metadata object (asynchronously)
     * Get a specific portfolio access metadata rule by specifying the corresponding identifier parts                No matching will be performed through this endpoint. To retrieve a rule, it is necessary to specify, exactly, the identifier of the rule
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code The code of the portfolio (required)
     * @param metadataKey Key of the metadata to retrieve (required)
    ...
    /**
     * [EXPERIMENTAL] Upsert a Portfolio Access Metadata Rule associated with specific metadataKey. This creates or updates the data in LUSID. (asynchronously)
     * Update or insert one Portfolio Access Metadata Rule in a single scope. An item will be updated if it already exists  and inserted if it does not.    The response will return the successfully updated or inserted Portfolio Access Metadata Rule or failure message if unsuccessful    It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exists with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched
     * @param scope The scope to use when updating or inserting the Portfolio Access Metadata Rule. (required)
     * @param code Portfolio code (required)
     * @param metadataKey Key of the access metadata to upsert (required)
     ...
     * @param returnScope The scope of the Returns. (required)
     * @param returnCode The code of the Returns. (required)
     * @param modelReturn This contains the Returns which need to be upsert. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertPortfolioReturnsCall(String scope, String code, String returnScope, String returnCode, List<ModelReturn> modelReturn, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertPortfolioReturnsValidateBeforeCall(String scope, String code, String returnScope, String returnCode, List<ModelReturn> modelReturn, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'modelReturn' is set
        if (modelReturn == null) {
            throw new ApiException("Missing the required parameter 'modelReturn' when calling upsertPortfolioReturns(Async)");
        }
        

        okhttp3.Call localVarCall = upsertPortfolioReturnsCall(scope, code, returnScope, returnCode, modelReturn, _callback);
        return localVarCall;
     ...
     */
    public UpsertReturnsResponse upsertPortfolioReturns(String scope, String code, String returnScope, String returnCode, List<ModelReturn> modelReturn) throws ApiException {
        ApiResponse<UpsertReturnsResponse> localVarResp = upsertPortfolioReturnsWithHttpInfo(scope, code, returnScope, returnCode, modelReturn);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertReturnsResponse> upsertPortfolioReturnsWithHttpInfo(String scope, String code, String returnScope, String returnCode, List<ModelReturn> modelReturn) throws ApiException {
        okhttp3.Call localVarCall = upsertPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, modelReturn, null);
        Type localVarReturnType = new TypeToken<UpsertReturnsResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert Returns (asynchronously)
     * Update or insert returns into the specified portfolio.
     * @param scope The scope of the Portfolio. (required)
     * @param code The code of the  Portfolio. (required)
     * @param returnScope The scope of the Returns. (required)
     ...
     */
    public okhttp3.Call upsertPortfolioReturnsAsync(String scope, String code, String returnScope, String returnCode, List<ModelReturn> modelReturn, final ApiCallback<UpsertReturnsResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertPortfolioReturnsValidateBeforeCall(scope, code, returnScope, returnCode, modelReturn, _callback);
        Type localVarReturnType = new TypeToken<UpsertReturnsResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
