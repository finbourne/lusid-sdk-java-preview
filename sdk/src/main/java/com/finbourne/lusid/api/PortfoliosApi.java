...
public class PortfoliosApi {
     ...
     */
    public okhttp3.Call patchPortfolioAccessMetadataCall(String scope, String code, List<Operation> operation, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchPortfolioAccessMetadataValidateBeforeCall(String scope, String code, List<Operation> operation, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = patchPortfolioAccessMetadataCall(scope, code, operation, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public Map<String, List<AccessMetadataValue>> patchPortfolioAccessMetadata(String scope, String code, List<Operation> operation, String effectiveAt) throws ApiException {
        ApiResponse<Map<String, List<AccessMetadataValue>>> localVarResp = patchPortfolioAccessMetadataWithHttpInfo(scope, code, operation, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, List<AccessMetadataValue>>> patchPortfolioAccessMetadataWithHttpInfo(String scope, String code, List<Operation> operation, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, operation, effectiveAt, null);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call patchPortfolioAccessMetadataAsync(String scope, String code, List<Operation> operation, String effectiveAt, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
        okhttp3.Call localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, operation, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
