...
public class PortfoliosApi {
    ...
    /**
     * [EXPERIMENTAL] GetPortfolioPropertyTimeSeries: Get portfolio property time series (asynchronously)
     * Show the complete time series (history) for a particular portfolio property.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param propertyKey The property key of the property whose history to show.              This must be from the &#39;Portfolio&#39; domain and in the format {domain}/{scope}/{code}, for example &#39;Portfolio/Manager/Id&#39;. (required)
    ...
    /**
     * [EXPERIMENTAL] GetPortfolioRelationships: Get portfolio relationships (asynchronously)
     * Get relationships for a particular portfolio.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to retrieve relationships. Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    /**
     * [EXPERIMENTAL] ListPortfolioProperties: Get portfolio properties (asynchronously)
     * List all the properties of a particular portfolio.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the scope this uniquely identifies the portfolio. (required)
     * @param effectiveAt The effective datetime or cut label at which to list the portfolio&#39;s properties. Defaults to the current LUSID system datetime if not specified. (optional)
    ...
    /**
     * [EXPERIMENTAL] PatchPortfolio: Patch portfolio. (asynchronously)
     * Create or update certain fields for a particular  portfolio.  The behaviour is defined by the JSON Patch specification.                Currently supported are: CreationDate.
     * @param scope The scope of the portfolio. (required)
     * @param code The code of the portfolio. Together with the               scope this uniquely identifies the portfolio. (required)
     * @param operation The json patch document. For more check: https://datatracker.ietf.org/doc/html/rfc6902. (required)
     ...
     */
    public okhttp3.Call patchPortfolioAccessMetadataCall(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = operation;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call patchPortfolioAccessMetadataValidateBeforeCall(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'operation' is set
        if (operation == null) {
            throw new ApiException("Missing the required parameter 'operation' when calling patchPortfolioAccessMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = patchPortfolioAccessMetadataCall(scope, code, operation, effectiveAt, effectiveUntil, _callback);
        return localVarCall;
     ...
     */
    public Map<String, List<AccessMetadataValue>> patchPortfolioAccessMetadata(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        ApiResponse<Map<String, List<AccessMetadataValue>>> localVarResp = patchPortfolioAccessMetadataWithHttpInfo(scope, code, operation, effectiveAt, effectiveUntil);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<Map<String, List<AccessMetadataValue>>> patchPortfolioAccessMetadataWithHttpInfo(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil) throws ApiException {
        okhttp3.Call localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, operation, effectiveAt, effectiveUntil, null);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] PatchPortfolioAccessMetadata: Patch Access Metadata rules for a Portfolio. (asynchronously)
     * Patch Portfolio Access Metadata Rules in a single scope.  The behaviour is defined by the JSON Patch specification.                Currently only &#39;add&#39; is a supported operation on the patch document  Currently only valid metadata keys are supported paths on the patch document    The response will return any affected Portfolio Access Metadata rules or a failure message if unsuccessful.    It is important to always check to verify success (or failure).                Multiple rules for a metadataKey can exist with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched
     * @param scope The scope of the Portfolio Access Metadata Rule. (required)
     * @param code Portfolio code (required)
     * @param operation The Json Patch document (required)
     ...
     */
    public okhttp3.Call patchPortfolioAccessMetadataAsync(String scope, String code, List<Operation> operation, String effectiveAt, OffsetDateTime effectiveUntil, final ApiCallback<Map<String, List<AccessMetadataValue>>> _callback) throws ApiException {
        okhttp3.Call localVarCall = patchPortfolioAccessMetadataValidateBeforeCall(scope, code, operation, effectiveAt, effectiveUntil, _callback);
        Type localVarReturnType = new TypeToken<Map<String, List<AccessMetadataValue>>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
