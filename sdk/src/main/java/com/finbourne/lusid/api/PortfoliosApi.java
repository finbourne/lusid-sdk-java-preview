...
public class PortfoliosApi {
     ...
     * @param key The key identifying the access metadata entry to delete (required)
     ...
     */
    public okhttp3.Call deleteKeyFromPortfolioAccessMetadataCall(String scope, String code, String key, String effectiveAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/portfolios/{scope}/{code}/metadata/{key}"
    ...
    private okhttp3.Call deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(String scope, String code, String key, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling deleteKeyFromPortfolioAccessMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = deleteKeyFromPortfolioAccessMetadataCall(scope, code, key, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public DeletedEntityResponse deleteKeyFromPortfolioAccessMetadata(String scope, String code, String key, String effectiveAt) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteKeyFromPortfolioAccessMetadataWithHttpInfo(scope, code, key, effectiveAt);
     ...
     */
    public ApiResponse<DeletedEntityResponse> deleteKeyFromPortfolioAccessMetadataWithHttpInfo(String scope, String code, String key, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, key, effectiveAt, null);
     ...
     */
    public okhttp3.Call deleteKeyFromPortfolioAccessMetadataAsync(String scope, String code, String key, String effectiveAt, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteKeyFromPortfolioAccessMetadataValidateBeforeCall(scope, code, key, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
     ...
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code The code of the portfolio (required)
     * @param key Key of the metadata to retrieve (required)
     ...
     */
    public okhttp3.Call getPortfoliosAccessMetadataByKeyCall(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getPortfoliosAccessMetadataByKeyValidateBeforeCall(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling getPortfoliosAccessMetadataByKey(Async)");
        }
        

        okhttp3.Call localVarCall = getPortfoliosAccessMetadataByKeyCall(scope, code, key, effectiveAt, asAt, _callback);
        return localVarCall;
     ...
     */
    public List<AccessMetadataValue> getPortfoliosAccessMetadataByKey(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        ApiResponse<List<AccessMetadataValue>> localVarResp = getPortfoliosAccessMetadataByKeyWithHttpInfo(scope, code, key, effectiveAt, asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<List<AccessMetadataValue>> getPortfoliosAccessMetadataByKeyWithHttpInfo(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getPortfoliosAccessMetadataByKeyValidateBeforeCall(scope, code, key, effectiveAt, asAt, null);
        Type localVarReturnType = new TypeToken<List<AccessMetadataValue>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get an entry identified by a key in the access metadata object (asynchronously)
     * Get a specific portfolio access metadata rule by specifying the corresponding identifier parts                No matching will be performed through this endpoint. To retrieve a rule, it is necessary to specify, exactly, the identifier of the rule
     * @param scope The scope of the Portfolio Access Metadata Rule to retrieve. (required)
     * @param code The code of the portfolio (required)
     * @param key Key of the metadata to retrieve (required)
     ...
     */
    public okhttp3.Call getPortfoliosAccessMetadataByKeyAsync(String scope, String code, String key, String effectiveAt, OffsetDateTime asAt, final ApiCallback<List<AccessMetadataValue>> _callback) throws ApiException {

        okhttp3.Call localVarCall = getPortfoliosAccessMetadataByKeyValidateBeforeCall(scope, code, key, effectiveAt, asAt, _callback);
        Type localVarReturnType = new TypeToken<List<AccessMetadataValue>>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param code Portfolio code (required)
     * @param key Key of the access metadata to upsert (required)
     * @param request The Portfolio Access Metadata Rule to update or insert (required)
     ...
     */
    public okhttp3.Call upsertPortfolioAccessMetadataCall(String scope, String code, String key, UpsertPortfolioAccessMetadataRequest request, String effectiveAt, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertPortfolioAccessMetadataValidateBeforeCall(String scope, String code, String key, UpsertPortfolioAccessMetadataRequest request, String effectiveAt, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'key' is set
        if (key == null) {
            throw new ApiException("Missing the required parameter 'key' when calling upsertPortfolioAccessMetadata(Async)");
        }
        
        // verify the required parameter 'request' is set
        if (request == null) {
            throw new ApiException("Missing the required parameter 'request' when calling upsertPortfolioAccessMetadata(Async)");
        }
        

        okhttp3.Call localVarCall = upsertPortfolioAccessMetadataCall(scope, code, key, request, effectiveAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfAccessMetadataValueOf upsertPortfolioAccessMetadata(String scope, String code, String key, UpsertPortfolioAccessMetadataRequest request, String effectiveAt) throws ApiException {
        ApiResponse<ResourceListOfAccessMetadataValueOf> localVarResp = upsertPortfolioAccessMetadataWithHttpInfo(scope, code, key, request, effectiveAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfAccessMetadataValueOf> upsertPortfolioAccessMetadataWithHttpInfo(String scope, String code, String key, UpsertPortfolioAccessMetadataRequest request, String effectiveAt) throws ApiException {
        okhttp3.Call localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, key, request, effectiveAt, null);
        Type localVarReturnType = new TypeToken<ResourceListOfAccessMetadataValueOf>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert a Portfolio Access Metadata Rule associated with specific key. This creates or updates the data in LUSID. (asynchronously)
     * Update or insert one Portfolio Access Metadata Rule in a single scope. An item will be updated if it already exists  and inserted if it does not.    The response will return the successfully updated or inserted Portfolio Access Metadata Rule or failure message if unsuccessful    It is important to always check to verify success (or failure).                Multiple rules for a key can exists with different effective at dates, when resources are accessed the rule that is active for the current time will be fetched
     * @param scope The scope to use when updating or inserting the Portfolio Access Metadata Rule. (required)
     * @param code Portfolio code (required)
     * @param key Key of the access metadata to upsert (required)
     ...
     */
    public okhttp3.Call upsertPortfolioAccessMetadataAsync(String scope, String code, String key, UpsertPortfolioAccessMetadataRequest request, String effectiveAt, final ApiCallback<ResourceListOfAccessMetadataValueOf> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertPortfolioAccessMetadataValidateBeforeCall(scope, code, key, request, effectiveAt, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfAccessMetadataValueOf>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
