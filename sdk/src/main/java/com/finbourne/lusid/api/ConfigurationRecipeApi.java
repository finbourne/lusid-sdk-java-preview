...
public class ConfigurationRecipeApi {
     ...
     */
    public okhttp3.Call upsertConfigurationRecipeCall(String scope, UpsertRecipeRequest upsertRecipeRequest, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertConfigurationRecipeValidateBeforeCall(String scope, UpsertRecipeRequest upsertRecipeRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertConfigurationRecipeCall(scope, upsertRecipeRequest, _callback);
        return localVarCall;
     ...
     */
    public UpsertSingleStructuredDataResponse upsertConfigurationRecipe(String scope, UpsertRecipeRequest upsertRecipeRequest) throws ApiException {
        ApiResponse<UpsertSingleStructuredDataResponse> localVarResp = upsertConfigurationRecipeWithHttpInfo(scope, upsertRecipeRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertSingleStructuredDataResponse> upsertConfigurationRecipeWithHttpInfo(String scope, UpsertRecipeRequest upsertRecipeRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertConfigurationRecipeValidateBeforeCall(scope, upsertRecipeRequest, null);
     ...
     */
    public okhttp3.Call upsertConfigurationRecipeAsync(String scope, UpsertRecipeRequest upsertRecipeRequest, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertConfigurationRecipeValidateBeforeCall(scope, upsertRecipeRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
