...
public class ConfigurationRecipeApi {
    ...
    /**
     * [EXPERIMENTAL] Delete a Configuration Recipe, assuming that it is present. (asynchronously)
     * Delete the specified Configuration Recipe from a single scope.                The response will return either detail of the deleted item, or an explanation (failure) as to why this did not succeed.                It is important to always check for any unsuccessful response.
     * @param scope The scope of the Configuration Recipe to delete. (required)
     * @param code The Configuration Recipe to delete. (required)
    ...
    /**
     * [EXPERIMENTAL] Get Configuration Recipe (asynchronously)
     * Get a Configuration Recipe from a single scope.                The response will return either the recipe that has been stored, or a failure explaining why the request was unsuccessful.                It is important to always check for any unsuccessful requests (failures).
     * @param scope The scope of the Configuration Recipe to retrieve. (required)
     * @param code The name of the recipe to retrieve the data for. (required)
     * @param asAt The asAt datetime at which to retrieve the Configuration Recipe. Defaults to return the latest version if not specified. (optional)
     ...
     * @param scope The scope of the Configuration Recipes to list (required)
     * @param asAt The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)
     * @param filter Expression to filter the result set.              For example, to filter on code, use \&quot;value.code eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call listConfigurationRecipesCall(String scope, OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/recipes/{scope}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listConfigurationRecipesValidateBeforeCall(String scope, OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listConfigurationRecipes(Async)");
        }
        

        okhttp3.Call localVarCall = listConfigurationRecipesCall(scope, asAt, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfGetRecipeResponse listConfigurationRecipes(String scope, OffsetDateTime asAt, String filter) throws ApiException {
        ApiResponse<ResourceListOfGetRecipeResponse> localVarResp = listConfigurationRecipesWithHttpInfo(scope, asAt, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfGetRecipeResponse> listConfigurationRecipesWithHttpInfo(String scope, OffsetDateTime asAt, String filter) throws ApiException {
        okhttp3.Call localVarCall = listConfigurationRecipesValidateBeforeCall(scope, asAt, filter, null);
        Type localVarReturnType = new TypeToken<ResourceListOfGetRecipeResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] List the set of Configuration Recipes (asynchronously)
     * List the set of  configuration recipes at the specified date/time and scope
     * @param scope The scope of the Configuration Recipes to list (required)
     * @param asAt The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)
     * @param filter Expression to filter the result set.              For example, to filter on code, use \&quot;value.code eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     ...
     */
    public okhttp3.Call listConfigurationRecipesAsync(String scope, OffsetDateTime asAt, String filter, final ApiCallback<ResourceListOfGetRecipeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listConfigurationRecipesValidateBeforeCall(scope, asAt, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfGetRecipeResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for listConfigurationRecipesForAllScopes
     * @param asAt The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)
     * @param filter Expression to filter the result set.             For example, to filter on code, use \&quot;value.code eq &#39;string&#39;\&quot;             Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The configuration recipes for all scopes </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listConfigurationRecipesForAllScopesCall(OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listConfigurationRecipesForAllScopesValidateBeforeCall(OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listConfigurationRecipesForAllScopesCall(asAt, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfGetRecipeResponse listConfigurationRecipesForAllScopes(OffsetDateTime asAt, String filter) throws ApiException {
        ApiResponse<ResourceListOfGetRecipeResponse> localVarResp = listConfigurationRecipesForAllScopesWithHttpInfo(asAt, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfGetRecipeResponse> listConfigurationRecipesForAllScopesWithHttpInfo(OffsetDateTime asAt, String filter) throws ApiException {
        okhttp3.Call localVarCall = listConfigurationRecipesForAllScopesValidateBeforeCall(asAt, filter, null);
        Type localVarReturnType = new TypeToken<ResourceListOfGetRecipeResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] List the set of Configuration Recipes from all scopes (asynchronously)
     * List the set of configuration recipes at the specified date/time across all the scopes and allowing filtering (e.g. filter by scope)
     * @param asAt The asAt datetime at which to list the Configuration Recipes. Defaults to latest if not specified. (optional)
     * @param filter Expression to filter the result set.             For example, to filter on code, use \&quot;value.code eq &#39;string&#39;\&quot;             Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call listConfigurationRecipesForAllScopesAsync(OffsetDateTime asAt, String filter, final ApiCallback<ResourceListOfGetRecipeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listConfigurationRecipesForAllScopesValidateBeforeCall(asAt, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfGetRecipeResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param scope The scope to use when updating or inserting the Configuration Recipe. (required)
     * @param structuredData The Configuration Recipe to update or insert (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertConfigurationRecipeCall(String scope, UpsertRecipeRequest structuredData, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertConfigurationRecipeValidateBeforeCall(String scope, UpsertRecipeRequest structuredData, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling upsertConfigurationRecipe(Async)");
        }
        
        // verify the required parameter 'structuredData' is set
        if (structuredData == null) {
            throw new ApiException("Missing the required parameter 'structuredData' when calling upsertConfigurationRecipe(Async)");
        }
        

        okhttp3.Call localVarCall = upsertConfigurationRecipeCall(scope, structuredData, _callback);
        return localVarCall;
     ...
     */
    public UpsertSingleStructuredDataResponse upsertConfigurationRecipe(String scope, UpsertRecipeRequest structuredData) throws ApiException {
        ApiResponse<UpsertSingleStructuredDataResponse> localVarResp = upsertConfigurationRecipeWithHttpInfo(scope, structuredData);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertSingleStructuredDataResponse> upsertConfigurationRecipeWithHttpInfo(String scope, UpsertRecipeRequest structuredData) throws ApiException {
        okhttp3.Call localVarCall = upsertConfigurationRecipeValidateBeforeCall(scope, structuredData, null);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert a Configuration Recipe. This creates or updates the data in Lusid. (asynchronously)
     * Update or insert one Configuration Recipe in a single scope. An item will be updated if it already exists  and inserted if it does not.                The response will return the successfully updated or inserted Configuration Recipe or failure message if unsuccessful                It is important to always check to verify success (or failure).
     * @param scope The scope to use when updating or inserting the Configuration Recipe. (required)
     * @param structuredData The Configuration Recipe to update or insert (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call upsertConfigurationRecipeAsync(String scope, UpsertRecipeRequest structuredData, final ApiCallback<UpsertSingleStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertConfigurationRecipeValidateBeforeCall(scope, structuredData, _callback);
        Type localVarReturnType = new TypeToken<UpsertSingleStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
