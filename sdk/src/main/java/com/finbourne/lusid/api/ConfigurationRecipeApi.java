...
public class ConfigurationRecipeApi {
     ...
     */
    public okhttp3.Call listConfigurationRecipesCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listConfigurationRecipesValidateBeforeCall(OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listConfigurationRecipesCall(asAt, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfGetRecipeResponse listConfigurationRecipes(OffsetDateTime asAt) throws ApiException {
        ApiResponse<ResourceListOfGetRecipeResponse> localVarResp = listConfigurationRecipesWithHttpInfo(asAt);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfGetRecipeResponse> listConfigurationRecipesWithHttpInfo(OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = listConfigurationRecipesValidateBeforeCall(asAt, null);
     ...
     */
    public okhttp3.Call listConfigurationRecipesAsync(OffsetDateTime asAt, final ApiCallback<ResourceListOfGetRecipeResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = listConfigurationRecipesValidateBeforeCall(asAt, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfGetRecipeResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call listConfigurationRecipesForAllScopesCall(OffsetDateTime asAt, String filter, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/recipes/list";
