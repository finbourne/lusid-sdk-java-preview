...
public class StructuredMarketDataApi {
     ...
     * @param structuredDataIds The structured market data Ids to delete, each keyed by a unique correlation id. (required)
     ...
     */
    public okhttp3.Call deleteStructuredMarketDataCall(String scope, Map<String, StructuredMarketDataId> structuredDataIds, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call deleteStructuredMarketDataValidateBeforeCall(String scope, Map<String, StructuredMarketDataId> structuredDataIds, final ApiCallback _callback) throws ApiException {
        ...
        if (structuredDataIds == null) {
            throw new ApiException("Missing the required parameter 'structuredDataIds' when calling deleteStructuredMarketData(Async)");
        }
        

        okhttp3.Call localVarCall = deleteStructuredMarketDataCall(scope, structuredDataIds, _callback);
        return localVarCall;
     ...
     */
    public AnnulStructuredDataResponse deleteStructuredMarketData(String scope, Map<String, StructuredMarketDataId> structuredDataIds) throws ApiException {
        ApiResponse<AnnulStructuredDataResponse> localVarResp = deleteStructuredMarketDataWithHttpInfo(scope, structuredDataIds);
     ...
     */
    public ApiResponse<AnnulStructuredDataResponse> deleteStructuredMarketDataWithHttpInfo(String scope, Map<String, StructuredMarketDataId> structuredDataIds) throws ApiException {
        okhttp3.Call localVarCall = deleteStructuredMarketDataValidateBeforeCall(scope, structuredDataIds, null);
     ...
     */
    public okhttp3.Call deleteStructuredMarketDataAsync(String scope, Map<String, StructuredMarketDataId> structuredDataIds, final ApiCallback<AnnulStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteStructuredMarketDataValidateBeforeCall(scope, structuredDataIds, _callback);
        Type localVarReturnType = new TypeToken<AnnulStructuredDataResponse>(){}.getType();
     ...
     */
    public okhttp3.Call getStructuredMarketDataCall(String scope, Map<String, StructuredMarketDataId> structuredDataIds, String effectiveAt, OffsetDateTime asAt, String maxAge, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = structuredDataIds;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getStructuredMarketDataValidateBeforeCall(String scope, Map<String, StructuredMarketDataId> structuredDataIds, String effectiveAt, OffsetDateTime asAt, String maxAge, final ApiCallback _callback) throws ApiException {
        ...
        // verify the required parameter 'structuredDataIds' is set
        if (structuredDataIds == null) {
            throw new ApiException("Missing the required parameter 'structuredDataIds' when calling getStructuredMarketData(Async)");
        }
        

        okhttp3.Call localVarCall = getStructuredMarketDataCall(scope, structuredDataIds, effectiveAt, asAt, maxAge, _callback);
        return localVarCall;
     ...
     */
    public GetStructuredMarketDataResponse getStructuredMarketData(String scope, Map<String, StructuredMarketDataId> structuredDataIds, String effectiveAt, OffsetDateTime asAt, String maxAge) throws ApiException {
        ApiResponse<GetStructuredMarketDataResponse> localVarResp = getStructuredMarketDataWithHttpInfo(scope, structuredDataIds, effectiveAt, asAt, maxAge);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<GetStructuredMarketDataResponse> getStructuredMarketDataWithHttpInfo(String scope, Map<String, StructuredMarketDataId> structuredDataIds, String effectiveAt, OffsetDateTime asAt, String maxAge) throws ApiException {
        okhttp3.Call localVarCall = getStructuredMarketDataValidateBeforeCall(scope, structuredDataIds, effectiveAt, asAt, maxAge, null);
     ...
     */
    public okhttp3.Call getStructuredMarketDataAsync(String scope, Map<String, StructuredMarketDataId> structuredDataIds, String effectiveAt, OffsetDateTime asAt, String maxAge, final ApiCallback<GetStructuredMarketDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getStructuredMarketDataValidateBeforeCall(scope, structuredDataIds, effectiveAt, asAt, maxAge, _callback);
        Type localVarReturnType = new TypeToken<GetStructuredMarketDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param structuredData The set of structured market data items to update or insert keyed by a unique correlation id. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertStructuredMarketDataCall(String scope, Map<String, UpsertStructuredMarketDataRequest> structuredData, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertStructuredMarketDataValidateBeforeCall(String scope, Map<String, UpsertStructuredMarketDataRequest> structuredData, final ApiCallback _callback) throws ApiException {
        ...
        if (structuredData == null) {
            throw new ApiException("Missing the required parameter 'structuredData' when calling upsertStructuredMarketData(Async)");
        }
        

        okhttp3.Call localVarCall = upsertStructuredMarketDataCall(scope, structuredData, _callback);
        return localVarCall;
     ...
     */
    public UpsertStructuredDataResponse upsertStructuredMarketData(String scope, Map<String, UpsertStructuredMarketDataRequest> structuredData) throws ApiException {
        ApiResponse<UpsertStructuredDataResponse> localVarResp = upsertStructuredMarketDataWithHttpInfo(scope, structuredData);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertStructuredDataResponse> upsertStructuredMarketDataWithHttpInfo(String scope, Map<String, UpsertStructuredMarketDataRequest> structuredData) throws ApiException {
        okhttp3.Call localVarCall = upsertStructuredMarketDataValidateBeforeCall(scope, structuredData, null);
     ...
     */
    public okhttp3.Call upsertStructuredMarketDataAsync(String scope, Map<String, UpsertStructuredMarketDataRequest> structuredData, final ApiCallback<UpsertStructuredDataResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertStructuredMarketDataValidateBeforeCall(scope, structuredData, _callback);
        Type localVarReturnType = new TypeToken<UpsertStructuredDataResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
