...
public class SchemasApi {
     ...
     */
    public okhttp3.Call getValueTypesCall(List<String> sortBy, Integer limit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getValueTypesValidateBeforeCall(List<String> sortBy, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getValueTypesCall(sortBy, limit, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfValueType getValueTypes(List<String> sortBy, Integer limit) throws ApiException {
     ...
     */
    public ApiResponse<ResourceListOfValueType> getValueTypesWithHttpInfo(List<String> sortBy, Integer limit) throws ApiException {
     ...
     */
    public okhttp3.Call getValueTypesAsync(List<String> sortBy, Integer limit, final ApiCallback<ResourceListOfValueType> _callback) throws ApiException {
