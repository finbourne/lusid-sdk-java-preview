...
public class ComplianceApi {
    ...
    /**
     * Build call for getBreachedOrdersInfo
     ...
     */
    public okhttp3.Call getBreachedOrdersInfoCall(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/runs/breached/{runId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getBreachedOrdersInfoValidateBeforeCall(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'runId' is set
        if (runId == null) {
            throw new ApiException("Missing the required parameter 'runId' when calling getBreachedOrdersInfo(Async)");
        }
        

        okhttp3.Call localVarCall = getBreachedOrdersInfoCall(runId, orderScope, orderCode, limit, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfComplianceBreachedOrderInfo getBreachedOrdersInfo(String runId, String orderScope, String orderCode, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfComplianceBreachedOrderInfo> localVarResp = getBreachedOrdersInfoWithHttpInfo(runId, orderScope, orderCode, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfComplianceBreachedOrderInfo> getBreachedOrdersInfoWithHttpInfo(String runId, String orderScope, String orderCode, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = getBreachedOrdersInfoValidateBeforeCall(runId, orderScope, orderCode, limit, null);
        Type localVarReturnType = new TypeToken<ResourceListOfComplianceBreachedOrderInfo>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetBreachedOrdersInfo: Get the Ids of Breached orders in a given compliance run and the corresponding list of rules that could have caused it. (asynchronously)
     * Use this endpoint to get a list or breached orders and the set of rules that may have caused the breach.
     * @param runId The RunId that the results should be checked for (required)
     * @param orderScope Optional. Find rules related to a specific order by providing an Order Scope/Code combination (optional)
     * @param orderCode Optional. Find rules related to a specific order by providing an Order Scope/Code combination (optional)
     ...
     */
    public okhttp3.Call getBreachedOrdersInfoAsync(String runId, String orderScope, String orderCode, Integer limit, final ApiCallback<ResourceListOfComplianceBreachedOrderInfo> _callback) throws ApiException {
        okhttp3.Call localVarCall = getBreachedOrdersInfoValidateBeforeCall(runId, orderScope, orderCode, limit, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfComplianceBreachedOrderInfo>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getComplianceRunResultsCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getComplianceRunResultsValidateBeforeCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getComplianceRunResultsCall(runId, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfComplianceRuleResult getComplianceRunResults(String runId, String page, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfComplianceRuleResult> localVarResp = getComplianceRunResultsWithHttpInfo(runId, page, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfComplianceRuleResult> getComplianceRunResultsWithHttpInfo(String runId, String page, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRunResultsValidateBeforeCall(runId, page, limit, filter, null);
     ...
     */
    public okhttp3.Call getComplianceRunResultsAsync(String runId, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRuleResult> _callback) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRunResultsValidateBeforeCall(runId, page, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfComplianceRuleResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call listComplianceRulesCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listComplianceRulesValidateBeforeCall(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listComplianceRulesCall(effectiveAt, asAt, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfComplianceRule listComplianceRules(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfComplianceRule> localVarResp = listComplianceRulesWithHttpInfo(effectiveAt, asAt, page, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfComplianceRule> listComplianceRulesWithHttpInfo(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRulesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, null);
     ...
     */
    public okhttp3.Call listComplianceRulesAsync(String effectiveAt, OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRule> _callback) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRulesValidateBeforeCall(effectiveAt, asAt, page, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfComplianceRule>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public ResourceListOfComplianceRunInfo listComplianceRunInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfComplianceRunInfo> localVarResp = listComplianceRunInfoWithHttpInfo(asAt, page, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfComplianceRunInfo> listComplianceRunInfoWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public okhttp3.Call listComplianceRunInfoAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRunInfo> _callback) throws ApiException {
     ...
     */
    public ComplianceRunInfo runCompliance(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots) throws ApiException {
        ApiResponse<ComplianceRunInfo> localVarResp = runComplianceWithHttpInfo(isPreTrade, recipeIdScope, recipeIdCode, byTaxlots);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ComplianceRunInfo> runComplianceWithHttpInfo(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots) throws ApiException {
     ...
     */
    public okhttp3.Call runComplianceAsync(Boolean isPreTrade, String recipeIdScope, String recipeIdCode, Boolean byTaxlots, final ApiCallback<ComplianceRunInfo> _callback) throws ApiException {
