...
import com.finbourne.lusid.model.PagedResourceListOfComplianceRuleResult;
import com.finbourne.lusid.model.PagedResourceListOfComplianceRun;
...
public class ComplianceApi {
     ...
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @return PagedResourceListOfComplianceRuleResult
     ...
     */
    public PagedResourceListOfComplianceRuleResult getComplianceRun(String runId, String page, Integer limit, String filter) throws ApiException {
        ApiResponse<PagedResourceListOfComplianceRuleResult> localVarResp = getComplianceRunWithHttpInfo(runId, page, limit, filter);
     ...
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @return ApiResponse&lt;PagedResourceListOfComplianceRuleResult&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PagedResourceListOfComplianceRuleResult> getComplianceRunWithHttpInfo(String runId, String page, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRunValidateBeforeCall(runId, page, limit, filter, null);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRuleResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetComplianceRun: Get the details of a single compliance run. (asynchronously)
     * Use this endpoint to fetch the detail associated with a specific compliance run, including a breakdown  of the passing state of each rule, portfolio combination.
     * @param runId The unique identifier of the compliance run requested. (required)
     * @param page The pagination token to use to continue listing compliance rule results from a previous call to list compliance rule result.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     ...
     */
    public okhttp3.Call getComplianceRunAsync(String runId, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfComplianceRuleResult> _callback) throws ApiException {
     ...
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @return PagedResourceListOfComplianceRun
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public PagedResourceListOfComplianceRun listComplianceRuns(String page, Integer limit, String filter) throws ApiException {
        ApiResponse<PagedResourceListOfComplianceRun> localVarResp = listComplianceRunsWithHttpInfo(page, limit, filter);
        return localVarResp.getData();
    }
     ...
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @return ApiResponse&lt;PagedResourceListOfComplianceRun&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<PagedResourceListOfComplianceRun> listComplianceRunsWithHttpInfo(String page, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = listComplianceRunsValidateBeforeCall(page, limit, filter, null);
        Type localVarReturnType = new TypeToken<PagedResourceListOfComplianceRun>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] ListComplianceRuns: List historical compliance runs. (asynchronously)
     * Use this endpoint to fetch a list of all historical compliance runs.
     * @param page The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     ...
     */
    public okhttp3.Call listComplianceRunsAsync(String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfComplianceRun> _callback) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] RunComplianceCheck: Kick off the compliance check process (asynchronously)
     * Use this endpoint to fetch the start a compliance run, based on a pre-set mapping file.
     * @param fileName The name of compliance mappings file to use. Has to exist in drive ComplianceRules folder (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
