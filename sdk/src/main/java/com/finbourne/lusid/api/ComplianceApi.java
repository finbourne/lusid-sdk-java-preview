...
public class ComplianceApi {
    ...
    /**
     * Build call for getComplianceRun
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The details of a specific compliance run </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getComplianceRunCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/{runId}"
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getComplianceRunValidateBeforeCall(String runId, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'runId' is set
        if (runId == null) {
            throw new ApiException("Missing the required parameter 'runId' when calling getComplianceRun(Async)");
        }
        

        okhttp3.Call localVarCall = getComplianceRunCall(runId, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfComplianceRuleResult getComplianceRun(String runId, String page, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfComplianceRuleResult> localVarResp = getComplianceRunWithHttpInfo(runId, page, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfComplianceRuleResult> getComplianceRunWithHttpInfo(String runId, String page, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRunValidateBeforeCall(runId, page, limit, filter, null);
        Type localVarReturnType = new TypeToken<ResourceListOfComplianceRuleResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] GetComplianceRun: Get the details of a single compliance run. -- DEPRECATING - POST TRADE ONLY (asynchronously)
     * Use this endpoint to fetch the detail associated with a specific compliance run, including a breakdown  of the passing state of each rule, portfolio combination.
     * @param runId The unique identifier of the compliance run requested. (required)
     * @param page The pagination token to use to continue listing compliance rule results from a previous call to list compliance rule result.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     ...
     */
    public okhttp3.Call getComplianceRunAsync(String runId, String page, Integer limit, String filter, final ApiCallback<ResourceListOfComplianceRuleResult> _callback) throws ApiException {
        okhttp3.Call localVarCall = getComplianceRunValidateBeforeCall(runId, page, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfComplianceRuleResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    public okhttp3.Call getComplianceRunResultsCall(String runId, String page, Integer limit, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/api/compliance/results/{runId}"
            .replaceAll("\\{" + "runId" + "\\}", localVarApiClient.escapeString(runId.toString()));
    ...
    /**
     * [EXPERIMENTAL] ListComplianceRuns: List historical compliance runs. -- DEPRECATING - POST TRADE ONLY (asynchronously)
     * Use this endpoint to fetch a list of all historical compliance runs.
     * @param page The pagination token to use to continue listing compliance runs from a previous call to list compliance runs.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    /**
     * Build call for runPreTradeComplianceCheck
     * @param recipeScope Scope of recipe to be used - required (required)
     * @param recipeCode Code of recipe to be used - if not provided, default recipe code will be used (optional)
     * @param byTaxlots calculate by taxlots or not - Default: False (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call runPreTradeComplianceCheckCall(String recipeScope, String recipeCode, Boolean byTaxlots, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/pretraderun";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call runPreTradeComplianceCheckValidateBeforeCall(String recipeScope, String recipeCode, Boolean byTaxlots, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'recipeScope' is set
        if (recipeScope == null) {
            throw new ApiException("Missing the required parameter 'recipeScope' when calling runPreTradeComplianceCheck(Async)");
        }
        

        okhttp3.Call localVarCall = runPreTradeComplianceCheckCall(recipeScope, recipeCode, byTaxlots, _callback);
        return localVarCall;
     ...
     */
    public ComplianceRun runPreTradeComplianceCheck(String recipeScope, String recipeCode, Boolean byTaxlots) throws ApiException {
        ApiResponse<ComplianceRun> localVarResp = runPreTradeComplianceCheckWithHttpInfo(recipeScope, recipeCode, byTaxlots);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ComplianceRun> runPreTradeComplianceCheckWithHttpInfo(String recipeScope, String recipeCode, Boolean byTaxlots) throws ApiException {
        okhttp3.Call localVarCall = runPreTradeComplianceCheckValidateBeforeCall(recipeScope, recipeCode, byTaxlots, null);
        Type localVarReturnType = new TypeToken<ComplianceRun>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] RunPreTradeComplianceCheck: Kick off the pre-trade compliance check process (asynchronously)
     * Use this endpoint to run a pre-trade compliance check, using all existing pre-trade applicable compliance rules
     * @param recipeScope Scope of recipe to be used - required (required)
     * @param recipeCode Code of recipe to be used - if not provided, default recipe code will be used (optional)
     * @param byTaxlots calculate by taxlots or not - Default: False (optional)
     ...
     */
    public okhttp3.Call runPreTradeComplianceCheckAsync(String recipeScope, String recipeCode, Boolean byTaxlots, final ApiCallback<ComplianceRun> _callback) throws ApiException {
        okhttp3.Call localVarCall = runPreTradeComplianceCheckValidateBeforeCall(recipeScope, recipeCode, byTaxlots, _callback);
        Type localVarReturnType = new TypeToken<ComplianceRun>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
