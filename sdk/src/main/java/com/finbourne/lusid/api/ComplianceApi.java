...
public class ComplianceApi {
     ...
     */
    public okhttp3.Call getComplianceRuleResultDetailsCall(String runScope, String runCode, String ruleScope, String ruleCode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/compliance/runs/summary/{runScope}/{runCode}/{ruleScope}/{ruleCode}"
            .replaceAll("\\{" + "runScope" + "\\}", localVarApiClient.escapeString(runScope.toString()))
            .replaceAll("\\{" + "runCode" + "\\}", localVarApiClient.escapeString(runCode.toString()))
            .replaceAll("\\{" + "ruleScope" + "\\}", localVarApiClient.escapeString(ruleScope.toString()))
            .replaceAll("\\{" + "ruleCode" + "\\}", localVarApiClient.escapeString(ruleCode.toString()));
    ...
    private okhttp3.Call getComplianceRuleResultDetailsValidateBeforeCall(String runScope, String runCode, String ruleScope, String ruleCode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getComplianceRuleResultDetailsCall(runScope, runCode, ruleScope, ruleCode, _callback);
        return localVarCall;
     ...
     */
    public ComplianceRunSummary getComplianceRuleResultDetails(String runScope, String runCode, String ruleScope, String ruleCode) throws ApiException {
     ...
     */
    public ApiResponse<ComplianceRunSummary> getComplianceRuleResultDetailsWithHttpInfo(String runScope, String runCode, String ruleScope, String ruleCode) throws ApiException {
    ...
    /**
     * [EARLY ACCESS] GetComplianceRuleResultDetails: Get summary results for a specific rule within a compliance run. (asynchronously)
     * Specify a run scope and code from a previously run compliance check, and the scope and code of a rule within that run, to get detailed results for that rule.
     * @param runScope Required: Run Scope. (required)
     * @param runCode Required: Run Code. (required)
     * @param ruleScope Required: Rule Scope. (required)
     ...
     */
    public okhttp3.Call getComplianceRuleResultDetailsAsync(String runScope, String runCode, String ruleScope, String ruleCode, final ApiCallback<ComplianceRunSummary> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call getComplianceRunSummaryCall(String runScope, String runCode, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call getComplianceRunSummaryValidateBeforeCall(String runScope, String runCode, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getComplianceRunSummaryCall(runScope, runCode, _callback);
        return localVarCall;
     ...
     */
    public ComplianceRunSummary getComplianceRunSummary(String runScope, String runCode) throws ApiException {
     ...
     */
    public ApiResponse<ComplianceRunSummary> getComplianceRunSummaryWithHttpInfo(String runScope, String runCode) throws ApiException {
     ...
     */
    public okhttp3.Call getComplianceRunSummaryAsync(String runScope, String runCode, final ApiCallback<ComplianceRunSummary> _callback) throws ApiException {
    ...
    private okhttp3.Call getDecoratedComplianceRunSummaryValidateBeforeCall(String scope, String code, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getDecoratedComplianceRunSummaryCall(scope, code, _callback);
        return localVarCall;
     ...
     */
    public okhttp3.Call listComplianceTemplatesCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;
    ...
    private okhttp3.Call listComplianceTemplatesValidateBeforeCall(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listComplianceTemplatesCall(asAt, page, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfComplianceTemplate listComplianceTemplates(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public ApiResponse<PagedResourceListOfComplianceTemplate> listComplianceTemplatesWithHttpInfo(OffsetDateTime asAt, String page, Integer limit, String filter) throws ApiException {
     ...
     */
    public okhttp3.Call listComplianceTemplatesAsync(OffsetDateTime asAt, String page, Integer limit, String filter, final ApiCallback<PagedResourceListOfComplianceTemplate> _callback) throws ApiException {
