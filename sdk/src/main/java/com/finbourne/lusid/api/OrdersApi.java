...
public class OrdersApi {
     ...
     * @param upsertOrderPropertiesRequest A collection of order property upsert requests. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call upsertOrderPropertiesCall(String scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = upsertOrderPropertiesRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertOrderPropertiesValidateBeforeCall(String scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = upsertOrderPropertiesCall(scope, upsertOrderPropertiesRequest, _callback);
        return localVarCall;
     ...
     */
    public UpsertOrderPropertiesResponse upsertOrderProperties(String scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest) throws ApiException {
        ApiResponse<UpsertOrderPropertiesResponse> localVarResp = upsertOrderPropertiesWithHttpInfo(scope, upsertOrderPropertiesRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<UpsertOrderPropertiesResponse> upsertOrderPropertiesWithHttpInfo(String scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest) throws ApiException {
        okhttp3.Call localVarCall = upsertOrderPropertiesValidateBeforeCall(scope, upsertOrderPropertiesRequest, null);
     ...
     */
    public okhttp3.Call upsertOrderPropertiesAsync(String scope, List<UpsertOrderPropertiesRequest> upsertOrderPropertiesRequest, final ApiCallback<UpsertOrderPropertiesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertOrderPropertiesValidateBeforeCall(scope, upsertOrderPropertiesRequest, _callback);
        Type localVarReturnType = new TypeToken<UpsertOrderPropertiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
