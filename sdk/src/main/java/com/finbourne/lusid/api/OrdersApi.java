...
public class OrdersApi {
     ...
     * @param filter Expression to filter the result set.  Currently Orders can be filtered by Id (e.g.              \&quot;Id eq &#39;TestScope/ORD001&#39;), Quantity (e.g. \&quot;Quantity lt 100\&quot;), Portfolio (e.g. \&quot;Portfolio eq &#39;TestScope/UKEquities&#39;\&quot;),              LUSID Instrument Id (e.g. \&quot;LusidInstrumentId eq &#39;LUID_12345678&#39;\&quot;), Scope (e.g. \&quot;Scope eq &#39;TestScope&#39;\&quot;),              or by Property (Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid). (optional)
     ...
     */
    public okhttp3.Call upsertOrdersCall(OrderSetRequest request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertOrdersValidateBeforeCall(OrderSetRequest request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = upsertOrdersCall(request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfOrder upsertOrders(OrderSetRequest request) throws ApiException {
        ApiResponse<ResourceListOfOrder> localVarResp = upsertOrdersWithHttpInfo(request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfOrder> upsertOrdersWithHttpInfo(OrderSetRequest request) throws ApiException {
        okhttp3.Call localVarCall = upsertOrdersValidateBeforeCall(request, null);
     ...
     */
    public okhttp3.Call upsertOrdersAsync(OrderSetRequest request, final ApiCallback<ResourceListOfOrder> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertOrdersValidateBeforeCall(request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfOrder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
