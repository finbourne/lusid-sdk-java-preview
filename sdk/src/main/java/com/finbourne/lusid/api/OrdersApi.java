...
import com.finbourne.lusid.model.OrderSet;
...
public class OrdersApi {
     ...
     * @param id The order&#39;s unique identifier. (required)
     * @param asAt The asat datetime at which to retrieve the order. Defaults to              return the latest version of each order if not specified. (optional)
     ...
     */
    public okhttp3.Call getOrderCall(String scope, String id, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/orders/{scope}/{id}"
    ...
    private okhttp3.Call getOrderValidateBeforeCall(String scope, String id, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getOrderCall(scope, id, asAt, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public Order getOrder(String scope, String id, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        ApiResponse<Order> localVarResp = getOrderWithHttpInfo(scope, id, asAt, propertyKeys);
     ...
     */
    public ApiResponse<Order> getOrderWithHttpInfo(String scope, String id, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = getOrderValidateBeforeCall(scope, id, asAt, propertyKeys, null);
        Type localVarReturnType = new TypeToken<Order>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Fetch a given order. (asynchronously)
     * 
     * @param scope The scope to which the order belongs. (required)
     * @param id The order&#39;s unique identifier. (required)
     * @param asAt The asat datetime at which to retrieve the order. Defaults to              return the latest version of each order if not specified. (optional)
     ...
     */
    public okhttp3.Call getOrderAsync(String scope, String id, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<Order> _callback) throws ApiException {

        okhttp3.Call localVarCall = getOrderValidateBeforeCall(scope, id, asAt, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<Order>(){}.getType();
     ...
     * @param scope The scope to which the orders belong. (required)
     * @param asAt The asat datetime at which to retrieve the orders. Defaults to              return the latest version of each order if not specified. (optional)
     ...
     */
    public okhttp3.Call listOrdersCall(String scope, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/orders/{scope}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listOrdersValidateBeforeCall(String scope, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listOrders(Async)");
        }
        

        okhttp3.Call localVarCall = listOrdersCall(scope, asAt, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfOrder listOrders(String scope, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        ApiResponse<ResourceListOfOrder> localVarResp = listOrdersWithHttpInfo(scope, asAt, propertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfOrder> listOrdersWithHttpInfo(String scope, OffsetDateTime asAt, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(scope, asAt, propertyKeys, null);
        Type localVarReturnType = new TypeToken<ResourceListOfOrder>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Fetch the last pre-AsAt date version of each order in scope (does not fetch the entire history). (asynchronously)
     * 
     * @param scope The scope to which the orders belong. (required)
     * @param asAt The asat datetime at which to retrieve the orders. Defaults to              return the latest version of each order if not specified. (optional)
     * @param propertyKeys A list of property keys from the \&quot;Orders\&quot; domain to decorate onto each order.              These take the format {domain}/{scope}/{code} e.g. \&quot;Orders/system/Name\&quot;. (optional)
     ...
     */
    public okhttp3.Call listOrdersAsync(String scope, OffsetDateTime asAt, List<String> propertyKeys, final ApiCallback<ResourceListOfOrder> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(scope, asAt, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfOrder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for upsertOrderProperties
     * @param scope The scope to which the orders belong. (required)
     * @param request A collection of order property upsert requests. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> An upsert order properties response. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call upsertOrderPropertiesCall(String scope, List<UpsertOrderPropertiesRequest> request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;

        // create path and map variables
        String localVarPath = "/api/orders/{scope}/properties"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertOrderPropertiesValidateBeforeCall(String scope, List<UpsertOrderPropertiesRequest> request, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling upsertOrderProperties(Async)");
        }
        

        okhttp3.Call localVarCall = upsertOrderPropertiesCall(scope, request, _callback);
        return localVarCall;
     ...
     */
    public UpsertOrderPropertiesResponse upsertOrderProperties(String scope, List<UpsertOrderPropertiesRequest> request) throws ApiException {
        ApiResponse<UpsertOrderPropertiesResponse> localVarResp = upsertOrderPropertiesWithHttpInfo(scope, request);
        return localVarResp.getData();
    }
     ...
     * @param scope The scope to which the orders belong. (required)
     * @param request A collection of order property upsert requests. (optional)
     * @return ApiResponse&lt;UpsertOrderPropertiesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<UpsertOrderPropertiesResponse> upsertOrderPropertiesWithHttpInfo(String scope, List<UpsertOrderPropertiesRequest> request) throws ApiException {
        okhttp3.Call localVarCall = upsertOrderPropertiesValidateBeforeCall(scope, request, null);
        Type localVarReturnType = new TypeToken<UpsertOrderPropertiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert; update properties on existing Orders with given ids. (asynchronously)
     * 
     * @param scope The scope to which the orders belong. (required)
     * @param request A collection of order property upsert requests. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call upsertOrderPropertiesAsync(String scope, List<UpsertOrderPropertiesRequest> request, final ApiCallback<UpsertOrderPropertiesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertOrderPropertiesValidateBeforeCall(scope, request, _callback);
        Type localVarReturnType = new TypeToken<UpsertOrderPropertiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param scope The scope to which the orders belong. (required)
     * @param request The collection of order requests. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 201 </td><td> A collection of successful and unsuccessful orders. </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call upsertOrdersCall(String scope, OrderSetRequest request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertOrdersValidateBeforeCall(String scope, OrderSetRequest request, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling upsertOrders(Async)");
        }
        

        okhttp3.Call localVarCall = upsertOrdersCall(scope, request, _callback);
        return localVarCall;
     ...
     */
    public OrderSet upsertOrders(String scope, OrderSetRequest request) throws ApiException {
        ApiResponse<OrderSet> localVarResp = upsertOrdersWithHttpInfo(scope, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<OrderSet> upsertOrdersWithHttpInfo(String scope, OrderSetRequest request) throws ApiException {
        okhttp3.Call localVarCall = upsertOrdersValidateBeforeCall(scope, request, null);
        Type localVarReturnType = new TypeToken<OrderSet>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Upsert; update existing orders with given ids, or create new orders otherwise. (asynchronously)
     * 
     * @param scope The scope to which the orders belong. (required)
     * @param request The collection of order requests. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     */
    public okhttp3.Call upsertOrdersAsync(String scope, OrderSetRequest request, final ApiCallback<OrderSet> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertOrdersValidateBeforeCall(scope, request, _callback);
        Type localVarReturnType = new TypeToken<OrderSet>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
