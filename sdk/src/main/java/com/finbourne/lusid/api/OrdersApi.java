...
public class OrdersApi {
     ...
     * @param filter Expression to filter the result set.  Currently Orders can be filtered by Code (e.g.              \&quot;Id eq &#39;TestScope/ORD001&#39;), Quantity (e.g. \&quot;Quantity lt 100\&quot;), Portfolio (e.g. \&quot;Portfolio eq &#39;TestScope/UKEquities&#39;\&quot;),              LUSID Instrument Id (e.g. \&quot;LusidInstrumentId eq &#39;LUID_12345678&#39;\&quot;) or by Property (Read more about filtering results from LUSID here:              https://support.lusid.com/filtering-results-from-lusid). (optional, default to &quot;Quantity gt 0&quot;)
     ...
     */
    public okhttp3.Call listOrdersCall(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listOrdersValidateBeforeCall(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = listOrdersCall(scope, asAt, page, sortBy, start, limit, filter, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfOrder listOrders(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        ApiResponse<PagedResourceListOfOrder> localVarResp = listOrdersWithHttpInfo(scope, asAt, page, sortBy, start, limit, filter, propertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfOrder> listOrdersWithHttpInfo(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(scope, asAt, page, sortBy, start, limit, filter, propertyKeys, null);
     ...
     */
    public okhttp3.Call listOrdersAsync(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfOrder> _callback) throws ApiException {

        okhttp3.Call localVarCall = listOrdersValidateBeforeCall(scope, asAt, page, sortBy, start, limit, filter, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfOrder>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public ResourceListOfOrder upsertOrders(String scope, OrderSetRequest request) throws ApiException {
        ApiResponse<ResourceListOfOrder> localVarResp = upsertOrdersWithHttpInfo(scope, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfOrder> upsertOrdersWithHttpInfo(String scope, OrderSetRequest request) throws ApiException {
     ...
     */
    public okhttp3.Call upsertOrdersAsync(String scope, OrderSetRequest request, final ApiCallback<ResourceListOfOrder> _callback) throws ApiException {
