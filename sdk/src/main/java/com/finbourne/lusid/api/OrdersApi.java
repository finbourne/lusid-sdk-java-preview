...
import com.finbourne.lusid.model.DeletedOrdersEntitiesResponse;
...
public class OrdersApi {
    ...
    /**
     * Build call for deleteOrders
     * @param resourceId The IDs of the orders to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The successfully deleted Orders along with any failures </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteOrdersCall(List<ResourceId> resourceId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = resourceId;

        // create path and map variables
        String localVarPath = "/api/orders/$delete";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteOrdersValidateBeforeCall(List<ResourceId> resourceId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'resourceId' is set
        if (resourceId == null) {
            throw new ApiException("Missing the required parameter 'resourceId' when calling deleteOrders(Async)");
        }
        

        okhttp3.Call localVarCall = deleteOrdersCall(resourceId, _callback);
        return localVarCall;
     ...
     * @param resourceId The IDs of the orders to delete. (required)
     * @return DeletedOrdersEntitiesResponse
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public DeletedOrdersEntitiesResponse deleteOrders(List<ResourceId> resourceId) throws ApiException {
        ApiResponse<DeletedOrdersEntitiesResponse> localVarResp = deleteOrdersWithHttpInfo(resourceId);
        return localVarResp.getData();
    }
     ...
     * Use this method to delete a collection of Orders, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.
     * @param resourceId The IDs of the orders to delete. (required)
     * @return ApiResponse&lt;DeletedOrdersEntitiesResponse&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<DeletedOrdersEntitiesResponse> deleteOrdersWithHttpInfo(List<ResourceId> resourceId) throws ApiException {
        okhttp3.Call localVarCall = deleteOrdersValidateBeforeCall(resourceId, null);
        Type localVarReturnType = new TypeToken<DeletedOrdersEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Delete Orders. (asynchronously)
     * Use this method to delete a collection of Orders, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.
     * @param resourceId The IDs of the orders to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteOrdersAsync(List<ResourceId> resourceId, final ApiCallback<DeletedOrdersEntitiesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteOrdersValidateBeforeCall(resourceId, _callback);
        Type localVarReturnType = new TypeToken<DeletedOrdersEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
