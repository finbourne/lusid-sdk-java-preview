...
public class SystemConfigurationApi {
    ...
    public ResourceListOfTransactionConfigurationData createConfigurationTransactionType(TransactionConfigurationDataRequest type) throws ApiException {
        ApiResponse<ResourceListOfTransactionConfigurationData> localVarResp = createConfigurationTransactionTypeWithHttpInfo(type);
     ...
     */
    public okhttp3.Call createConfigurationTransactionTypeAsync(TransactionConfigurationDataRequest type, final ApiCallback<ResourceListOfTransactionConfigurationData> _callback) throws ApiException {
    ...
    public ResourceListOfTransactionConfigurationData listConfigurationTransactionTypes() throws ApiException {
        ApiResponse<ResourceListOfTransactionConfigurationData> localVarResp = listConfigurationTransactionTypesWithHttpInfo();
        return localVarResp.getData();
    }
     ...
     */
    public okhttp3.Call listConfigurationTransactionTypesAsync(final ApiCallback<ResourceListOfTransactionConfigurationData> _callback) throws ApiException {
     ...
     */
    public okhttp3.Call setConfigurationTransactionTypesCall(List<TransactionConfigurationDataRequest> types, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setConfigurationTransactionTypesValidateBeforeCall(List<TransactionConfigurationDataRequest> types, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = setConfigurationTransactionTypesCall(types, _callback);
        return localVarCall;
    ...
    public ResourceListOfTransactionConfigurationData setConfigurationTransactionTypes(List<TransactionConfigurationDataRequest> types) throws ApiException {
        ApiResponse<ResourceListOfTransactionConfigurationData> localVarResp = setConfigurationTransactionTypesWithHttpInfo(types);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<ResourceListOfTransactionConfigurationData> setConfigurationTransactionTypesWithHttpInfo(List<TransactionConfigurationDataRequest> types) throws ApiException {
        okhttp3.Call localVarCall = setConfigurationTransactionTypesValidateBeforeCall(types, null);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call setConfigurationTransactionTypesAsync(List<TransactionConfigurationDataRequest> types, final ApiCallback<ResourceListOfTransactionConfigurationData> _callback) throws ApiException {

        okhttp3.Call localVarCall = setConfigurationTransactionTypesValidateBeforeCall(types, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
