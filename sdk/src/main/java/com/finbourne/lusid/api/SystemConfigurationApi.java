...
import com.finbourne.lusid.model.ResourceListOfTransactionConfigurationData;
...
public class SystemConfigurationApi {
     ...
     */
    public com.squareup.okhttp.Call createConfigurationTransactionTypeCall(TransactionConfigurationDataRequest type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = type;

        // create path and map variables
        String localVarPath = "/api/systemconfiguration/transactiontypes";
    ...
    private com.squareup.okhttp.Call createConfigurationTransactionTypeValidateBeforeCall(TransactionConfigurationDataRequest type, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = createConfigurationTransactionTypeCall(type, progressListener, progressRequestListener);
        return call;
     ...
     * @param type A transaction type definition (optional)
     * @return ResourceListOfTransactionConfigurationData
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfTransactionConfigurationData createConfigurationTransactionType(TransactionConfigurationDataRequest type) throws ApiException {
        ApiResponse<ResourceListOfTransactionConfigurationData> resp = createConfigurationTransactionTypeWithHttpInfo(type);
        return resp.getData();
    }
     ...
     * Create a new transaction type by specifying a definition and the mappings to movements
     * @param type A transaction type definition (optional)
     * @return ApiResponse&lt;ResourceListOfTransactionConfigurationData&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfTransactionConfigurationData> createConfigurationTransactionTypeWithHttpInfo(TransactionConfigurationDataRequest type) throws ApiException {
        com.squareup.okhttp.Call call = createConfigurationTransactionTypeValidateBeforeCall(type, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create transaction type (asynchronously)
     * Create a new transaction type by specifying a definition and the mappings to movements
     * @param type A transaction type definition (optional)
     ...
     */
    public com.squareup.okhttp.Call createConfigurationTransactionTypeAsync(TransactionConfigurationDataRequest type, final ApiCallback<ResourceListOfTransactionConfigurationData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createConfigurationTransactionTypeValidateBeforeCall(type, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listConfigurationTransactionTypesCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listConfigurationTransactionTypesValidateBeforeCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listConfigurationTransactionTypesCall(progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfTransactionConfigurationData listConfigurationTransactionTypes() throws ApiException {
        ApiResponse<ResourceListOfTransactionConfigurationData> resp = listConfigurationTransactionTypesWithHttpInfo();
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfTransactionConfigurationData> listConfigurationTransactionTypesWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = listConfigurationTransactionTypesValidateBeforeCall(null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listConfigurationTransactionTypesAsync(final ApiCallback<ResourceListOfTransactionConfigurationData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listConfigurationTransactionTypesValidateBeforeCall(progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @param types The complete set of transaction type definitions (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setConfigurationTransactionTypesCall(List<TransactionConfigurationDataRequest> types, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = types;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setConfigurationTransactionTypesValidateBeforeCall(List<TransactionConfigurationDataRequest> types, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = setConfigurationTransactionTypesCall(types, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfTransactionConfigurationData setConfigurationTransactionTypes(List<TransactionConfigurationDataRequest> types) throws ApiException {
        ApiResponse<ResourceListOfTransactionConfigurationData> resp = setConfigurationTransactionTypesWithHttpInfo(types);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfTransactionConfigurationData> setConfigurationTransactionTypesWithHttpInfo(List<TransactionConfigurationDataRequest> types) throws ApiException {
        com.squareup.okhttp.Call call = setConfigurationTransactionTypesValidateBeforeCall(types, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Set transaction types (asynchronously)
     * Set all transaction types to be used by the movements engine, for the organisation                WARNING! Changing these mappings will have a material impact on how data, new and old, is processed and aggregated by LUSID. This will affect your whole organisation. Only change if you are fully aware of the implications of the change.
     * @param types The complete set of transaction type definitions (optional)
     * @param callback The callback to be executed when the API call finishes
     * @return The request call
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setConfigurationTransactionTypesAsync(List<TransactionConfigurationDataRequest> types, final ApiCallback<ResourceListOfTransactionConfigurationData> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setConfigurationTransactionTypesValidateBeforeCall(types, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfTransactionConfigurationData>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
