...
public class SystemConfigurationApi {
     ...
     * @param side The definition of the side to be created. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call createSideDefinitionCall(SideConfigurationDataRequest side, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = side;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call createSideDefinitionValidateBeforeCall(SideConfigurationDataRequest side, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createSideDefinitionCall(side, _callback);
        return localVarCall;
     ...
     */
    public TransactionSetConfigurationData createSideDefinition(SideConfigurationDataRequest side) throws ApiException {
        ApiResponse<TransactionSetConfigurationData> localVarResp = createSideDefinitionWithHttpInfo(side);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TransactionSetConfigurationData> createSideDefinitionWithHttpInfo(SideConfigurationDataRequest side) throws ApiException {
        okhttp3.Call localVarCall = createSideDefinitionValidateBeforeCall(side, null);
        Type localVarReturnType = new TypeToken<TransactionSetConfigurationData>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call createSideDefinitionAsync(SideConfigurationDataRequest side, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {

        okhttp3.Call localVarCall = createSideDefinitionValidateBeforeCall(side, _callback);
        Type localVarReturnType = new TypeToken<TransactionSetConfigurationData>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call setConfigurationTransactionTypesCall(TransactionSetConfigurationDataRequest types, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setConfigurationTransactionTypesValidateBeforeCall(TransactionSetConfigurationDataRequest types, final ApiCallback _callback) throws ApiException {
     ...
     */
    public TransactionSetConfigurationData setConfigurationTransactionTypes(TransactionSetConfigurationDataRequest types) throws ApiException {
        ApiResponse<TransactionSetConfigurationData> localVarResp = setConfigurationTransactionTypesWithHttpInfo(types);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<TransactionSetConfigurationData> setConfigurationTransactionTypesWithHttpInfo(TransactionSetConfigurationDataRequest types) throws ApiException {
     ...
     */
    public okhttp3.Call setConfigurationTransactionTypesAsync(TransactionSetConfigurationDataRequest types, final ApiCallback<TransactionSetConfigurationData> _callback) throws ApiException {
