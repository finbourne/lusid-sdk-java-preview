...
public class AllocationsApi {
    ...
    /**
     * [EXPERIMENTAL] Delete allocation (asynchronously)
     * Delete an allocation. Deletion will be valid from the allocation&#39;s creation datetime.  This means that the allocation will no longer exist at any effective datetime from the asAt datetime of deletion.
     * @param scope The allocation scope. (required)
     * @param code The allocation&#39;s code. This, together with the scope uniquely identifies the allocation to delete. (required)
    ...
    /**
     * Build call for deleteAllocations
     * @param resourceId The IDs of the allocations to delete. (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The successfully deleted Allocations along with any failures </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteAllocationsCall(List<ResourceId> resourceId, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = resourceId;

        // create path and map variables
        String localVarPath = "/api/allocations/$delete";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAllocationsValidateBeforeCall(List<ResourceId> resourceId, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'resourceId' is set
        if (resourceId == null) {
            throw new ApiException("Missing the required parameter 'resourceId' when calling deleteAllocations(Async)");
        }
        

        okhttp3.Call localVarCall = deleteAllocationsCall(resourceId, _callback);
        return localVarCall;
     ...
     */
    public DeletedOrdersEntitiesResponse deleteAllocations(List<ResourceId> resourceId) throws ApiException {
        ApiResponse<DeletedOrdersEntitiesResponse> localVarResp = deleteAllocationsWithHttpInfo(resourceId);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<DeletedOrdersEntitiesResponse> deleteAllocationsWithHttpInfo(List<ResourceId> resourceId) throws ApiException {
        okhttp3.Call localVarCall = deleteAllocationsValidateBeforeCall(resourceId, null);
        Type localVarReturnType = new TypeToken<DeletedOrdersEntitiesResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Delete Allocations. (asynchronously)
     * Use this method to delete a collection of Allocations, each defined by ResourceId. Each delete will be attempted  independently, and the method will return lists of successful and failed attempts.
     * @param resourceId The IDs of the allocations to delete. (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call deleteAllocationsAsync(List<ResourceId> resourceId, final ApiCallback<DeletedOrdersEntitiesResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAllocationsValidateBeforeCall(resourceId, _callback);
        Type localVarReturnType = new TypeToken<DeletedOrdersEntitiesResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * [EXPERIMENTAL] Get Allocation (asynchronously)
     * Fetch an Allocation matching the provided identifier
     * @param scope The scope to which the allocation belongs. (required)
     * @param code The allocation&#39;s unique identifier. (required)
     * @param asAt The asAt datetime at which to retrieve the allocation. Defaults to return the latest version of the allocation if not specified. (optional)
    ...
    /**
     * [EXPERIMENTAL] List Allocations (asynchronously)
     * Fetch the last pre-AsAt date version of each allocation in scope (does not fetch the entire history).
     * @param asAt The asAt datetime at which to retrieve the allocation. Defaults to return the latest version of the allocation if not specified. (optional)
     * @param page The pagination token to use to continue listing allocations from a previous call to list allocations.              This value is returned from the previous call. If a pagination token is provided the sortBy, filter, effectiveAt, and asAt fields              must not have changed since the original request. Also, if set, a start value cannot be provided. (optional)
     * @param sortBy Allocation the results by these fields. Use use the &#39;-&#39; sign to denote descending allocation e.g. -MyFieldName. (optional)
    ...
    /**
     * [EXPERIMENTAL] Upsert Allocations (asynchronously)
     * Upsert; update existing allocations with given ids, or create new allocations otherwise.
     * @param allocationSetRequest The collection of allocation requests. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
