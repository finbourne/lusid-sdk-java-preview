...
public class AllocationsApi {
     ...
     * @param scope The scope to which the allocations belong. (required)
     * @param asAt The asAt datetime at which to retrieve the allocation. Defaults to return the latest version of the allocation if not specified. (optional)
     ...
     */
    public okhttp3.Call listAllocationsCall(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();

        // create path and map variables
        String localVarPath = "/api/allocations/{scope}"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAllocationsValidateBeforeCall(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling listAllocations(Async)");
        }
        

        okhttp3.Call localVarCall = listAllocationsCall(scope, asAt, page, sortBy, start, limit, filter, propertyKeys, _callback);
        return localVarCall;
     ...
     */
    public PagedResourceListOfAllocation listAllocations(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        ApiResponse<PagedResourceListOfAllocation> localVarResp = listAllocationsWithHttpInfo(scope, asAt, page, sortBy, start, limit, filter, propertyKeys);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<PagedResourceListOfAllocation> listAllocationsWithHttpInfo(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys) throws ApiException {
        okhttp3.Call localVarCall = listAllocationsValidateBeforeCall(scope, asAt, page, sortBy, start, limit, filter, propertyKeys, null);
     ...
     */
    public okhttp3.Call listAllocationsAsync(String scope, OffsetDateTime asAt, String page, List<String> sortBy, Integer start, Integer limit, String filter, List<String> propertyKeys, final ApiCallback<PagedResourceListOfAllocation> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAllocationsValidateBeforeCall(scope, asAt, page, sortBy, start, limit, filter, propertyKeys, _callback);
        Type localVarReturnType = new TypeToken<PagedResourceListOfAllocation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call upsertAllocationsCall(String scope, AllocationSetRequest request, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call upsertAllocationsValidateBeforeCall(String scope, AllocationSetRequest request, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling upsertAllocations(Async)");
        }
        

        okhttp3.Call localVarCall = upsertAllocationsCall(scope, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfAllocation upsertAllocations(String scope, AllocationSetRequest request) throws ApiException {
        ApiResponse<ResourceListOfAllocation> localVarResp = upsertAllocationsWithHttpInfo(scope, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfAllocation> upsertAllocationsWithHttpInfo(String scope, AllocationSetRequest request) throws ApiException {
        okhttp3.Call localVarCall = upsertAllocationsValidateBeforeCall(scope, request, null);
     ...
     */
    public okhttp3.Call upsertAllocationsAsync(String scope, AllocationSetRequest request, final ApiCallback<ResourceListOfAllocation> _callback) throws ApiException {

        okhttp3.Call localVarCall = upsertAllocationsValidateBeforeCall(scope, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfAllocation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
