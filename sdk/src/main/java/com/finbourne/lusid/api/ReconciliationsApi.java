...
public class ReconciliationsApi {
     ...
     * @param request The specifications of the inputs to the reconciliation. This request can take tolerance for units and cost. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call reconcileHoldingsPreviewCall(List<String> sortBy, Integer start, Integer limit, String filter, PortfoliosReconciliationRequestPreview request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reconcileHoldingsPreviewValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, PortfoliosReconciliationRequestPreview request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = reconcileHoldingsPreviewCall(sortBy, start, limit, filter, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfReconciliationBreak reconcileHoldingsPreview(List<String> sortBy, Integer start, Integer limit, String filter, PortfoliosReconciliationRequestPreview request) throws ApiException {
        ApiResponse<ResourceListOfReconciliationBreak> localVarResp = reconcileHoldingsPreviewWithHttpInfo(sortBy, start, limit, filter, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfReconciliationBreak> reconcileHoldingsPreviewWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, PortfoliosReconciliationRequestPreview request) throws ApiException {
        okhttp3.Call localVarCall = reconcileHoldingsPreviewValidateBeforeCall(sortBy, start, limit, filter, request, null);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call reconcileHoldingsPreviewAsync(List<String> sortBy, Integer start, Integer limit, String filter, PortfoliosReconciliationRequestPreview request, final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {

        okhttp3.Call localVarCall = reconcileHoldingsPreviewValidateBeforeCall(sortBy, start, limit, filter, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call reconcileInlineCall(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reconcileInlineValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = reconcileInlineCall(sortBy, start, limit, filter, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfReconciliationBreak reconcileInline(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest request) throws ApiException {
        ApiResponse<ResourceListOfReconciliationBreak> localVarResp = reconcileInlineWithHttpInfo(sortBy, start, limit, filter, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfReconciliationBreak> reconcileInlineWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest request) throws ApiException {
        okhttp3.Call localVarCall = reconcileInlineValidateBeforeCall(sortBy, start, limit, filter, request, null);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Reconcile valuations performed on one or two sets of inline instruments using one or two configuration recipes. (asynchronously)
     * Perform valuation of one or two set of inline instruments using different one or two configuration recipes. Produce a breakdown of the resulting differences in valuation.
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     ...
     */
    public okhttp3.Call reconcileInlineAsync(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest request, final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {

        okhttp3.Call localVarCall = reconcileInlineValidateBeforeCall(sortBy, start, limit, filter, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call reconcileValuationCall(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reconcileValuationValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = reconcileValuationCall(sortBy, start, limit, filter, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfReconciliationBreak reconcileValuation(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest request) throws ApiException {
        ApiResponse<ResourceListOfReconciliationBreak> localVarResp = reconcileValuationWithHttpInfo(sortBy, start, limit, filter, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfReconciliationBreak> reconcileValuationWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest request) throws ApiException {
        okhttp3.Call localVarCall = reconcileValuationValidateBeforeCall(sortBy, start, limit, filter, request, null);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Reconcile valuations performed on one or two sets of holdings using one or two configuration recipes. (asynchronously)
     * Perform valuation of one or two set of holdings using different one or two configuration recipes. Produce a breakdown of the resulting differences in valuation.
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     ...
     */
    public okhttp3.Call reconcileValuationAsync(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest request, final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {

        okhttp3.Call localVarCall = reconcileValuationValidateBeforeCall(sortBy, start, limit, filter, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
