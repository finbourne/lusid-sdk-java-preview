...
public class ReconciliationsApi {
     ...
     */
    public ResourceListOfReconciliationBreak reconcileInline(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
        ApiResponse<ResourceListOfReconciliationBreak> localVarResp = reconcileInlineWithHttpInfo(sortBy, start, limit, filter, inlineValuationsReconciliationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfReconciliationBreak> reconcileInlineWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
     ...
     */
    public okhttp3.Call reconcileInlineAsync(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {
