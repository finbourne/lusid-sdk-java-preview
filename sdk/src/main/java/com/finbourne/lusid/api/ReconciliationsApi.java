...
import com.finbourne.lusid.model.AggregationReconciliation;
...
public class ReconciliationsApi {
     ...
     */
    public okhttp3.Call reconcileInlineCall(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reconcileInlineValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = reconcileInlineCall(sortBy, start, limit, filter, inlineValuationsReconciliationRequest, _callback);
        return localVarCall;
     ...
     */
    public AggregationReconciliation reconcileInline(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
        ApiResponse<AggregationReconciliation> localVarResp = reconcileInlineWithHttpInfo(sortBy, start, limit, filter, inlineValuationsReconciliationRequest);
        return localVarResp.getData();
    }
     ...
     * @param filter Optional. Expression to filter the result set.              For example, to filter on the left portfolio Code, use \&quot;left.portfolioId.code eq &#39;string&#39;\&quot;              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param inlineValuationsReconciliationRequest The specifications of the inputs to the reconciliation (optional)
     * @return ApiResponse&lt;AggregationReconciliation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<AggregationReconciliation> reconcileInlineWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
        okhttp3.Call localVarCall = reconcileInlineValidateBeforeCall(sortBy, start, limit, filter, inlineValuationsReconciliationRequest, null);
        Type localVarReturnType = new TypeToken<AggregationReconciliation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call reconcileInlineAsync(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback<AggregationReconciliation> _callback) throws ApiException {

        okhttp3.Call localVarCall = reconcileInlineValidateBeforeCall(sortBy, start, limit, filter, inlineValuationsReconciliationRequest, _callback);
        Type localVarReturnType = new TypeToken<AggregationReconciliation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call reconcileValuationCall(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call reconcileValuationValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = reconcileValuationCall(sortBy, start, limit, filter, valuationsReconciliationRequest, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfReconciliationBreak reconcileValuation(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest) throws ApiException {
        ApiResponse<ResourceListOfReconciliationBreak> localVarResp = reconcileValuationWithHttpInfo(sortBy, start, limit, filter, valuationsReconciliationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfReconciliationBreak> reconcileValuationWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest) throws ApiException {
        okhttp3.Call localVarCall = reconcileValuationValidateBeforeCall(sortBy, start, limit, filter, valuationsReconciliationRequest, null);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call reconcileValuationAsync(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback<ResourceListOfReconciliationBreak> _callback) throws ApiException {

        okhttp3.Call localVarCall = reconcileValuationValidateBeforeCall(sortBy, start, limit, filter, valuationsReconciliationRequest, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfReconciliationBreak>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
