...
public class ReconciliationsApi {
     ...
     */
    public ListAggregationReconciliation reconcileInline(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
        ApiResponse<ListAggregationReconciliation> localVarResp = reconcileInlineWithHttpInfo(sortBy, start, limit, filter, inlineValuationsReconciliationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationReconciliation> reconcileInlineWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest) throws ApiException {
     ...
     */
    public okhttp3.Call reconcileInlineAsync(List<String> sortBy, Integer start, Integer limit, String filter, InlineValuationsReconciliationRequest inlineValuationsReconciliationRequest, final ApiCallback<ListAggregationReconciliation> _callback) throws ApiException {
     ...
     */
    public ListAggregationReconciliation reconcileValuation(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest) throws ApiException {
        ApiResponse<ListAggregationReconciliation> localVarResp = reconcileValuationWithHttpInfo(sortBy, start, limit, filter, valuationsReconciliationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationReconciliation> reconcileValuationWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest) throws ApiException {
     ...
     */
    public okhttp3.Call reconcileValuationAsync(List<String> sortBy, Integer start, Integer limit, String filter, ValuationsReconciliationRequest valuationsReconciliationRequest, final ApiCallback<ListAggregationReconciliation> _callback) throws ApiException {
