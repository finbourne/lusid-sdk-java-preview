...
public class ReconciliationsApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 200 </td><td> A flag that will be true if a mapping was deleted, false if it didn&#39;t exist. </td><td>  -  </td></tr>
     ...
     */
    public Boolean deleteReconciliationMapping(String scope, String code) throws ApiException {
        ApiResponse<Boolean> localVarResp = deleteReconciliationMappingWithHttpInfo(scope, code);
     ...
     */
    public ApiResponse<Boolean> deleteReconciliationMappingWithHttpInfo(String scope, String code) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] DeleteReconciliationMapping: Delete a mapping (asynchronously)
     * Deletes the mapping identified by the scope and code
     * @param scope The scope of the mapping. (required)
     * @param code The code fof the mapping. (required)
     ...
     */
    public okhttp3.Call deleteReconciliationMappingAsync(String scope, String code, final ApiCallback<Boolean> _callback) throws ApiException {
    ...
    /**
     * [EXPERIMENTAL] GetReconciliationMapping: Get a mapping (asynchronously)
     * Gets a mapping identified by the given scope and code
     * @param scope The scope of the mapping. (required)
     * @param code The code fof the mapping. (required)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param reconciliationType Optional parameter to specify which type of mappings should be returned.              Currently only supports Transaction types (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
    ...
    /**
     * [EXPERIMENTAL] ListReconciliationMappings: List the reconciliation mappings (asynchronously)
     * Lists all mappings this user is entitled to see
     * @param reconciliationType Optional parameter to specify which type of mappings should be returned.              Currently only supports Transaction types (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * [EXPERIMENTAL] ReconcileTransactions: Perform a Transactions Reconciliation. (asynchronously)
     * Evaluates two sets of transactions to determine which transactions from each set likely match  using the rules of a specified mapping.
     * @param transactionReconciliationRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    /**
     * [EXPERIMENTAL] UpsertReconciliationMapping: Create or update a mapping (asynchronously)
     * If no mapping exists with the specified scope and code will create a new one.  Else will update the existing mapping
     * @param mapping The mapping to be created / updated. (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
