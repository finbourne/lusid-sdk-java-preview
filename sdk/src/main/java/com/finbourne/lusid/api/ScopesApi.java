...
public class ScopesApi {
     ...
     */
    public okhttp3.Call listScopesCall(List<String> sortBy, Integer start, Integer limit, String filter, String query, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call listScopesValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, String query, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listScopesCall(sortBy, start, limit, filter, query, _callback);
        return localVarCall;
    ...
    public ResourceListOfScopeDefinition listScopes(List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        ApiResponse<ResourceListOfScopeDefinition> localVarResp = listScopesWithHttpInfo(sortBy, start, limit, filter, query);
    ...
    public ApiResponse<ResourceListOfScopeDefinition> listScopesWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        okhttp3.Call localVarCall = listScopesValidateBeforeCall(sortBy, start, limit, filter, query, null);
     ...
     */
    public okhttp3.Call listScopesAsync(List<String> sortBy, Integer start, Integer limit, String filter, String query, final ApiCallback<ResourceListOfScopeDefinition> _callback) throws ApiException {

        okhttp3.Call localVarCall = listScopesValidateBeforeCall(sortBy, start, limit, filter, query, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfScopeDefinition>(){}.getType();
