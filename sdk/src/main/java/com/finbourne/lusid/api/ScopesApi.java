...
public class ScopesApi {
     ...
     */
    public com.squareup.okhttp.Call listScopesCall(List<String> sortBy, Integer start, Integer limit, String filter, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    private com.squareup.okhttp.Call listScopesValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, String query, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listScopesCall(sortBy, start, limit, filter, query, progressListener, progressRequestListener);
        return call;
     ...
     */
    public ResourceListOfScopeDefinition listScopes(List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        ApiResponse<ResourceListOfScopeDefinition> resp = listScopesWithHttpInfo(sortBy, start, limit, filter, query);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfScopeDefinition> listScopesWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, String query) throws ApiException {
        com.squareup.okhttp.Call call = listScopesValidateBeforeCall(sortBy, start, limit, filter, query, null, null);
     ...
     */
    public com.squareup.okhttp.Call listScopesAsync(List<String> sortBy, Integer start, Integer limit, String filter, String query, final ApiCallback<ResourceListOfScopeDefinition> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listScopesValidateBeforeCall(sortBy, start, limit, filter, query, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfScopeDefinition>(){}.getType();
