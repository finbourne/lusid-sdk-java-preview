...
public class AggregationApi {
    ...
    private okhttp3.Call generateConfigurationRecipeValidateBeforeCall(String scope, String code, CreateRecipeRequest createRecipeRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = generateConfigurationRecipeCall(scope, code, createRecipeRequest, _callback);
        return localVarCall;
    ...
    /**
     * [EXPERIMENTAL] Generates a recipe sufficient to perform valuations for the given portfolio. (asynchronously)
     * Given a set of scopes, a portfolio Id and a basic recipe, this endpoint generates a configuration recipe with relevant rules that can value the instruments in the portfolio.
     * @param scope The scope of the portfolio (required)
     * @param code The code of the portfolio (required)
     * @param createRecipeRequest The request specifying the parameters to generating the recipe (optional)
    ...
    /**
     * Build call for getAggregation
     * @param scope The scope of the portfolio or portfolio group (required)
     * @param code The code of the portfolio or portfolio group (required)
     ...
     * @param aggregationRequest The request specifying the parameters of the aggregation (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAggregationCall(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;

        // create path and map variables
        String localVarPath = "/api/aggregation/{scope}/{code}/$aggregate"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregationValidateBeforeCall(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getAggregation(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getAggregation(Async)");
        }
        

        okhttp3.Call localVarCall = getAggregationCall(scope, code, sortBy, start, limit, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public ListAggregationResponse getAggregation(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<ListAggregationResponse> localVarResp = getAggregationWithHttpInfo(scope, code, sortBy, start, limit, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationResponse> getAggregationWithHttpInfo(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getAggregationValidateBeforeCall(scope, code, sortBy, start, limit, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group (asynchronously)
     * Aggregate data sourced from the specified portfolio or portfolio group
     * @param scope The scope of the portfolio or portfolio group (required)
     * @param code The code of the portfolio or portfolio group (required)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     ...
     */
    public okhttp3.Call getAggregationAsync(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregationValidateBeforeCall(scope, code, sortBy, start, limit, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getAggregationByGroupCall(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregationByGroupValidateBeforeCall(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAggregationByGroupCall(scope, code, sortBy, start, limit, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public ListAggregationResponse getAggregationByGroup(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<ListAggregationResponse> localVarResp = getAggregationByGroupWithHttpInfo(scope, code, sortBy, start, limit, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationResponse> getAggregationByGroupWithHttpInfo(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getAggregationByGroupValidateBeforeCall(scope, code, sortBy, start, limit, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAggregationByGroupAsync(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregationByGroupValidateBeforeCall(scope, code, sortBy, start, limit, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getAggregationByPortfolioCall(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregationByPortfolioValidateBeforeCall(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAggregationByPortfolioCall(scope, code, sortBy, start, limit, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public ListAggregationResponse getAggregationByPortfolio(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<ListAggregationResponse> localVarResp = getAggregationByPortfolioWithHttpInfo(scope, code, sortBy, start, limit, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationResponse> getAggregationByPortfolioWithHttpInfo(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getAggregationByPortfolioValidateBeforeCall(scope, code, sortBy, start, limit, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAggregationByPortfolioAsync(String scope, String code, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregationByPortfolioValidateBeforeCall(scope, code, sortBy, start, limit, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getAggregationByResultSetCall(String scope, String resultsKey, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregationByResultSetValidateBeforeCall(String scope, String resultsKey, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAggregationByResultSetCall(scope, resultsKey, sortBy, start, limit, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public ListAggregationResponse getAggregationByResultSet(String scope, String resultsKey, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<ListAggregationResponse> localVarResp = getAggregationByResultSetWithHttpInfo(scope, resultsKey, sortBy, start, limit, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationResponse> getAggregationByResultSetWithHttpInfo(String scope, String resultsKey, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getAggregationByResultSetValidateBeforeCall(scope, resultsKey, sortBy, start, limit, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAggregationByResultSetAsync(String scope, String resultsKey, List<String> sortBy, Integer start, Integer limit, AggregationRequest aggregationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregationByResultSetValidateBeforeCall(scope, resultsKey, sortBy, start, limit, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @param start Optional. When paginating, skip this number of results (optional)
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param inlineAggregationRequest The request specifying the parameters of the aggregation and the inlined set of instruments to aggregate over. (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call getAggregationOfWeightedInstrumentsCall(String scope, List<String> sortBy, Integer start, Integer limit, InlineAggregationRequest inlineAggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = inlineAggregationRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregationOfWeightedInstrumentsValidateBeforeCall(String scope, List<String> sortBy, Integer start, Integer limit, InlineAggregationRequest inlineAggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAggregationOfWeightedInstrumentsCall(scope, sortBy, start, limit, inlineAggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public ListAggregationResponse getAggregationOfWeightedInstruments(String scope, List<String> sortBy, Integer start, Integer limit, InlineAggregationRequest inlineAggregationRequest) throws ApiException {
        ApiResponse<ListAggregationResponse> localVarResp = getAggregationOfWeightedInstrumentsWithHttpInfo(scope, sortBy, start, limit, inlineAggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationResponse> getAggregationOfWeightedInstrumentsWithHttpInfo(String scope, List<String> sortBy, Integer start, Integer limit, InlineAggregationRequest inlineAggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getAggregationOfWeightedInstrumentsValidateBeforeCall(scope, sortBy, start, limit, inlineAggregationRequest, null);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getAggregationOfWeightedInstrumentsAsync(String scope, List<String> sortBy, Integer start, Integer limit, InlineAggregationRequest inlineAggregationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregationOfWeightedInstrumentsValidateBeforeCall(scope, sortBy, start, limit, inlineAggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    /**
     * Build call for getNestedAggregation
     * @param scope The scope of the portfolio or portfolio group (required)
     * @param code The code of the portfolio or portfolio group (required)
     * @param aggregationRequest The request specifying the parameters of the aggregation (optional)
     * @param _callback Callback for upload/download progress
     ...
     */
    public okhttp3.Call getNestedAggregationCall(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;

        // create path and map variables
        String localVarPath = "/api/aggregation/{scope}/{code}/$aggregatenested"
            .replaceAll("\\{" + "scope" + "\\}", localVarApiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "code" + "\\}", localVarApiClient.escapeString(code.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNestedAggregationValidateBeforeCall(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getNestedAggregation(Async)");
        }
        
        // verify the required parameter 'code' is set
        if (code == null) {
            throw new ApiException("Missing the required parameter 'code' when calling getNestedAggregation(Async)");
        }
        

        okhttp3.Call localVarCall = getNestedAggregationCall(scope, code, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public NestedAggregationResponse getNestedAggregation(String scope, String code, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<NestedAggregationResponse> localVarResp = getNestedAggregationWithHttpInfo(scope, code, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NestedAggregationResponse> getNestedAggregationWithHttpInfo(String scope, String code, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getNestedAggregationValidateBeforeCall(scope, code, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<NestedAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group, as nested (asynchronously)
     * Aggregate data sourced from the specified portfolio or portfolio group into a nested structure. Data is nested following the group-by specifications.
     * @param scope The scope of the portfolio or portfolio group (required)
     * @param code The code of the portfolio or portfolio group (required)
     * @param aggregationRequest The request specifying the parameters of the aggregation (optional)
     ...
     */
    public okhttp3.Call getNestedAggregationAsync(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback<NestedAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNestedAggregationValidateBeforeCall(scope, code, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<NestedAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getNestedAggregationByGroupCall(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNestedAggregationByGroupValidateBeforeCall(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getNestedAggregationByGroupCall(scope, code, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public NestedAggregationResponse getNestedAggregationByGroup(String scope, String code, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<NestedAggregationResponse> localVarResp = getNestedAggregationByGroupWithHttpInfo(scope, code, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NestedAggregationResponse> getNestedAggregationByGroupWithHttpInfo(String scope, String code, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getNestedAggregationByGroupValidateBeforeCall(scope, code, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<NestedAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getNestedAggregationByGroupAsync(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback<NestedAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNestedAggregationByGroupValidateBeforeCall(scope, code, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<NestedAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getNestedAggregationByPortfolioCall(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = aggregationRequest;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getNestedAggregationByPortfolioValidateBeforeCall(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getNestedAggregationByPortfolioCall(scope, code, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public NestedAggregationResponse getNestedAggregationByPortfolio(String scope, String code, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<NestedAggregationResponse> localVarResp = getNestedAggregationByPortfolioWithHttpInfo(scope, code, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<NestedAggregationResponse> getNestedAggregationByPortfolioWithHttpInfo(String scope, String code, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getNestedAggregationByPortfolioValidateBeforeCall(scope, code, aggregationRequest, null);
        Type localVarReturnType = new TypeToken<NestedAggregationResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call getNestedAggregationByPortfolioAsync(String scope, String code, AggregationRequest aggregationRequest, final ApiCallback<NestedAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getNestedAggregationByPortfolioValidateBeforeCall(scope, code, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<NestedAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call getQueryableKeysCall(String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getQueryableKeysValidateBeforeCall(String page, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = getQueryableKeysCall(page, start, limit, filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfAggregationQuery getQueryableKeys(String page, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfAggregationQuery> localVarResp = getQueryableKeysWithHttpInfo(page, start, limit, filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfAggregationQuery> getQueryableKeysWithHttpInfo(String page, Integer start, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = getQueryableKeysValidateBeforeCall(page, start, limit, filter, null);
     ...
     */
    public okhttp3.Call getQueryableKeysAsync(String page, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfAggregationQuery> _callback) throws ApiException {

        okhttp3.Call localVarCall = getQueryableKeysValidateBeforeCall(page, start, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfAggregationQuery>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
