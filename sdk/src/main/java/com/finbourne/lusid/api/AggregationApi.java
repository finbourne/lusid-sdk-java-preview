...
public class AggregationApi {
     ...
     */
    public okhttp3.Call getAggregationByResultSetCall(String scope, String resultsKey, List<String> sortBy, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAggregationByResultSetValidateBeforeCall(String scope, String resultsKey, List<String> sortBy, Integer limit, AggregationRequest aggregationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAggregationByResultSetCall(scope, resultsKey, sortBy, limit, aggregationRequest, _callback);
        return localVarCall;
     ...
     */
    public ListAggregationResponse getAggregationByResultSet(String scope, String resultsKey, List<String> sortBy, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        ApiResponse<ListAggregationResponse> localVarResp = getAggregationByResultSetWithHttpInfo(scope, resultsKey, sortBy, limit, aggregationRequest);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ListAggregationResponse> getAggregationByResultSetWithHttpInfo(String scope, String resultsKey, List<String> sortBy, Integer limit, AggregationRequest aggregationRequest) throws ApiException {
        okhttp3.Call localVarCall = getAggregationByResultSetValidateBeforeCall(scope, resultsKey, sortBy, limit, aggregationRequest, null);
     ...
     */
    public okhttp3.Call getAggregationByResultSetAsync(String scope, String resultsKey, List<String> sortBy, Integer limit, AggregationRequest aggregationRequest, final ApiCallback<ListAggregationResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAggregationByResultSetValidateBeforeCall(scope, resultsKey, sortBy, limit, aggregationRequest, _callback);
        Type localVarReturnType = new TypeToken<ListAggregationResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
