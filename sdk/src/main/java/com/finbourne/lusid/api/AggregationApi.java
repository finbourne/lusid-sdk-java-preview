...
public class AggregationApi {
     ...
     * @param request The request specifying the parameters to generating the recipe (optional)
     ...
     */
    public okhttp3.Call generateConfigurationRecipeCall(String scope, String code, CreateRecipeRequest request, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call generateConfigurationRecipeValidateBeforeCall(String scope, String code, CreateRecipeRequest request, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = generateConfigurationRecipeCall(scope, code, request, _callback);
        return localVarCall;
     ...
     */
    public ConfigurationRecipe generateConfigurationRecipe(String scope, String code, CreateRecipeRequest request) throws ApiException {
        ApiResponse<ConfigurationRecipe> localVarResp = generateConfigurationRecipeWithHttpInfo(scope, code, request);
     ...
     */
    public ApiResponse<ConfigurationRecipe> generateConfigurationRecipeWithHttpInfo(String scope, String code, CreateRecipeRequest request) throws ApiException {
        okhttp3.Call localVarCall = generateConfigurationRecipeValidateBeforeCall(scope, code, request, null);
     ...
     */
    public okhttp3.Call generateConfigurationRecipeAsync(String scope, String code, CreateRecipeRequest request, final ApiCallback<ConfigurationRecipe> _callback) throws ApiException {

        okhttp3.Call localVarCall = generateConfigurationRecipeValidateBeforeCall(scope, code, request, _callback);
        Type localVarReturnType = new TypeToken<ConfigurationRecipe>(){}.getType();
