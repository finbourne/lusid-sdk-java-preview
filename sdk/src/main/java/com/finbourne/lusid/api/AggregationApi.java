...
import com.finbourne.lusid.model.Aggregation;
...
import com.finbourne.lusid.model.SupportedAnalyticsInternalRequest;
...
public class AggregationApi {
    ...
    private okhttp3.Call getQueryableKeysValidateBeforeCall(String page, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getQueryableKeysCall(page, limit, filter, _callback);
        return localVarCall;
    ...
    /**
     * [EXPERIMENTAL] GetQueryableKeys: Query the set of supported \&quot;addresses\&quot; that can be queried from the aggregation endpoint. (asynchronously)
     * When a request is made for aggregation, the user needs to know what keys can be passed to it for queryable data. This endpoint allows to queries to provide the set of keys,  what they are and what they return.
     * @param page The pagination token to use to continue listing queryable keys from a previous call to list queryable keys.              This value is returned from the previous call. (optional)
     * @param limit When paginating, limit the number of returned results to this many. (optional)
     * @param filter Expression to filter the result set.              Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
    ...
    /**
     * Build call for supportedAnalyticsInternal
     * @param supportedAnalyticsInternalRequest  (optional)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     * @http.response.details
     ...
     */
    public okhttp3.Call supportedAnalyticsInternalCall(SupportedAnalyticsInternalRequest supportedAnalyticsInternalRequest, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = supportedAnalyticsInternalRequest;

        // create path and map variables
        String localVarPath = "/api/aggregation/supportedanalyticsinternal";
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call supportedAnalyticsInternalValidateBeforeCall(SupportedAnalyticsInternalRequest supportedAnalyticsInternalRequest, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = supportedAnalyticsInternalCall(supportedAnalyticsInternalRequest, _callback);
        return localVarCall;
     ...
     */
    public Aggregation supportedAnalyticsInternal(SupportedAnalyticsInternalRequest supportedAnalyticsInternalRequest) throws ApiException {
        ApiResponse<Aggregation> localVarResp = supportedAnalyticsInternalWithHttpInfo(supportedAnalyticsInternalRequest);
        return localVarResp.getData();
    }
     ...
     * Breaks down, e.g. by model and instrument type, either feature groups (such as pv, accrued, risk, cashflows) that are supported or the specific address keys that are supported for them.
     * @param supportedAnalyticsInternalRequest  (optional)
     * @return ApiResponse&lt;Aggregation&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<Aggregation> supportedAnalyticsInternalWithHttpInfo(SupportedAnalyticsInternalRequest supportedAnalyticsInternalRequest) throws ApiException {
        okhttp3.Call localVarCall = supportedAnalyticsInternalValidateBeforeCall(supportedAnalyticsInternalRequest, null);
        Type localVarReturnType = new TypeToken<Aggregation>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [INTERNAL] SupportedAnalyticsInternal: Generates a matrix of analytics features supported by LUSID. (asynchronously)
     * Breaks down, e.g. by model and instrument type, either feature groups (such as pv, accrued, risk, cashflows) that are supported or the specific address keys that are supported for them.
     * @param supportedAnalyticsInternalRequest  (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call supportedAnalyticsInternalAsync(SupportedAnalyticsInternalRequest supportedAnalyticsInternalRequest, final ApiCallback<Aggregation> _callback) throws ApiException {
        okhttp3.Call localVarCall = supportedAnalyticsInternalValidateBeforeCall(supportedAnalyticsInternalRequest, _callback);
        Type localVarReturnType = new TypeToken<Aggregation>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
