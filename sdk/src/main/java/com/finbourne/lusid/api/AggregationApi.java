...
public class AggregationApi {
    ...
    /**
     * [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group  Deprecated: Please use the GetValuation endpoint. It is aimed at a simpler set of requirements now deemed stable.  Aggregation will shortly be modified to include experimental features such as Simulation and XVA (asynchronously)
     * Aggregate data sourced from the specified portfolio or portfolio group
     * @param scope The scope of the portfolio or portfolio group (required)
     * @param code The code of the portfolio or portfolio group (required)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
    ...
    /**
     * [EXPERIMENTAL] Aggregate data in a portfolio or portfolio group, as nested                Deprecated: Endpoint is being retired. The nested functionality is supported on the valuation endpoint through use of an &#39;include subtotals&#39; flag. (asynchronously)
     * Aggregate data sourced from the specified portfolio or portfolio group into a nested structure. Data is nested following the group-by specifications.
     * @param scope The scope of the portfolio or portfolio group (required)
     * @param code The code of the portfolio or portfolio group (required)
     * @param aggregationRequest The request specifying the parameters of the aggregation (optional)
    ...
    private okhttp3.Call getValuationValidateBeforeCall(ValuationRequest valuationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getValuationCall(valuationRequest, _callback);
        return localVarCall;
    ...
    /**
     * [EXPERIMENTAL] Perform valuation for a list of portfolios and/or portfolio groups (asynchronously)
     * Perform valuation on specified list of portfolio and/or portfolio groups for a set of dates.
     * @param valuationRequest The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
    ...
    private okhttp3.Call getValuationOfWeightedInstrumentsValidateBeforeCall(InlineValuationRequest inlineValuationRequest, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getValuationOfWeightedInstrumentsCall(inlineValuationRequest, _callback);
        return localVarCall;
    ...
    /**
     * [EXPERIMENTAL] Perform valuation for an inlined portfolio (asynchronously)
     * Perform valuation on the portfolio that is defined by the weighted set of instruments passed to the request.
     * @param inlineValuationRequest The request specifying the set of portfolios and dates on which to calculate a set of valuation metrics (optional)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
