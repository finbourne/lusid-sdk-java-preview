...
public class OrderManagementApi {
     ...
     */
    public okhttp3.Call bookTransactionsCall(List<ResourceId> resourceId, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call bookTransactionsValidateBeforeCall(List<ResourceId> resourceId, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = bookTransactionsCall(resourceId, _callback);
        return localVarCall;
     ...
     */
    public BookTransactionsResponse bookTransactions(List<ResourceId> resourceId) throws ApiException {
        ApiResponse<BookTransactionsResponse> localVarResp = bookTransactionsWithHttpInfo(resourceId);
     ...
     */
    public ApiResponse<BookTransactionsResponse> bookTransactionsWithHttpInfo(List<ResourceId> resourceId) throws ApiException {
        okhttp3.Call localVarCall = bookTransactionsValidateBeforeCall(resourceId, null);
     ...
     */
    public okhttp3.Call bookTransactionsAsync(List<ResourceId> resourceId, final ApiCallback<BookTransactionsResponse> _callback) throws ApiException {
        okhttp3.Call localVarCall = bookTransactionsValidateBeforeCall(resourceId, _callback);
        Type localVarReturnType = new TypeToken<BookTransactionsResponse>(){}.getType();
