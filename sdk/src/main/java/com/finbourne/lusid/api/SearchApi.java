...
public class SearchApi {
     ...
     */
    public okhttp3.Call instrumentsSearchCall(String masteredEffectiveAt, Boolean masteredOnly, List<InstrumentSearchProperty> symbols, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call instrumentsSearchValidateBeforeCall(String masteredEffectiveAt, Boolean masteredOnly, List<InstrumentSearchProperty> symbols, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = instrumentsSearchCall(masteredEffectiveAt, masteredOnly, symbols, _callback);
        return localVarCall;
     ...
     */
    public List<InstrumentMatch> instrumentsSearch(String masteredEffectiveAt, Boolean masteredOnly, List<InstrumentSearchProperty> symbols) throws ApiException {
        ApiResponse<List<InstrumentMatch>> localVarResp = instrumentsSearchWithHttpInfo(masteredEffectiveAt, masteredOnly, symbols);
     ...
     */
    public ApiResponse<List<InstrumentMatch>> instrumentsSearchWithHttpInfo(String masteredEffectiveAt, Boolean masteredOnly, List<InstrumentSearchProperty> symbols) throws ApiException {
        okhttp3.Call localVarCall = instrumentsSearchValidateBeforeCall(masteredEffectiveAt, masteredOnly, symbols, null);
        Type localVarReturnType = new TypeToken<List<InstrumentMatch>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Search instruments (asynchronously)
     * Search through instruments that have been mastered in LUSID, and optionally augment results with instruments from a symbology service
     * @param masteredEffectiveAt Optional. The effective date for searching mastered instruments. If this is not set, then the current date is taken.  This parameter has no effect on instruments that have not been mastered within LUSID. (optional)
     * @param masteredOnly Optional. If set to true, only search over instruments that have been mastered within LUSID. Default to false (optional, default to false)
     * @param symbols A collection of instrument symbols to search for (optional)
     ...
     */
    public okhttp3.Call instrumentsSearchAsync(String masteredEffectiveAt, Boolean masteredOnly, List<InstrumentSearchProperty> symbols, final ApiCallback<List<InstrumentMatch>> _callback) throws ApiException {

        okhttp3.Call localVarCall = instrumentsSearchValidateBeforeCall(masteredEffectiveAt, masteredOnly, symbols, _callback);
        Type localVarReturnType = new TypeToken<List<InstrumentMatch>>(){}.getType();
     ...
     */
    public okhttp3.Call portfolioGroupsSearchCall(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call portfolioGroupsSearchValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = portfolioGroupsSearchCall(sortBy, start, limit, filter, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioGroup portfolioGroupsSearch(List<String> sortBy, Integer start, Integer limit, String filter, Object request) throws ApiException {
        ApiResponse<ResourceListOfPortfolioGroup> localVarResp = portfolioGroupsSearchWithHttpInfo(sortBy, start, limit, filter, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioGroup> portfolioGroupsSearchWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, Object request) throws ApiException {
        okhttp3.Call localVarCall = portfolioGroupsSearchValidateBeforeCall(sortBy, start, limit, filter, request, null);
     ...
     */
    public okhttp3.Call portfolioGroupsSearchAsync(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback<ResourceListOfPortfolioGroup> _callback) throws ApiException {

        okhttp3.Call localVarCall = portfolioGroupsSearchValidateBeforeCall(sortBy, start, limit, filter, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioGroup>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call portfoliosSearchCall(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call portfoliosSearchValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = portfoliosSearchCall(sortBy, start, limit, filter, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioSearchResult portfoliosSearch(List<String> sortBy, Integer start, Integer limit, String filter, Object request) throws ApiException {
        ApiResponse<ResourceListOfPortfolioSearchResult> localVarResp = portfoliosSearchWithHttpInfo(sortBy, start, limit, filter, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioSearchResult> portfoliosSearchWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, Object request) throws ApiException {
        okhttp3.Call localVarCall = portfoliosSearchValidateBeforeCall(sortBy, start, limit, filter, request, null);
     ...
     */
    public okhttp3.Call portfoliosSearchAsync(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback<ResourceListOfPortfolioSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = portfoliosSearchValidateBeforeCall(sortBy, start, limit, filter, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     */
    public okhttp3.Call propertiesSearchCall(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = request;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call propertiesSearchValidateBeforeCall(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = propertiesSearchCall(sortBy, start, limit, filter, request, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPropertyDefinition propertiesSearch(List<String> sortBy, Integer start, Integer limit, String filter, Object request) throws ApiException {
        ApiResponse<ResourceListOfPropertyDefinition> localVarResp = propertiesSearchWithHttpInfo(sortBy, start, limit, filter, request);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPropertyDefinition> propertiesSearchWithHttpInfo(List<String> sortBy, Integer start, Integer limit, String filter, Object request) throws ApiException {
        okhttp3.Call localVarCall = propertiesSearchValidateBeforeCall(sortBy, start, limit, filter, request, null);
     ...
     */
    public okhttp3.Call propertiesSearchAsync(List<String> sortBy, Integer start, Integer limit, String filter, Object request, final ApiCallback<ResourceListOfPropertyDefinition> _callback) throws ApiException {

        okhttp3.Call localVarCall = propertiesSearchValidateBeforeCall(sortBy, start, limit, filter, request, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPropertyDefinition>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
