...
public class SearchApi {
     ...
     */
    public okhttp3.Call searchPortfoliosCall(String filter, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchPortfoliosValidateBeforeCall(String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchPortfoliosCall(filter, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioSearchResult searchPortfolios(String filter) throws ApiException {
        ApiResponse<ResourceListOfPortfolioSearchResult> localVarResp = searchPortfoliosWithHttpInfo(filter);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioSearchResult> searchPortfoliosWithHttpInfo(String filter) throws ApiException {
        okhttp3.Call localVarCall = searchPortfoliosValidateBeforeCall(filter, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call searchPortfoliosAsync(String filter, final ApiCallback<ResourceListOfPortfolioSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchPortfoliosValidateBeforeCall(filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
