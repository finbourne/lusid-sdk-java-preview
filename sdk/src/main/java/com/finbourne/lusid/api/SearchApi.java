...
public class SearchApi {
     ...
     */
    public okhttp3.Call instrumentsSearchCall(List<InstrumentSearchProperty> instrumentSearchProperty, String masteredEffectiveAt, Boolean masteredOnly, final ApiCallback _callback) throws ApiException {
    ...
    private okhttp3.Call instrumentsSearchValidateBeforeCall(List<InstrumentSearchProperty> instrumentSearchProperty, String masteredEffectiveAt, Boolean masteredOnly, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = instrumentsSearchCall(instrumentSearchProperty, masteredEffectiveAt, masteredOnly, _callback);
        return localVarCall;
     ...
     */
    public List<InstrumentMatch> instrumentsSearch(List<InstrumentSearchProperty> instrumentSearchProperty, String masteredEffectiveAt, Boolean masteredOnly) throws ApiException {
        ApiResponse<List<InstrumentMatch>> localVarResp = instrumentsSearchWithHttpInfo(instrumentSearchProperty, masteredEffectiveAt, masteredOnly);
     ...
     */
    public ApiResponse<List<InstrumentMatch>> instrumentsSearchWithHttpInfo(List<InstrumentSearchProperty> instrumentSearchProperty, String masteredEffectiveAt, Boolean masteredOnly) throws ApiException {
        okhttp3.Call localVarCall = instrumentsSearchValidateBeforeCall(instrumentSearchProperty, masteredEffectiveAt, masteredOnly, null);
        Type localVarReturnType = new TypeToken<List<InstrumentMatch>>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] InstrumentsSearch: Instruments search (asynchronously)
     * Search across all instruments that have been mastered in LUSID. Optionally augment the results with instruments from an external symbology service,  currently OpenFIGI.
     * @param instrumentSearchProperty A collection of instrument properties to search for. LUSID will return instruments for any matched              properties. (required)
     * @param masteredEffectiveAt The effective datetime or cut label to use when searching mastered instruments. This parameter has no effect on instruments that  have not been mastered within LUSID. Defaults to the current LUSID system datetime if not specified. (optional)
     * @param masteredOnly If set to true, only search over instruments that have been mastered within LUSID. Defaults to false. (optional, default to false)
     ...
     */
    public okhttp3.Call instrumentsSearchAsync(List<InstrumentSearchProperty> instrumentSearchProperty, String masteredEffectiveAt, Boolean masteredOnly, final ApiCallback<List<InstrumentMatch>> _callback) throws ApiException {
        okhttp3.Call localVarCall = instrumentsSearchValidateBeforeCall(instrumentSearchProperty, masteredEffectiveAt, masteredOnly, _callback);
        Type localVarReturnType = new TypeToken<List<InstrumentMatch>>(){}.getType();
