...
public class SearchApi {
     ...
     */
    public okhttp3.Call searchPortfoliosCall(String filter, String sortBy, Integer start, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchPortfoliosValidateBeforeCall(String filter, String sortBy, Integer start, Integer limit, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchPortfoliosCall(filter, sortBy, start, limit, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioSearchResult searchPortfolios(String filter, String sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfPortfolioSearchResult> localVarResp = searchPortfoliosWithHttpInfo(filter, sortBy, start, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioSearchResult> searchPortfoliosWithHttpInfo(String filter, String sortBy, Integer start, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = searchPortfoliosValidateBeforeCall(filter, sortBy, start, limit, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call searchPortfoliosAsync(String filter, String sortBy, Integer start, Integer limit, final ApiCallback<ResourceListOfPortfolioSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchPortfoliosValidateBeforeCall(filter, sortBy, start, limit, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
