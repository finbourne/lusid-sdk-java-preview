...
public class SearchApi {
    ...
    /**
     * [EXPERIMENTAL] Portfolio groups search (asynchronously)
     * Search across all portfolio groups across all scopes.
     * @param request The search query to use. Read more about search queries in LUSID here https://support.lusid.com/constructing-a-search-request. (required)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param _callback The callback to be executed when the API call finishes
    ...
    /**
     * [EXPERIMENTAL] Portfolios search (asynchronously)
     * Search across all portfolios across all scopes.
     * @param request The search query to use. Read more about search queries in LUSID here https://support.lusid.com/constructing-a-search-request. (required)
     * @param filter Expression to filter the result set. Read more about filtering results from LUSID here https://support.lusid.com/filtering-results-from-lusid. (optional)
     * @param _callback The callback to be executed when the API call finishes
     ...
     * @param search A parameter used for searching any portfolio field. Wildcards(*) are supported at the end of words (e.g. &#39;Port*&#39;). See &lt;see href&#x3D;\&quot;https://support.lusid.com/filtering-results-from-lusid\&quot;&gt; filtering results from LUSID &lt;/see&gt; for more details. (optional)
     ...
     */
    public okhttp3.Call searchPortfoliosCall(String search, String filter, String sortBy, Integer start, Integer limit, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call searchPortfoliosValidateBeforeCall(String search, String filter, String sortBy, Integer start, Integer limit, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = searchPortfoliosCall(search, filter, sortBy, start, limit, _callback);
        return localVarCall;
     ...
     */
    public ResourceListOfPortfolioSearchResult searchPortfolios(String search, String filter, String sortBy, Integer start, Integer limit) throws ApiException {
        ApiResponse<ResourceListOfPortfolioSearchResult> localVarResp = searchPortfoliosWithHttpInfo(search, filter, sortBy, start, limit);
        return localVarResp.getData();
    }
     ...
     */
    public ApiResponse<ResourceListOfPortfolioSearchResult> searchPortfoliosWithHttpInfo(String search, String filter, String sortBy, Integer start, Integer limit) throws ApiException {
        okhttp3.Call localVarCall = searchPortfoliosValidateBeforeCall(search, filter, sortBy, start, limit, null);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }
     ...
     */
    public okhttp3.Call searchPortfoliosAsync(String search, String filter, String sortBy, Integer start, Integer limit, final ApiCallback<ResourceListOfPortfolioSearchResult> _callback) throws ApiException {

        okhttp3.Call localVarCall = searchPortfoliosValidateBeforeCall(search, filter, sortBy, start, limit, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfPortfolioSearchResult>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
