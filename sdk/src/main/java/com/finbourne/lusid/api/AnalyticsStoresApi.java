...
import com.finbourne.lusid.model.AnalyticStore;
import com.finbourne.lusid.model.CreateAnalyticStoreRequest;
import com.finbourne.lusid.model.DeletedEntityResponse;
import com.finbourne.lusid.model.InstrumentAnalytic;
import com.finbourne.lusid.model.LusidProblemDetails;
import com.finbourne.lusid.model.LusidValidationProblemDetails;
import java.time.OffsetDateTime;
import com.finbourne.lusid.model.ResourceListOfAnalyticStoreKey;
...
public class AnalyticsStoresApi {
    ...
    public AnalyticsStoresApi(ApiClient apiClient) {
    ...
    /**
     * Build call for createAnalyticStore
     * @param request A populated analytic store definition (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call createAnalyticStoreCall(CreateAnalyticStoreRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = request;

        // create path and map variables
        String localVarPath = "/api/analytics";
    ...
    private com.squareup.okhttp.Call createAnalyticStoreValidateBeforeCall(CreateAnalyticStoreRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = createAnalyticStoreCall(request, progressListener, progressRequestListener);
        return call;
     ...
     */
    public AnalyticStore createAnalyticStore(CreateAnalyticStoreRequest request) throws ApiException {
        ApiResponse<AnalyticStore> resp = createAnalyticStoreWithHttpInfo(request);
        return resp.getData();
    }
     ...
     * Create a new analytic store for the specified scope and date
     * @param request A populated analytic store definition (optional)
     * @return ApiResponse&lt;AnalyticStore&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AnalyticStore> createAnalyticStoreWithHttpInfo(CreateAnalyticStoreRequest request) throws ApiException {
        com.squareup.okhttp.Call call = createAnalyticStoreValidateBeforeCall(request, null, null);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Create analytic store (asynchronously)
     * Create a new analytic store for the specified scope and date
     * @param request A populated analytic store definition (optional)
     ...
     */
    public com.squareup.okhttp.Call createAnalyticStoreAsync(CreateAnalyticStoreRequest request, final ApiCallback<AnalyticStore> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = createAnalyticStoreValidateBeforeCall(request, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for deleteAnalyticStore
     * @param scope The analytics data scope (required)
     * @param year The year component of the date (required)
     * @param month The month component of the date (required)
     * @param day The day component of the date (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteAnalyticStoreCall(String scope, Integer year, Integer month, Integer day, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/api/analytics/{scope}/{year}/{month}/{day}"
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteAnalyticStoreValidateBeforeCall(String scope, Integer year, Integer month, Integer day, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling deleteAnalyticStore(Async)");
        }
        
        // verify the required parameter 'year' is set
        if (year == null) {
            throw new ApiException("Missing the required parameter 'year' when calling deleteAnalyticStore(Async)");
        }
        
        // verify the required parameter 'month' is set
        if (month == null) {
            throw new ApiException("Missing the required parameter 'month' when calling deleteAnalyticStore(Async)");
        }
        
        // verify the required parameter 'day' is set
        if (day == null) {
            throw new ApiException("Missing the required parameter 'day' when calling deleteAnalyticStore(Async)");
        }
        

        com.squareup.okhttp.Call call = deleteAnalyticStoreCall(scope, year, month, day, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public DeletedEntityResponse deleteAnalyticStore(String scope, Integer year, Integer month, Integer day) throws ApiException {
        ApiResponse<DeletedEntityResponse> resp = deleteAnalyticStoreWithHttpInfo(scope, year, month, day);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<DeletedEntityResponse> deleteAnalyticStoreWithHttpInfo(String scope, Integer year, Integer month, Integer day) throws ApiException {
        com.squareup.okhttp.Call call = deleteAnalyticStoreValidateBeforeCall(scope, year, month, day, null, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Delete analytic store (asynchronously)
     * Delete stored analytic data in the specified scope for the specified date
     * @param scope The analytics data scope (required)
     * @param year The year component of the date (required)
     * @param month The month component of the date (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteAnalyticStoreAsync(String scope, Integer year, Integer month, Integer day, final ApiCallback<DeletedEntityResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteAnalyticStoreValidateBeforeCall(scope, year, month, day, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for getAnalyticStore
     * @param scope The analytics data scope (required)
     * @param year The year component of the date for the data in the scope (required)
     * @param month The month component of the date for the data in the scope (required)
     * @param day The day component of the date for the data in the scope (required)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getAnalyticStoreCall(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getAnalyticStoreValidateBeforeCall(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling getAnalyticStore(Async)");
        }
        
        // verify the required parameter 'year' is set
        if (year == null) {
            throw new ApiException("Missing the required parameter 'year' when calling getAnalyticStore(Async)");
        }
        
        // verify the required parameter 'month' is set
        if (month == null) {
            throw new ApiException("Missing the required parameter 'month' when calling getAnalyticStore(Async)");
        }
        
        // verify the required parameter 'day' is set
        if (day == null) {
            throw new ApiException("Missing the required parameter 'day' when calling getAnalyticStore(Async)");
        }
        

        com.squareup.okhttp.Call call = getAnalyticStoreCall(scope, year, month, day, asAt, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AnalyticStore getAnalyticStore(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt) throws ApiException {
        ApiResponse<AnalyticStore> resp = getAnalyticStoreWithHttpInfo(scope, year, month, day, asAt);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AnalyticStore> getAnalyticStoreWithHttpInfo(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt) throws ApiException {
        com.squareup.okhttp.Call call = getAnalyticStoreValidateBeforeCall(scope, year, month, day, asAt, null, null);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Get analytic store (asynchronously)
     * Get the meta data associated with a specified scope and date combination (analytic store)
     * @param scope The analytics data scope (required)
     * @param year The year component of the date for the data in the scope (required)
     * @param month The month component of the date for the data in the scope (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getAnalyticStoreAsync(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt, final ApiCallback<AnalyticStore> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getAnalyticStoreValidateBeforeCall(scope, year, month, day, asAt, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for listAnalyticStores
     * @param asAt Optional. The AsAt date of the data (optional)
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call listAnalyticStoresCall(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call listAnalyticStoresValidateBeforeCall(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        

        com.squareup.okhttp.Call call = listAnalyticStoresCall(asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        return call;
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Optional. Expression to filter the result set (optional)
     * @return ResourceListOfAnalyticStoreKey
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ResourceListOfAnalyticStoreKey listAnalyticStores(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfAnalyticStoreKey> resp = listAnalyticStoresWithHttpInfo(asAt, sortBy, start, limit, filter);
        return resp.getData();
    }
     ...
     * @param limit Optional. When paginating, limit the number of returned results to this many. (optional)
     * @param filter Optional. Expression to filter the result set (optional)
     * @return ApiResponse&lt;ResourceListOfAnalyticStoreKey&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<ResourceListOfAnalyticStoreKey> listAnalyticStoresWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        com.squareup.okhttp.Call call = listAnalyticStoresValidateBeforeCall(asAt, sortBy, start, limit, filter, null, null);
        Type localVarReturnType = new TypeToken<ResourceListOfAnalyticStoreKey>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * List analytic stores (asynchronously)
     * List all defined analytic stores
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call listAnalyticStoresAsync(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfAnalyticStoreKey> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = listAnalyticStoresValidateBeforeCall(asAt, sortBy, start, limit, filter, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<ResourceListOfAnalyticStoreKey>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for setAnalytics
     * @param scope The scope of the data being stored (required)
     * @param year The year component of the date for the data (required)
     * @param month The month component of the date for the data (required)
     * @param day The day component of the date for the data (required)
     * @param data The analytic data being inserted (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call setAnalyticsCall(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = data;

        // create path and map variables
        String localVarPath = "/api/analytics/{scope}/{year}/{month}/{day}/prices"
            .replaceAll("\\{" + "scope" + "\\}", apiClient.escapeString(scope.toString()))
            .replaceAll("\\{" + "year" + "\\}", apiClient.escapeString(year.toString()))
            .replaceAll("\\{" + "month" + "\\}", apiClient.escapeString(month.toString()))
            .replaceAll("\\{" + "day" + "\\}", apiClient.escapeString(day.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call setAnalyticsValidateBeforeCall(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'scope' is set
        if (scope == null) {
            throw new ApiException("Missing the required parameter 'scope' when calling setAnalytics(Async)");
        }
        
        // verify the required parameter 'year' is set
        if (year == null) {
            throw new ApiException("Missing the required parameter 'year' when calling setAnalytics(Async)");
        }
        
        // verify the required parameter 'month' is set
        if (month == null) {
            throw new ApiException("Missing the required parameter 'month' when calling setAnalytics(Async)");
        }
        
        // verify the required parameter 'day' is set
        if (day == null) {
            throw new ApiException("Missing the required parameter 'day' when calling setAnalytics(Async)");
        }
        

        com.squareup.okhttp.Call call = setAnalyticsCall(scope, year, month, day, data, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AnalyticStore setAnalytics(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data) throws ApiException {
        ApiResponse<AnalyticStore> resp = setAnalyticsWithHttpInfo(scope, year, month, day, data);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AnalyticStore> setAnalyticsWithHttpInfo(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data) throws ApiException {
        com.squareup.okhttp.Call call = setAnalyticsValidateBeforeCall(scope, year, month, day, data, null, null);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Set analytic data (asynchronously)
     * Store the complete set of analytics for an existing analytic store for the specified scope and date
     * @param scope The scope of the data being stored (required)
     * @param year The year component of the date for the data (required)
     * @param month The month component of the date for the data (required)
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call setAnalyticsAsync(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data, final ApiCallback<AnalyticStore> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = setAnalyticsValidateBeforeCall(scope, year, month, day, data, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
