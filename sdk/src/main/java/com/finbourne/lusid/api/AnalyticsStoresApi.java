...
public class AnalyticsStoresApi {
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        ...
        <tr><td> 201 </td><td> The meta data of the created analytic store </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call createAnalyticStoreCall(CreateAnalyticStoreRequest request, final ApiCallback _callback) throws ApiException {
        ...
        localVarHeaderParams.put("X-LUSID-SDK-Version", "0.10.465");
    ...
    private okhttp3.Call createAnalyticStoreValidateBeforeCall(CreateAnalyticStoreRequest request, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createAnalyticStoreCall(request, _callback);
        return localVarCall;
    ...
    public AnalyticStore createAnalyticStore(CreateAnalyticStoreRequest request) throws ApiException {
        ApiResponse<AnalyticStore> localVarResp = createAnalyticStoreWithHttpInfo(request);
    ...
    public ApiResponse<AnalyticStore> createAnalyticStoreWithHttpInfo(CreateAnalyticStoreRequest request) throws ApiException {
        okhttp3.Call localVarCall = createAnalyticStoreValidateBeforeCall(request, null);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Create analytic store (asynchronously)
     * Create a new analytic store for the specified scope and date
     * @param request A populated analytic store definition (optional)
     ...
     */
    public okhttp3.Call createAnalyticStoreAsync(CreateAnalyticStoreRequest request, final ApiCallback<AnalyticStore> _callback) throws ApiException {

        okhttp3.Call localVarCall = createAnalyticStoreValidateBeforeCall(request, _callback);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A confirmation of the deleted store </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call deleteAnalyticStoreCall(String scope, Integer year, Integer month, Integer day, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/api/analytics/{scope}/{year}/{month}/{day}"
            ...
            .replaceAll("\\{" + "month" + "\\}", localVarApiClient.escapeString(month.toString()))
            .replaceAll("\\{" + "day" + "\\}", localVarApiClient.escapeString(day.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call deleteAnalyticStoreValidateBeforeCall(String scope, Integer year, Integer month, Integer day, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = deleteAnalyticStoreCall(scope, year, month, day, _callback);
        return localVarCall;
    ...
    public DeletedEntityResponse deleteAnalyticStore(String scope, Integer year, Integer month, Integer day) throws ApiException {
        ApiResponse<DeletedEntityResponse> localVarResp = deleteAnalyticStoreWithHttpInfo(scope, year, month, day);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<DeletedEntityResponse> deleteAnalyticStoreWithHttpInfo(String scope, Integer year, Integer month, Integer day) throws ApiException {
        okhttp3.Call localVarCall = deleteAnalyticStoreValidateBeforeCall(scope, year, month, day, null);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Delete analytic store (asynchronously)
     * Delete stored analytic data in the specified scope for the specified date
     * @param scope The analytics data scope (required)
     * @param year The year component of the date (required)
     * @param month The month component of the date (required)
     ...
     */
    public okhttp3.Call deleteAnalyticStoreAsync(String scope, Integer year, Integer month, Integer day, final ApiCallback<DeletedEntityResponse> _callback) throws ApiException {

        okhttp3.Call localVarCall = deleteAnalyticStoreValidateBeforeCall(scope, year, month, day, _callback);
        Type localVarReturnType = new TypeToken<DeletedEntityResponse>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The analytic store&#39;s meta data </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call getAnalyticStoreCall(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call getAnalyticStoreValidateBeforeCall(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = getAnalyticStoreCall(scope, year, month, day, asAt, _callback);
        return localVarCall;
    ...
    public AnalyticStore getAnalyticStore(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt) throws ApiException {
        ApiResponse<AnalyticStore> localVarResp = getAnalyticStoreWithHttpInfo(scope, year, month, day, asAt);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<AnalyticStore> getAnalyticStoreWithHttpInfo(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt) throws ApiException {
        okhttp3.Call localVarCall = getAnalyticStoreValidateBeforeCall(scope, year, month, day, asAt, null);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Get analytic store (asynchronously)
     * Get the meta data associated with a specified scope and date combination (analytic store)
     * @param scope The analytics data scope (required)
     * @param year The year component of the date for the data in the scope (required)
     * @param month The month component of the date for the data in the scope (required)
     ...
     */
    public okhttp3.Call getAnalyticStoreAsync(String scope, Integer year, Integer month, Integer day, OffsetDateTime asAt, final ApiCallback<AnalyticStore> _callback) throws ApiException {

        okhttp3.Call localVarCall = getAnalyticStoreValidateBeforeCall(scope, year, month, day, asAt, _callback);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> A list of analytic store keys </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call listAnalyticStoresCall(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = new Object();
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call listAnalyticStoresValidateBeforeCall(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = listAnalyticStoresCall(asAt, sortBy, start, limit, filter, _callback);
        return localVarCall;
    ...
    public ResourceListOfAnalyticStoreKey listAnalyticStores(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        ApiResponse<ResourceListOfAnalyticStoreKey> localVarResp = listAnalyticStoresWithHttpInfo(asAt, sortBy, start, limit, filter);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<ResourceListOfAnalyticStoreKey> listAnalyticStoresWithHttpInfo(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter) throws ApiException {
        okhttp3.Call localVarCall = listAnalyticStoresValidateBeforeCall(asAt, sortBy, start, limit, filter, null);
        Type localVarReturnType = new TypeToken<ResourceListOfAnalyticStoreKey>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] List analytic stores (asynchronously)
     * List all defined analytic stores
     * @param asAt Optional. The AsAt date of the data (optional)
     * @param sortBy Optional. Order the results by these fields. Use use the &#39;-&#39; sign to denote descending order e.g. -MyFieldName (optional)
     * @param start Optional. When paginating, skip this number of results (optional)
     ...
     */
    public okhttp3.Call listAnalyticStoresAsync(OffsetDateTime asAt, List<String> sortBy, Integer start, Integer limit, String filter, final ApiCallback<ResourceListOfAnalyticStoreKey> _callback) throws ApiException {

        okhttp3.Call localVarCall = listAnalyticStoresValidateBeforeCall(asAt, sortBy, start, limit, filter, _callback);
        Type localVarReturnType = new TypeToken<ResourceListOfAnalyticStoreKey>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
     ...
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
        <tr><td> 200 </td><td> The meta data of the analytic store </td><td>  -  </td></tr>
        <tr><td> 400 </td><td> The details of the input related failure </td><td>  -  </td></tr>
        <tr><td> 0 </td><td> Error response </td><td>  -  </td></tr>
     </table>
     */
    public okhttp3.Call setAnalyticsCall(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data, final ApiCallback _callback) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call setAnalyticsValidateBeforeCall(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data, final ApiCallback _callback) throws ApiException {
        ...
        okhttp3.Call localVarCall = setAnalyticsCall(scope, year, month, day, data, _callback);
        return localVarCall;
    ...
    public AnalyticStore setAnalytics(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data) throws ApiException {
        ApiResponse<AnalyticStore> localVarResp = setAnalyticsWithHttpInfo(scope, year, month, day, data);
        return localVarResp.getData();
    }
    ...
    public ApiResponse<AnalyticStore> setAnalyticsWithHttpInfo(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data) throws ApiException {
        okhttp3.Call localVarCall = setAnalyticsValidateBeforeCall(scope, year, month, day, data, null);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * [EXPERIMENTAL] Set analytic data (asynchronously)
     * Store the complete set of analytics for an existing analytic store for the specified scope and date
     * @param scope The scope of the data being stored (required)
     * @param year The year component of the date for the data (required)
     * @param month The month component of the date for the data (required)
     ...
     */
    public okhttp3.Call setAnalyticsAsync(String scope, Integer year, Integer month, Integer day, List<InstrumentAnalytic> data, final ApiCallback<AnalyticStore> _callback) throws ApiException {

        okhttp3.Call localVarCall = setAnalyticsValidateBeforeCall(scope, year, month, day, data, _callback);
        Type localVarReturnType = new TypeToken<AnalyticStore>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
