...
public class PagedResourceListOfComplianceRuleResponse {
  ...
  private List<ComplianceRuleResponse> values = new ArrayList<>();
  ...
  public PagedResourceListOfComplianceRuleResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfComplianceRuleResponse previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfComplianceRuleResponse values(List<ComplianceRuleResponse> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfComplianceRuleResponse addValuesItem(ComplianceRuleResponse valuesItem) {
  ...
  **/
  ...
  public List<ComplianceRuleResponse> getValues() {
    return values;
  }

  public void setValues(List<ComplianceRuleResponse> values) {
    this.values = values;
  }


  public PagedResourceListOfComplianceRuleResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfComplianceRuleResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfComplianceRuleResponse addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfComplianceRuleResponse {\n");
