 ...
 */
@ApiModel(description = "Instrument capabilities containing useful information about the instrument and the model. This includes  - features corresponding to the instrument i.e. Optionality:American, Other:InflationLinked  - supported addresses (if model provided) i.e. Valuation/Pv, Valuation/DirtyPriceKey, Valuation/Accrued  - economic dependencies (if model provided) i.e. Cash:USD, Fx:GBP.USD, Rates:GBP.GBPOIS")
...
public class InstrumentCapabilities {
  ...
  private List<String> supportedAddresses = null;
  ...
  private List<EconomicDependency> economicDependencies = null;
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(value = "The Lusid insturment id for the instrument e.g. 'LUID_00003D4X'.")
   ...
   * @return model
  **/
  @ApiModelProperty(value = "The pricing model e.g. 'Discounting'.")
  ...
  public InstrumentCapabilities features(List<String> features) {
    this.features = features; 
    return this;
  }

  public InstrumentCapabilities addFeaturesItem(String featuresItem) {
   ...
   * @return features
  **/
  @ApiModelProperty(value = "Features of the instrument describing its optionality, payoff type and more e.g. 'Other:Callable', 'Other:Delivery', 'Optionality:European'")
  ...
  public InstrumentCapabilities supportedAddresses(List<String> supportedAddresses) {
    this.supportedAddresses = supportedAddresses; 
    return this;
  }

  public InstrumentCapabilities addSupportedAddressesItem(String supportedAddressesItem) {
  ...
  **/
  @ApiModelProperty(value = "Queryable addresses supported by the model, e.g. 'Valuation/Pv', 'Valuation/Accrued'.")
  ...
  **/
  @ApiModelProperty(value = "Economic dependencies for the model, e.g. 'Fx:GBP.USD', 'Cash:GBP', 'Rates:GBP.GBPOIS'.")
