 ...
 */
@ApiModel(description = "Representation of Reconciliation in LUSID Api")
...
public class Reconciliation {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name of the scheduled reconciliation")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description of the scheduled reconciliation")
  ...
  **/
  @ApiModelProperty(value = "Specifies whether reconciliation is between portfolios or portfolio groups")
  ...
  **/
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Reconciliation properties")
