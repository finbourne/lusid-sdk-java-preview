...
public class CashFlowEventAllOf {
  ...
  public CashFlowEventAllOf amount(java.math.BigDecimal amount) {
    this.amount = amount; 
    return this;
  }
   ...
   * @return amount
  **/
  @ApiModelProperty(value = "The quantity (amount) that will be paid, if known. This value will be negative if it is paid, and positive  if it is received.")
  ...
  public CashFlowEventAllOf currency(String currency) {
  ...
  **/
   ...
   * @return eventType
  **/
  @ApiModelProperty(required = true, value = "What type of internal event does this represent; coupon, principal, premium etc.")
  ...
  public CashFlowEventAllOf eventStatus(String eventStatus) {
  ...
  **/
  ...
  public CashFlowEventAllOf paymentDate(OffsetDateTime paymentDate) {
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The date on which the cashflow is scheduled to be paid into the recipient's bank account.")
  ...
  public CashFlowEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
