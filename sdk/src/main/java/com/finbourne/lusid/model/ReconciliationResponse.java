 ...
 */
@ApiModel(description = "Class representing the set of comparisons that result from comparing holdings and their valuations between two separate evaluations.")
...
public class ReconciliationResponse {
  ...
  private List<ReconciliationLine> comparisons = null;
   ...
   * @return comparisons
  **/
  @ApiModelProperty(value = "List of comparisons of left to right hand sides.")
