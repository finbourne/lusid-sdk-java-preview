 ...
 */
@ApiModel(description = "Supported pricing models for an instrument.")
...
public class InstrumentModels {
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(value = "The unique LUSID Instrument Identifier (LUID) of the instrument.")
  ...
  **/
  @ApiModelProperty(value = "The pricing models supported by the instrument e.g. 'Discounting'.")
