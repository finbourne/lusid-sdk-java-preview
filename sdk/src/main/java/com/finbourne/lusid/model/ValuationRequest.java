...
public class ValuationRequest {
  ...
  **/
  ...
  public ValuationRequest addPortfolioEntityIdsItem(PortfolioEntityId portfolioEntityIdsItem) {
   ...
   /**
   * The set of portfolio or portfolio group identifiers that state what is to be valued.
   * @return portfolioEntityIds
  **/
  @ApiModelProperty(value = "The set of portfolio or portfolio group identifiers that state what is to be valued.")
