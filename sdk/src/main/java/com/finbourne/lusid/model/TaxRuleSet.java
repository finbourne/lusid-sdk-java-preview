...
public class TaxRuleSet {
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "A description of what this rule set is for")
  ...
  **/
  @ApiModelProperty(required = true, value = "The property key that this rule set will write to")
   ...
   * @return rules
  **/
  @ApiModelProperty(required = true, value = "The rules of this rule set, which stipulate what rate to apply (i.e. write to the OutputPropertyKey) under certain conditions")
