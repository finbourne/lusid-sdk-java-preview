...
public class ConstantVolatilitySurfaceAllOf {
  ...
  public ConstantVolatilitySurfaceAllOf baseDate(OffsetDateTime baseDate) {
   ...
   * @return baseDate
  **/
  @ApiModelProperty(required = true, value = "Base date of the engine - this is the reference date for resolution of tenors.")
  ...
  public ConstantVolatilitySurfaceAllOf assetType(String assetType) {
  ...
  **/
  ...
  public ConstantVolatilitySurfaceAllOf lineage(String lineage) {
  ...
  **/
  ...
  public ConstantVolatilitySurfaceAllOf volatility(java.math.BigDecimal volatility) {
   ...
   * @return volatility
  **/
  @ApiModelProperty(required = true, value = "Volatility value.")
  ...
  public ConstantVolatilitySurfaceAllOf marketDataType(MarketDataTypeEnum marketDataType) {
