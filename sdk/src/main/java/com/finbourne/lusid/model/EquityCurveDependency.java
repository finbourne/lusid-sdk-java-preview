...
import com.finbourne.lusid.model.EquityCurveDependencyAllOf;
 ...
 */
@ApiModel(description = "For indicating a dependency on an EquityCurve.  E.g. When pricing an EquitySwap one may want to make predictions about the price of the underlying equity at future dates.  If so, that model would declare an EquityCurve dependency so that it could obtain predictions from the EquityCurve.")
...
public class EquityCurveDependency extends EconomicDependency {
  ...
  public EquityCurveDependency() {
    //this.economicDependencyType = this.getClass().getSimpleName();
  }

  public EquityCurveDependency marketIdentifier(String marketIdentifier) {
  ...
  **/
  ...
  public EquityCurveDependency code(String code) {
    this.code = code; 
    return this;
  }
  ...
  **/
  ...
  public EquityCurveDependency curveType(String curveType) {
  ...
  **/
  ...
  public EquityCurveDependency date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
