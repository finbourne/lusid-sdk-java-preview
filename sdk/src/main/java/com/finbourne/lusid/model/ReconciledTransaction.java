 ...
 */
@ApiModel(description = "Information about reconciled transactions.  At least one of Finbourne.WebApi.Interface.Dto.Reconciliation.ReconciledTransaction.Left and Finbourne.WebApi.Interface.Dto.Reconciliation.ReconciledTransaction.Right will be populated.")
...
public class ReconciledTransaction {
  ...
  private List<Boolean> mappingRuleSetResults = null;
  ...
  **/
  @ApiModelProperty(value = "How good a match this is considered to be.")
  ...
  **/
  @ApiModelProperty(value = "The result of each individual mapping rule result.  Will only be present if both Finbourne.WebApi.Interface.Dto.Reconciliation.ReconciledTransaction.Left and Finbourne.WebApi.Interface.Dto.Reconciliation.ReconciledTransaction.Right are populated.")
