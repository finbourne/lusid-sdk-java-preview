...
public class CreateCorporateActionSourceRequest {
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "The scope of the corporate action source")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code of the corporate action source")
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "The name of the corporate action source")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description of the corporate action source")
  ...
  **/
  @ApiModelProperty(value = "The list of instrument scopes used as the scope resolution strategy when resolving instruments of upserted corporate actions.")
