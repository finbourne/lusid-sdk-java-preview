 ...
 */
@ApiModel(description = "A collection of details about Orders, partitioned in successful and unsuccessful sets.  Unsuccessful in this case indicates that the API call to create, upsert or retrieve them  was unsuccessful in some way (e.g. a specific order requested was not found).")
...
public class OrderSet {
  ...
  public OrderSet orders(List<Order> orders) {
    this.orders = orders;
    return this;
  }

  public OrderSet addOrdersItem(Order ordersItem) {
  ...
  **/
  ...
  public OrderSet failures(List<ErrorDetail> failures) {
    this.failures = failures;
    return this;
  }

  public OrderSet addFailuresItem(ErrorDetail failuresItem) {
  ...
  **/
  ...
  public OrderSet links(List<Link> links) {
    this.links = links;
    return this;
  }

  public OrderSet addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.orders, orderSet.orders) &&
        Objects.equals(this.failures, orderSet.failures) &&
        Objects.equals(this.links, orderSet.links);
  }

  @Override
  public int hashCode() {
    return Objects.hash(orders, failures, links);
  }
