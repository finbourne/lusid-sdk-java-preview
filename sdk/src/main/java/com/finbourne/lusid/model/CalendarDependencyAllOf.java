...
public class CalendarDependencyAllOf {
  ...
  public CalendarDependencyAllOf calendars(List<String> calendars) {
    this.calendars = calendars; 
    return this;
  }

  public CalendarDependencyAllOf addCalendarsItem(String calendarsItem) {
   ...
   * @return calendars
  **/
  @ApiModelProperty(required = true, value = "The Codes of the calendars that are depended upon.")
  ...
  public CalendarDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
