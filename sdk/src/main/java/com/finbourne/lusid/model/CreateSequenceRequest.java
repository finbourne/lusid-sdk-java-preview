...
public class CreateSequenceRequest {
  ...
  **/
   ...
   * @return cycle
  **/
  @ApiModelProperty(value = "Indicates if the sequence would start from minimun value once it reaches maximum value. If set to false, a failure would return if the sequence reaches maximum value. Default to false.")
   ...
   * @return pattern
  **/
  @ApiModelProperty(value = "The pattern to be used to generate next values in the sequence. Default to null. Please provide a null value until further notice.")
  ...
  public CreateSequenceRequest links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public CreateSequenceRequest addLinksItem(Link linksItem) {
