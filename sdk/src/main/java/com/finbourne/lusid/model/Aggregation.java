...
import com.finbourne.lusid.model.IDataRecord;
...
public class Aggregation {
  ...
  private List<IDataRecord> data = new ArrayList<>();
  ...
  private List<MarketDataManifest> manifests = new ArrayList<>();

  public static final String SERIALIZED_NAME_LINKS = "links";
  @SerializedName(SERIALIZED_NAME_LINKS)
  private List<Link> links = new ArrayList<>();

  public Aggregation aggregationEffectiveAt(OffsetDateTime aggregationEffectiveAt) {
  ...
  **/
  ...
  public Aggregation aggregationAsAt(OffsetDateTime aggregationAsAt) {
  ...
  **/
  ...
  public Aggregation href(URI href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public Aggregation data(List<IDataRecord> data) {
    this.data = data;
    return this;
  }

  public Aggregation addDataItem(IDataRecord dataItem) {
    if (this.data == null) {
  ...
  **/
  ...
  public void setData(List<IDataRecord> data) {
    this.data = data;
  }

  public Aggregation aggregationCurrency(String aggregationCurrency) {
  ...
  **/
  ...
  public Aggregation dataSchema(ResultDataSchema dataSchema) {
  ...
  **/
  ...
  public Aggregation aggregationFailures(List<AggregationMeasureFailureDetail> aggregationFailures) {
    this.aggregationFailures = aggregationFailures;
    return this;
  }

  public Aggregation addAggregationFailuresItem(AggregationMeasureFailureDetail aggregationFailuresItem) {
  ...
  **/
  ...
  public Aggregation manifests(List<MarketDataManifest> manifests) {
    this.manifests = manifests;
    return this;
  }

  public Aggregation addManifestsItem(MarketDataManifest manifestsItem) {
  ...
  **/
  @ApiModelProperty(value = "")
  public List<MarketDataManifest> getManifests() {
    return manifests;
  }

  public void setManifests(List<MarketDataManifest> manifests) {
    this.manifests = manifests;
  }

  public Aggregation links(List<Link> links) {
    this.links = links;
    return this;
  }

  public Aggregation addLinksItem(Link linksItem) {
    if (this.links == null) {
