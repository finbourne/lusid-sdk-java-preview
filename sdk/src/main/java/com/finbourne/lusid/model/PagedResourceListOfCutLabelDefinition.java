...
public class PagedResourceListOfCutLabelDefinition {
  ...
  public PagedResourceListOfCutLabelDefinition nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfCutLabelDefinition previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfCutLabelDefinition values(List<CutLabelDefinition> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfCutLabelDefinition addValuesItem(CutLabelDefinition valuesItem) {
  ...
  **/
  ...
  public PagedResourceListOfCutLabelDefinition href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfCutLabelDefinition links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfCutLabelDefinition addLinksItem(Link linksItem) {
