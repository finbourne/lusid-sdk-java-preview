 ...
 */
@ApiModel(description = "Query for cashflows from one or more portfolios")
...
public class QueryCashFlowsRequest {
   ...
   * @return asAt
  **/
  @ApiModelProperty(value = "The time of the system at which to query for bucketed cashflows.")
  ...
  **/
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The Effective date used in the valuation of the cashflows.")
