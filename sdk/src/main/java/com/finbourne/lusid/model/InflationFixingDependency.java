...
import com.finbourne.lusid.model.InflationFixingDependencyAllOf;
 ...
 */
@ApiModel(description = "For indicating a dependency upon an inflation fixing")
...
public class InflationFixingDependency extends EconomicDependency {
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The Type of fixing (index, ratio or assumption)")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The Code of the fixing, typically the index name")
   ...
   * @return date
  **/
  @ApiModelProperty(required = true, value = "The effectiveAt of the inflation fixing")
