...
public class UpsertReconciliationBreakRequest {
   ...
   * @return leftFields
  **/
  @ApiModelProperty(value = "Fields for the left hand side of the reconciliation")
   ...
   * @return rightFields
  **/
  @ApiModelProperty(value = "Fields for the right hand side of the reconciliation")
   ...
   * @return diff
  **/
  @ApiModelProperty(value = "The difference between two matching fields")
