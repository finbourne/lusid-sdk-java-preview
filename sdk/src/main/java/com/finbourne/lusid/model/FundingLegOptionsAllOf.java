...
public class FundingLegOptionsAllOf {
  ...
  public FundingLegOptionsAllOf expectedFundingLegNotional(String expectedFundingLegNotional) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Assumption made on future expected notional of the funding leg.")
  ...
  public FundingLegOptionsAllOf modelOptionsType(ModelOptionsTypeEnum modelOptionsType) {
