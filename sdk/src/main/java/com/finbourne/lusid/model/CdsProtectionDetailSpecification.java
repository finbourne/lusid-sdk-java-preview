...
public class CdsProtectionDetailSpecification {
   ...
   * @return seniority
  **/
  @ApiModelProperty(required = true, value = "The seniority level of the CDS.  Supported string (enumeration) values are: [SNR, SUB, JRSUBUT2, PREFT1, SECDOM, SNRFOR, SUBLT2].")
  ...
  **/
  @ApiModelProperty(required = true, value = "The restructuring clause.  Supported string (enumeration) values are: [CR, MR, MM, XR].")
