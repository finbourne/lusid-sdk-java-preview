 ...
 */
@ApiModel(description = "A Cleardown Module definition")
...
public class CleardownModuleResponse {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The Cleardown Module status. Can be Active, Inactive or Deleted. Defaults to Active.")
