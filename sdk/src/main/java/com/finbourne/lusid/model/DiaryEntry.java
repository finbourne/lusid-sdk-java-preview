...
public class DiaryEntry {
  ...
  **/
  @ApiModelProperty(value = "The code of the diary entry.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of the diary entry.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The name of the diary entry.")
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The status of the diary entry. Defaults to 'Undefined'.")
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The effective time of the diary entry.")
  ...
  **/
  @ApiModelProperty(value = "The entry time of the previous diary entry.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Properties to add to the diary entry.")
