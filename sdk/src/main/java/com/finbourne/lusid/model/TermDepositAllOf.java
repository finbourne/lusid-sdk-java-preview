...
public class TermDepositAllOf {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The start date of the instrument. For term deposits this is the start date of the interest calculation period.")
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(required = true, value = "The maturity date of the instrument. For term deposits this is the last date of the interest calculation period.")
  ...
  public TermDepositAllOf contractSize(java.math.BigDecimal contractSize) {
   ...
   * @return contractSize
  **/
  @ApiModelProperty(required = true, value = "The principal amount of the term deposit.")
  ...
  **/
  ...
  public TermDepositAllOf rate(java.math.BigDecimal rate) {
    this.rate = rate; 
    return this;
  }
  ...
  **/
  ...
  public TermDepositAllOf domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
