...
public class ResourceListOfRelationship {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Relationship> values = new ArrayList<>();
  ...
  public ResourceListOfRelationship values(List<Relationship> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfRelationship addValuesItem(Relationship valuesItem) {
  ...
  **/
  ...
  public List<Relationship> getValues() {
    return values;
  }

  public void setValues(List<Relationship> values) {
    this.values = values;
  }


  public ResourceListOfRelationship href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfRelationship links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfRelationship addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public ResourceListOfRelationship nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfRelationship previousPage(String previousPage) {
