...
public class PropertyFilter {
  ...
  public enum RightOperandTypeEnum {
    ...
    public static RightOperandTypeEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<RightOperandTypeEnum> {
      ...
      public RightOperandTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return RightOperandTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("rightOperandType")
  private RightOperandTypeEnum rightOperandType = null;
