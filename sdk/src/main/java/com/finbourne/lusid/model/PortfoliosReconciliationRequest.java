...
public class PortfoliosReconciliationRequest {
   ...
   * @return left
  **/
  @ApiModelProperty(required = true, value = "The specification of the left hand side of the portfolio reconciliation")
   ...
   * @return right
  **/
  @ApiModelProperty(required = true, value = "The specification of the right hand side of the portfolio reconciliation")
