...
public class UpsertSingleStructuredDataResponse {
  ...
  public UpsertSingleStructuredDataResponse href(String href) {
    this.href = href;
    return this;
  }
   ...
   * @return href
  **/
  @ApiModelProperty(value = "reference to data location")
  ...
  public UpsertSingleStructuredDataResponse value(OffsetDateTime value) {
   ...
   /**
   * the time for the successfully inserted value.
   * @return value
  **/
  @ApiModelProperty(value = "the time for the successfully inserted value.")
