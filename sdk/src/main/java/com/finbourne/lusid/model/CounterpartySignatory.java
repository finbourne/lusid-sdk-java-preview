...
public class CounterpartySignatory {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "A user-defined name or label for the counterparty signatory.  There is no requirement for this to match the \"displayName\" of the legal entity.")
