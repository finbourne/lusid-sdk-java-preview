...
public class SideDefinition {
   ...
   * @return side
  **/
  @ApiModelProperty(required = true, value = "A unique label identifying the side definition.")
   ...
   * @return security
  **/
  @ApiModelProperty(required = true, value = "The field or property key defining the side's security, or instrument.")
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The field or property key defining the side's currency.")
   ...
   * @return rate
  **/
  @ApiModelProperty(required = true, value = "The field or property key defining the side's rate.")
   ...
   * @return units
  **/
  @ApiModelProperty(required = true, value = "The value, field or property key defining the side's units.")
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "The value, field or property key defining the side's amount")
  ...
  **/
  @ApiModelProperty(value = "The value, field or property key defining the side's notional amount")
