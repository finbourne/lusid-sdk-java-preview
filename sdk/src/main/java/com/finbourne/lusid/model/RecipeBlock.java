 ...
 */
@ApiModel(description = "An atomic operation used in Recipe composer to compose a Configuration Recipe")
...
public class RecipeBlock {
  ...
  **/
   ...
   * @return path
  **/
  @ApiModelProperty(value = "Path of the Value that the operation is to be performed on.")
   ...
   * @return op
  **/
  @ApiModelProperty(value = "Operation to be performed on the part of the value.")
  public String getOp() {
    return op;
  }
