 ...
 */
@ApiModel(description = "Id of the Translation Script.")
...
public class TranslationScriptId {
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "Scope of the translation script.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Code of the translation script.")
   ...
   * @return version
  **/
  @ApiModelProperty(required = true, value = "Semantic Version of the translation script of the form MAJOR.MINOR.PATCH.")
