...
public class FixedScheduleAllOf {
  ...
  public FixedScheduleAllOf startDate(OffsetDateTime startDate) {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "Date to start generate from")
  ...
  public FixedScheduleAllOf maturityDate(OffsetDateTime maturityDate) {
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(required = true, value = "Date to generate to")
  ...
  public FixedScheduleAllOf flowConventions(FlowConventions flowConventions) {
  ...
  **/
  ...
  public FixedScheduleAllOf couponRate(java.math.BigDecimal couponRate) {
   ...
   * @return couponRate
  **/
  @ApiModelProperty(value = "Coupon rate given as a fraction.")
  ...
  public FixedScheduleAllOf conventionName(FlowConventionName conventionName) {
  ...
  **/
  ...
  public FixedScheduleAllOf exDividendDays(Integer exDividendDays) {
  ...
  **/
  @ApiModelProperty(value = "Optional. Number of calendar days in the ex-dividend period.  If the settlement date falls in the ex-dividend period then the coupon paid is zero and the accrued interest is negative.  If set, this must be a non-negative number.  If not set, or set to 0, then there is no ex-dividend period.                NOTE: This field is deprecated.  If you wish to set the ExDividendDays on a bond, please use the ExDividendConfiguration.")
  ...
  public FixedScheduleAllOf notional(java.math.BigDecimal notional) {
   ...
   * @return notional
  **/
  @ApiModelProperty(value = "Scaling factor, the quantity outstanding on which the rate will be paid.")
  ...
  public FixedScheduleAllOf paymentCurrency(String paymentCurrency) {
  ...
  **/
  @ApiModelProperty(value = "Payment currency. This does not have to be the same as the nominal bond or observation/reset currency.")
  ...
  public FixedScheduleAllOf stubType(String stubType) {
   ...
   * @return stubType
  **/
  @ApiModelProperty(value = "StubType required of the schedule    Supported string (enumeration) values are: [ShortFront, ShortBack, LongBack, LongFront, Both].")
  ...
  public FixedScheduleAllOf exDividendConfiguration(ExDividendConfiguration exDividendConfiguration) {
  ...
  **/
  ...
  public FixedScheduleAllOf scheduleType(ScheduleTypeEnum scheduleType) {
