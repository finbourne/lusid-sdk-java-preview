...
public class PlacementRequest {
  ...
  public static final String SERIALIZED_NAME_PARTICIPATION_IDS = "participationIds";
  @SerializedName(SERIALIZED_NAME_PARTICIPATION_IDS)
  private List<ResourceId> participationIds = new ArrayList<>();
  ...
  **/
  ...
  public PlacementRequest participationIds(List<ResourceId> participationIds) {
    this.participationIds = participationIds;
    return this;
  }

  public PlacementRequest addParticipationIdsItem(ResourceId participationIdsItem) {
    this.participationIds.add(participationIdsItem);
    return this;
  }

   /**
   * IDs of Participations associated with this placement.
   * @return participationIds
  **/
  @ApiModelProperty(required = true, value = "IDs of Participations associated with this placement.")
  public List<ResourceId> getParticipationIds() {
    return participationIds;
  }

  public void setParticipationIds(List<ResourceId> participationIds) {
    this.participationIds = participationIds;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    participationIds: ").append(toIndentedString(participationIds)).append("\n");
