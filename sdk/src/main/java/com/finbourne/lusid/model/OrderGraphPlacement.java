...
public class OrderGraphPlacement {
  ...
  **/
   ...
   * @return orderIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers for all orders in the block - DEPRECATED: see Ordered.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Identifiers for all allocations relating to this placement - DEPRECATED: see Allocated.")
   ...
   * @return executionIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers of all executions against this placement - DEPRECATED: see Executed.")
