 ...
 */
@ApiModel(description = "Item which is stepped in level/quantity.")
...
public class OptionEntry {
   ...
   * @return strike
  **/
  @ApiModelProperty(required = true, value = "The strike on this date")
   ...
   * @return date
  **/
  @ApiModelProperty(required = true, value = "The date at which the option can be actioned at this strike")
