...
public class OrderGraphBlockAllocationSynopsis {
   ...
   * @return quantity
  **/
  @ApiModelProperty(required = true, value = "Total number of units allocated.")
   ...
   * @return details
  **/
  @ApiModelProperty(required = true, value = "Identifiers for each allocation in this block.")
