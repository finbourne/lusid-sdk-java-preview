 ...
 */
@ApiModel(description = "A Cleardown Module rules update response")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class CleardownModuleRulesUpdatedResponse {
  public static final String SERIALIZED_NAME_RULES = "rules";
  @SerializedName(SERIALIZED_NAME_RULES)
  private List<CleardownModuleRule> rules = null;
   ...
   * @return rules
  **/
  @ApiModelProperty(value = "The Cleardown Rules that apply for the Cleardown Module. Rules are evaluated in the order they occur in this collection.")
