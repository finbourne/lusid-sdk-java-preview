...
public class AddressKeyListAllOf {
  ...
  public AddressKeyListAllOf values(List<String> values) {
    this.values = values; 
    return this;
  }

  public AddressKeyListAllOf addValuesItem(String valuesItem) {
  ...
  **/
  ...
  public AddressKeyListAllOf referenceListType(ReferenceListTypeEnum referenceListType) {
