...
public class AggregatedReturnsRequest {
  ...
  **/
   ...
   * @return currency
  **/
  @ApiModelProperty(value = "Optional - either a string or a property. If provided, the results will be converted to the specified currency")
   ...
   * @return runMode
  **/
  @ApiModelProperty(value = "The dates the AggregatedReturns output will be calculated: ReturnData/WeekDays/AllDays/MonthEnd. Defaults to ReturnData.")
