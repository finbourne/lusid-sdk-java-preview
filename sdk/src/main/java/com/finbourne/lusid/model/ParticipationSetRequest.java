 ...
 */
@ApiModel(description = "A request to create or update multiple Participations.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ParticipationSetRequest {
  public static final String SERIALIZED_NAME_REQUESTS = "requests";
  @SerializedName(SERIALIZED_NAME_REQUESTS)
  private List<ParticipationRequest> requests = null;
   ...
   * @return requests
  **/
  @ApiModelProperty(value = "A collection of ParticipationRequests.")
