 ...
 */
@ApiModel(description = "A condition to be evaluated.  Each supported CriterionType has a corresponding schema.")
...
public class MatchCriterion {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: PropertyValueEquals, PropertyValueIn, SubHoldingKeyValueEquals")
