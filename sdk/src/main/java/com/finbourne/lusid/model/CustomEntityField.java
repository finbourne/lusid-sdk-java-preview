...
public class CustomEntityField {
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the field in the custom entity type definition.")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The value for the field.")
  ...
  **/
  @ApiModelProperty(value = "The effective datetime from which the field's value is valid. For timeVariant fields, this defaults to the beginning of time.")
  ...
  **/
  @ApiModelProperty(value = "The effective datetime until which the field's value is valid. If not supplied, the value will be valid indefinitely or until the next “effectiveFrom” date of the field.")
