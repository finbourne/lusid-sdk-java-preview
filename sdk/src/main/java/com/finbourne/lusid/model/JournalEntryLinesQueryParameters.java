...
public class JournalEntryLinesQueryParameters {
  ...
  **/
   ...
   * @return dateMode
  **/
  @ApiModelProperty(value = "The mode of calculation of the journal entry lines. The available values are: ActivityDate.")
  ...
  **/
  @ApiModelProperty(value = "The optional code of a general ledger profile used to decorate journal entry lines with levels.")
   ...
   * @return propertyKeys
  **/
  @ApiModelProperty(value = "A list of property keys from the 'Instrument', 'Transaction', 'Portfolio', 'Account', 'LegalEntity' or 'CustodianAccount' domain to decorate onto the journal entry lines.")
