 ...
 */
@ApiModel(description = "Security election for Events that result in equity")
...
public class SecurityElection {
   ...
   * @return electionKey
  **/
  @ApiModelProperty(required = true, value = "Unique key associated to this election.")
   ...
   * @return isChosen
  **/
  @ApiModelProperty(value = "Is this the election that has been explicitly chosen from multiple options.")
   ...
   * @return isDefault
  **/
  @ApiModelProperty(value = "Is this election automatically applied in the absence of an election having been made.  May only be true for one election if multiple are provided.")
   ...
   * @return price
  **/
  @ApiModelProperty(required = true, value = "Price per unit of the security. At least one of UnitsRatio or Price must be provided.")
