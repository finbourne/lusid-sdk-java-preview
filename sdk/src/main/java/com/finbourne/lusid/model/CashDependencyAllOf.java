...
public class CashDependencyAllOf {
  ...
  public CashDependencyAllOf currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The Currency that is depended upon.")
  ...
  public CashDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public CashDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
