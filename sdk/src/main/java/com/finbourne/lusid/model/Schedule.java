 ...
 */
@ApiModel(description = "Schedule represents a base class for creation of schedules.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class Schedule {
  /**
   * The available values are: Fixed, Float, Optionality, Step, Exercise, Invalid
   */
   ...
   * @return scheduleType
  **/
  @ApiModelProperty(required = true, value = "The available values are: Fixed, Float, Optionality, Step, Exercise, Invalid")
