 ...
 */
@ApiModel(description = "The upsert accounts response")
...
public class CustodianAccountsUpsertResponse {
  ...
  private List<CustodianAccount> custodianAccounts = null;
  ...
  **/
  @ApiModelProperty(value = "The Custodian Accounts which have been upserted.")
