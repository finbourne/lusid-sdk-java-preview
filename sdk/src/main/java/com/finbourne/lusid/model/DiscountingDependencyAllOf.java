...
public class DiscountingDependencyAllOf {
  ...
  public DiscountingDependencyAllOf currency(String currency) {
  ...
  **/
  ...
  public DiscountingDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public DiscountingDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
