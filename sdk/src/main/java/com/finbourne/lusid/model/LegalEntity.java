...
public class LegalEntity {
  ...
  **/
  ...
  public LegalEntity lusidLegalEntityId(String lusidLegalEntityId) {
   ...
   /**
   * The unique LUSID Legal Entity Identifier (LULEID) of the Legal Entity.
   * @return lusidLegalEntityId
  **/
  @ApiModelProperty(value = "The unique LUSID Legal Entity Identifier (LULEID) of the Legal Entity.")
