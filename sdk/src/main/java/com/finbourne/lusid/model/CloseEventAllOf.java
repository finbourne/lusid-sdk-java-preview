...
public class CloseEventAllOf {
  ...
  public CloseEventAllOf anchorDate(OffsetDateTime anchorDate) {
   ...
   * @return anchorDate
  **/
  @ApiModelProperty(value = "The date on which the instrument closes/matures")
  ...
  public CloseEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
