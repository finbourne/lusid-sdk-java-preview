...
public class InflationLegAllOf {
  ...
  public InflationLegAllOf startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public InflationLegAllOf maturityDate(OffsetDateTime maturityDate) {
  ...
  **/
  ...
  public InflationLegAllOf flowConventions(FlowConventions flowConventions) {
  ...
  **/
  ...
  public InflationLegAllOf baseCPI(java.math.BigDecimal baseCPI) {
   ...
   * @return baseCPI
  **/
  @ApiModelProperty(value = "Optional BaseCPI, if specified it will be used in place of BaseCPI(StartDate).  This should not be required for standard inflation swaps.")
  ...
  public InflationLegAllOf calculationType(String calculationType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The calculation type.  ZeroCoupon is used for CPILegs where there is a single payment at maturity of  Notional * (CPI(T) / CPI(T0) - 1)  where CPI(T0) is the BaseCPI of this leg  YearOnYear is used for YoY and LPI swap legs where there is a series of annual payments  Notional * dayCount * (CPI(t) / CPI(t-1) - 1)  If a cap and floor is added to this it becomes an LPI swap leg.  Compounded is used for inflation swap legs where there is a series of annual payments  Notional * dayCount * (CPI(t) / CPI(T0) - 1)  i.e. the BaseCPI is used every year. These swaps are not as common as CPI or    Supported string (enumeration) values are: [ZeroCoupon, YearOnYear, Compounded].")
  ...
  public InflationLegAllOf capRate(java.math.BigDecimal capRate) {
   ...
   * @return capRate
  **/
  @ApiModelProperty(value = "Optional cap, needed for LPI Legs or CPI Legs with Caps")
  ...
  public InflationLegAllOf floorRate(java.math.BigDecimal floorRate) {
   ...
   * @return floorRate
  **/
  @ApiModelProperty(value = "Optional floor, needed for LPI Legs or CPI Legs with Floors.")
  ...
  public InflationLegAllOf inflationIndexConventions(InflationIndexConventions inflationIndexConventions) {
  ...
  **/
  ...
  public InflationLegAllOf notional(java.math.BigDecimal notional) {
  ...
  **/
  ...
  public InflationLegAllOf payReceive(String payReceive) {
   ...
   * @return payReceive
  **/
  @ApiModelProperty(value = "PayReceive flag for the inflation leg.  This field is optional and defaults to Pay.    Supported string (enumeration) values are: [Pay, Receive].")
  ...
  public InflationLegAllOf instrumentType(InstrumentTypeEnum instrumentType) {
