 ...
 */
@ApiModel(description = "Lusid-ibor internal representation of a Forward Rate Agreement")
...
public class ForwardRateAgreement extends LusidInstrument {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The settlement date of the FRA")
