...
public class Results {
  ...
  /**
   * The available values are: DataReader, Portfolio, Csv, Unknown
   */
  ...
  **/
   ...
   * @return format
  **/
  @ApiModelProperty(value = "The available values are: DataReader, Portfolio, Csv, Unknown")
