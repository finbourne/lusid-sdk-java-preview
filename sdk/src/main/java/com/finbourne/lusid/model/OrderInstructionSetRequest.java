 ...
 */
@ApiModel(description = "A request to create or update multiple OrderInstructions.")

public class OrderInstructionSetRequest {
  public static final String SERIALIZED_NAME_REQUESTS = "requests";
  @SerializedName(SERIALIZED_NAME_REQUESTS)
  private List<OrderInstructionRequest> requests = new ArrayList<>();
   ...
   * @return requests
  **/
  @ApiModelProperty(value = "A collection of OrderInstructionRequests.")
