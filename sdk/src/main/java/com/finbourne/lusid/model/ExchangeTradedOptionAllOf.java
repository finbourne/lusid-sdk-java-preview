...
public class ExchangeTradedOptionAllOf {
  ...
  public ExchangeTradedOptionAllOf startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public ExchangeTradedOptionAllOf contractDetails(ExchangeTradedOptionContractDetails contractDetails) {
  ...
  **/
  ...
  public ExchangeTradedOptionAllOf instrumentType(InstrumentTypeEnum instrumentType) {
