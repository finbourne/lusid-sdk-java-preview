 ...
 */
@ApiModel(description = "Virtual document consists of (potentially several) upserted documents.                The documents get parsed according to the provided data map on upsert, the collection of resulting values in  aggregated in a virtual document")
...
public class VirtualDocument {
  ...
  private List<VirtualDocumentRow> data = null;
  ...
  **/
   ...
   * @return data
  **/
  @ApiModelProperty(value = "The data inside the document")
