 ...
 */
@ApiModel(description = "An individual row containing details of a single cashflow in the diary.")
...
public class InstrumentPaymentDiaryRow {
  ...
  **/
   ...
   * @return currency
  **/
  @ApiModelProperty(value = "The payment currency of the cash flow.")
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(value = "The date at which the given cash flow is due to be paid.")
   ...
   * @return payOrReceive
  **/
  @ApiModelProperty(value = "Does the cash flow belong to the Pay or Receive leg.")
   ...
   * @return accrualStart
  **/
  @ApiModelProperty(value = "The date on which accruals start for this cashflow.")
   ...
   * @return accrualEnd
  **/
  @ApiModelProperty(value = "The date on which accruals end for this cashflow.")
   ...
   * @return cashFlowType
  **/
  @ApiModelProperty(value = "The type of cashflow.")
  ...
  **/
  @ApiModelProperty(value = "Is the cashflow determined as of the effective date time.")
  ...
  **/
  @ApiModelProperty(value = "Has the cashflow been paid, i.e. has it become a historic cashflow, as of the date and time pointed to be effectiveAt.")
  ...
  **/
  @ApiModelProperty(value = "Weighting factor to discount cashflow to the present value.")
  ...
  **/
  @ApiModelProperty(value = "The expected cashflow amount taking into account the discount factor.")
  ...
  **/
  @ApiModelProperty(value = "The day count fraction, if appropriate.")
   ...
   * @return forwardRate
  **/
  @ApiModelProperty(value = "Forward rate for cash flow if appropriate. (as in for a rates fixed or floating leg)")
   ...
   * @return resetRate
  **/
  @ApiModelProperty(value = "The value of the reset, if any.")
   ...
   * @return spread
  **/
  @ApiModelProperty(value = "The spread that exists on the payoff.")
