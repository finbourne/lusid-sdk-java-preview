...
public class ResourceListOfSideDefinition {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<SideDefinition> values = new ArrayList<>();
  ...
  public ResourceListOfSideDefinition values(List<SideDefinition> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfSideDefinition addValuesItem(SideDefinition valuesItem) {
  ...
  **/
  ...
  public List<SideDefinition> getValues() {
    return values;
  }

  public void setValues(List<SideDefinition> values) {
    this.values = values;
  }


  public ResourceListOfSideDefinition href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfSideDefinition links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfSideDefinition addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public ResourceListOfSideDefinition nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfSideDefinition previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfSideDefinition {\n");
