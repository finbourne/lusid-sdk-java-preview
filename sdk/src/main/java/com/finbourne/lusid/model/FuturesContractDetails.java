...
public class FuturesContractDetails {
  ...
  **/
   ...
   * @return fgnCcy
  **/
  @ApiModelProperty(value = "Currency of the underlying, for use with FX Futures")
   ...
   * @return assetClass
  **/
  @ApiModelProperty(value = "The asset class of the underlying. Optional and will default to Unknown if not set.    Supported string (enumeration) values are: [InterestRates, FX, Inflation, Equities, Credit, Commodities, Money].")
   ...
   * @return contractCode
  **/
  @ApiModelProperty(required = true, value = "The contract code used by the exchange, e.g. “CL” for Crude Oil, “ES” for E-mini SP 500, “FGBL” for Bund Futures, etc.")
  ...
  **/
   ...
   * @return contractSize
  **/
  @ApiModelProperty(required = true, value = "Size of a single contract.")
   ...
   * @return convention
  **/
  @ApiModelProperty(value = "If appropriate, the day count convention method used in pricing (rates futures).  For more information on day counts, see [knowledge base article KA-01798](https://support.lusid.com/knowledgebase/article/KA-01798)                Supported string (enumeration) values are: [Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActualActual, ActAct, ActActIsda, ActActIsma, ActActIcma, OneOne, Act364, Act365F, Act365L, Act365_25, Act252, Bus252, NL360, NL365, ActActAFB, Act365Cad, ThirtyActIsda, Thirty365Isda, ThirtyEActIsda, ThirtyE360Isda, ThirtyE365Isda, ThirtyU360EOM].")
   ...
   * @return country
  **/
  @ApiModelProperty(value = "Country (code) for the exchange.")
  ...
  **/
   ...
   * @return exchangeCode
  **/
  @ApiModelProperty(required = true, value = "Exchange code for contract. This can be any string to uniquely identify the exchange (e.g. Exchange Name, MIC, BBG code).")
   ...
   * @return exchangeName
  **/
  @ApiModelProperty(value = "Exchange name (for when code is not automatically recognised).")
   ...
   * @return tickerStep
  **/
  @ApiModelProperty(value = "Minimal step size change in ticker.")
   ...
   * @return unitValue
  **/
  @ApiModelProperty(value = "The value in the currency of a 1 unit change in the contract price.")
   ...
   * @return calendars
  **/
  @ApiModelProperty(value = "Holiday calendars that apply to yield-to-price conversions (i.e. for BRL futures).")
