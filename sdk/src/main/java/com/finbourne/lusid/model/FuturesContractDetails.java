...
public class FuturesContractDetails {
   ...
   */
  @JsonAdapter(ConventionEnum.Adapter.class)
  public enum ConventionEnum {
    ...
    public static class Adapter extends TypeAdapter<ConventionEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final ConventionEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public ConventionEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return ConventionEnum.fromValue(value);
      }
    }
  }
  ...
  **/
  @ApiModelProperty(required = true, value = "which month does the contract trade for.")
  ...
  **/
  ...
  public FuturesContractDetails convention(ConventionEnum convention) {
   ...
   * @return convention
  **/
  @ApiModelProperty(required = true, value = "The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, ActActIsma, ActActIcma, Invalid")
  ...
  **/
   ...
   * @return exchangeCode
  **/
  @ApiModelProperty(required = true, value = "Exchange code for contract")
