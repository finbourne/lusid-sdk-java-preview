...
public class FuturesContractDetails {
  ...
  **/
   ...
   * @return exchangeCode
  **/
  @ApiModelProperty(required = true, value = "Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX, LME].")
