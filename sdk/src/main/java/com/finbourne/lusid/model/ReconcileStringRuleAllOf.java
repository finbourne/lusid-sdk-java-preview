...
public class ReconcileStringRuleAllOf {
  /**
  ...
  private Map<String, List<String>> oneOfCandidates = null;
  ...
  public ReconcileStringRuleAllOf comparisonType(ComparisonTypeEnum comparisonType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Exact, Contains, CaseInsensitive, ContainsAnyCase, IsOneOf")
  ...
  public ReconcileStringRuleAllOf oneOfCandidates(Map<String, List<String>> oneOfCandidates) {
    this.oneOfCandidates = oneOfCandidates; 
    return this;
  }

  public ReconcileStringRuleAllOf putOneOfCandidatesItem(String key, List<String> oneOfCandidatesItem) {
  ...
  **/
  @ApiModelProperty(value = "For cases of \"IsOneOf\" a set is required to match values against.  Fuzzy matching of strings against one of a set. There can be cases where systems \"A\" and \"B\" might use different terms for the same logical entity. A common case would be  comparison of something like a day count fraction where some convention like the \"actual 365\" convention might be represented as one of [\"A365\", \"Act365\", \"Actual365\"] or similar.  This is to allow this kind of fuzzy matching of values. Note that as this is exhaustive comparison across sets it will be slow and should therefore be used sparingly.")
  ...
  public ReconcileStringRuleAllOf appliesTo(AggregateSpec appliesTo) {
  ...
  **/
  ...
  public ReconcileStringRuleAllOf ruleType(RuleTypeEnum ruleType) {
   ...
   * @return ruleType
  **/
  @ApiModelProperty(required = true, value = "The available values are: ReconcileNumericRule, ReconcileDateTimeRule, ReconcileStringRule, ReconcileExact")
