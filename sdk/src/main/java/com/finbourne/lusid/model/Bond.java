 ...
 */
@ApiModel(description = "LUSID representation of a Vanilla Fixed Rate Bond.")
...
public class Bond extends LusidInstrument {
  ...
  **/
  @ApiModelProperty(value = "Optional and to be DEPRECATED. If set, this is the date at which the bond begins to accrue interest. Instead, this information should be entered in the field StartDate.")
  ...
  **/
  @ApiModelProperty(value = "The price the bond was issued at. This is to be entered as a percentage of par, for example a value of 98.5 would represent 98.5%.")
