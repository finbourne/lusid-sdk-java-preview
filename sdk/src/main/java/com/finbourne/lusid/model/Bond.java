...
import com.finbourne.lusid.model.BondAllOf;
...
public class Bond extends LusidInstrument {
  ...
  **/
  @ApiModelProperty(value = "The number of days before the next coupon payment for which the bond goes ex-dividend.")
  ...
  **/
  @ApiModelProperty(value = "The initial coupon date which specifies the accrual start period for a fixed coupon bond with ex dividend schedule")
  ...
  **/
  @ApiModelProperty(value = "The calculation type applied to the bond coupon amount. This is required for bonds that have a particular type of computing the period coupon, such as simple compounding,  irregular coupons etc.  Supported string (enumeration) values are: [Standard, NoCalculationFloater, BrazilFixedCoupon].")
