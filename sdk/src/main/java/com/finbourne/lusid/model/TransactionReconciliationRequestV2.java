 ...
 */
@ApiModel(description = "Specification for the reconciliation request. Left and Right hand sides are constructed. Each consists of transactions from a portfolio  The results of this can then be compared to each other.")
...
public class TransactionReconciliationRequestV2 {
  ...
  private List<ReconciliationRule> comparisonRules = null;
  ...
  **/
   ...
   * @return preserveKeys
  **/
  @ApiModelProperty(value = "List of keys to preserve (from rhs) in the diff. Used in conjunction with filtering/grouping.  If two values are equal, for a given key then the value is elided from the results. Setting it here  will preserve it (takes the values from the RHS and puts it into the line by line results).")
