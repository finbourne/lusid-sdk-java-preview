...
public class ResetEventAllOf {
  ...
  /**
   * The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, RawVendorEvent, InformationalErrorEvent
   */
  ...
  public ResetEventAllOf value(java.math.BigDecimal value) {
    this.value = value; 
    return this;
  }
  ...
  **/
  ...
  public ResetEventAllOf resetType(String resetType) {
  ...
  **/
  ...
  public ResetEventAllOf fixingSource(String fixingSource) {
  ...
  **/
  ...
  public ResetEventAllOf eventStatus(String eventStatus) {
  ...
  **/
  ...
  public ResetEventAllOf fixingDate(OffsetDateTime fixingDate) {
  ...
  **/
  ...
  public ResetEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The Type of Event. The available values are: TransitionEvent, InformationalEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent, AmortisationEvent, CashFlowEvent, ExerciseEvent, ResetEvent, RawVendorEvent, InformationalErrorEvent")
