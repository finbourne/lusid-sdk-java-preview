 ...
 */
@ApiModel(description = "A leg containing a set of cashflows.")
...
public class InstrumentPaymentDiaryLeg {
  ...
  private List<InstrumentPaymentDiaryRow> rows = null;
   ...
   * @return legIndex
  **/
  @ApiModelProperty(value = "Index (integer) for the leg of a payment diary.")
   ...
   * @return legId
  **/
  @ApiModelProperty(value = "Identifier string for the leg of a payment diary.")
   ...
   * @return rows
  **/
  @ApiModelProperty(value = "List of individual cashflows within the payment diary.")
