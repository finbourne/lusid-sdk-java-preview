...
public class SequenceDefinition {
  ...
  **/
   ...
   * @return increment
  **/
  @ApiModelProperty(required = true, value = "The Resource Id of the sequence definition")
   ...
   * @return minValue
  **/
  @ApiModelProperty(required = true, value = "The minimum value of the sequence")
   ...
   * @return maxValue
  **/
  @ApiModelProperty(required = true, value = "The maximum value of the sequence")
   ...
   * @return start
  **/
  @ApiModelProperty(required = true, value = "The start value of the sequence")
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The last used value of the sequence")
   ...
   * @return cycle
  **/
  @ApiModelProperty(required = true, value = "Indicates if the sequence would start from minimun value once it reaches maximum value. If set to false, a failure would return if the sequence reaches maximum value.")
   ...
   * @return pattern
  **/
  @ApiModelProperty(required = true, value = "The pattern to be used to generate next values in the sequence.")
