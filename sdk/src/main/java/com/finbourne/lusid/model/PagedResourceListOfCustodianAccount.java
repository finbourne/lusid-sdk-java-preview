...
public class PagedResourceListOfCustodianAccount {
  ...
  private List<CustodianAccount> values = new ArrayList<>();
  ...
  public PagedResourceListOfCustodianAccount nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfCustodianAccount previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfCustodianAccount values(List<CustodianAccount> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfCustodianAccount addValuesItem(CustodianAccount valuesItem) {
  ...
  **/
  ...
  public List<CustodianAccount> getValues() {
    return values;
  }

  public void setValues(List<CustodianAccount> values) {
    this.values = values;
  }


  public PagedResourceListOfCustodianAccount href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfCustodianAccount links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfCustodianAccount addLinksItem(Link linksItem) {
