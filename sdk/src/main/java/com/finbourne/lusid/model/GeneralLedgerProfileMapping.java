...
public class GeneralLedgerProfileMapping {
  ...
  **/
  @ApiModelProperty(required = true, value = "The filter syntax for the Mapping filter. See https://support.lusid.com/knowledgebase/article/KA-02140 for more information on filter syntax")
   ...
   * @return levels
  **/
  @ApiModelProperty(required = true, value = "References fields and properties on the associated Journal Entry Line and graph of associated objects.")
