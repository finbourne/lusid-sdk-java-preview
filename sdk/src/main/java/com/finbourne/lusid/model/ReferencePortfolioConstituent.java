...
public class ReferencePortfolioConstituent {
  ...
  **/
  ...
  public ReferencePortfolioConstituent instrumentUid(String instrumentUid) {
   ...
   /**
   * Internal Identifier for this constituent
   * @return instrumentUid
  **/
  @ApiModelProperty(required = true, value = "Internal Identifier for this constituent")
  ...
  **/
  ...
  public ReferencePortfolioConstituent weight(Double weight) {
   ...
   /**
   * Original/Static weight assigned to the constituent
   * @return weight
  **/
  @ApiModelProperty(required = true, value = "Original/Static weight assigned to the constituent")
  ...
  **/
  @ApiModelProperty(value = "Floating weight")
