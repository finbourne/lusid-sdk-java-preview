 ...
 */
@ApiModel(description = "An individual mapping rule, for mapping between a left and right field/property.")
...
public class MappingRule {
  ...
  private List<MappedString> mappedStrings = null;
   ...
   * @return left
  **/
  @ApiModelProperty(value = "The name of the field/property in the left resource (e.g. a transaction)")
   ...
   * @return right
  **/
  @ApiModelProperty(value = "The name of the field/property in the right resource (e.g. a transaction)")
  ...
  **/
  @ApiModelProperty(value = "The type of comparison to be performed")
  ...
  **/
  @ApiModelProperty(value = "The (optional) value used with Finbourne.WebApi.Interface.Dto.Mappings.MappingRule.ComparisonType")
   ...
   * @return weight
  **/
  @ApiModelProperty(value = "A factor used to influence the importance of this item.")
  ...
  **/
  @ApiModelProperty(value = "The (optional) value used to map string values.")
  ...
  **/
  @ApiModelProperty(value = "Should string comparisons take case into account, defaults to `false`.")
