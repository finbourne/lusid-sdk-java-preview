...
import com.finbourne.lusid.model.ConstantVolatilitySurfaceAllOf;
 ...
 */
@ApiModel(description = "Market Data required to build a volatility surface for pricing.  Single constant volatility point.")
