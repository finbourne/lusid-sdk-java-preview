...
public class DividendReinvestmentEventAllOf {
  ...
  public DividendReinvestmentEventAllOf announcementDate(OffsetDateTime announcementDate) {
  ...
  **/
  @ApiModelProperty(value = "Date on which the dividend was announced / declared.")
  ...
  public DividendReinvestmentEventAllOf cashElections(List<CashElection> cashElections) {
    this.cashElections = cashElections; 
    return this;
  }

  public DividendReinvestmentEventAllOf addCashElectionsItem(CashElection cashElectionsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "CashElection for this DividendReinvestmentEvent")
  ...
  public DividendReinvestmentEventAllOf exDate(OffsetDateTime exDate) {
    this.exDate = exDate; 
    return this;
  }
   ...
   * @return exDate
  **/
  @ApiModelProperty(required = true, value = "The first business day on which the dividend is not owed to the buying party.  Typically this is T-1 from the RecordDate.")
  ...
  public DividendReinvestmentEventAllOf paymentDate(OffsetDateTime paymentDate) {
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The date the company pays out dividends to shareholders.")
  ...
  public DividendReinvestmentEventAllOf recordDate(OffsetDateTime recordDate) {
   ...
   * @return recordDate
  **/
  @ApiModelProperty(required = true, value = "Date you have to be the holder of record in order to participate in the tender.")
  ...
  public DividendReinvestmentEventAllOf securityElections(List<SecurityElection> securityElections) {
    this.securityElections = securityElections; 
    return this;
  }

  public DividendReinvestmentEventAllOf addSecurityElectionsItem(SecurityElection securityElectionsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "SecurityElection for this DividendReinvestmentEvent")
  ...
  public DividendReinvestmentEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
