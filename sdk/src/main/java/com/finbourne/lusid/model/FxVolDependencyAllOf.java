...
public class FxVolDependencyAllOf {
  ...
  public FxVolDependencyAllOf domesticCurrency(String domesticCurrency) {
  ...
  **/
  ...
  public FxVolDependencyAllOf foreignCurrency(String foreignCurrency) {
  ...
  **/
  ...
  public FxVolDependencyAllOf volType(String volType) {
  ...
  **/
  ...
  public FxVolDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public FxVolDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
