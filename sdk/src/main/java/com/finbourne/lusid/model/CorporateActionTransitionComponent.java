 ...
 */
@ApiModel(description = "A single transition component, when grouped with other components a corporate action transition is formed.")
...
public class CorporateActionTransitionComponent {
  ...
  **/
  @ApiModelProperty(required = true, value = "The scope in which the instrument lies.")
