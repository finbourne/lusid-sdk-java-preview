...
public class ExchangeTradedOptionContractDetails {
  ...
  **/
   ...
   * @return deliveryType
  **/
  @ApiModelProperty(required = true, value = "The delivery type, cash or physical. An option on a future is physically settled if upon exerciseing the  holder receives a future.  Supported string (enumeration) values are: [Cash, Physical].")
  ...
  **/
   ...
   * @return exchangeCode
  **/
  @ApiModelProperty(required = true, value = "Exchange code for contract  Supported string (enumeration) values are: [ASX, CBOT, CBF, CME, CMX, EOP, HKG, KFE, MFM, OSE, SGX, NYBOT, KCBT, MGE, MATIF, SFE, NYFE, NYM, LIFFE, EUREX, ICE, MSE, NASDAQ, EEX].")
  ...
  **/
   ...
   * @return exerciseType
  **/
  @ApiModelProperty(required = true, value = "The exercise type, European, American or Bermudan  Supported string (enumeration) values are: [None, European, Bermudan, American].")
  ...
  **/
   ...
   * @return optionType
  **/
  @ApiModelProperty(required = true, value = "The option type, Call or Put.  Supported string (enumeration) values are: [None, Call, Put].")
