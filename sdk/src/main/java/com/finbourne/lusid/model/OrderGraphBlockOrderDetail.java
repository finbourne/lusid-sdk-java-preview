...
public class OrderGraphBlockOrderDetail {
  ...
  **/
  @ApiModelProperty(required = true, value = "The compliance state of this order. Possible values are 'Pending', 'Failed', 'Manually approved' and 'Passed'.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The approval state of this order. Possible values are 'Pending', 'Rejected' and 'Approved'.")
  ...
  **/
  @ApiModelProperty(value = "The name of the order's referenced Portfolio.")
