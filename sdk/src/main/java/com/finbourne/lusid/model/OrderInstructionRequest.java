 ...
 */
@ApiModel(description = "A request to create or update a Order Instruction.")
...
public class OrderInstructionRequest {
  ...
  **/
   ...
   * @return createdDate
  **/
  @ApiModelProperty(required = true, value = "The active date of this order instruction.")
  ...
  **/
  @ApiModelProperty(value = "The instrument ordered.")
   ...
   * @return quantity
  **/
  @ApiModelProperty(value = "The quantity of given instrument ordered.")
   ...
   * @return weight
  **/
  @ApiModelProperty(value = "The weight of given instrument ordered.")
