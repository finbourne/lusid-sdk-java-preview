...
public class PagedResourceListOfTranslationScriptId {
  ...
  private List<TranslationScriptId> values = new ArrayList<>();
  ...
  public PagedResourceListOfTranslationScriptId nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfTranslationScriptId previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfTranslationScriptId values(List<TranslationScriptId> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfTranslationScriptId addValuesItem(TranslationScriptId valuesItem) {
  ...
  **/
  ...
  public List<TranslationScriptId> getValues() {
    return values;
  }

  public void setValues(List<TranslationScriptId> values) {
    this.values = values;
  }


  public PagedResourceListOfTranslationScriptId href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfTranslationScriptId links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfTranslationScriptId addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfTranslationScriptId {\n");
