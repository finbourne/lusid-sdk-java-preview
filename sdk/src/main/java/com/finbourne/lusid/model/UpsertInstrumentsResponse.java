...
public class UpsertInstrumentsResponse {
  ...
  **/
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The instruments which have been successfully updated or created.")
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The instruments that could not be updated or created or were left unchanged without error along with a reason for their failure.")
   ...
   * @return metadata
  **/
  @ApiModelProperty(value = "Meta data associated with the upsert event.")
