...
public class FloatingLegAllOf {
  ...
  **/
  ...
  public FloatingLegAllOf notional(java.math.BigDecimal notional) {
  ...
  **/
  ...
  public FloatingLegAllOf capRate(java.math.BigDecimal capRate) {
   ...
   * @return capRate
  **/
  @ApiModelProperty(value = "The maximum floating rate which a cashflow can accrue.")
  ...
  public FloatingLegAllOf floorRate(java.math.BigDecimal floorRate) {
   ...
   * @return floorRate
  **/
  @ApiModelProperty(value = "The minimum floating rate which a cashflow can accrue.")
