...
import com.finbourne.lusid.model.FxForwardPipsCurveDataAllOf;
 ...
 */
@ApiModel(description = "Contains data (i.e. dates and pips + metadata) for building fx forward curves (when combined with a spot rate to build on)")
...
public class FxForwardPipsCurveData extends ComplexMarketData {
  ...
  **/
  ...
  public FxForwardPipsCurveData pipRates(List<Double> pipRates) {
    this.pipRates = pipRates; 
    return this;
  }

  public FxForwardPipsCurveData addPipRatesItem(Double pipRatesItem) {
