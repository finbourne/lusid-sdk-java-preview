...
import com.finbourne.lusid.model.IndustryClassificationScheme;
 ...
 */
@ApiModel(description = "The information that describes a counterparty to a transaction (or trade). This information allows one to identify the unique legal entity with whom a transaction  takes place along with key information that would link it to any Credit Support Annex or related information that allows trades to be netted together for  the purposes of determining such calculations as Credit-Valuation-Adjustments, Debit-Valuation-Adjustments (CVA, DVA, XVA etc.). It would also help in the identification  of appropriate credit curves for the purposes of such calculations and any other relevant legal document, trade coverage, contacts and similar information.")
...
public class Counterparty {
  ...
  public static final String SERIALIZED_NAME_ISSUER_RATINGS = "issuerRatings";
  @SerializedName(SERIALIZED_NAME_ISSUER_RATINGS)
  private List<CreditRating> issuerRatings = new ArrayList<>();

  public static final String SERIALIZED_NAME_INDUSTRY_SCHEME = "industryScheme";
  @SerializedName(SERIALIZED_NAME_INDUSTRY_SCHEME)
  private IndustryClassificationScheme industryScheme = null;
  ...
  public Counterparty counterpartyId(String counterpartyId) {
  ...
  **/
  @ApiModelProperty(required = true, value = "A unique identifier that determines the identity of the counter-party, disambiguating between related legal entities, particularly necessary in the case of multi-nationals.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The legal name of the entity to which this counterparty refers.")
  ...
  public Counterparty countryOfRisk(String countryOfRisk) {
  ...
  **/
  @ApiModelProperty(required = true, value = "To which country would one naturally ascribe risk. Typically this will be synonymous with legal registration entity.  This can be used to infer funding currency and related market data in the absence of specific overrides or preference.")
  ...
  public Counterparty issuerRatings(List<CreditRating> issuerRatings) {
    this.issuerRatings = issuerRatings;
    return this;
  }

  public Counterparty addIssuerRatingsItem(CreditRating issuerRatingsItem) {
    this.issuerRatings.add(issuerRatingsItem);
    return this;
  }
  ...
  **/
  @ApiModelProperty(required = true, value = "A set of credit ratings for the counterparty fro, e.g. Standard and Poor or Moody's.")
  public List<CreditRating> getIssuerRatings() {
    return issuerRatings;
  }

  public void setIssuerRatings(List<CreditRating> issuerRatings) {
    this.issuerRatings = issuerRatings;
  }

  public Counterparty industryScheme(IndustryClassificationScheme industryScheme) {
   ...
   /**
   * Get industryScheme
   * @return industryScheme
  **/
  @ApiModelProperty(required = true, value = "")
  public IndustryClassificationScheme getIndustryScheme() {
    return industryScheme;
  }

  public void setIndustryScheme(IndustryClassificationScheme industryScheme) {
    this.industryScheme = industryScheme;
  }

  public Counterparty scope(String scope) {
    this.scope = scope;
    return this;
  }
  ...
  **/
  ...
  public Counterparty code(String code) {
    this.code = code;
    return this;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    issuerRatings: ").append(toIndentedString(issuerRatings)).append("\n");
    sb.append("    industryScheme: ").append(toIndentedString(industryScheme)).append("\n");
