...
public class AnnulStructuredDataResponse {
  ...
  **/
  ...
  public AnnulStructuredDataResponse putFailedItem(String key, ErrorDetail failedItem) {
   ...
   /**
   * The set of values where removal failed, with a description as to why that is the case.
   * @return failed
  **/
  @ApiModelProperty(value = "The set of values where removal failed, with a description as to why that is the case.")
