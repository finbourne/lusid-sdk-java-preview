...
public class EquityCurveDependencyAllOf {
  ...
  public EquityCurveDependencyAllOf marketIdentifier(String marketIdentifier) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Type of the code identifying the corresponding equity, e.g. ISIN or CUSIP")
  ...
  public EquityCurveDependencyAllOf code(String code) {
    this.code = code; 
    return this;
  }
  ...
  **/
  ...
  public EquityCurveDependencyAllOf curveType(String curveType) {
   ...
   * @return curveType
  **/
  @ApiModelProperty(required = true, value = "The curve type of the EquityCurve required. E.g. EquityCurveByPrices")
  ...
  public EquityCurveDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public EquityCurveDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
