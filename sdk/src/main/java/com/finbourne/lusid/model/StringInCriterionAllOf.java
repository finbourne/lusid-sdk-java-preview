...
public class StringInCriterionAllOf {
  ...
  public StringInCriterionAllOf key(String key) {
    this.key = key; 
    return this;
  }
  ...
  **/
  ...
  public StringInCriterionAllOf value(List<String> value) {
    this.value = value; 
    return this;
  }

  public StringInCriterionAllOf addValueItem(String valueItem) {
  ...
  **/
  ...
  public StringInCriterionAllOf op(OpEnum op) {
    this.op = op; 
    return this;
  }
   ...
   * @return op
  **/
  @ApiModelProperty(required = true, value = "The available values are: Equals, In")
  public OpEnum getOp() {
    return op;
  }
  ...
  public String toString() {
    ...
    sb.append("class StringInCriterionAllOf {\n");
