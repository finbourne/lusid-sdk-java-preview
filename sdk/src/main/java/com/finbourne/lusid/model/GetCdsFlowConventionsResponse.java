...
public class GetCdsFlowConventionsResponse {
  ...
  **/
  ...
  public GetCdsFlowConventionsResponse putFailedItem(String key, ErrorDetail failedItem) {
   ...
   /**
   * The identifiers which did not resolve to a conventions along with the nature of the failure.
   * @return failed
  **/
  @ApiModelProperty(value = "The identifiers which did not resolve to a conventions along with the nature of the failure.")
