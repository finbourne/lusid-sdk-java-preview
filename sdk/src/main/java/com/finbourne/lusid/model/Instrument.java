...
public class Instrument {
  ...
  **/
   ...
   * @return state
  **/
  @ApiModelProperty(required = true, value = "The state of of the instrument at the asAt datetime of this version of the instrument definition. The available values are: Active, Inactive, Deleted")
   ...
   * @return assetClass
  **/
  @ApiModelProperty(value = "The nominal asset class of the instrument, e.g. InterestRates, FX, Inflation, Equities, Credit, Commodities, etc. The available values are: InterestRates, FX, Inflation, Equities, Credit, Commodities, Money, Unknown")
   ...
   * @return domCcy
  **/
  @ApiModelProperty(value = "The domestic currency, meaning the currency in which the instrument would typically be expected to pay cashflows, e.g. a share in AAPL being USD.")
  ...
  **/
  @ApiModelProperty(value = "A set of relationships associated to the instrument.")
