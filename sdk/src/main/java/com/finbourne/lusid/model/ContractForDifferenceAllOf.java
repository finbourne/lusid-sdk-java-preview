...
public class ContractForDifferenceAllOf {
  ...
  **/
  ...
  public ContractForDifferenceAllOf referenceRate(Double referenceRate) {
   ...
   /**
   * The reference rate of the CFD, this can be set to 0 but not negative values.
   * @return referenceRate
  **/
  @ApiModelProperty(required = true, value = "The reference rate of the CFD, this can be set to 0 but not negative values.")
  ...
  **/
  @ApiModelProperty(required = true, value = "external market codes and identifiers for the CFD, e.g. RIC.  Supported string (enumeration) values are: [LusidInstrumentId, Isin, Sedol, Cusip, ClientInternal, Figi, RIC, QuotePermId].")
