...
public class ContractForDifferenceAllOf {
  ...
  **/
  ...
  public ContractForDifferenceAllOf referenceDate(OffsetDateTime referenceDate) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The reference date of the CFD.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The reference rate of the CFD.")
