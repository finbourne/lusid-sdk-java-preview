...
public class DeleteRelationRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The identifier of the source entity of the relation to be deleted.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The identifier of the target entity of the relation to be deleted.")
