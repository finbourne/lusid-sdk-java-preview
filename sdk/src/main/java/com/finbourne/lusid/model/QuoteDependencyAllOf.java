...
public class QuoteDependencyAllOf {
  ...
  public QuoteDependencyAllOf marketIdentifier(String marketIdentifier) {
  ...
  **/
  ...
  public QuoteDependencyAllOf code(String code) {
    this.code = code; 
    return this;
  }
  ...
  **/
  ...
  public QuoteDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public QuoteDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
