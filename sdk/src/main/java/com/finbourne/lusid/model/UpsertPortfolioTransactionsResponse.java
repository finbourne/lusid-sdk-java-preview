...
public class UpsertPortfolioTransactionsResponse {
  ...
  **/
  ...
  public UpsertPortfolioTransactionsResponse metadata(Map<String, List<ResponseMetaData>> metadata) {
    this.metadata = metadata; 
    return this;
  }

  public UpsertPortfolioTransactionsResponse putMetadataItem(String key, List<ResponseMetaData> metadataItem) {
