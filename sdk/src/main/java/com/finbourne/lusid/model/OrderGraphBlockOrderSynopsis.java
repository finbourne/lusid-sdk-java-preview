...
public class OrderGraphBlockOrderSynopsis {
   ...
   * @return quantity
  **/
  @ApiModelProperty(required = true, value = "Total number of units ordered.")
   ...
   * @return details
  **/
  @ApiModelProperty(required = true, value = "Identifiers and other info for each order in this block.")
