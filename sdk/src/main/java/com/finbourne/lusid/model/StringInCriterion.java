...
import com.finbourne.lusid.model.PropertyCriterion;
import com.finbourne.lusid.model.StringInCriterionAllOf;
...
public class StringInCriterion extends PropertyCriterion {
  ...
  public StringInCriterion() {
    //this.criterionOp = this.getClass().getSimpleName();
  }

  public StringInCriterion key(String key) {
    this.key = key; 
    return this;
  }
   ...
   * @return key
  **/
  @ApiModelProperty(required = true, value = "The property key whose value will form the left-hand side of the operation")
  ...
  public StringInCriterion value(List<String> value) {
    this.value = value; 
    return this;
  }

  public StringInCriterion addValueItem(String valueItem) {
   ...
   * @return value
  **/
  @ApiModelProperty(required = true, value = "The value to be compared against")
  ...
  public String toString() {
    ...
    sb.append("class StringInCriterion {\n");
