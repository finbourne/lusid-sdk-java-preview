...
public class MarketDataKeyRule {
  ...
  **/
   ...
   * @return field
  **/
  @ApiModelProperty(value = "The conceptual qualification for the field, such as bid, mid, or ask.   The field must be one of a defined set for the given supplier, in the same way as it  is for the Finbourne.WebApi.Interface.Dto.Quotes.QuoteSeriesId")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, supplier, dataScope, quoteType, field);
  }
