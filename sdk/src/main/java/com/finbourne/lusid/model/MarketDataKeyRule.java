...
public class MarketDataKeyRule {
  ...
  **/
  @ApiModelProperty(required = true, value = "Shorthand for the time interval used to select market data.")
   ...
   * @return asAt
  **/
  @ApiModelProperty(required = true, value = "The AsAt predicate specification.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(key, supplier, dataScope, quoteType, field, quoteInterval, asAt);
  }
