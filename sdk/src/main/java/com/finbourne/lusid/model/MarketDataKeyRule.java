...
public class MarketDataKeyRule {
  ...
  public enum PriceSideEnum {
    ...
    public static PriceSideEnum fromValue(String value) {
    ...
    public static class Adapter extends TypeAdapter<PriceSideEnum> {
      ...
      public PriceSideEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return PriceSideEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_PRICE_SIDE = "priceSide";
  @SerializedName(SERIALIZED_NAME_PRICE_SIDE)
  private PriceSideEnum priceSide;
