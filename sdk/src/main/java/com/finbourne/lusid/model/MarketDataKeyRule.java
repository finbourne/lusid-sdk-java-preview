...
public class MarketDataKeyRule {
  ...
  **/
   ...
   * @return quoteType
  **/
  @ApiModelProperty(required = true, value = "The available values are: Price, Spread, Rate, LogNormalVol, NormalVol, ParSpread, IsdaSpread, Upfront, Index, Ratio, Delta")
  ...
  **/
   ...
   * @return sourceSystem
  **/
  @ApiModelProperty(value = "Determines from where LUSID should attempt to find the data. Optional and, if omitted, will default to \"Lusid\".  This means that data will be retrieved from the Quote store and the ComplexMarketData store.  These can be populated using the Quotes and ComplexMarketData endpoints.                This can be set to \"MarketDataOverrides\" if Supplier is set to \"Client\".")
