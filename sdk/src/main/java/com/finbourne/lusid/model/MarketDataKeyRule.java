...
public class MarketDataKeyRule {
  ...
  public enum SupplierEnum {
    ...
    public static SupplierEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<SupplierEnum> {
      ...
      public SupplierEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return SupplierEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("supplier")
  private SupplierEnum supplier = null;

  @SerializedName("dataScope")
  private String dataScope = null;
   ...
   */
  @JsonAdapter(PriceSideEnum.Adapter.class)
  public enum PriceSideEnum {
    ...
    public static PriceSideEnum fromValue(String text) {
      for (PriceSideEnum b : PriceSideEnum.values()) {
        if (String.valueOf(b.value).equals(text)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<PriceSideEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PriceSideEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PriceSideEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return PriceSideEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("priceSide")
  private PriceSideEnum priceSide = null;
  ...
  **/
   ...
   * @return quoteType
  **/
  @ApiModelProperty(value = "Is the quote to be looked for a price, yield etc.")
  ...
  public MarketDataKeyRule priceSide(PriceSideEnum priceSide) {
   ...
   * @return priceSide
  **/
  @ApiModelProperty(value = "The conceptual qualification for the field. Something like Bid, Ask or Mid.")
  public PriceSideEnum getPriceSide() {
    return priceSide;
  }

  public void setPriceSide(PriceSideEnum priceSide) {
    this.priceSide = priceSide;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.key, marketDataKeyRule.key) &&
        ...
        Objects.equals(this.priceSide, marketDataKeyRule.priceSide);
  }

  @Override
  public int hashCode() {
    return Objects.hash(key, supplier, dataScope, quoteType, priceSide);
  }
  ...
  public String toString() {
    ...
    sb.append("    priceSide: ").append(toIndentedString(priceSide)).append("\n");
    sb.append("}");
    return sb.toString();
  }
