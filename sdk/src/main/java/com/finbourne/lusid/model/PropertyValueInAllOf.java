...
public class PropertyValueInAllOf {
  ...
  public PropertyValueInAllOf propertyKey(String propertyKey) {
  ...
  **/
  ...
  public PropertyValueInAllOf value(List<String> value) {
    this.value = value; 
    return this;
  }

  public PropertyValueInAllOf addValueItem(String valueItem) {
  ...
  **/
  ...
  public PropertyValueInAllOf criterionType(CriterionTypeEnum criterionType) {
