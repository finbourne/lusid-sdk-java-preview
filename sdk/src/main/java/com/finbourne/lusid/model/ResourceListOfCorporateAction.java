...
public class ResourceListOfCorporateAction {
  ...
  private List<CorporateAction> values = new ArrayList<>();
  ...
  public ResourceListOfCorporateAction values(List<CorporateAction> values) {
    this.values = values;
    return this;
  }

  public ResourceListOfCorporateAction addValuesItem(CorporateAction valuesItem) {
  ...
  **/
  ...
  public List<CorporateAction> getValues() {
    return values;
  }

  public void setValues(List<CorporateAction> values) {
    this.values = values;
  }

  public ResourceListOfCorporateAction href(String href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfCorporateAction count(Integer count) {
    this.count = count;
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfCorporateAction links(List<Link> links) {
    this.links = links;
    return this;
  }

  public ResourceListOfCorporateAction addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ResourceListOfCorporateAction resourceListOfCorporateAction = (ResourceListOfCorporateAction) o;
    return Objects.equals(this.values, resourceListOfCorporateAction.values) &&
        Objects.equals(this.href, resourceListOfCorporateAction.href) &&
        Objects.equals(this.count, resourceListOfCorporateAction.count) &&
        Objects.equals(this.links, resourceListOfCorporateAction.links);
  }
