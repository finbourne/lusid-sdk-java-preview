...
public class UpsertInstrumentPropertyRequest {
  ...
  public UpsertInstrumentPropertyRequest identifierType(String identifierType) {
   ...
   /**
   * The unique instrument identifier type
   * @return identifierType
  **/
  @ApiModelProperty(required = true, value = "The unique instrument identifier type")
   ...
   * @return identifier
  **/
  @ApiModelProperty(required = true, value = "The unique instrument identifier")
