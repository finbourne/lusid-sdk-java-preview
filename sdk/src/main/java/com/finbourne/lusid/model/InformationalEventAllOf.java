...
public class InformationalEventAllOf {
  ...
  **/
  ...
  public InformationalEventAllOf eventStatus(String eventStatus) {
  ...
  **/
  ...
  public InformationalEventAllOf anchorDate(OffsetDateTime anchorDate) {
   ...
   * @return anchorDate
  **/
  @ApiModelProperty(required = true, value = "In the case of a point event, the single date on which the event occurs. In the case of an event which is  spread over a window, e.g. a barrier or American option, the start of that window.")
  ...
  **/
  ...
  public InformationalEventAllOf diagnostics(ResultValueDictionary diagnostics) {
  ...
  **/
  ...
  public InformationalEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
