...
public class PagedResourceListOfAddressKeyDefinition {
  ...
  public PagedResourceListOfAddressKeyDefinition nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfAddressKeyDefinition previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfAddressKeyDefinition values(List<AddressKeyDefinition> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfAddressKeyDefinition addValuesItem(AddressKeyDefinition valuesItem) {
  ...
  **/
  ...
  public PagedResourceListOfAddressKeyDefinition href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfAddressKeyDefinition links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfAddressKeyDefinition addLinksItem(Link linksItem) {
