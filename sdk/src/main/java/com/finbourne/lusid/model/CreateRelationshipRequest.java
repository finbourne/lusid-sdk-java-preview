...
public class CreateRelationshipRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The identifier of the source entity.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The identifier of the target entity.")
  ...
  **/
  @ApiModelProperty(value = "The effective date of the relationship to be created")
  ...
  **/
  @ApiModelProperty(value = "The effective datetime until which the relationship is valid. If not supplied this will be valid indefinitely.")
