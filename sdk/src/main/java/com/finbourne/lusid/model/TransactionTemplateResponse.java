...
public class TransactionTemplateResponse {
  ...
  **/
  @ApiModelProperty(required = true, value = "A value that represents the instrument event type.")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "The description of the transaction template.")
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "The scope in which the transaction template resides.")
  ...
  **/
  @ApiModelProperty(required = true, value = "A set of component transactions that relate to the template to be created.")
