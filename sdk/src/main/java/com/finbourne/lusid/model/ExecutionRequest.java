...
public class ExecutionRequest {
   ...
   * @return executionId
  **/
  @ApiModelProperty(required = true, value = "FIX Field 17.  Unique execution identifier.")
   ...
   * @return side
  **/
  @ApiModelProperty(required = true, value = "FIX Field 54.")
  ...
  **/
  @ApiModelProperty(required = true, value = "FIX field 60.  Time the transaction represented by this ExecutionReport occurred.")
   ...
   * @return lastShares
  **/
  @ApiModelProperty(required = true, value = "FIX field 32.")
   ...
   * @return lastPx
  **/
  @ApiModelProperty(required = true, value = "FIX field 31.")
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "FIX field 15.")
