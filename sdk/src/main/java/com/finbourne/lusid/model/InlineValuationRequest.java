...
public class InlineValuationRequest {
  ...
  **/
  @ApiModelProperty(value = "For complex results or financially meaningful results,  there is a need for a result to contain metadata about its currency and/or units  or to have a more complicated 1D or 2D structure")
