 ...
 * An JELines entity.
 */
@ApiModel(description = "An JELines entity.")
...
public class JELines {
  ...
  **/
  @ApiModelProperty(required = true, value = "The JELines accounting date.")
  ...
  **/
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(required = true, value = "To indicate the instrument of the transaction that the JE line posted for, if applicable.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The scope in which the JELines instrument is in.")
  ...
  **/
   ...
   * @return taxLotId
  **/
  @ApiModelProperty(required = true, value = "The tax lot Id that JE line is impacting.")
   ...
   * @return glCode
  **/
  @ApiModelProperty(required = true, value = "Code of general ledger the JE lines posting to.")
  ...
  **/
  @ApiModelProperty(value = "The code of the posting module where the posting rules derived the JE Lines.")
   ...
   * @return postingRule
  **/
  @ApiModelProperty(required = true, value = "The rule generating the JELinse.")
   ...
   * @return asAtDate
  **/
  @ApiModelProperty(required = true, value = "The corresponding input date and time of the Transaction generating the JELine.")
  ...
  **/
  @ApiModelProperty(value = "This would be the description of the business activities where these JE lines are posting for.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Raw JE Line details of the economic bucket for the JE Line.")
