...
import com.finbourne.lusid.model.CapFloorAllOf;
 ...
 */
@ApiModel(description = "Interest rate Cap, Floor or Collar  Derivative instrument on an underlying interest rate index.  Cap Type: Buyer will receive payments at the end of each period when floating rate is above the CapStrike level.  Floor Type: Buyer will receive payments at the end of each period when floating rate is below the FloorStrike level.  Collar Type: Strategy of buying one Cap and selling one Floor where FloorStrike is less than CapStrike.")
...
public class CapFloor extends LusidInstrument {
  ...
  private FloatingLeg underlyingFloatingLeg = null;
   ...
   * @return capFloorType
  **/
  @ApiModelProperty(required = true, value = "Determine if it's CAP, FLOOR, or COLLAR.  Supported string (enumeration) values are: [Cap, Floor, Collar].")
  ...
  **/
  @ApiModelProperty(required = true, value = "Include first caplet flag.")
