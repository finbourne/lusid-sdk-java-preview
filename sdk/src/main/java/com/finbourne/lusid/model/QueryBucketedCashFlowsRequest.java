 ...
 */
@ApiModel(description = "Query for bucketed cashflows from one or more portfolios.")
...
public class QueryBucketedCashFlowsRequest {
  ...
  private List<String> bucketingTenors = null;
  ...
  **/
   ...
   * @return windowStart
  **/
  @ApiModelProperty(required = true, value = "The lower bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.  There is no lower bound if this is not specified.")
   ...
   * @return windowEnd
  **/
  @ApiModelProperty(required = true, value = "The upper bound effective datetime or cut label (inclusive) from which to retrieve the cashflows.  The upper bound defaults to 'today' if it is not specified")
  ...
  **/
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The valuation (pricing) effective datetime or cut label (inclusive) at which to evaluate the cashflows.  This determines whether cashflows are evaluated in a historic or forward looking context and will, for certain models, affect where data is looked up.  For example, on a swap if the effectiveAt is in the middle of the window, cashflows before it will be historic and resets assumed to exist where if the effectiveAt  is before the start of the range they are forward looking and will be expectations assuming the model supports that.  There is evidently a presumption here about availability of data and that the effectiveAt is realistically on or before the real-world today.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Three letter ISO currency string indicating what currency to report in for ReportCurrency denominated queries.")
