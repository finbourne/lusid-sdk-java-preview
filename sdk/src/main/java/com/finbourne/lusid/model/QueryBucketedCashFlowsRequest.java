...
public class QueryBucketedCashFlowsRequest {
   ...
   * @return asAt
  **/
  @ApiModelProperty(required = true, value = "The time of the system at which to query for bucketed cashflows.")
  ...
  **/
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The valuation (pricing) effective datetime or cut label (inclusive) at which to evaluate the cashflows")
  ...
  **/
   ...
   * @return groupBy
  **/
  @ApiModelProperty(value = "The set of address keys to use to group the bucketed cash flows.")
