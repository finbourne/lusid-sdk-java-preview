 ...
 */
@ApiModel(description = "Rows identified by the composite id, based on the data maps")
...
public class VirtualRow {
   ...
   * @return rowId
  **/
  @ApiModelProperty(value = "The identifier for the row. This is keyed by address keys, and values obtained through applying the data map to the documents.")
   ...
   * @return rowData
  **/
  @ApiModelProperty(value = "The data for the particular row")
