...
public class SetPersonPropertiesRequest {
  ...
  public SetPersonPropertiesRequest putPropertiesItem(String key, List<Property> propertiesItem) {
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Properties to set for a Person. All time-variant properties must have same EffectiveFrom date. Properties not included in the request will not be amended.")
