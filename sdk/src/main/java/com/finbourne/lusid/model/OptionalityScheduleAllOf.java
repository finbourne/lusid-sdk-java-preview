...
public class OptionalityScheduleAllOf {
  ...
  private List<OptionEntry> optionEntries = null;
  ...
  public OptionalityScheduleAllOf exerciseType(String exerciseType) {
   ...
   * @return exerciseType
  **/
  @ApiModelProperty(value = "The exercise type of the optionality schedule (American or European).  For American type, the bond is perpetually callable from a given exercise date until it matures, or the next date in the schedule.  For European type, the bond is only callable on a given exercise date.    Supported string (enumeration) values are: [European, American].")
  ...
  public OptionalityScheduleAllOf optionEntries(List<OptionEntry> optionEntries) {
    this.optionEntries = optionEntries; 
    return this;
  }

  public OptionalityScheduleAllOf addOptionEntriesItem(OptionEntry optionEntriesItem) {
  ...
  **/
  @ApiModelProperty(value = "The dates at which the bond call/put may be actioned, and associated strikes.")
  ...
  public OptionalityScheduleAllOf optionType(String optionType) {
   ...
   * @return optionType
  **/
  @ApiModelProperty(value = "Type of optionality for the schedule.    Supported string (enumeration) values are: [Call, Put].")
  ...
  public OptionalityScheduleAllOf scheduleType(ScheduleTypeEnum scheduleType) {
   ...
   * @return scheduleType
  **/
  @ApiModelProperty(required = true, value = "The available values are: FixedSchedule, FloatSchedule, OptionalitySchedule, StepSchedule, Exercise, FxRateSchedule, Invalid")
