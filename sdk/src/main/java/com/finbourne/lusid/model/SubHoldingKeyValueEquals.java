...
import com.finbourne.lusid.model.SubHoldingKeyValueEqualsAllOf;
 ...
 */
@ApiModel(description = "A criterion that checks whether a SubHoldingKey Value is equal to the given string value")
...
public class SubHoldingKeyValueEquals extends MatchCriterion {
  ...
  **/
  @ApiModelProperty(required = true, value = "The sub holding key whose value will form the left-hand side of the operation")
