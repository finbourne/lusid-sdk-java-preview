...
public class CreatePropertyDefinitionRequest {
   ...
   * @return domain
  **/
  @ApiModelProperty(value = "The domain that the property will be created in.")
  ...
  **/
  ...
  public CreatePropertyDefinitionRequest type(TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.domain, createPropertyDefinitionRequest.domain) &&
        ...
        Objects.equals(this.type, createPropertyDefinitionRequest.type);
  }

  @Override
  public int hashCode() {
    return Objects.hash(domain, scope, code, valueRequired, displayName, dataTypeId, lifeTime, type);
  }
