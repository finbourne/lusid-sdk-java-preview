...
public class CreatePropertyDefinitionRequest {
   ...
   * @return domain
  **/
  @ApiModelProperty(required = true, value = "The domain that the property will be created in.")
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "The scope that the property will be created in.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code that the property will be created with. Together with the domain and  scope this uniquely identifies the property.")
  ...
  **/
  @ApiModelProperty(value = "Whether or not a value is always required for this property. Defaults to false if not specified.")
  ...
  **/
   ...
   * @return lifeTime
  **/
  @ApiModelProperty(value = "Controls how the property's values can change over time. Defaults to \"Perpetual\" if not specified.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(domain, scope, code, valueRequired, displayName, dataTypeId, lifeTime);
  }
