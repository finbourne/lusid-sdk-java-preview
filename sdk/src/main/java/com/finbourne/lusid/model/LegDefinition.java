...
public class LegDefinition {
  ...
  **/
   ...
   * @return stubType
  **/
  @ApiModelProperty(required = true, value = "The available values are: Front, Back, Both")
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: None, Initial, Final, Both")
