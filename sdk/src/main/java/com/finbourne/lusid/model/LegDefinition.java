...
public class LegDefinition {
  ...
  **/
   ...
   * @return payReceive
  **/
  @ApiModelProperty(required = true, value = "Is the leg to be paid or received  Supported string (enumeration) values are: [NotDefined, Pay, Receive].")
  ...
  **/
  @ApiModelProperty(required = true, value = "Control how resets are generated relative to swap payment convention(s).  Supported string (enumeration) values are: [InAdvance, InArrears].")
   ...
   * @return stubType
  **/
  @ApiModelProperty(required = true, value = "If a stub is required should it be at the front or back of the leg.  Supported string (enumeration) values are: [Front, Back, Both].")
