...
public class LegDefinition {
   ...
   */
  @JsonAdapter(StubTypeEnum.Adapter.class)
  public enum StubTypeEnum {
    ...
    public static StubTypeEnum fromValue(String value) {
      for (StubTypeEnum b : StubTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<StubTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final StubTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public StubTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return StubTypeEnum.fromValue(value);
      }
    }
  }
  ...
  private StubTypeEnum stubType;

  /**
   * Is the leg to be paid or received
   */
  @JsonAdapter(PayReceiveEnum.Adapter.class)
  public enum PayReceiveEnum {
    ...
    public static PayReceiveEnum fromValue(String value) {
      for (PayReceiveEnum b : PayReceiveEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<PayReceiveEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PayReceiveEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PayReceiveEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return PayReceiveEnum.fromValue(value);
      }
    }
  }
  ...
  private PayReceiveEnum payReceive;
   ...
   * @return rateOrSpread
  **/
  @ApiModelProperty(value = "Is there either a fixed rate (non-zero) or spread to be paid over the value of the leg.")
  ...
  **/
  ...
  public LegDefinition stubType(StubTypeEnum stubType) {
   ...
   * @return stubType
  **/
  @ApiModelProperty(required = true, value = "If a stub is required should it be at the front or back of the leg.")
  public StubTypeEnum getStubType() {
    return stubType;
  }

  public void setStubType(StubTypeEnum stubType) {
    this.stubType = stubType;
  }

  public LegDefinition payReceive(PayReceiveEnum payReceive) {
   ...
   * @return payReceive
  **/
  @ApiModelProperty(required = true, value = "Is the leg to be paid or received")
  public PayReceiveEnum getPayReceive() {
    return payReceive;
  }

  public void setPayReceive(PayReceiveEnum payReceive) {
    this.payReceive = payReceive;
  }

  public LegDefinition notionalExchangeType(NotionalExchangeTypeEnum notionalExchangeType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "what type of notional exchange does the leg have")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.rateOrSpread, legDefinition.rateOrSpread) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(rateOrSpread, indexConvention, stubType, payReceive, notionalExchangeType, conventions);
  }
