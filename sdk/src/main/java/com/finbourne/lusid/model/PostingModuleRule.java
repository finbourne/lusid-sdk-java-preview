...
public class PostingModuleRule {
   ...
   * @return ruleId
  **/
  @ApiModelProperty(required = true, value = "The identifier for the rule")
  ...
  **/
   ...
   * @return ruleFilter
  **/
  @ApiModelProperty(required = true, value = "The filter syntax for the rule. See KB for filter syntax https://support.lusid.com/knowledgebase/article/KA-01914/en-us")
