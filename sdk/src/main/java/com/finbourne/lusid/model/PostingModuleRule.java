 ...
 * A Posting rule
 */
@ApiModel(description = "A Posting rule")
...
public class PostingModuleRule {
   ...
   * @return ruleId
  **/
  @ApiModelProperty(required = true, value = "The identifier for the Posting Rule.")
   ...
   * @return account
  **/
  @ApiModelProperty(required = true, value = "The account to post the Activity credit or debit to.")
   ...
   * @return ruleFilter
  **/
  @ApiModelProperty(required = true, value = "The filter syntax for the Posting Rule. See https://support.lusid.com/knowledgebase/article/KA-02140 for more information on filter syntax.")
