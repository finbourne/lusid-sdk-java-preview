...
public class CompositeDispersion {
  ...
  **/
  @ApiModelProperty(value = "The result for the dispersion calculation on the given effectiveAt.")
   ...
   * @return variance
  **/
  @ApiModelProperty(value = "The variance on the given effectiveAt.")
  ...
  **/
  @ApiModelProperty(value = "First Quartile (Q1) =  (lower quartile) = the middle of the bottom half of the returns.")
  ...
  **/
  @ApiModelProperty(value = "Third Quartile (Q3) =  (higher quartile) = the middle of the top half of the returns.")
   ...
   * @return range
  **/
  @ApiModelProperty(value = "Highest return - Lowest return.")
