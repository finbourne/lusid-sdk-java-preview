...
import com.finbourne.lusid.model.Counterparty;
...
public class GetCounterpartyResponse {
  ...
  private Counterparty value = null;
  ...
  public GetCounterpartyResponse href(URI href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public GetCounterpartyResponse value(Counterparty value) {
    this.value = value;
    return this;
  }
  ...
  **/
  ...
  public Counterparty getValue() {
    return value;
  }

  public void setValue(Counterparty value) {
    this.value = value;
  }

  public GetCounterpartyResponse failed(Map<String, ErrorDetail> failed) {
    this.failed = failed;
    return this;
  }

  public GetCounterpartyResponse putFailedItem(String key, ErrorDetail failedItem) {
    if (this.failed == null) {
   ...
   /**
   * The counterparty that could not be updated or inserted along with a reason for failure.
   * @return failed
  **/
  @ApiModelProperty(value = "The counterparty that could not be updated or inserted along with a reason for failure.")
  ...
  public GetCounterpartyResponse links(List<Link> links) {
    this.links = links;
    return this;
  }

  public GetCounterpartyResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class GetCounterpartyResponse {\n");
