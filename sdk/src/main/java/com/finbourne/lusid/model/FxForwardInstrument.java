...
public class FxForwardInstrument {
  ...
  **/
   ...
   * @return isNdf
  **/
  @ApiModelProperty(required = true, value = "Is the contract an Fx-Forward of \"Non-Deliverable\" type, meaning a single payment in the domestic currency based on  the change in fx-rate vs  a reference rate is used.")
   ...
   * @return fixingDate
  **/
  @ApiModelProperty(required = true, value = "The fixing date. Its presence determines the NDF status of the instrument.")
  ...
  **/
   ...
   * @return refSpotRate
  **/
  @ApiModelProperty(required = true, value = "The reference Fx Spot rate for currency pair Foreign-Domestic that was seen on the trade start date (time).")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.domAmount, fxForwardInstrument.domAmount) &&
        ...
        Objects.equals(this.instrumentType, fxForwardInstrument.instrumentType);
  }
