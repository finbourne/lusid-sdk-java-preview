...
public class TranslateInstrumentDefinitionsResponse {
  ...
  **/
  ...
  public TranslateInstrumentDefinitionsResponse putValuesItem(String key, LusidInstrument valuesItem) {
    if (this.values == null) {
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The instruments which have been successfully translated.")
  public Map<String, LusidInstrument> getValues() {
    return values;
  }

  public void setValues(Map<String, LusidInstrument> values) {
    this.values = values;
  }
  ...
  public TranslateInstrumentDefinitionsResponse putFailedItem(String key, ErrorDetail failedItem) {
    if (this.failed == null) {
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The instruments that could not be translated along with a reason for their failure.")
