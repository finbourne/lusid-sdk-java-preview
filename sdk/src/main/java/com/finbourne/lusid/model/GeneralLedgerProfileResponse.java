 ...
 */
@ApiModel(description = "A General Ledger Profile Definition.")
...
public class GeneralLedgerProfileResponse {
  ...
  **/
  @ApiModelProperty(required = true, value = "The unique code for the General Ledger Profile")
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "The name of the General Ledger Profile")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description for the General Ledger Profile")
  ...
  **/
  @ApiModelProperty(required = true, value = "Rules for mapping Account or property values to aggregation pattern definitions")
