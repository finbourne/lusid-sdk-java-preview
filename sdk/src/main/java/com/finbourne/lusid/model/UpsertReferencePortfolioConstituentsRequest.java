...
public class UpsertReferencePortfolioConstituentsRequest {
  ...
  /**
   * Indicates the weight reset methods. Static, floating or periodical
   */
  ...
  /**
   * Indicates the period type (daily, weekly) that weights will reset
   */
  ...
  public UpsertReferencePortfolioConstituentsRequest effectiveFrom(OffsetDateTime effectiveFrom) {
  ...
  **/
   ...
   * @return weightType
  **/
  @ApiModelProperty(required = true, value = "Indicates the weight reset methods. Static, floating or periodical")
   ...
   * @return periodType
  **/
  @ApiModelProperty(value = "Indicates the period type (daily, weekly) that weights will reset")
  ...
  public UpsertReferencePortfolioConstituentsRequest periodCount(Integer periodCount) {
   ...
   /**
   * How many multiples of the period between resets
   * @return periodCount
  **/
  @ApiModelProperty(value = "How many multiples of the period between resets")
