 ...
 */
@ApiModel(description = "Recipe composer is an object used to dynamically compose Configuration Recipe from atomic operations.")
...
public class RecipeComposer {
  ...
  private List<RecipeBlock> operations = null;
  ...
  **/
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "The scope used when updating or inserting the Recipe Composer.")
   ...
   * @return operations
  **/
  @ApiModelProperty(value = "Atomic operations used to compose a Configuration Recipe.")
