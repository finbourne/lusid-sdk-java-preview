...
public class OrderGraphPlacementPlacementSynopsis {
   ...
   * @return details
  **/
  @ApiModelProperty(required = true, value = "Identifiers for each child placement for this placement.")
   ...
   * @return quantity
  **/
  @ApiModelProperty(required = true, value = "Total number of units placed.")
