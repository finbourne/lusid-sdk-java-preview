 ...
 */
@ApiModel(description = "Object describing a particular industry classifier,  which comprises a classification code and the name of the classification system to which the code belongs.")
...
public class IndustryClassifier {
  ...
  **/
  @ApiModelProperty(required = true, value = "The name of the classification system to which the classification code belongs (e.g. GICS).")
  ...
  **/
  @ApiModelProperty(required = true, value = "The specific industry classification code assigned to the legal entity.")
