...
public class DeleteRelationshipRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "The identifier of the source entity of the relationship to be deleted.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The identifier of the target entity of the relationship to be deleted.")
  ...
  **/
  @ApiModelProperty(value = "The effective date of the relationship to be deleted")
  ...
  **/
  @ApiModelProperty(value = "The effective datetime until which the relationship will be deleted. If not supplied the deletion will be permanent.")
