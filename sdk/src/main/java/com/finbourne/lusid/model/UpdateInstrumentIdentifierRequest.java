...
public class UpdateInstrumentIdentifierRequest {
   ...
   * @return type
  **/
  @ApiModelProperty(value = "The type of the identifier to upsert. This must be one of the code types marked as   allowable for instrument identifiers.")
  ...
  public UpdateInstrumentIdentifierRequest value(String value) {
   ...
   /**
   * The value of the identifier. If set to &#x60;null&#x60;, this will remove the identifier completely.  Note that, if an instrument only has one identifier, it is an error to remove this.
   * @return value
  **/
  @ApiModelProperty(value = "The value of the identifier. If set to `null`, this will remove the identifier completely.  Note that, if an instrument only has one identifier, it is an error to remove this.")
  ...
  public UpdateInstrumentIdentifierRequest effectiveAt(String effectiveAt) {
   ...
   /**
   * The date at which the identifier modification is to be effective from. If unset, will  default to &#x60;now&#x60;.
   * @return effectiveAt
  **/
  @ApiModelProperty(value = "The date at which the identifier modification is to be effective from. If unset, will  default to `now`.")
