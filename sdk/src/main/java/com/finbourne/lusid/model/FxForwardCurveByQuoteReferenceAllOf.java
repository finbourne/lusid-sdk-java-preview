...
public class FxForwardCurveByQuoteReferenceAllOf {
  ...
  public FxForwardCurveByQuoteReferenceAllOf domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf fgnCcy(String fgnCcy) {
    this.fgnCcy = fgnCcy; 
    return this;
  }
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf tenors(List<String> tenors) {
    this.tenors = tenors; 
    return this;
  }

  public FxForwardCurveByQuoteReferenceAllOf addTenorsItem(String tenorsItem) {
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf quoteReferences(List<Map<String, String>> quoteReferences) {
    this.quoteReferences = quoteReferences; 
    return this;
  }

  public FxForwardCurveByQuoteReferenceAllOf addQuoteReferencesItem(Map<String, String> quoteReferencesItem) {
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf lineage(String lineage) {
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf marketDataOptions(MarketDataOptions marketDataOptions) {
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf calendars(List<FxTenorConvention> calendars) {
    this.calendars = calendars; 
    return this;
  }

  public FxForwardCurveByQuoteReferenceAllOf addCalendarsItem(FxTenorConvention calendarsItem) {
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf spotDaysCalculationType(String spotDaysCalculationType) {
  ...
  **/
  ...
  public FxForwardCurveByQuoteReferenceAllOf marketDataType(MarketDataTypeEnum marketDataType) {
