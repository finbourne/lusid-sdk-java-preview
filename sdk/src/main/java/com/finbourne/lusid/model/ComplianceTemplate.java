...
public class ComplianceTemplate {
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "The description of the Compliance Template")
   ...
   * @return tags
  **/
  @ApiModelProperty(value = "Tags for a Compliance Template")
   ...
   * @return variations
  **/
  @ApiModelProperty(required = true, value = "Variation details of a Compliance Template")
