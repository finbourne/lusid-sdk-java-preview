...
public class FxDependencyAllOf {
  ...
  public FxDependencyAllOf domesticCurrency(String domesticCurrency) {
  ...
  **/
  ...
  public FxDependencyAllOf foreignCurrency(String foreignCurrency) {
  ...
  **/
  ...
  public FxDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public FxDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
