...
public class ResourceListOfAggregatedReturn {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<AggregatedReturn> values = new ArrayList<>();
  ...
  public ResourceListOfAggregatedReturn values(List<AggregatedReturn> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfAggregatedReturn addValuesItem(AggregatedReturn valuesItem) {
  ...
  **/
  ...
  public List<AggregatedReturn> getValues() {
    return values;
  }

  public void setValues(List<AggregatedReturn> values) {
    this.values = values;
  }


  public ResourceListOfAggregatedReturn href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfAggregatedReturn links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfAggregatedReturn addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public ResourceListOfAggregatedReturn nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfAggregatedReturn previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfAggregatedReturn {\n");
