 ...
 */
@ApiModel(description = "An instrument which has the Lusid economic representation where it exists.  Lusid has two ways of representing instruments with an extended definition. The first is native to Lusid using the LusidInstrument format.  The second is essentially a free-text methodology where 'any' Json or Xml string can be given. This is to support the use case where Lusid does not  understand the instrument natively but may be able to run a limited set of queries against it.")

public class ExpandedInstrument {
  ...
  public ExpandedInstrument href(URI href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public ExpandedInstrument lusidInstrumentId(String lusidInstrumentId) {
  ...
  **/
  ...
  public ExpandedInstrument version(Version version) {
  ...
  **/
  ...
  public ExpandedInstrument name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public ExpandedInstrument identifiers(Map<String, String> identifiers) {
    this.identifiers = identifiers;
    return this;
  }

  public ExpandedInstrument putIdentifiersItem(String key, String identifiersItem) {
  ...
  **/
  ...
  public ExpandedInstrument properties(List<Property> properties) {
    this.properties = properties;
    return this;
  }

  public ExpandedInstrument addPropertiesItem(Property propertiesItem) {
  ...
  **/
  ...
  public ExpandedInstrument lookthroughPortfolio(ResourceId lookthroughPortfolio) {
  ...
  **/
  ...
  public ExpandedInstrument instrumentDefinition(LusidInstrument instrumentDefinition) {
  ...
  **/
  ...
  public ExpandedInstrument state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public ExpandedInstrument links(List<Link> links) {
    this.links = links;
    return this;
  }

  public ExpandedInstrument addLinksItem(Link linksItem) {
    if (this.links == null) {
