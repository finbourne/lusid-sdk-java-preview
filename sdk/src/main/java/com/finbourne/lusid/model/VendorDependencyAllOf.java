...
public class VendorDependencyAllOf {
  ...
  public VendorDependencyAllOf vendorName(String vendorName) {
  ...
  **/
  ...
  public VendorDependencyAllOf vendorPath(List<String> vendorPath) {
    this.vendorPath = vendorPath; 
    return this;
  }

  public VendorDependencyAllOf addVendorPathItem(String vendorPathItem) {
  ...
  **/
  ...
  public VendorDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public VendorDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
