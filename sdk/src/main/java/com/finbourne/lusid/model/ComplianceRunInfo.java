...
public class ComplianceRunInfo {
   ...
   * @return runId
  **/
  @ApiModelProperty(required = true, value = "The unique identifier of a compliance run")
   ...
   * @return instigatedAt
  **/
  @ApiModelProperty(required = true, value = "The time the compliance run was launched (e.g. button pressed). Currently it is also both the as at and effective at time in whichthe rule set and portfolio data (including any pending trades if the run is pretrade) is taken for the caluation, although it may be possible to run compliance for historical effective at and as at dates in the future.")
   ...
   * @return completedAt
  **/
  @ApiModelProperty(required = true, value = "The time the compliance run calculation was completed")
   ...
   * @return schedule
  **/
  @ApiModelProperty(required = true, value = "Whether the compliance run was pre or post trade")
  ...
  **/
  @ApiModelProperty(required = true, value = "True if all rules passed, for all the portfolios they were assigned to")
   ...
   * @return hasResults
  **/
  @ApiModelProperty(required = true, value = "False when no results have been returned eg. when no rules exist")
   ...
   * @return asAt
  **/
  @ApiModelProperty(required = true, value = "Legacy AsAt time for backwards compatibility")
