...
public class PortfolioCashFlow {
  ...
  public static final String SERIALIZED_NAME_SUB_HOLDINGS = "subHoldings";
  @SerializedName(SERIALIZED_NAME_SUB_HOLDINGS)
  private Map<String, PerpetualProperty> subHoldings = new HashMap<>();
  ...
  **/
  ...
  public PortfolioCashFlow subHoldings(Map<String, PerpetualProperty> subHoldings) {
    this.subHoldings = subHoldings;
    return this;
  }

  public PortfolioCashFlow putSubHoldingsItem(String key, PerpetualProperty subHoldingsItem) {
    if (this.subHoldings == null) {
      this.subHoldings = new HashMap<>();
    }
    this.subHoldings.put(key, subHoldingsItem);
    return this;
  }
  ...
  **/
  ...
  public Map<String, PerpetualProperty> getSubHoldings() {
    return subHoldings;
  }

  public void setSubHoldings(Map<String, PerpetualProperty> subHoldings) {
    this.subHoldings = subHoldings;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    subHoldings: ").append(toIndentedString(subHoldings)).append("\n");
