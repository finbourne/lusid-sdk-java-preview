 ...
 */
@ApiModel(description = "Query for tradetickets resulting from events on instrument that are taken from one or more portfolios")
...
public class QueryTradeTicketsRequest {
   ...
   * @return asAt
  **/
  @ApiModelProperty(value = "The time of the system at which to query for tradetickets.")
   ...
   * @return windowStart
  **/
  @ApiModelProperty(required = true, value = "The start date of the window.")
   ...
   * @return windowEnd
  **/
  @ApiModelProperty(required = true, value = "The end date of the window.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The set of portfolios and portfolio groups to which the instrument events must belong.")
  ...
  **/
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(required = true, value = "The Effective date used in the valuation of the tradetickets.")
