...
import com.finbourne.lusid.model.BondDefaultEventAllOf;
 ...
 */
@ApiModel(description = "Indicates when an issuer has defaulted on an obligation due to technical default, missed payments, or bankruptcy filing.")
...
public class BondDefaultEvent extends InstrumentEvent {
   ...
   * @return amount
  **/
  @ApiModelProperty(required = true, value = "Percentage or amount of each share held to be given to shareholders.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Date that the missed coupon is paid if payment is made within grace period.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The status of the bond default (i.e., technical or default)    Supported string (enumeration) values are: [Technical, Default].")
   ...
   * @return defaultType
  **/
  @ApiModelProperty(required = true, value = "The type of the default. (coupon payment, principal payment, covenant ...)    Supported string (enumeration) values are: [CouponPayment, CouponAndPrincipalPayment, PrincipalPayment, Covenant, Bankruptcy, BuyBackOption].")
   ...
   * @return graceEndDate
  **/
  @ApiModelProperty(required = true, value = "Date the grace period for making coupon payment ends.")
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The date the coupon payment was missed.")
