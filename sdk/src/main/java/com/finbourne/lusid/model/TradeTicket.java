 ...
 */
@ApiModel(description = "The base class for representing a Trade Ticket in LUSID.")
...
public class TradeTicket {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: LusidTradeTicket, ExternalTradeTicket")
