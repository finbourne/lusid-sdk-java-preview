 ...
 */
@ApiModel(description = "Unique identifier of a given Dialect")
...
public class DialectId {
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "The Scope of the dialect.")
   ...
   * @return vendor
  **/
  @ApiModelProperty(required = true, value = "The vendor of the dialect, the entity that created it. e.g. ISDA, FINBOURNE.")
   ...
   * @return sourceSystem
  **/
  @ApiModelProperty(required = true, value = "The source system of the dialect, the system that understands it. e.g. LUSID, QuantLib.")
   ...
   * @return version
  **/
  @ApiModelProperty(required = true, value = "The semantic version of the dialect: MAJOR.MINOR.PATCH.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The serialisation format of a document in this dialect. e.g. JSON, XML.")
   ...
   * @return entityType
  **/
  @ApiModelProperty(required = true, value = "The type of entity this dialect describes e.g. Instrument.")
