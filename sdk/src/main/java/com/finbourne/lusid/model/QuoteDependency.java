...
import com.finbourne.lusid.model.QuoteDependencyAllOf;
 ...
 */
@ApiModel(description = "For indicating a dependency on the value of an asset at a point in time.  If the time is omitted, then the dependency is interpreted as the latest value with respect to anything observing it.  E.g. An EquitySwap will declare a dependency on the current price of the underlying equity.")
...
public class QuoteDependency extends EconomicDependency {
  ...
  **/
  @ApiModelProperty(required = true, value = "Type of the code identifying the asset, e.g. ISIN or CUSIP")
  ...
  **/
   ...
   * @return date
  **/
  @ApiModelProperty(required = true, value = "The effectiveAt of the quote for the identified entity.")
