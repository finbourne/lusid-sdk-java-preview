...
public class StepScheduleAllOf {
  ...
  public StepScheduleAllOf levelType(String levelType) {
   ...
   * @return levelType
  **/
  @ApiModelProperty(required = true, value = "The type of shift or adjustment that the quantity represents.    Supported string (enumeration) values are: [Absolute, AbsoluteShift, Percentage, AbsolutePercentage].")
  ...
  public StepScheduleAllOf stepScheduleType(String stepScheduleType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The type of step that this schedule is for.  Supported string (enumeration) values are: [Coupon, Notional, Spread].")
  ...
  public StepScheduleAllOf steps(List<LevelStep> steps) {
    this.steps = steps; 
    return this;
  }

  public StepScheduleAllOf addStepsItem(LevelStep stepsItem) {
   ...
   * @return steps
  **/
  @ApiModelProperty(required = true, value = "The level steps which are applied.")
  ...
  public StepScheduleAllOf scheduleType(ScheduleTypeEnum scheduleType) {
