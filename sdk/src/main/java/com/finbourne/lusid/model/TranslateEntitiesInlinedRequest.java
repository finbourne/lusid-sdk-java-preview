 ...
 */
@ApiModel(description = "Request to translate financial entities with a given script body.  The output of the translation is validated against a schema specified in the request.")
...
public class TranslateEntitiesInlinedRequest {
  ...
  **/
  @ApiModelProperty(required = true, value = "Entity payloads to be translated indexed by (ephemeral) unique correlation ids.")
   ...
   * @return scriptBody
  **/
  @ApiModelProperty(required = true, value = "The body of the translation script to use for translating the entities.")
