...
public class FloatScheduleAllOf {
  ...
  public FloatScheduleAllOf startDate(OffsetDateTime startDate) {
   ...
   * @return startDate
  **/
  @ApiModelProperty(value = "Date to start generate from")
  ...
  public FloatScheduleAllOf maturityDate(OffsetDateTime maturityDate) {
   ...
   * @return maturityDate
  **/
  @ApiModelProperty(value = "Date to generate to")
  ...
  public FloatScheduleAllOf flowConventions(FlowConventions flowConventions) {
  ...
  **/
  ...
  public FloatScheduleAllOf conventionName(FlowConventionName conventionName) {
  ...
  **/
  ...
  public FloatScheduleAllOf exDividendDays(Integer exDividendDays) {
  ...
  **/
  ...
  public FloatScheduleAllOf indexConventionName(FlowConventionName indexConventionName) {
  ...
  **/
  ...
  public FloatScheduleAllOf indexConventions(IndexConvention indexConventions) {
  ...
  **/
  ...
  public FloatScheduleAllOf notional(java.math.BigDecimal notional) {
  ...
  **/
  ...
  public FloatScheduleAllOf paymentCurrency(String paymentCurrency) {
  ...
  **/
  ...
  public FloatScheduleAllOf spread(java.math.BigDecimal spread) {
    this.spread = spread; 
    return this;
  }
   ...
   * @return spread
  **/
  @ApiModelProperty(value = "Spread over floating rate given as a fraction.")
  ...
  public FloatScheduleAllOf stubType(String stubType) {
  ...
  **/
  ...
  public FloatScheduleAllOf exDividendConfiguration(ExDividendConfiguration exDividendConfiguration) {
  ...
  **/
  ...
  public FloatScheduleAllOf compounding(Compounding compounding) {
  ...
  **/
  ...
  public FloatScheduleAllOf resetConvention(String resetConvention) {
  ...
  **/
  @ApiModelProperty(value = "Control how resets are generated relative to payment convention(s).    Supported string (enumeration) values are: [InAdvance, InArrears].")
  ...
  public FloatScheduleAllOf scheduleType(ScheduleTypeEnum scheduleType) {
