 ...
 */
@ApiModel(description = "An AborConfiguration entity.")
...
public class AborConfiguration {
  ...
  private List<String> postingModuleCodes = null;
  ...
  private List<String> cleardownModuleCodes = null;
  ...
  **/
   ...
   * @return displayName
  **/
  @ApiModelProperty(value = "The name of the Abor Configuration.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description for the Abor Configuration.")
  ...
  **/
  @ApiModelProperty(value = "The Posting Module Codes from which the rules to be applied are retrieved.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "A set of properties for the Abor Configuration.")
  ...
  **/
  @ApiModelProperty(value = "The Cleardown Module Codes from which the rules to be applied are retrieved.")
