...
public class AborConfiguration {
  ...
  private List<ResourceId> postingModuleIds = null;
  ...
  **/
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description for the AborConfiguration.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The given name for the AborConfiguration.")
  ...
  **/
  @ApiModelProperty(value = "The Posting Modules Ids from where the rules to be applied are retrieved.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Properties to add to the AborConfiguration.")
