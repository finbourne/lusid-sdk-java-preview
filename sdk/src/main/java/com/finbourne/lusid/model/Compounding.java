...
public class Compounding {
  ...
  **/
  @ApiModelProperty(required = true, value = "If the interest rate is simple or compounded.  Supported string (enumeration) values are: [Average, Compounded, None].")
  ...
  **/
  ...
  public Compounding spreadCompoundingMethod(String spreadCompoundingMethod) {
   ...
   /**
   * Defines how the computed leg spread is applied to compounded rate.  It applies only when CompoundingMethod &#x3D; ‘Compounded‘.  Supported string (enumeration) values are: [IsdaCompounding, NoCompounding, IsdaFlatCompounding].
   * @return spreadCompoundingMethod
  **/
  @ApiModelProperty(required = true, value = "Defines how the computed leg spread is applied to compounded rate.  It applies only when CompoundingMethod = ‘Compounded‘.  Supported string (enumeration) values are: [IsdaCompounding, NoCompounding, IsdaFlatCompounding].")
