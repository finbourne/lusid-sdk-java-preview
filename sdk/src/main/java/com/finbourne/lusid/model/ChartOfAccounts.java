 ...
 * A chart of account.
 */
@ApiModel(description = "A chart of account.")
...
public class ChartOfAccounts {
  ...
  **/
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The given name for the chart of account.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description for the chart of account.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Chart of Accounts properties to add to the chart of account.")
