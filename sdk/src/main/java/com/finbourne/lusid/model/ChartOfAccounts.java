...
public class ChartOfAccounts {
  ...
  **/
   ...
   * @return displayName
  **/
  @ApiModelProperty(value = "The name of the Chart of Account.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description of the Chart of Accounts.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "A set of properties for the Chart of Accounts.")
