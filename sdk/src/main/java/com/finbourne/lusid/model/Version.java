...
public class Version {
  ...
  **/
   ...
   * @return asAtCreated
  **/
  @ApiModelProperty(value = "The asAt datetime at which the entity was first created in LUSID.")
  ...
  **/
  @ApiModelProperty(value = "The unique id of the user who created the entity.")
  ...
  **/
  @ApiModelProperty(value = "The unique request id of the command that created the entity.")
   ...
   * @return asAtModified
  **/
  @ApiModelProperty(value = "The asAt datetime at which the entity (including its properties) was last updated in LUSID.")
  ...
  **/
  @ApiModelProperty(value = "The unique id of the user who last updated the entity (including its properties) in LUSID.")
  ...
  **/
  @ApiModelProperty(value = "The unique request id of the command that last updated the entity (including its properties) in LUSID.")
  ...
  **/
  @ApiModelProperty(value = "The integer version number for the entity (the entity was created at version 1)")
