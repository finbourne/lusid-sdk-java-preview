...
public class PagedResourceListOfPackage {
  ...
  private List<ModelPackage> values = new ArrayList<>();
  ...
  public PagedResourceListOfPackage nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfPackage previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfPackage values(List<ModelPackage> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfPackage addValuesItem(ModelPackage valuesItem) {
  ...
  **/
  ...
  public List<ModelPackage> getValues() {
    return values;
  }

  public void setValues(List<ModelPackage> values) {
    this.values = values;
  }


  public PagedResourceListOfPackage href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfPackage links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfPackage addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfPackage {\n");
