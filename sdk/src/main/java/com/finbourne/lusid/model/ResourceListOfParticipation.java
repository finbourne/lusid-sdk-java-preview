...
public class ResourceListOfParticipation {
  public static final String SERIALIZED_NAME_VALUES = "values";
  @SerializedName(SERIALIZED_NAME_VALUES)
  private List<Participation> values = new ArrayList<>();
  ...
  public ResourceListOfParticipation values(List<Participation> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfParticipation addValuesItem(Participation valuesItem) {
  ...
  **/
  ...
  public List<Participation> getValues() {
    return values;
  }

  public void setValues(List<Participation> values) {
    this.values = values;
  }


  public ResourceListOfParticipation href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfParticipation links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfParticipation addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public ResourceListOfParticipation nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfParticipation previousPage(String previousPage) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class ResourceListOfParticipation {\n");
