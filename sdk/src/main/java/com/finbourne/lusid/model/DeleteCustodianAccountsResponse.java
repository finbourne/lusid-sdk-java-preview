 ...
 */
@ApiModel(description = "The delete custodian accounts response")
...
public class DeleteCustodianAccountsResponse {
  ...
  private List<ResourceId> custodianAccountIds = null;
  ...
  **/
  @ApiModelProperty(value = "The Custodian Accounts which have been soft/hard deleted.")
