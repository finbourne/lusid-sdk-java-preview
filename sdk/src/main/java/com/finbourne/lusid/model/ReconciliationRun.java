 ...
 */
@ApiModel(description = "Representation of a reconciliation run in LUSID Api")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class ReconciliationRun {
  public static final String SERIALIZED_NAME_ID = "id";
  @SerializedName(SERIALIZED_NAME_ID)
  private ReconciliationRunId id;
  ...
  public ReconciliationRun id(ReconciliationRunId id) {
    this.id = id; 
    return this;
  }
  ...
  **/
  ...
  public ReconciliationRunId getId() {
    return id;
  }

  public void setId(ReconciliationRunId id) {
    this.id = id;
  }


  public ReconciliationRun href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ReconciliationRun links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ReconciliationRun addLinksItem(Link linksItem) {
