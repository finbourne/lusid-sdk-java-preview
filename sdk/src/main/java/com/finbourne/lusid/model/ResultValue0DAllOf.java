...
public class ResultValue0DAllOf {
  ...
  public ResultValue0DAllOf units(String units) {
    this.units = units; 
    return this;
  }
  ...
  **/
  ...
  public ResultValue0DAllOf dimension(Integer dimension) {
  ...
  **/
  ...
  public ResultValue0DAllOf resultValueType(ResultValueTypeEnum resultValueType) {
