...
public class AddressKeyDefinition {
   ...
   * @return addressKey
  **/
  @ApiModelProperty(required = true, value = "The address key of the address key definition.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The type of the address key definition")
