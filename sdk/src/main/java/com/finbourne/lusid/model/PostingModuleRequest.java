...
public class PostingModuleRequest {
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code given for the chart of account.")
  ...
  **/
   ...
   * @return rules
  **/
  @ApiModelProperty(value = "The posting rules that apply for the Posting Module")
