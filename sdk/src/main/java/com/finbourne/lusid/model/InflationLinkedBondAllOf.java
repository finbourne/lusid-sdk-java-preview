...
public class InflationLinkedBondAllOf {
  ...
  **/
  ...
  public InflationLinkedBondAllOf inflationIndexConventions(InflationIndexConventions inflationIndexConventions) {
  ...
  **/
  @ApiModelProperty(value = "The calculation type applied to the bond coupon and principal amount.  The default CalculationType is `Standard`.    Supported string (enumeration) values are: [Standard, Quarterly, Ratio, Brazil].")
  ...
  public InflationLinkedBondAllOf exDividendDays(Integer exDividendDays) {
  ...
  **/
  @ApiModelProperty(value = "Number of Good Business Days before the next coupon payment, in which the bond goes ex-dividend.")
  ...
  **/
  ...
  public InflationLinkedBondAllOf roundingConventions(List<RoundingConvention> roundingConventions) {
    this.roundingConventions = roundingConventions; 
    return this;
  }

  public InflationLinkedBondAllOf addRoundingConventionsItem(RoundingConvention roundingConventionsItem) {
