...
public class InflationLinkedBondAllOf {
  ...
  public InflationLinkedBondAllOf startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf maturityDate(OffsetDateTime maturityDate) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf flowConventions(FlowConventions flowConventions) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf couponRate(java.math.BigDecimal couponRate) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf identifiers(Map<String, String> identifiers) {
    this.identifiers = identifiers; 
    return this;
  }

  public InflationLinkedBondAllOf putIdentifiersItem(String key, String identifiersItem) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
  ...
  **/
  ...
  public InflationLinkedBondAllOf baseCPI(java.math.BigDecimal baseCPI) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf baseCPIDate(OffsetDateTime baseCPIDate) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf calculationType(String calculationType) {
  ...
  **/
  @ApiModelProperty(value = "The calculation type applied to the bond coupon and principal amount.  The default CalculationType is `Standard` and currently this is the only value supported.    Supported string (enumeration) values are: [Standard, Quarterly].")
  ...
  public InflationLinkedBondAllOf indexPrecision(Integer indexPrecision) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf inflationIndexName(String inflationIndexName) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf inflationInterpolation(String inflationInterpolation) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf inflationRollDay(Integer inflationRollDay) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf observationLag(String observationLag) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Observation lag. This is a Tenor that must have units of Month.  This field is typically 3 or 4 months, but can vary, older bonds have 8 months lag.")
  ...
  public InflationLinkedBondAllOf principal(java.math.BigDecimal principal) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf principalProtection(Boolean principalProtection) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf stubType(String stubType) {
  ...
  **/
  ...
  public InflationLinkedBondAllOf instrumentType(InstrumentTypeEnum instrumentType) {
