...
public class OrderGraphBlockPlacementSynopsis {
  ...
  public OrderGraphBlockPlacementSynopsis states(String states) {
    this.states = states; 
    return this;
  }
   ...
   * @return states
  **/
  @ApiModelProperty(required = true, value = "List of placement states of all the placements on this block.")
  ...
  **/
   ...
   * @return details
  **/
  @ApiModelProperty(required = true, value = "Identifiers for each placement in this block.")
