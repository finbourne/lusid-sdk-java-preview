 ...
 */
@ApiModel(description = "A definition for the period you wish to close")
...
public class ClosePeriodDiaryEntryRequest {
  ...
  **/
  @ApiModelProperty(value = "Unique code assigned to a period. When left blank a code will be created by the system in the format 'yyyyMMDD'.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "Identifiable Name assigned to the period. Where left blank, the system will generate a name in the format 'yyyyMMDD'.")
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(value = "The effective time of the diary entry.")
   ...
   * @return queryAsAt
  **/
  @ApiModelProperty(value = "The query time of the diary entry. Defaults to latest.")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "The status of the diary entry. Defaults to 'Undefined' for valuation points and 'Estimate' for closing periods.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "A set of properties for the diary entry.")
