...
public class InstrumentEventHolder {
  ...
  **/
  ...
  public InstrumentEventHolder properties(List<Property> properties) {
    this.properties = properties; 
    return this;
  }

  public InstrumentEventHolder addPropertiesItem(Property propertiesItem) {
  ...
  **/
  ...
  public InstrumentEventHolder anchorDate(OffsetDateTime anchorDate) {
   ...
   * @return anchorDate
  **/
  @ApiModelProperty(value = "The date the event is determined to have occured.")
