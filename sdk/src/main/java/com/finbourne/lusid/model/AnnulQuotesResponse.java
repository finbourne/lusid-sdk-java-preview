...
public class AnnulQuotesResponse {
  ...
  **/
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The collection of quotes requested to be annulled with the asAt time   at which they were annulled")
  ...
  public AnnulQuotesResponse failed(Map<String, List<String>> failed) {
    this.failed = failed;
    return this;
  }

  public AnnulQuotesResponse putFailedItem(String key, List<String> failedItem) {
    if (this.failed == null) {
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "If any quotes could not be annulled, they will be listed in 'Failed', along  with a reason why.")
