...
public class TargetTaxLot {
  ...
  private Double portfolioCost = null;
   ...
   * @return units
  **/
  @ApiModelProperty(required = true, value = "Quantity of holding")
   ...
   * @return cost
  **/
  @ApiModelProperty(value = "Book cost of holding in transaction currency")
  ...
  **/
  @ApiModelProperty(value = "Book cost of holding in portfolio currency")
   ...
   * @return price
  **/
  @ApiModelProperty(value = "Purchase price. Part of the unique key required for multiple taxlots")
   ...
   * @return purchaseDate
  **/
  @ApiModelProperty(value = "Purchase Date. Part of the unique key required for multiple taxlots")
  ...
  **/
  @ApiModelProperty(value = "Original settlement date of the tax-lot's opening transaction.")
