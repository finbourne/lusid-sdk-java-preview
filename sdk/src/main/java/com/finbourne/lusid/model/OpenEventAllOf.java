...
public class OpenEventAllOf {
  ...
  /**
   * The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent
   */
  ...
  public OpenEventAllOf anchorDate(OffsetDateTime anchorDate) {
   ...
   * @return anchorDate
  **/
  @ApiModelProperty(value = "The date on the which the instrument was opened.")
  ...
  public OpenEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent, StockSplitEvent, BondDefaultEvent, CashDividendEvent")
