...
public class OpenEventAllOf {
  ...
  /**
   * The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent
   */
  ...
  **/
  @ApiModelProperty(required = true, value = "The Type of Event. The available values are: TransitionEvent, InternalEvent, CouponEvent, OpenEvent, CloseEvent")
