...
public class CorporateAction {
  ...
  **/
  @ApiModelProperty(required = true, value = "Unique identifier for the corporate action")
  ...
  public CorporateAction description(String description) {
   ...
   /**
   * A description of the Corporate Action
   * @return description
  **/
  @ApiModelProperty(value = "A description of the Corporate Action")
