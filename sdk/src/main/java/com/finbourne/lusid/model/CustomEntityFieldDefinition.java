...
public class CustomEntityFieldDefinition {
  ...
  **/
   ...
   * @return lifetime
  **/
  @ApiModelProperty(required = true, value = "Describes how the field’s values can change over time. The available values are: “Perpetual”, “TimeVariant”.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The value type for the field. Available values are: “String”, “Boolean”, “DateTime”, “Decimal”.")
  ...
  **/
  @ApiModelProperty(value = "The collection type for the field. Available values are: “Single”, “Array”. Null value defaults to “Single”")
   ...
   * @return required
  **/
  @ApiModelProperty(required = true, value = "Whether the field is required or not.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "An optional description for the field.")
