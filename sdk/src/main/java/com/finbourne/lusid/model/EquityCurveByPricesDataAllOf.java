...
public class EquityCurveByPricesDataAllOf {
  ...
  public EquityCurveByPricesDataAllOf baseDate(OffsetDateTime baseDate) {
  ...
  **/
  ...
  public EquityCurveByPricesDataAllOf dates(List<OffsetDateTime> dates) {
    this.dates = dates; 
    return this;
  }

  public EquityCurveByPricesDataAllOf addDatesItem(OffsetDateTime datesItem) {
  ...
  **/
  ...
  public EquityCurveByPricesDataAllOf lineage(String lineage) {
  ...
  **/
  ...
  public EquityCurveByPricesDataAllOf prices(List<java.math.BigDecimal> prices) {
    this.prices = prices; 
    return this;
  }

  public EquityCurveByPricesDataAllOf addPricesItem(java.math.BigDecimal pricesItem) {
  ...
  **/
  ...
  public EquityCurveByPricesDataAllOf marketDataOptions(MarketDataOptions marketDataOptions) {
  ...
  **/
  ...
  public EquityCurveByPricesDataAllOf marketDataType(MarketDataTypeEnum marketDataType) {
