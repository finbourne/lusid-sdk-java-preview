...
public class ValuationSchedule {
  ...
  **/
  ...
  public ValuationSchedule rollConvention(String rollConvention) {
   ...
   /**
   * When Tenor is given and is not equal to \&quot;1D\&quot;, there may be cases where \&quot;date + tenor\&quot; ends up hitting non business days around month end. In that case,  what convention, e.g. modified following \&quot;MF\&quot; should be applied to determine the next GBD.
   * @return rollConvention
  **/
  @ApiModelProperty(value = "When Tenor is given and is not equal to \"1D\", there may be cases where \"date + tenor\" ends up hitting non business days around month end. In that case,  what convention, e.g. modified following \"MF\" should be applied to determine the next GBD.")
  ...
  public ValuationSchedule addHolidayCalendarsItem(String holidayCalendarsItem) {
   ...
   /**
   * What holiday calendars should be considered effective in determining the date schedule. Note that where these are not available, perhaps because the user  has insufficient permissions, a recipe setting will be used to determine whether the whole batch should then fail or whether the calendar not being available  should simply be ignored.
   * @return holidayCalendars
  **/
  @ApiModelProperty(value = "What holiday calendars should be considered effective in determining the date schedule. Note that where these are not available, perhaps because the user  has insufficient permissions, a recipe setting will be used to determine whether the whole batch should then fail or whether the calendar not being available  should simply be ignored.")
  ...
  public ValuationSchedule addValuationDateTimesItem(String valuationDateTimesItem) {
   ...
   /**
   * If given, the exact set of dates on which to perform a valuation. This will replace/override all other specified values if given
   * @return valuationDateTimes
  **/
  @ApiModelProperty(value = "If given, the exact set of dates on which to perform a valuation. This will replace/override all other specified values if given")
