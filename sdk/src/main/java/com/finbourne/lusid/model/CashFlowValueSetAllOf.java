...
public class CashFlowValueSetAllOf {
  ...
  public CashFlowValueSetAllOf cashflows(List<CashFlowValue> cashflows) {
    this.cashflows = cashflows; 
    return this;
  }

  public CashFlowValueSetAllOf addCashflowsItem(CashFlowValue cashflowsItem) {
   ...
   * @return cashflows
  **/
  @ApiModelProperty(value = "The set of cash flows in the result")
  ...
  public CashFlowValueSetAllOf resultValueType(ResultValueTypeEnum resultValueType) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class CashFlowValueSetAllOf {\n");
