...
public class CouponEventAllOf {
  ...
  public CouponEventAllOf anchorDate(OffsetDateTime anchorDate) {
    this.anchorDate = anchorDate; 
    return this;
  }

   /**
   * Date on which the coupon payment occurs.
   * @return anchorDate
  **/
  @ApiModelProperty(value = "Date on which the coupon payment occurs.")
  ...
  public CouponEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class CouponEventAllOf {\n");
