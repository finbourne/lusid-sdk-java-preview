...
public class CustomEntityId {
  ...
  **/
  @ApiModelProperty(required = true, value = "The scope the identifier resides in (the scope of the identifier property definition).")
  ...
  **/
  @ApiModelProperty(required = true, value = "What the identifier represents (the code of the identifier property definition).")
  ...
  **/
  @ApiModelProperty(required = true, value = "The value of the identifier for this entity.")
  ...
  **/
  @ApiModelProperty(value = "The effective datetime from which the identifier is valid.")
  ...
  **/
  @ApiModelProperty(value = "The effective datetime until which the identifier is valid. If not supplied this will be valid indefinitely, or until the next 'effectiveFrom' datetime of the identifier.")
