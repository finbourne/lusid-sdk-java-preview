...
public class TransactionConfigurationTypeAlias {
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "Transaction Code")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "Transaction Code description")
  ...
  **/
  @ApiModelProperty(required = true, value = "Transaction Class")
  ...
  **/
  @ApiModelProperty(required = true, value = "Transaction Group")
  ...
  **/
  @ApiModelProperty(required = true, value = "Transaction Roles")
