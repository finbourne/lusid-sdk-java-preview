 ...
 * An account
 */
@ApiModel(description = "An account")
...
public class Account {
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code given for the account.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description for the account.")
   ...
   * @return type
  **/
  @ApiModelProperty(required = true, value = "The account type. Can have the values: Asset/Liabilities/Income/Expense/Capital/Revenue.")
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The account status. Can be Active, Inactive or Deleted. Defaults to Active. The available values are: Active, Inactive, Deleted")
   ...
   * @return control
  **/
  @ApiModelProperty(required = true, value = "This allows users to specify whether this a protected account that prevents direct manual journal adjustment. Can have the values: System/ManualIt will default to “Manual”.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Account properties to add to the account.")
