...
public class BondCouponEventAllOf {
  ...
  public BondCouponEventAllOf exDate(OffsetDateTime exDate) {
    this.exDate = exDate; 
    return this;
  }
   ...
   * @return exDate
  **/
  @ApiModelProperty(required = true, value = "Ex-Dividend date of the coupon payment")
  ...
  public BondCouponEventAllOf paymentDate(OffsetDateTime paymentDate) {
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "Payment date of the coupon payment")
  ...
  public BondCouponEventAllOf currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "Currency of the coupon payment")
  ...
  public BondCouponEventAllOf couponPerUnit(java.math.BigDecimal couponPerUnit) {
  ...
  **/
  @ApiModelProperty(required = true, value = "CouponRate*Principal")
  ...
  public BondCouponEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
