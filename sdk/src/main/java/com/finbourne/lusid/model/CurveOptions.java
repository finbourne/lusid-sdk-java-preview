...
import com.finbourne.lusid.model.CurveOptionsAllOf;
 ...
 */
@ApiModel(description = "Options for configuring how ComplexMarketData representing a 'curve' is interpreted.")
...
public class CurveOptions extends MarketDataOptions {
  ...
  **/
  @ApiModelProperty(value = "Day count convention of the curve. Defaults to \"Act360\".")
  ...
  **/
  @ApiModelProperty(value = "What type of extrapolation is used to build the curve  Imagine that the curve is facing the observer(you), then the \"front\" direction is the closest point on the curve onward. <br />  example: 0D tenor to past  Defaults to \"Flat\". Supported string (enumeration) values are: [None, Flat, Linear].")
