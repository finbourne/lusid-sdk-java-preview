...
public class BucketedCashFlowResponse {
  ...
  **/
  ...
  public BucketedCashFlowResponse data(List<IDataRecord> data) {
    this.data = data;
    return this;
  }

  public BucketedCashFlowResponse addDataItem(IDataRecord dataItem) {
    if (this.data == null) {
   ...
   /**
   * DataRecord array of BucketedCashFlow
   * @return data
  **/
  @ApiModelProperty(value = "DataRecord array of BucketedCashFlow")
