...
public class GetConventionsResponse {
  ...
  private FlowConventions values = null;
  ...
  public GetConventionsResponse href(URI href) {
    this.href = href;
    return this;
  }
  ...
  **/
  ...
  public GetConventionsResponse values(FlowConventions values) {
    this.values = values;
    return this;
  }
  ...
  **/
  ...
  public FlowConventions getValues() {
    return values;
  }

  public void setValues(FlowConventions values) {
    this.values = values;
  }

  public GetConventionsResponse failed(Map<String, ErrorDetail> failed) {
    this.failed = failed;
    return this;
  }

  public GetConventionsResponse putFailedItem(String key, ErrorDetail failedItem) {
    if (this.failed == null) {
   ...
   /**
   * The identifiers which did not resolve to a convention along with the nature of the failure.
   * @return failed
  **/
  @ApiModelProperty(value = "The identifiers which did not resolve to a convention along with the nature of the failure.")
  ...
  public GetConventionsResponse links(List<Link> links) {
    this.links = links;
    return this;
  }

  public GetConventionsResponse addLinksItem(Link linksItem) {
    if (this.links == null) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class GetConventionsResponse {\n");
