 ...
 * An Abor entity.
 */
@ApiModel(description = "An Abor entity.")
...
public class Abor {
  ...
  **/
   ...
   * @return displayName
  **/
  @ApiModelProperty(value = "The given name for the Abor.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description for the Abor.")
   ...
   * @return portfolioIds
  **/
  @ApiModelProperty(required = true, value = "The list with the portfolio ids which are part of the Abor. For now the only supported value is SinglePortfolio.")
  ...
  **/
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Properties to add to the Abor.")
