...
public class TransactionQueryParameters {
  ...
  public enum QueryModeEnum {
    ...
    public static class Adapter extends TypeAdapter<QueryModeEnum> {
      ...
      public QueryModeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return QueryModeEnum.fromValue(String.valueOf(value));
      }
    }
  }
  ...
  private Boolean showCancelledTransactions = null;
   ...
   * @return startDate
  **/
  @ApiModelProperty(value = "The required set of transactions should begin from this date")
   ...
   * @return endDate
  **/
  @ApiModelProperty(value = "The required set of transactions should end at this date")
   ...
   * @return queryMode
  **/
  @ApiModelProperty(value = "The method for date selection. Trade date or Settlement date")
  ...
  **/
  @ApiModelProperty(value = "Option to include cancelled transactions in the results")
  public Boolean isShowCancelledTransactions() {
    return showCancelledTransactions;
  }
