...
public class TransactionQueryParameters {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The lower bound effective datetime (inclusive) from which to build the transactions.")
   ...
   * @return endDate
  **/
  @ApiModelProperty(required = true, value = "The upper bound effective datetime (inclusive) from which to retrieve transactions.")
   ...
   * @return queryMode
  **/
  @ApiModelProperty(value = "The date to compare against the upper and lower bounds for the effective datetime. Defaults to 'TradeDate' if not specified.")
