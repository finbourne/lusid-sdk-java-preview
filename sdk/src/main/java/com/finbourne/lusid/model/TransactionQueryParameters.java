...
public class TransactionQueryParameters {
   ...
   * @return startDate
  **/
  @ApiModelProperty(required = true, value = "The lower bound effectiveAt datetime (inclusive) from which to build the transactions.")
   ...
   * @return endDate
  **/
  @ApiModelProperty(required = true, value = "The upper bound effectiveAt datetime (inclusive) from which to retrieve transactions.")
   ...
   * @return queryMode
  **/
  @ApiModelProperty(value = "The date to compare against the upper and lower bounds for the effectiveAt datetime. Defaults to 'TradeDate' if not specified.")
