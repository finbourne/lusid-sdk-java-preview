 ...
 */
@ApiModel(description = "An address key with additional data describing what this key is for.")
...
public class DescribedAddressKey {
   ...
   * @return addressKey
  **/
  @ApiModelProperty(value = "Address key of some underlying object e.g. Valuation/PV, Instrument/Features")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "Description of the address key.")
