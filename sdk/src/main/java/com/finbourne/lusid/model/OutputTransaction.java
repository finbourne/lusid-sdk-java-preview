...
public class OutputTransaction {
  ...
  private List<Long> holdingIds = null;
  ...
  **/
  @ApiModelProperty(required = true, value = "The unique Lusid Instrument Id (LUID) of the instrument that the transaction is in.")
  ...
  **/
   ...
   * @return holdingIds
  **/
  @ApiModelProperty(value = "The collection of single identifiers for the holding within the portfolio. The holdingId is constructed from the LusidInstrumentId, sub-holding keys and currrency and is unique within the portfolio.")
