...
public class ComplianceRuleResult {
  ...
  private Integer ruleLowerLimit;
  ...
  private Integer ruleUpperLimit;
   ...
   * @return ruleId
  **/
  @ApiModelProperty(required = true, value = "The unique identifierof a compliance rule")
   ...
   * @return ruleName
  **/
  @ApiModelProperty(required = true, value = "The User-given name of the rule")
  ...
  **/
  @ApiModelProperty(required = true, value = "The User-given description of the rule")
  ...
  **/
   ...
   * @return passed
  **/
  @ApiModelProperty(required = true, value = "The result of an individual compliance run, true if passed")
  ...
  **/
  @ApiModelProperty(required = true, value = "The value matched by the rule")
  ...
  **/
  @ApiModelProperty(required = true, value = "The property key matched by the rule")
  ...
  public ComplianceRuleResult ruleLowerLimit(Integer ruleLowerLimit) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The lower limit of the rule")
  public Integer getRuleLowerLimit() {
    return ruleLowerLimit;
  }

  public void setRuleLowerLimit(Integer ruleLowerLimit) {
    this.ruleLowerLimit = ruleLowerLimit;
  }


  public ComplianceRuleResult ruleUpperLimit(Integer ruleUpperLimit) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The upper limit of the rule")
  public Integer getRuleUpperLimit() {
    return ruleUpperLimit;
  }

  public void setRuleUpperLimit(Integer ruleUpperLimit) {
    this.ruleUpperLimit = ruleUpperLimit;
  }
