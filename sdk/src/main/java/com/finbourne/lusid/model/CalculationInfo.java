...
public class CalculationInfo {
  ...
  /**
   * The available values are: Rate, BasisPoints, Bps, Percentage, Flat, FlatFee, None
   */
  ...
  /**
   * The available values are: Quantity, Value, None
   */
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Rate, BasisPoints, Bps, Percentage, Flat, FlatFee, None")
   ...
   * @return multiplier
  **/
  @ApiModelProperty(required = true, value = "The available values are: Quantity, Value, None")
