...
public class CalculationInfo {
  public static final String SERIALIZED_NAME_CALCULATION_DESCRIPTION = "calculationDescription";
  @SerializedName(SERIALIZED_NAME_CALCULATION_DESCRIPTION)
  private String calculationDescription;

  /**
   * Method of calculating the fees or commission among: BasisPoints, Percentage, Rate, Flat etc. The available values are: Rate, BasisPoints, Percentage, Flat
   */
  ...
  /**
   * . The available values are: None, Quantity, Value
   */
  @JsonAdapter(MultiplierEnum.Adapter.class)
  public enum MultiplierEnum {
    ...
    public static MultiplierEnum fromValue(String value) {
      for (MultiplierEnum b : MultiplierEnum.values()) {
        if (b.value.equals(value)) {
          return b;
        }
      }
    ...
    public static class Adapter extends TypeAdapter<MultiplierEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final MultiplierEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public MultiplierEnum read(final JsonReader jsonReader) throws IOException {
        String value =  jsonReader.nextString();
        return MultiplierEnum.fromValue(value);
      }
    }
  }
  ...
  public CalculationInfo calculationDescription(String calculationDescription) {
    this.calculationDescription = calculationDescription; 
    return this;
  }

   /**
   * Description of what the calculation applies to eg. Fee, MinFee, MaxFee
   * @return calculationDescription
  **/
  @ApiModelProperty(required = true, value = "Description of what the calculation applies to eg. Fee, MinFee, MaxFee")
  ...
  public CalculationInfo calculationMethod(CalculationMethodEnum calculationMethod) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Method of calculating the fees or commission among: BasisPoints, Percentage, Rate, Flat etc. The available values are: Rate, BasisPoints, Percentage, Flat")
  ...
  public CalculationInfo multiplier(MultiplierEnum multiplier) {
   ...
   * @return multiplier
  **/
  @ApiModelProperty(required = true, value = ". The available values are: None, Quantity, Value")
  public MultiplierEnum getMultiplier() {
    return multiplier;
  }

  public void setMultiplier(MultiplierEnum multiplier) {
    this.multiplier = multiplier;
  }
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    calculationDescription: ").append(toIndentedString(calculationDescription)).append("\n");
