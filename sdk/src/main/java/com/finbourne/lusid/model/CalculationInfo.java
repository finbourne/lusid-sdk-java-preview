...
public class CalculationInfo {
  ...
  **/
  @ApiModelProperty(required = true, value = "Method of calculating the fees or commission among: BasisPoints, Percentage, Rate, Flat etc.")
   ...
   * @return multiplier
  **/
  @ApiModelProperty(required = true, value = "Field by which to multiply the numerical amount. Eg: Quantity, Value")
