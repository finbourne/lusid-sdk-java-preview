...
import com.finbourne.lusid.model.InternalEventAllOf;
 ...
 */
@ApiModel(description = "A generic event which contains a number of possible events derived from the economic definition of an instrument.")
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen")
public class InternalEvent extends InstrumentEvent {
   ...
   * @return eventType
  **/
  @ApiModelProperty(value = "What category of event does this represent; instrument opening, closing, transition or other.")
  ...
  public InternalEvent eventCategory(String eventCategory) {
  ...
  **/
  ...
  public InternalEvent eventSource(String eventSource) {
   ...
   * @return eventSource
  **/
  @ApiModelProperty(value = "What is the event source, what causes it to happen.")
  ...
  public InternalEvent anchorDate(OffsetDateTime anchorDate) {
   ...
   * @return anchorDate
  **/
  @ApiModelProperty(value = "In the case of a point event, the single date on which the event occurs. In the case of an event which is  spread over a window, e.g. a barrier or American option, the start of that window.")
  ...
  **/
  @ApiModelProperty(value = "In the case of a point event this is identical to the anchor date. In the case of an event that is spread over a window,  this is the end of that window.")
