...
public class MarketOptions {
  ...
  public enum DefaultSupplierEnum {
    ...
    public static DefaultSupplierEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<DefaultSupplierEnum> {
      ...
      public DefaultSupplierEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return DefaultSupplierEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("defaultSupplier")
  private DefaultSupplierEnum defaultSupplier = null;
  ...
  public enum DefaultInstrumentCodeTypeEnum {
    ...
    public static DefaultInstrumentCodeTypeEnum fromValue(String text) {
    ...
    public static class Adapter extends TypeAdapter<DefaultInstrumentCodeTypeEnum> {
      ...
      public DefaultInstrumentCodeTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return DefaultInstrumentCodeTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }

  @SerializedName("defaultInstrumentCodeType")
  private DefaultInstrumentCodeTypeEnum defaultInstrumentCodeType = null;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(defaultSupplier, defaultInstrumentCodeType, defaultScope);
  }
