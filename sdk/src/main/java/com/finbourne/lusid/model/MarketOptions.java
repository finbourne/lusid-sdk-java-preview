...
public class MarketOptions {
  ...
  **/
   ...
   * @return defaultScope
  **/
  @ApiModelProperty(required = true, value = "For default rules, which scope should data be searched for in")
  ...
  **/
  @ApiModelProperty(value = "The scope in which holiday calendars stored")
  ...
  **/
  @ApiModelProperty(value = "The scope in which conventions stored")
