...
public class MarketOptions {
  /**
   * The available values are: DataScope, Lusid, Isda, Client, Edi, TraderMade, FactSet
   */
  ...
  /**
   * The available values are: LusidInstrumentId, Figi, RIC, QuotePermId, Isin, CurrencyPair
   */
  ...
  /**
   * The available values are: None, Full
   */
  ...
  **/
  @ApiModelProperty(value = "The available values are: DataScope, Lusid, Isda, Client, Edi, TraderMade, FactSet")
  ...
  **/
  @ApiModelProperty(value = "The available values are: LusidInstrumentId, Figi, RIC, QuotePermId, Isin, CurrencyPair")
  ...
  **/
  @ApiModelProperty(value = "The available values are: None, Full")
