...
import com.finbourne.lusid.model.VendorDependencyAllOf;
 ...
 */
@ApiModel(description = "For indicating a dependency on some opaque market data requested by an outside vendor")
...
public class VendorDependency extends EconomicDependency {
   ...
   * @return vendorName
  **/
  @ApiModelProperty(required = true, value = "The name of the outside vendor")
   ...
   * @return vendorPath
  **/
  @ApiModelProperty(required = true, value = "The specific dependency path")
   ...
   * @return date
  **/
  @ApiModelProperty(required = true, value = "The effectiveDate of the entity that this is a dependency for.")
