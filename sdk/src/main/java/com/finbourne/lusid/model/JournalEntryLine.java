 ...
 */
@ApiModel(description = "A Journal Entry line entity.")
...
public class JournalEntryLine {
  ...
  private List<String> sourceLevels = null;
  ...
  **/
  @ApiModelProperty(required = true, value = "The Journal Entry Line accounting date.")
   ...
   * @return activityDate
  **/
  @ApiModelProperty(required = true, value = "The actual date of the activity. Differs from the accounting date when creating journals that would occur in a closed period.")
  ...
  **/
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(required = true, value = "To indicate the instrument of the transaction that the Journal Entry Line posted for, if applicable.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The scope in which the Journal Entry Line instrument is in.")
  ...
  **/
  @ApiModelProperty(value = "The sub-holding properties which are part of the AccountingKey.")
   ...
   * @return taxLotId
  **/
  @ApiModelProperty(required = true, value = "The tax lot Id that the Journal Entry Line is impacting.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The code of the account in the general ledger the Journal Entry was posted to.")
  ...
  **/
  @ApiModelProperty(value = "The code of the posting module where the posting rules derived the Journal Entry lines.")
   ...
   * @return postingRule
  **/
  @ApiModelProperty(required = true, value = "The rule generating the Journal Entry Line.")
   ...
   * @return asAtDate
  **/
  @ApiModelProperty(required = true, value = "The corresponding input date and time of the Transaction generating the Journal Entry Line.")
  ...
  **/
  @ApiModelProperty(value = "This would be the description of the business activities this Journal Entry Line is for.")
   ...
   * @return sourceType
  **/
  @ApiModelProperty(required = true, value = "So far are 4 types: LusidTxn, LusidValuation, Manual and External.")
   ...
   * @return sourceId
  **/
  @ApiModelProperty(required = true, value = "For the Lusid Source Type this will be the txn Id. For the rest will be what the user populates.")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "A set of properties for the Abor.")
   ...
   * @return movementName
  **/
  @ApiModelProperty(required = true, value = "The name of the movement.")
   ...
   * @return holdingType
  **/
  @ApiModelProperty(required = true, value = "Defines the broad category holding within the portfolio.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Raw Journal Entry Line details of the economic bucket for the Journal Entry Line.")
  ...
  **/
  @ApiModelProperty(value = "Sub bucket of the economic bucket.")
   ...
   * @return levels
  **/
  @ApiModelProperty(value = "Resolved data from the general ledger profile where the GeneralLedgerProfileCode is specified in the GetJournalEntryLines request body.")
   ...
   * @return sourceLevels
  **/
  @ApiModelProperty(value = "Source data from the general ledger profile where the GeneralLedgerProfileCode is specified in the GetJournalEntryLines request body.")
   ...
   * @return movementSign
  **/
  @ApiModelProperty(value = "Indicates if the Journal Entry Line corresponds to a Long or Short movement.")
   ...
   * @return holdingSign
  **/
  @ApiModelProperty(value = "Indicates if the Journal Entry Line is operating against a Long or Short holding.")
