...
public class HoldingAdjustmentWithDate {
   ...
   * @return effectiveAt
  **/
  @ApiModelProperty(value = "The effective date of the holding adjustment")
  ...
  **/
  @ApiModelProperty(required = true, value = "The unique Lusid Instrument Id (LUID) of the instrument that the holding adjustment is in.")
