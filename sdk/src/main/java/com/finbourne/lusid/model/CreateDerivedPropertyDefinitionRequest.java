...
public class CreateDerivedPropertyDefinitionRequest {
  ...
  **/
  ...
  public CreateDerivedPropertyDefinitionRequest derivation(String derivation) {
   ...
   * @return derivation
  **/
  @ApiModelProperty(value = "The string that contains the rule for the derived property.")
