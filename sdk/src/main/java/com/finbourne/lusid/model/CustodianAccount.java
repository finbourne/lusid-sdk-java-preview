...
public class CustodianAccount {
  ...
  **/
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The Account status. Can be Active, Inactive or Deleted. Defaults to Active.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The Custodian Account Number")
   ...
   * @return accountName
  **/
  @ApiModelProperty(required = true, value = "The identifiable name given to the Custodian Account")
  ...
  **/
  @ApiModelProperty(required = true, value = "The Accounting method to be used")
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "The Currency for the Account")
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Set of unique Custodian Account properties and associated values to store with the Custodian Account. Each property must be from the 'CustodianAccount' domain.")
  ...
  **/
   ...
   * @return accountType
  **/
  @ApiModelProperty(required = true, value = "The Type of the Custodian Account. Can be Margin, Cash or Swap. Defaults to Margin.")
