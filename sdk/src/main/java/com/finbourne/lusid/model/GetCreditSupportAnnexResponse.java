...
public class GetCreditSupportAnnexResponse {
  ...
  private CreditSupportAnnex value = null;
  ...
  **/
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The credit support annex that could not be updated or inserted along with a reason for failure.")
