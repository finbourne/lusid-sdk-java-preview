...
public class PagedResourceListOfAborConfiguration {
  ...
  private List<AborConfiguration> values = new ArrayList<>();
  ...
  public PagedResourceListOfAborConfiguration nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfAborConfiguration previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfAborConfiguration values(List<AborConfiguration> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfAborConfiguration addValuesItem(AborConfiguration valuesItem) {
  ...
  **/
  ...
  public List<AborConfiguration> getValues() {
    return values;
  }

  public void setValues(List<AborConfiguration> values) {
    this.values = values;
  }


  public PagedResourceListOfAborConfiguration href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfAborConfiguration links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfAborConfiguration addLinksItem(Link linksItem) {
