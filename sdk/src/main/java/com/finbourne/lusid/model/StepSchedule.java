 ...
 */
@ApiModel(description = "Schedule that steps at known dated points in time.  Used in representation of a sinking bond, also called amortisation, steps in coupons for fixed bonds and spreads for floating bonds.")
...
public class StepSchedule {
  ...
  **/
  ...
  public StepSchedule scheduleType(String scheduleType) {
    this.scheduleType = scheduleType; 
    return this;
  }

   /**
   * What type of schedule does this represent.  Supported string (enumeration) values are: [Fixed, Float, Optionality, Step, Payment, Accrual].
   * @return scheduleType
  **/
  @ApiModelProperty(required = true, value = "What type of schedule does this represent.  Supported string (enumeration) values are: [Fixed, Float, Optionality, Step, Payment, Accrual].")
