...
public class SimpleCashFlowLoanAllOf {
  ...
  public SimpleCashFlowLoanAllOf startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public SimpleCashFlowLoanAllOf maturityDate(OffsetDateTime maturityDate) {
  ...
  **/
  ...
  public SimpleCashFlowLoanAllOf domCcy(String domCcy) {
    this.domCcy = domCcy; 
    return this;
  }
  ...
  **/
  ...
  public SimpleCashFlowLoanAllOf periods(List<LoanPeriod> periods) {
    this.periods = periods; 
    return this;
  }

  public SimpleCashFlowLoanAllOf addPeriodsItem(LoanPeriod periodsItem) {
  ...
  **/
  ...
  public SimpleCashFlowLoanAllOf instrumentType(InstrumentTypeEnum instrumentType) {
