...
public class CutLabelDefinition {
  ...
  public CutLabelDefinition code(String code) {
   ...
   /**
   * Unique code to identify this cut label. Must be less than 20 characters, and only contain letters, numbers or underscores.
   * @return code
  **/
  @ApiModelProperty(value = "Unique code to identify this cut label. Must be less than 20 characters, and only contain letters, numbers or underscores.")
  ...
  public CutLabelDefinition displayName(String displayName) {
   ...
   /**
   * The human-readable name for this cut.
   * @return displayName
  **/
  @ApiModelProperty(value = "The human-readable name for this cut.")
  ...
  public CutLabelDefinition description(String description) {
   ...
   /**
   * The description for this cut.
   * @return description
  **/
  @ApiModelProperty(value = "The description for this cut.")
  ...
  **/
  ...
  public CutLabelDefinition timeZone(String timeZone) {
   ...
   /**
   * The ID of the IANA global timezone for which this cut should be evaluated.
   * @return timeZone
  **/
  @ApiModelProperty(value = "The ID of the IANA global timezone for which this cut should be evaluated.")
