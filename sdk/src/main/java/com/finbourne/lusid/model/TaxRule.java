...
public class TaxRule {
  ...
  **/
   ...
   * @return rate
  **/
  @ApiModelProperty(required = true, value = "The rate to be applied if all criteria are met")
  ...
  **/
  @ApiModelProperty(required = true, value = "A set of criteria to be met for this rule to be applied")
