...
public class TaxRule {
  ...
  private List<PropertyCriterion> criteria = new ArrayList<>();
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "A user-friendly name")
   ...
   * @return description
  **/
  @ApiModelProperty(required = true, value = "A description for this rule")
  ...
  public TaxRule rate(java.math.BigDecimal rate) {
   ...
   /**
   * The rate to be applied if all conditions are met
   * @return rate
  **/
  @ApiModelProperty(required = true, value = "The rate to be applied if all conditions are met")
  ...
  public TaxRule criteria(List<PropertyCriterion> criteria) {
    this.criteria = criteria; 
    return this;
  }

  public TaxRule addCriteriaItem(PropertyCriterion criteriaItem) {
   ...
   /**
   * A set of conditions to be met for this rule to be applied
   * @return criteria
  **/
  @ApiModelProperty(required = true, value = "A set of conditions to be met for this rule to be applied")
  ...
  public TaxRule links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public TaxRule addLinksItem(Link linksItem) {
