...
import com.finbourne.lusid.model.LifeCycleEventValueAllOf;
 ...
 */
@ApiModel(description = "The instrument life cycle event result value type")
...
public class LifeCycleEventValue extends ResultValue {
  ...
  private ResultValueDictionary eventValues = null;
  ...
  **/
  @ApiModelProperty(value = "The effective date of the event")
