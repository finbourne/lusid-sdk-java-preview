...
public class GetVirtualDocumentResponse {
  ...
  private Map<String, VirtualDocument> values = null;
  ...
  **/
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The set of calues that could not be retrieved along with a reason for this, e.g. badly formed request.")
