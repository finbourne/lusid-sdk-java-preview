 ...
 */
@ApiModel(description = "The result of invoking a translation script.")
...
public class TranslationResult {
   ...
   * @return entity
  **/
  @ApiModelProperty(required = true, value = "The serialised entity the translation script produced.")
   ...
   * @return properties
  **/
  @ApiModelProperty(required = true, value = "Any properties the translation script produced.")
