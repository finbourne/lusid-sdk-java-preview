...
public class FxRateScheduleAllOf {
  public static final String SERIALIZED_NAME_FIXING_LAG = "fixingLag";
  @SerializedName(SERIALIZED_NAME_FIXING_LAG)
  ...
  private List<String> fxConversionTypes = null;
  ...
  public FxRateScheduleAllOf fixingLag(Integer fixingLag) {
   ...
   * @return fixingLag
  **/
  @ApiModelProperty(value = "If rate is not known upfront then will need a fixing rate. Can be fixed x number of days before payment date.")
  ...
  public FxRateScheduleAllOf fxConversionTypes(List<String> fxConversionTypes) {
    this.fxConversionTypes = fxConversionTypes; 
    return this;
  }

  public FxRateScheduleAllOf addFxConversionTypesItem(String fxConversionTypesItem) {
  ...
  **/
  @ApiModelProperty(value = "List of flags to indicate if coupon payments, principal payments or both are converted")
  ...
  public FxRateScheduleAllOf rate(java.math.BigDecimal rate) {
    this.rate = rate; 
    return this;
  }
   ...
   * @return rate
  **/
  @ApiModelProperty(value = "FxRate used to convert payments. Assumed to be in units of the ToCurrency so conversion is paymentAmount x fxRate")
  ...
  public FxRateScheduleAllOf toCurrency(String toCurrency) {
   ...
   * @return toCurrency
  **/
  @ApiModelProperty(value = "Currency that payments are converted to")
  ...
  public FxRateScheduleAllOf scheduleType(ScheduleTypeEnum scheduleType) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    fixingLag: ").append(toIndentedString(fixingLag)).append("\n");
