...
public class UpsertStructuredDataResponse {
  ...
  **/
  ...
  public UpsertStructuredDataResponse putValuesItem(String key, OffsetDateTime valuesItem) {
   ...
   /**
   * the times for the successfully inserted values.
   * @return values
  **/
  @ApiModelProperty(value = "the times for the successfully inserted values.")
  ...
  public UpsertStructuredDataResponse putFailedItem(String key, ErrorDetail failedItem) {
   ...
   /**
   * The cases where the upsert failed for some reason.
   * @return failed
  **/
  @ApiModelProperty(value = "The cases where the upsert failed for some reason.")
