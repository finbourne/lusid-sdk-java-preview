...
public class PagedResourceListOfPostingModuleResponse {
  ...
  private List<PostingModuleResponse> values = new ArrayList<>();
  ...
  public PagedResourceListOfPostingModuleResponse nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfPostingModuleResponse previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfPostingModuleResponse values(List<PostingModuleResponse> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfPostingModuleResponse addValuesItem(PostingModuleResponse valuesItem) {
  ...
  **/
  ...
  public List<PostingModuleResponse> getValues() {
    return values;
  }

  public void setValues(List<PostingModuleResponse> values) {
    this.values = values;
  }


  public PagedResourceListOfPostingModuleResponse href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfPostingModuleResponse links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfPostingModuleResponse addLinksItem(Link linksItem) {
