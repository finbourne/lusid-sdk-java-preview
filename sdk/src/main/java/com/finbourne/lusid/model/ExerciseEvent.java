...
import com.finbourne.lusid.model.ExerciseEventAllOf;
 ...
 */
@ApiModel(description = "Definition of an exercise event.  This is an event that occurs on transformation of an instrument owing to exercise. e.g. an option of  some type into its underlying.")
