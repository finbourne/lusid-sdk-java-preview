...
public class CustodianAccountRequest {
   ...
   * @return scope
  **/
  @ApiModelProperty(value = "The Scope assigned to the Custodian Account, where left blank the parent Portfolio Scope will be used")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "Unique Code representing the Custodian Account")
   ...
   * @return status
  **/
  @ApiModelProperty(value = "The account status. Can be Active, Inactive or Deleted. Defaults to Active.")
  ...
  **/
   ...
   * @return accountType
  **/
  @ApiModelProperty(value = "The Type of the Custodian Account. Can be Margin, Cash or Swap. Defaults to Margin.")
