...
import com.finbourne.lusid.model.DividendOptionEventAllOf;
...
public class DividendOptionEvent extends InstrumentEvent {
  ...
  **/
   ...
   * @return recordDate
  **/
  @ApiModelProperty(value = "Date you have to be the holder of record in order to participate in the tender.")
  ...
  **/
  @ApiModelProperty(value = "Date on which the dividend was the security settles.  Equal to the PaymentDate if not provided.")
