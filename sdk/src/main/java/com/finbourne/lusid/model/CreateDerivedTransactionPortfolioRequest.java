...
public class CreateDerivedTransactionPortfolioRequest {
  ...
  /**
   * Default taxlot selection method for the portfolio
   */
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "Portfolio display name")
  ...
  **/
  @ApiModelProperty(value = "Default taxlot selection method for the portfolio")
  ...
  **/
  @ApiModelProperty(value = "Set of unique holding identifiers, e.g. trader, desk, strategy.")
