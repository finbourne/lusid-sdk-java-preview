...
/**
 * Gets or Sets MarketIdentifier
 */
@JsonAdapter(MarketIdentifier.Adapter.class)
public enum MarketIdentifier {
  ...
  public static MarketIdentifier fromValue(String value) {
    for (MarketIdentifier b : MarketIdentifier.values()) {
  ...
  public static class Adapter extends TypeAdapter<MarketIdentifier> {
    @Override
    public void write(final JsonWriter jsonWriter, final MarketIdentifier enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public MarketIdentifier read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return MarketIdentifier.fromValue(value);
    }
  }
}
