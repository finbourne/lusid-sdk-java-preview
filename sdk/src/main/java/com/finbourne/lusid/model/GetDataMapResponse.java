...
public class GetDataMapResponse {
  ...
  private Map<String, DataMapping> values = null;
  ...
  **/
   ...
   * @return failed
  **/
  @ApiModelProperty(value = "The set of values that could not be retrieved along with a reason for this, e.g. badly formed request.")
