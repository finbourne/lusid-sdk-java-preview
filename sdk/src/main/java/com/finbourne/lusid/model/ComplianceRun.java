...
public class ComplianceRun {
  ...
  public ComplianceRun runId(String runId) {
    this.runId = runId; 
    return this;
  }
  ...
  **/
  ...
  public ComplianceRun asAt(OffsetDateTime asAt) {
    this.asAt = asAt; 
    return this;
  }

   /**
   * The date at time at which the compliance run was run
   * @return asAt
  **/
  @ApiModelProperty(required = true, value = "The date at time at which the compliance run was run")
