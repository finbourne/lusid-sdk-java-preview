...
import com.finbourne.lusid.model.RawVendorEventAllOf;
 ...
 */
@ApiModel(description = "A generic event derived from the economic definition of an instrument. This should be considered purely  informational; any data provided by this event is not guaranteed to be processable by LUSID.")
