...
import com.finbourne.lusid.model.EquityCurveByPricesDataAllOf;
 ...
 */
@ApiModel(description = "Contains data (i.e. dates and prices + metadata) for building Equity curves")
...
public class EquityCurveByPricesData extends ComplexMarketData {
   ...
   * @return baseDate
  **/
  @ApiModelProperty(required = true, value = "EffectiveAt date of the provided prices")
   ...
   * @return dates
  **/
  @ApiModelProperty(required = true, value = "Dates provided for the forward price of the Equity at the corresponding price in Prices.  These dates should be in the future with respect to the BaseDate.")
  ...
  **/
   ...
   * @return prices
  **/
  @ApiModelProperty(required = true, value = "Prices provided for the forward price of the Equity at the corresponding date in Dates.")
