...
public class OrderBySpec {
   ...
   * @return key
  **/
  @ApiModelProperty(required = true, value = "The key that uniquely identifies the property. It has the format {domain}/{scope}/{code}.")
   ...
   * @return sortOrder
  **/
  @ApiModelProperty(required = true, value = "The available values are: Ascending, Descending")
