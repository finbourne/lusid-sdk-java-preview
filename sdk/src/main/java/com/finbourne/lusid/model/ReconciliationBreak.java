...
public class ReconciliationBreak {
  ...
  private Double leftUnits = null;

  @SerializedName("rightUnits")
  private Double rightUnits = null;

  @SerializedName("differenceUnits")
  private Double differenceUnits = null;
  ...
  **/
  ...
  public ReconciliationBreak subHoldingKeys(List<PerpetualProperty> subHoldingKeys) {
    this.subHoldingKeys = subHoldingKeys;
    return this;
  }

  public ReconciliationBreak addSubHoldingKeysItem(PerpetualProperty subHoldingKeysItem) {
  ...
  **/
   ...
   * @return leftCost
  **/
  @ApiModelProperty(required = true, value = "Cost from the left hand side")
   ...
   * @return rightCost
  **/
  @ApiModelProperty(required = true, value = "Cost from the right hand side")
  ...
  **/
  @ApiModelProperty(required = true, value = "Difference in cost")
  ...
  **/
  @ApiModelProperty(required = true, value = "Additional features relating to the security")
