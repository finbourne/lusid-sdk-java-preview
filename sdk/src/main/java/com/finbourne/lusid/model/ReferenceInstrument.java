...
import com.finbourne.lusid.model.ReferenceInstrumentAllOf;
 ...
 */
@ApiModel(description = "An abstract class to hold a reference to another (already loaded) instrument (e.g. a lookthrough to a portfolio) be expanded later")
...
public class ReferenceInstrument extends LusidInstrument {
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(required = true, value = "The Identifier code")
  ...
  **/
  @ApiModelProperty(required = true, value = "the type of the instrument id e.g. LusidInstrument Id")
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "(optional) Scope for the instrument")
