 ...
 */
@ApiModel(description = "LUSID representation of a reference to another instrument that has already been loaded (e.g. a lookthrough to a portfolio).")
...
public class ReferenceInstrument extends LusidInstrument {
  ...
  **/
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "Scope for the instrument (optional)")
