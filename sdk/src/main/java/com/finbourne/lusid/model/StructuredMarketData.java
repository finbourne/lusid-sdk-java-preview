...
public class StructuredMarketData {
  ...
  **/
  @ApiModelProperty(required = true, value = "The format of the document.")
   ...
   * @return version
  **/
  @ApiModelProperty(value = "Semantic version of the document; MAJOR.MINOR.PATCH")
  ...
  public StructuredMarketData name(String name) {
   ...
   /**
   * name of the document. An identifier that is effectively a free-text field for an appropriate description if desired
   * @return name
  **/
  @ApiModelProperty(value = "name of the document. An identifier that is effectively a free-text field for an appropriate description if desired")
   ...
   * @return document
  **/
  @ApiModelProperty(required = true, value = "The document, serialized to a string.")
