...
public class ResourceListOfA2BDataRecord {
  ...
  public ResourceListOfA2BDataRecord values(List<A2BDataRecord> values) {
    this.values = values; 
    return this;
  }

  public ResourceListOfA2BDataRecord addValuesItem(A2BDataRecord valuesItem) {
  ...
  **/
  ...
  public ResourceListOfA2BDataRecord href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public ResourceListOfA2BDataRecord links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public ResourceListOfA2BDataRecord addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public ResourceListOfA2BDataRecord nextPage(String nextPage) {
  ...
  **/
  ...
  public ResourceListOfA2BDataRecord previousPage(String previousPage) {
