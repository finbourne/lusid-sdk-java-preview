...
public class ConfigurationRecipe {
  ...
  **/
  ...
  public ConfigurationRecipe market(MarketContext market) {
   ...
   /**
   * The market configuration that defines where market data used in processing a request is loaded from and how it is resolved.
   * @return market
  **/
  @ApiModelProperty(value = "The market configuration that defines where market data used in processing a request is loaded from and how it is resolved.")
  ...
  public ConfigurationRecipe pricing(PricingContext pricing) {
   ...
   /**
   * The pricing configuration that defines which pricing library is used to price a given instrument and what models and preferences are used with those.
   * @return pricing
  **/
  @ApiModelProperty(value = "The pricing configuration that defines which pricing library is used to price a given instrument and what models and preferences are used with those.")
  ...
  public ConfigurationRecipe aggregation(AggregationContext aggregation) {
   ...
   /**
   * The aggregation configuration that defines how results are amalgamated and what logic to follow when applying sql-like rules.
   * @return aggregation
  **/
  @ApiModelProperty(value = "The aggregation configuration that defines how results are amalgamated and what logic to follow when applying sql-like rules.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, market, pricing, aggregation);
  }
