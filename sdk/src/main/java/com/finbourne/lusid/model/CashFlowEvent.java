...
import com.finbourne.lusid.model.CashFlowEventAllOf;
 ...
 */
@ApiModel(description = "Definition of a CashFlow event.  This is an event that describes the occurence of a cashflow and associated information.")
...
public class CashFlowEvent extends InstrumentEvent {
  ...
  public CashFlowEvent amount(java.math.BigDecimal amount) {
    this.amount = amount; 
    return this;
  }
  ...
  **/
  ...
  public CashFlowEvent currency(String currency) {
  ...
  **/
  ...
  public CashFlowEvent paymentDate(OffsetDateTime paymentDate) {
