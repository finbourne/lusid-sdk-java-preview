...
public class OrderGraphBlock {
  ...
  **/
   ...
   * @return orderIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers for all the orders in this block - DEPRECATED: see Ordered.")
   ...
   * @return placementIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers of all placements for the block - DEPRECATED: see Placed.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Identifiers for all allocations of placements to orders in the block - DEPRECATED: see Allocated.")
   ...
   * @return executionIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers of all executions against placements in the block - DEPRECATED: see Executed.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The overall compliance state of a block, derived from the block's orders. Possible values are 'Pending', 'Failed', 'Manually approved' and 'Passed'.")
