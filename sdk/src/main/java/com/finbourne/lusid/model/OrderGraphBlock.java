...
public class OrderGraphBlock {
  ...
  private OrderGraphSynopsis ordered;
  ...
  **/
  ...
  public OrderGraphBlock ordered(OrderGraphSynopsis ordered) {
  ...
  **/
  @ApiModelProperty(required = true, value = "")
  public OrderGraphSynopsis getOrdered() {
    return ordered;
  }

  public void setOrdered(OrderGraphSynopsis ordered) {
    this.ordered = ordered;
  }


  public OrderGraphBlock placed(OrderGraphSynopsis placed) {
    this.placed = placed; 
    return this;
  }
  ...
  **/
  ...
  public OrderGraphBlock executed(OrderGraphSynopsis executed) {
  ...
  **/
  ...
  public OrderGraphBlock allocated(OrderGraphSynopsis allocated) {
  ...
  **/
  @ApiModelProperty(required = true, value = "A simple description of the compliance state of a block. Possible values are [Unchecked, Non-compliant, Compliant]")
