...
public class OrderGraphBlock {
  ...
  **/
  @ApiModelProperty(required = true, value = "The overall compliance state of a block, derived from the block's orders. Possible values are Pending, Failed, and Passed.")
