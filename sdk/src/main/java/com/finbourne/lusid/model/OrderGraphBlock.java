...
public class OrderGraphBlock {
  ...
  **/
  ...
  public OrderGraphBlock orderIds(List<ResourceId> orderIds) {
    this.orderIds = orderIds; 
    return this;
  }

  public OrderGraphBlock addOrderIdsItem(ResourceId orderIdsItem) {
   ...
   * @return orderIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers for all the orders in this block.")
  ...
  public OrderGraphBlock placementIds(List<ResourceId> placementIds) {
    this.placementIds = placementIds; 
    return this;
  }

  public OrderGraphBlock addPlacementIdsItem(ResourceId placementIdsItem) {
   ...
   * @return placementIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers of all placements for the block.")
  ...
  public OrderGraphBlock allocationIds(List<ResourceId> allocationIds) {
    this.allocationIds = allocationIds; 
    return this;
  }

  public OrderGraphBlock addAllocationIdsItem(ResourceId allocationIdsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Identifiers for all allocations of placements to orders in the block.")
  ...
  public OrderGraphBlock executionIds(List<ResourceId> executionIds) {
    this.executionIds = executionIds; 
    return this;
  }

  public OrderGraphBlock addExecutionIdsItem(ResourceId executionIdsItem) {
   ...
   * @return executionIds
  **/
  @ApiModelProperty(required = true, value = "Identifiers of all executions against placements in the block.")
  ...
  public OrderGraphBlock ordered(Double ordered) {
   ...
   * @return ordered
  **/
  @ApiModelProperty(required = true, value = "Total number of units of the instrument across all orders in the block.")
  ...
  public OrderGraphBlock placed(Double placed) {
    this.placed = placed; 
    return this;
  }
   ...
   * @return placed
  **/
  @ApiModelProperty(required = true, value = "Number of units of the instrument across all placements in the block.")
  ...
  public OrderGraphBlock allocated(Double allocated) {
   ...
   * @return allocated
  **/
  @ApiModelProperty(required = true, value = "Number of units of the instrument across all allocations in the block.")
  ...
  public OrderGraphBlock executed(Double executed) {
   ...
   * @return executed
  **/
  @ApiModelProperty(required = true, value = "How many of the quantity ordered for this block have been executed in the market.")
   ...
   * @return derivedState
  **/
  @ApiModelProperty(required = true, value = "A simple description of the overall state of a block.")
