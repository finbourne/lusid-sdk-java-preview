...
import com.finbourne.lusid.model.AccumulationEventAllOf;
 ...
 */
@ApiModel(description = "Accumulation dividend")
...
public class AccumulationEvent extends InstrumentEvent {
  ...
  **/
  @ApiModelProperty(required = true, value = "Payment currency")
   ...
   * @return dividendRate
  **/
  @ApiModelProperty(required = true, value = "Dividend rate or payment rate as a percentage.  i.e. 5% is written as 0.05")
