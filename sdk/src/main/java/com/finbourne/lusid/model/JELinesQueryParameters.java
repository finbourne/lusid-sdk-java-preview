...
public class JELinesQueryParameters {
   ...
   * @return startDate
  **/
  @ApiModelProperty(value = "The start date of the JELines.")
   ...
   * @return endDate
  **/
  @ApiModelProperty(value = "The end date of the JELInes")
   ...
   * @return filter
  **/
  @ApiModelProperty(value = "Expression to filter the result set.")
   ...
   * @return propertyKeys
  **/
  @ApiModelProperty(value = "A list of property keys from the 'Instrument', 'Transaction', 'Portfolio', 'Account', 'LegalEntity' or 'CustodianAccount' domain to decorate onto the JELine.")
