...
public class ReconcileDateTimeRuleAllOf {
  /**
  ...
  public ReconcileDateTimeRuleAllOf comparisonType(ComparisonTypeEnum comparisonType) {
  ...
  **/
  ...
  public ReconcileDateTimeRuleAllOf appliesTo(AggregateSpec appliesTo) {
  ...
  **/
  ...
  public ReconcileDateTimeRuleAllOf ruleType(RuleTypeEnum ruleType) {
