...
public class PortfolioHolding {
  ...
  **/
  @ApiModelProperty(value = "The scope in which the holding's instrument is in.")
  ...
  **/
   ...
   * @return holdingType
  **/
  @ApiModelProperty(required = true, value = "The code for the type of the holding e.g. P, B, C, R, F etc.")
  ...
  **/
  @ApiModelProperty(value = "The decoded type of the holding e.g. Position, Balance, CashCommitment, Receivable, ForwardFX etc.")
   ...
   * @return holdingId
  **/
  @ApiModelProperty(value = "A single identifier for the holding within the portfolio. The holdingId is constructed from the LusidInstrumentId, sub-holding keys and currrency and is unique within the portfolio.")
