...
public class PortfolioHolding {
  ...
  **/
  ...
  public PortfolioHolding subHoldingKeys(List<PerpetualProperty> subHoldingKeys) {
    this.subHoldingKeys = subHoldingKeys;
    return this;
  }

  public PortfolioHolding addSubHoldingKeysItem(PerpetualProperty subHoldingKeysItem) {
  ...
  **/
  ...
  public PortfolioHolding properties(List<Property> properties) {
    this.properties = properties;
    return this;
  }

  public PortfolioHolding addPropertiesItem(Property propertiesItem) {
  ...
  **/
   ...
   * @return holdingType
  **/
  @ApiModelProperty(required = true, value = "Type of holding, eg Position, Balance, CashCommitment, Receivable, ForwardFX")
  ...
  **/
   ...
   * @return settledUnits
  **/
  @ApiModelProperty(required = true, value = "Settled quantity of holding")
   ...
   * @return cost
  **/
  @ApiModelProperty(required = true, value = "Book cost of holding in transaction currency")
  ...
  **/
  @ApiModelProperty(required = true, value = "Book cost of holding in portfolio currency")
   ...
   * @return transaction
  **/
  @ApiModelProperty(value = "If this is commitment-type holding, the transaction behind it")
