 ...
 * A Cleardown rule
 */
@ApiModel(description = "A Cleardown rule")
...
public class CleardownModuleRule {
   ...
   * @return ruleId
  **/
  @ApiModelProperty(required = true, value = "The identifier for the Cleardown Rule.")
  ...
  **/
  @ApiModelProperty(required = true, value = "The account to post the residual P&L to.")
   ...
   * @return ruleFilter
  **/
  @ApiModelProperty(required = true, value = "The filter syntax for the Cleardown Rule. See https://support.lusid.com/knowledgebase/article/KA-02140 for more information on filter syntax.")
