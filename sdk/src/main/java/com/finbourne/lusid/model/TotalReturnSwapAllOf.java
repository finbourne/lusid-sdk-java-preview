...
public class TotalReturnSwapAllOf {
  ...
  public TotalReturnSwapAllOf startDate(OffsetDateTime startDate) {
  ...
  **/
  ...
  public TotalReturnSwapAllOf maturityDate(OffsetDateTime maturityDate) {
  ...
  **/
  ...
  public TotalReturnSwapAllOf paymentLeg(InstrumentLeg paymentLeg) {
  ...
  **/
  ...
  public TotalReturnSwapAllOf underlyingLeg(UnderlyingLeg underlyingLeg) {
  ...
  **/
  ...
  public TotalReturnSwapAllOf instrumentType(InstrumentTypeEnum instrumentType) {
