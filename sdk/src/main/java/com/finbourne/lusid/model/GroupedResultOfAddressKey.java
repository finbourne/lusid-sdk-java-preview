 ...
 */
@ApiModel(description = "Holder class for a group of results. It consists of a list of columns and values for that column.")
...
public class GroupedResultOfAddressKey {
  ...
  private List<AtomValue> values = null;
   ...
   * @return columns
  **/
  @ApiModelProperty(value = "The columns, or keys, for a particular group of results")
  ...
  public GroupedResultOfAddressKey values(List<AtomValue> values) {
    this.values = values; 
    return this;
  }

  public GroupedResultOfAddressKey addValuesItem(AtomValue valuesItem) {
   ...
   * @return values
  **/
  @ApiModelProperty(value = "The values for the list of results")
