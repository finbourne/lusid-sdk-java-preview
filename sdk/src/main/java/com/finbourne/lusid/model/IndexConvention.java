...
public class IndexConvention {
  ...
  private Tenor paymentTenor = null;
  ...
  **/
  ...
  public IndexConvention name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the index convention")
  ...
  **/
  ...
  public IndexConvention paymentTenor(Tenor paymentTenor) {
  ...
  **/
  ...
  public IndexConvention dayCountConvention(DayCountConventionEnum dayCountConvention) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.fixingReference, indexConvention.fixingReference) &&
        Objects.equals(this.name, indexConvention.name) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(fixingReference, name, publicationDayLag, paymentTenor, dayCountConvention, currency);
  }
