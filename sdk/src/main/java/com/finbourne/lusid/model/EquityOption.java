...
public class EquityOption extends LusidInstrument {
  ...
  /**
   * Type of optionality for the option
   */
  ...
  /**
   * is the option cash settled or physical delivery of option
   */
  ...
  /**
   * external market codes and identifiers for the option, e.g. RIC.
   */
  ...
  **/
   ...
   * @return optionType
  **/
  @ApiModelProperty(required = true, value = "Type of optionality for the option")
   ...
   * @return deliveryType
  **/
  @ApiModelProperty(required = true, value = "is the option cash settled or physical delivery of option")
  ...
  **/
  @ApiModelProperty(required = true, value = "external market codes and identifiers for the option, e.g. RIC.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, strike, optionMaturityDate, optionSettlementDate, startDate, optionType, deliveryType, underlyingIdentifier, domCcy, super.hashCode());
  }
