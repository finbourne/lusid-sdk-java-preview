...
public class EquityOption extends LusidInstrument {
  ...
  /**
   * The available values are: LusidInstrumentId, Isin, Sedol, Cusip, ClientInternal, Figi, RIC, QuotePermId
   */
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: LusidInstrumentId, Isin, Sedol, Cusip, ClientInternal, Figi, RIC, QuotePermId")
