 ...
 */
@ApiModel(description = "LUSID representation of a plain vanilla OTC Equity Option.")
...
public class EquityOption extends LusidInstrument {
  ...
  **/
   ...
   * @return deliveryType
  **/
  @ApiModelProperty(required = true, value = "Is the option cash settled or physical delivery of option    Supported string (enumeration) values are: [Cash, Physical].")
   ...
   * @return optionType
  **/
  @ApiModelProperty(required = true, value = "Type of optionality for the option    Supported string (enumeration) values are: [Call, Put].")
  ...
  **/
  @ApiModelProperty(required = true, value = "The market identifier type of the underlying code, e.g RIC.    Supported string (enumeration) values are: [LusidInstrumentId, Isin, Sedol, Cusip, ClientInternal, Figi, RIC, QuotePermId, REDCode, BBGId, ICECode].")
  ...
  **/
  @ApiModelProperty(value = "Equity option types. E.g. Vanilla (default), RightsIssue, Warrant.    Supported string (enumeration) values are: [Vanilla, RightsIssue, Warrant].")
  ...
  **/
   ...
   * @return exerciseType
  **/
  @ApiModelProperty(value = "Type of optionality that is present; European, American.    Supported string (enumeration) values are: [European, American].")
