...
public class PeriodDiaryEntriesReopenedResponse {
  ...
  **/
  @ApiModelProperty(required = true, value = "Number of Diary Entries removed as a result of reopening periods")
  ...
  **/
  @ApiModelProperty(required = true, value = "The start point where periods were removed from")
  ...
  **/
  @ApiModelProperty(required = true, value = "The end point where periods were removed to")
