...
public class Mapping {
   ...
   * @return scope
  **/
  @ApiModelProperty(value = "The scope for this mapping.")
   ...
   * @return code
  **/
  @ApiModelProperty(value = "The code for this mapping.")
   ...
   * @return name
  **/
  @ApiModelProperty(value = "The mapping name")
  ...
  public Mapping _for(String _for) {
    this._for = _for; 
    return this;
  }
   ...
   * @return _for
  **/
  @ApiModelProperty(value = "What type of reconciliation this mapping is for")
