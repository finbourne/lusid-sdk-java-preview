 ...
 */
@ApiModel(description = "Defines the rule set to be used to determine if entries should be considered as a match.")
...
public class Mapping {
  ...
  private List<MappingRule> rules = null;
   ...
   * @return scope
  **/
  @ApiModelProperty(required = true, value = "The scope for this mapping.")
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code for this mapping.")
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The mapping name")
  ...
  **/
  @ApiModelProperty(required = true, value = "What type of reconciliation this mapping is for")
   ...
   * @return rules
  **/
  @ApiModelProperty(value = "The rules in this mapping, keyed by the left field/property name")
