...
import com.finbourne.lusid.model.Leg;
...
public class SwapInstrument {
   ...
   */
  @JsonAdapter(NotionalExchangeEnum.Adapter.class)
  public enum NotionalExchangeEnum {
    ...
    NotionalExchangeEnum(String value) {
      this.value = value;
    }
    ...
    public static NotionalExchangeEnum fromValue(String value) {
      for (NotionalExchangeEnum b : NotionalExchangeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<NotionalExchangeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final NotionalExchangeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public NotionalExchangeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return NotionalExchangeEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_NOTIONAL_EXCHANGE = "notionalExchange";
  @SerializedName(SERIALIZED_NAME_NOTIONAL_EXCHANGE)
  private NotionalExchangeEnum notionalExchange;
  ...
  **/
  ...
  public SwapInstrument legs(List<Leg> legs) {
    this.legs = legs;
    return this;
  }

  public SwapInstrument addLegsItem(Leg legsItem) {
  ...
  **/
  ...
  public SwapInstrument notionalExchange(NotionalExchangeEnum notionalExchange) {
  ...
  **/
  ...
  public NotionalExchangeEnum getNotionalExchange() {
    return notionalExchange;
  }

  public void setNotionalExchange(NotionalExchangeEnum notionalExchange) {
    this.notionalExchange = notionalExchange;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    SwapInstrument swapInstrument = (SwapInstrument) o;
    return Objects.equals(this.startDate, swapInstrument.startDate) &&
        Objects.equals(this.maturityDate, swapInstrument.maturityDate) &&
        Objects.equals(this.legs, swapInstrument.legs) &&
        Objects.equals(this.notional, swapInstrument.notional) &&
        Objects.equals(this.isAmortizing, swapInstrument.isAmortizing) &&
        Objects.equals(this.notionalExchange, swapInstrument.notionalExchange) &&
        Objects.equals(this.instrumentType, swapInstrument.instrumentType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(startDate, maturityDate, legs, notional, isAmortizing, notionalExchange, instrumentType);
  }
  ...
  public String toString() {
    ...
    sb.append("    notionalExchange: ").append(toIndentedString(notionalExchange)).append("\n");
