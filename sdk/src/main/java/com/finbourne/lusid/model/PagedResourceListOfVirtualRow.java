...
public class PagedResourceListOfVirtualRow {
  ...
  private List<VirtualRow> values = new ArrayList<>();
  ...
  public PagedResourceListOfVirtualRow nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfVirtualRow previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfVirtualRow values(List<VirtualRow> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfVirtualRow addValuesItem(VirtualRow valuesItem) {
  ...
  **/
  ...
  public List<VirtualRow> getValues() {
    return values;
  }

  public void setValues(List<VirtualRow> values) {
    this.values = values;
  }


  public PagedResourceListOfVirtualRow href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfVirtualRow links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfVirtualRow addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfVirtualRow {\n");
