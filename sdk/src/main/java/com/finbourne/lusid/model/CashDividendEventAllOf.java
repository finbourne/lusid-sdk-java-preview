...
public class CashDividendEventAllOf {
  ...
  public CashDividendEventAllOf paymentDate(OffsetDateTime paymentDate) {
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "The date the company begins distributing the dividend.")
  ...
  public CashDividendEventAllOf exDate(OffsetDateTime exDate) {
    this.exDate = exDate; 
    return this;
  }
   ...
   * @return exDate
  **/
  @ApiModelProperty(required = true, value = "The first business day on which the dividend is not owed to the buying party.")
  ...
  public CashDividendEventAllOf cashElections(List<CashElection> cashElections) {
    this.cashElections = cashElections; 
    return this;
  }

  public CashDividendEventAllOf addCashElectionsItem(CashElection cashElectionsItem) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Possible elections for this event, each keyed with a unique identifier.")
  ...
  public CashDividendEventAllOf announcementDate(OffsetDateTime announcementDate) {
  ...
  **/
  @ApiModelProperty(value = "Date on which the dividend is announced by the company.")
  ...
  public CashDividendEventAllOf recordDate(OffsetDateTime recordDate) {
  ...
  **/
  ...
  public CashDividendEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
