...
public class CashDividendEventAllOf {
  ...
  public CashDividendEventAllOf grossAmount(java.math.BigDecimal grossAmount) {
   ...
   * @return grossAmount
  **/
  @ApiModelProperty(required = true, value = "The before tax amount for each share held being paid out to shareholders.")
