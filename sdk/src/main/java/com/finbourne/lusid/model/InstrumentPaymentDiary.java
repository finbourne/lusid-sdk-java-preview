 ...
 */
@ApiModel(description = "A payment diary containing all the cashflows on a single instrument.")
...
public class InstrumentPaymentDiary {
  ...
  private List<InstrumentPaymentDiaryLeg> legs = null;
  ...
  **/
  @ApiModelProperty(value = "The identifier type of the instrument.")
   ...
   * @return instrumentId
  **/
  @ApiModelProperty(value = "The identifier for the instrument.")
  ...
  **/
  @ApiModelProperty(value = "The scope of the instrument.")
  ...
  **/
   ...
   * @return legs
  **/
  @ApiModelProperty(value = "Aggregated sets of Cashflows.")
