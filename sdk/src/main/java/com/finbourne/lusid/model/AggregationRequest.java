...
public class AggregationRequest {
  ...
  **/
  ...
  public AggregationRequest effectiveFrom(OffsetDateTime effectiveFrom) {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipeId, inlineRecipe, asAt, effectiveFrom, effectiveAt, metrics, groupBy, filters, limit, sort);
  }
