...
public class AggregationRequest {
  ...
  public AggregationRequest recipeId(ResourceId recipeId) {
   ...
   /**
   * The configuration recipe, consisting of recipe scope and recipe name, to use in performing the aggregation.
   * @return recipeId
  **/
  @ApiModelProperty(value = "The configuration recipe, consisting of recipe scope and recipe name, to use in performing the aggregation.")
  ...
  public AggregationRequest inlineRecipe(ConfigurationRecipe inlineRecipe) {
   ...
   /**
   * Target Method for providing a non-named recipe.  If given, this replaces the &#39;RecipeId&#39; used with the bespoke recipe. This is intended to allow use of non-named  recipes to iterate quickly for design purposes. Ultimately it is recommended that production recipes would be stored  in Lusid.    USE OF ANY (INLINE) RECIPE IS AT PRESENT LIABLE TO CHANGE.
   * @return inlineRecipe
  **/
  @ApiModelProperty(value = "Target Method for providing a non-named recipe.  If given, this replaces the 'RecipeId' used with the bespoke recipe. This is intended to allow use of non-named  recipes to iterate quickly for design purposes. Ultimately it is recommended that production recipes would be stored  in Lusid.    USE OF ANY (INLINE) RECIPE IS AT PRESENT LIABLE TO CHANGE.")
  ...
  **/
  ...
  public AggregationRequest effectiveAt(OffsetDateTime effectiveAt) {
  ...
  **/
  ...
  public AggregationRequest sort(String sort) {
    this.sort = sort;
    return this;
  }
   ...
   * @return sort
  **/
  @ApiModelProperty(value = "Sort the results or not.")
  ...
  @Override
  public int hashCode() {
    return Objects.hash(recipeId, inlineRecipe, asAt, effectiveAt, metrics, groupBy, filters, limit, sort);
  }
