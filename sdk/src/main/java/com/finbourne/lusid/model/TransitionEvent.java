 ...
 */
@ApiModel(description = "A generic event with event consequences modeled as transitions.")
...
public class TransitionEvent extends InstrumentEvent {
  ...
  **/
  ...
  public TransitionEvent transitions(List<CorporateActionTransitionRequest> transitions) {
    this.transitions = transitions; 
    return this;
  }

  public TransitionEvent addTransitionsItem(CorporateActionTransitionRequest transitionsItem) {
