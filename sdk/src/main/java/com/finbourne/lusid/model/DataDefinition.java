...
public class DataDefinition {
   ...
   * @return address
  **/
  @ApiModelProperty(required = true, value = "The internal address (LUSID native) of the unit in the provided data itself and corresponds to the external name of the data item")
  ...
  **/
   ...
   * @return dataType
  **/
  @ApiModelProperty(value = "A member of the set of possible data types, that all data passed under that key is expected to be of.  Currently limited to one of [string, integer, decimal, result0d].")
   ...
   * @return keyType
  **/
  @ApiModelProperty(value = "Is the item either a unique key for the dictionary, i.e. does it identify a unique index or conceptual 'row' within the list of dictionaries,  or a partial key or is it simply a data item within that dictionary. Must be one of [Unique,PartOfUnique,Leaf, CompositeLeaf]")
   ...
   * @return allowNull
  **/
  @ApiModelProperty(value = "The path to the field must exist (unless AllowMissing is true) but the actual value is allowed to be null.")
   ...
   * @return allowMissing
  **/
  @ApiModelProperty(value = "The path (or column) is allowed to be missing but if it is present it is not allowed to be null unless AllowNull is true.")
