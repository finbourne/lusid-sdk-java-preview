...
public class ModelSelection {
  ...
  /**
   * The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes
   */
  ...
  **/
   ...
   * @return model
  **/
  @ApiModelProperty(required = true, value = "The available values are: SimpleStatic, Discounting, VendorDefault, BlackScholes")
