 ...
 */
@ApiModel(description = "Cash election for Events that result in a cash payment.")
...
public class CashElection {
   ...
   * @return electionKey
  **/
  @ApiModelProperty(required = true, value = "Unique key used to identify this election.")
   ...
   * @return exchangeRate
  **/
  @ApiModelProperty(value = "The exchange rate if this is not the declared CashElection.  Defaults to 1 if Election is Declared.")
   ...
   * @return dividendRate
  **/
  @ApiModelProperty(required = true, value = "The payment rate for this CashElection.")
   ...
   * @return isChosen
  **/
  @ApiModelProperty(value = "Has this election been chosen.  Only one Election may be Chosen per Event.")
   ...
   * @return isDeclared
  **/
  @ApiModelProperty(value = "Is this the declared CashElection.  Only one Election may be Declared per Event.")
   ...
   * @return isDefault
  **/
  @ApiModelProperty(value = "Is this election the default.  Only one Election may be Default per Event")
  ...
  **/
  @ApiModelProperty(required = true, value = "The payment currency for this CashElection.")
