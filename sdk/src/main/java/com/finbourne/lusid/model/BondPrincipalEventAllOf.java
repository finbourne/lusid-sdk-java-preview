...
public class BondPrincipalEventAllOf {
  ...
  public BondPrincipalEventAllOf currency(String currency) {
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "Currency of the principal payment")
  ...
  public BondPrincipalEventAllOf exDate(OffsetDateTime exDate) {
    this.exDate = exDate; 
    return this;
  }
   ...
   * @return exDate
  **/
  @ApiModelProperty(required = true, value = "Ex-Dividend date of the principal payment")
  ...
  public BondPrincipalEventAllOf paymentDate(OffsetDateTime paymentDate) {
   ...
   * @return paymentDate
  **/
  @ApiModelProperty(required = true, value = "Payment date of the principal payment")
  ...
  public BondPrincipalEventAllOf principalPerUnit(java.math.BigDecimal principalPerUnit) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Principal per unit")
  ...
  public BondPrincipalEventAllOf instrumentEventType(InstrumentEventTypeEnum instrumentEventType) {
