 ...
 */
@ApiModel(description = "Base class for representing result key rules in LUSID, which describe how to resolve (unit) result data.  This base class should not be directly instantiated; each supported ResultKeyRuleType has a corresponding inherited class.")
...
public class ResultKeyRule {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Invalid, ResultDataKeyRule, PortfolioResultDataKeyRule")
