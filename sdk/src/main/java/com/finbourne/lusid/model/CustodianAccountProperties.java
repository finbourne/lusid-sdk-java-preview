...
public class CustodianAccountProperties {
  ...
  public CustodianAccountProperties href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public CustodianAccountProperties properties(Map<String, Property> properties) {
    this.properties = properties; 
    return this;
  }

  public CustodianAccountProperties putPropertiesItem(String key, Property propertiesItem) {
   ...
   /**
   * The Custodian Account properties. These will be from the &#39;CustodianAccount&#39; domain.
   * @return properties
  **/
  @ApiModelProperty(value = "The Custodian Account properties. These will be from the 'CustodianAccount' domain.")
  ...
  public CustodianAccountProperties version(Version version) {
  ...
  **/
  ...
  public CustodianAccountProperties links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public CustodianAccountProperties addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class CustodianAccountProperties {\n");
