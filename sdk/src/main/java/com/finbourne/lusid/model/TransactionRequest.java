...
public class TransactionRequest {
  ...
  public static final String SERIALIZED_NAME_NETTING_SET = "nettingSet";
  @SerializedName(SERIALIZED_NAME_NETTING_SET)
  ...
  **/
   ...
   * @return properties
  **/
  @ApiModelProperty(value = "Set of unique transaction properties and associated values to store with the transaction. Each property must be from the 'Trade' domain.")
  ...
  **/
   ...
   * @return nettingSet
  **/
  @ApiModelProperty(value = "The netting set.")
