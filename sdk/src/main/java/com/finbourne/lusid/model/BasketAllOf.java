...
public class BasketAllOf {
  ...
  **/
   ...
   * @return basketType
  **/
  @ApiModelProperty(required = true, value = "What contents does the basket have. The validation will check that the instrument types contained match those expected.  Supported string (enumeration) values are: [Bonds, Credits, Equities, EquitySwap, Unknown].")
