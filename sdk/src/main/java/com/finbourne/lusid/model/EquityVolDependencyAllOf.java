...
public class EquityVolDependencyAllOf {
  ...
  public EquityVolDependencyAllOf code(String code) {
    this.code = code; 
    return this;
  }
   ...
   * @return code
  **/
  @ApiModelProperty(required = true, value = "The code identifying the corresponding equity, e.g. US0378331005 if the MarketIdentifier was set to ISIN")
  ...
  public EquityVolDependencyAllOf domesticCurrency(String domesticCurrency) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The domestic currency of the instrument declaring this dependency.")
  ...
  public EquityVolDependencyAllOf volType(String volType) {
   ...
   * @return volType
  **/
  @ApiModelProperty(required = true, value = "Volatility type e.g. \"LN\" and \"N\" for log-normal and normal volatility.")
  ...
  public EquityVolDependencyAllOf date(OffsetDateTime date) {
    this.date = date; 
    return this;
  }
  ...
  **/
  ...
  public EquityVolDependencyAllOf dependencyType(DependencyTypeEnum dependencyType) {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Opaque, Cash, Discounting, EquityCurve, EquityVol, Fx, FxForwards, FxVol, IndexProjection, IrVol, Quote, Vendor")
  ...
  public String toString() {
    ...
    sb.append("class EquityVolDependencyAllOf {\n");
