 ...
 */
@ApiModel(description = "Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. coal within energy)  These commonly include  ICB https://en.wikipedia.org/wiki/Industry_Classification_Benchmark  TRBC https://en.wikipedia.org/wiki/The_Refinitiv_Business_Classification  GICS https://en.wikipedia.org/wiki/Global_Industry_Classification_Standard.  These links are not intended as a complete reference but are freely available as a starting point.")

public class IndustryClassificationScheme {
  ...
  public static final String SERIALIZED_NAME_ECONOMIC_SECTOR = "economicSector";
  @SerializedName(SERIALIZED_NAME_ECONOMIC_SECTOR)
  private String economicSector;

  public static final String SERIALIZED_NAME_BUSINESS_SECTOR = "businessSector";
  @SerializedName(SERIALIZED_NAME_BUSINESS_SECTOR)
  ...
  public static final String SERIALIZED_NAME_INDUSTRY_ACTIVITY = "industryActivity";
  @SerializedName(SERIALIZED_NAME_INDUSTRY_ACTIVITY)
  private String industryActivity;

  public IndustryClassificationScheme schemeName(String schemeName) {
   ...
   * @return schemeName
  **/
  @ApiModelProperty(required = true, value = "The type of the industry classification scheme (TRBC, GICs, ICB)")
  ...
  public IndustryClassificationScheme schemeId(String schemeId) {
   ...
   * @return schemeId
  **/
  @ApiModelProperty(required = true, value = "Within the given scheme, the unique id that identifies this particular classification.  e.g. within \"TRCS\", 5010202011 identifies \"Oil Exploration \\amp; Production - Onshore\" within the Energy, fossil-fuels and Oil hierarchy.")
  ...
  public IndustryClassificationScheme economicSector(String economicSector) {
  ...
  **/
  @ApiModelProperty(required = true, value = "Various schemes exist to classify the business sector within which a company operates.  They divide it into various categories around business, economic and sub-sectors (e.g. fossil fuels within energy)  Under ICB, TRBC, GICS which economic sector is the counterparty assigned to. This is Lvl 1 of that scheme (coarsest)")
  ...
  public IndustryClassificationScheme businessSector(String businessSector) {
  ...
  **/
  ...
  public IndustryClassificationScheme industry(String industry) {
  ...
  **/
  ...
  public IndustryClassificationScheme industryActivity(String industryActivity) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("    businessSector: ").append(toIndentedString(businessSector)).append("\n");
    sb.append("    industry: ").append(toIndentedString(industry)).append("\n");
    sb.append("    industryActivity: ").append(toIndentedString(industryActivity)).append("\n");
    sb.append("}");
    return sb.toString();
  }
