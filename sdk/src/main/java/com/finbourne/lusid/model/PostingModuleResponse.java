 ...
 */
@ApiModel(description = "A Posting Module definition")
...
public class PostingModuleResponse {
  ...
  private List<PostingModuleRule> rules = null;
  ...
  **/
  @ApiModelProperty(required = true, value = "The code of the Posting Module.")
  ...
  **/
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "The name to identify the Posting Module by")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "The description for the Posting Module")
   ...
   * @return rules
  **/
  @ApiModelProperty(value = "The posting rules that apply for the Posting Module. Rules are evaluated in the order they occur in this collection.")
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The Posting Module status. Can be Active, Inactive or Deleted. Defaults to Active.")
