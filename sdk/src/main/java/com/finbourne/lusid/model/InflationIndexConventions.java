 ...
 */
@ApiModel(description = "A set of conventions that describe the conventions for an inflation index.")
...
public class InflationIndexConventions {
  ...
  **/
   ...
   * @return currency
  **/
  @ApiModelProperty(required = true, value = "Currency of the inflation index convention.")
  ...
  **/
  @ApiModelProperty(required = true, value = "Observation lag. This is a string that must have units of Month.  This field is typically 3 or 4 months, but can vary, older bonds and swaps have 8 months lag.  For Bonds with a calculation type of Ratio, this property, if set, must be 0Invalid.")
