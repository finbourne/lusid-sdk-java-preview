 ...
 */
@ApiModel(description = "The request used in the AggregatedReturnsDispersionMetric.")
...
public class AggregatedReturnsDispersionRequest {
  ...
  private List<ResourceId> returnIds = null;
  ...
  **/
  @ApiModelProperty(value = "The end date for when the you want the dispersion to be calculated.")
   ...
   * @return yearsCount
  **/
  @ApiModelProperty(value = "For how many years to calculate the dispersion. Default to 10.")
   ...
   * @return returnIds
  **/
  @ApiModelProperty(value = "The Scope and code of the returns.")
  ...
  **/
  @ApiModelProperty(value = "Optional - either a date, or the key for a portfolio property containing a date. If provided, the given date will override the inception date for this request.")
