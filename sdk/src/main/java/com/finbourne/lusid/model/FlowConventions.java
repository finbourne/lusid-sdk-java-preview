...
public class FlowConventions {
   ...
   */
  @JsonAdapter(DayCountBasisEnum.Adapter.class)
  public enum DayCountBasisEnum {
    ...
    DayCountBasisEnum(String value) {
      this.value = value;
    }
    ...
    public static DayCountBasisEnum fromValue(String value) {
      for (DayCountBasisEnum b : DayCountBasisEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<DayCountBasisEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final DayCountBasisEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public DayCountBasisEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return DayCountBasisEnum.fromValue(value);
      }
    }
  }

  public static final String SERIALIZED_NAME_DAY_COUNT_BASIS = "dayCountBasis";
  @SerializedName(SERIALIZED_NAME_DAY_COUNT_BASIS)
  private DayCountBasisEnum dayCountBasis;
  ...
  **/
  ...
  public FlowConventions dayCountBasis(DayCountBasisEnum dayCountBasis) {
  ...
  **/
  ...
  public DayCountBasisEnum getDayCountBasis() {
    return dayCountBasis;
  }

  public void setDayCountBasis(DayCountBasisEnum dayCountBasis) {
    this.dayCountBasis = dayCountBasis;
  }
  ...
  **/
  ...
  public FlowConventions holidayCalendars(String holidayCalendars) {
  ...
  **/
  @ApiModelProperty(required = true, value = "A comma separated string denoting holiday calendars that apply to generation and payment.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.currency, flowConventions.currency) &&
        ...
        Objects.equals(this.dayCountBasis, flowConventions.dayCountBasis) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(currency, paymentFrequency, dayCountBasis, rollConvention, holidayCalendars);
  }
