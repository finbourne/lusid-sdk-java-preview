...
public class FlowConventions {
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: Actual360, Act360, MoneyMarket, Actual365, Act365, Thirty360, ThirtyU360, Bond, ThirtyE360, EuroBond, ActAct, ActualActual, ActActIsda, Invalid")
  ...
  **/
  @ApiModelProperty(required = true, value = "The available values are: NoAdjustment, None, Previous, P, Following, F, ModifiedPrevious, MP, ModifiedFollowing, MF, EndOfMonth, EOM, EndOfMonthPrevious, EOMP, EndOfMonthFollowing, EOMF, Invalid")
  ...
  **/
   ...
   * @return settleDays
  **/
  @ApiModelProperty(value = "Number of Good Business Days between the trade date and the effective or settlement date of the instrument.")
   ...
   * @return resetDays
  **/
  @ApiModelProperty(value = "The number of Good Business Days between determination and payment of reset.")
