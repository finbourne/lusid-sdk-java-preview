...
public class PagedResourceListOfReconciliationRunBreak {
  ...
  private List<ReconciliationRunBreak> values = new ArrayList<>();
  ...
  public PagedResourceListOfReconciliationRunBreak nextPage(String nextPage) {
  ...
  **/
  ...
  public PagedResourceListOfReconciliationRunBreak previousPage(String previousPage) {
  ...
  **/
  ...
  public PagedResourceListOfReconciliationRunBreak values(List<ReconciliationRunBreak> values) {
    this.values = values; 
    return this;
  }

  public PagedResourceListOfReconciliationRunBreak addValuesItem(ReconciliationRunBreak valuesItem) {
  ...
  **/
  ...
  public List<ReconciliationRunBreak> getValues() {
    return values;
  }

  public void setValues(List<ReconciliationRunBreak> values) {
    this.values = values;
  }


  public PagedResourceListOfReconciliationRunBreak href(URI href) {
    this.href = href; 
    return this;
  }
  ...
  **/
  ...
  public PagedResourceListOfReconciliationRunBreak links(List<Link> links) {
    this.links = links; 
    return this;
  }

  public PagedResourceListOfReconciliationRunBreak addLinksItem(Link linksItem) {
  ...
  **/
  ...
  public String toString() {
    ...
    sb.append("class PagedResourceListOfReconciliationRunBreak {\n");
