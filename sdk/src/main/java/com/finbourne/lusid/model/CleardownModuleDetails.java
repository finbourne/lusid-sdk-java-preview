 ...
 */
@ApiModel(description = "A Cleardown Module request definition")
...
public class CleardownModuleDetails {
   ...
   * @return displayName
  **/
  @ApiModelProperty(required = true, value = "The name of the Cleardown Module.")
   ...
   * @return description
  **/
  @ApiModelProperty(value = "A description for the Cleardown Module.")
   ...
   * @return status
  **/
  @ApiModelProperty(required = true, value = "The Cleardown Module status. Can be Active or Inactive. Defaults to Active.")
