...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:40691";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.3833/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:40691
