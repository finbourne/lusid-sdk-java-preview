...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:62910";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.2540/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:62910
