...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:42335";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.2473/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:42335
