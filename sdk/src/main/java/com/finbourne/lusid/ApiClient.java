...
public class ApiClient {
    ...
    private String basePath = "http://local-unit-test-server.lusid.com:32672";
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/0.11.3008/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://local-unit-test-server.lusid.com:32672
