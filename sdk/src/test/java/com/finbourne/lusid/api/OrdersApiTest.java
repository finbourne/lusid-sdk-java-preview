...
public class OrdersApiTest {
    ...
    public void deleteOrderTest() throws ApiException {
        String scope = null;
        String code = null;
        DeletedEntityResponse response = api.deleteOrder(scope, code);
    ...
    public void upsertOrdersTest() throws ApiException {
        OrderSetRequest orderSetRequest = null;
        ResourceListOfOrder response = api.upsertOrders(orderSetRequest);
