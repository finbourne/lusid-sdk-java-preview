...
public class RelationsApiTest {
    ...
    public void createRelationTest() throws ApiException {
        String scope = null;
        String code = null;
        CreateRelationRequest createRelationRequest = null;
        String effectiveAt = null;
        CompleteRelation response = api.createRelation(scope, code, createRelationRequest, effectiveAt);
    ...
    public void deleteRelationTest() throws ApiException {
        String scope = null;
        String code = null;
        DeleteRelationRequest deleteRelationRequest = null;
        String effectiveAt = null;
        DeletedEntityResponse response = api.deleteRelation(scope, code, deleteRelationRequest, effectiveAt);
