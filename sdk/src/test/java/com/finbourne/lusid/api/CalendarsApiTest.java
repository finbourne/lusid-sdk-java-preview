...
import com.finbourne.lusid.model.ResourceListOfDate;
...
public class CalendarsApiTest {
    ...
    public void addDateToCalendarTest() throws ApiException {
        ...
        java.util.Date response = api.addDateToCalendar(scope, code, createDateRequest);
    ...
    public void deleteDateFromCalendarTest() throws ApiException {
        ...
        String code = null;
        String dateId = null;
        java.util.Date response = api.deleteDateFromCalendar(scope, code, dateId);
    ...
    public void getDatesTest() throws ApiException {
        ...
        ResourceListOfDate response = api.getDates(scope, code, fromEffectiveAt, toEffectiveAt, asAt, idFilter);
