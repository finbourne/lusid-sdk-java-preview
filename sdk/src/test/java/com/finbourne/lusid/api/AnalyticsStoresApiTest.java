...
/**
 * API tests for AnalyticsStoresApi
 */
@Ignore
public class AnalyticsStoresApiTest {

    private final AnalyticsStoresApi api = new AnalyticsStoresApi();
     ...
     */
    @Test
    public void createAnalyticStoreTest() throws ApiException {
        CreateAnalyticStoreRequest request = null;
        AnalyticStore response = api.createAnalyticStore(request);
     ...
     */
    @Test
    public void deleteAnalyticStoreTest() throws ApiException {
        String scope = null;
        Integer year = null;
        Integer month = null;
        Integer day = null;
        DeletedEntityResponse response = api.deleteAnalyticStore(scope, year, month, day);
     ...
     */
    @Test
    public void getAnalyticStoreTest() throws ApiException {
        String scope = null;
        Integer year = null;
        Integer month = null;
        Integer day = null;
        OffsetDateTime asAt = null;
        AnalyticStore response = api.getAnalyticStore(scope, year, month, day, asAt);
     ...
     */
    @Test
    public void listAnalyticStoresTest() throws ApiException {
        OffsetDateTime asAt = null;
        List<String> sortBy = null;
        Integer start = null;
        Integer limit = null;
        String filter = null;
        ResourceListOfAnalyticStoreKey response = api.listAnalyticStores(asAt, sortBy, start, limit, filter);
     ...
     */
    @Test
    public void setAnalyticsTest() throws ApiException {
        String scope = null;
        Integer year = null;
        Integer month = null;
        Integer day = null;
        List<InstrumentAnalytic> data = null;
        AnalyticStore response = api.setAnalytics(scope, year, month, day, data);
