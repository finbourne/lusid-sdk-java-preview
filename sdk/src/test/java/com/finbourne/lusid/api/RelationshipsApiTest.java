...
public class RelationshipsApiTest {
    ...
    public void createRelationshipTest() throws ApiException {
        String scope = null;
        String code = null;
        CreateRelationshipRequest createRelationshipRequest = null;
        CompleteRelationship response = api.createRelationship(scope, code, createRelationshipRequest);
    ...
    public void deleteRelationshipTest() throws ApiException {
        String scope = null;
        String code = null;
        DeleteRelationshipRequest deleteRelationshipRequest = null;
        DeletedEntityResponse response = api.deleteRelationship(scope, code, deleteRelationshipRequest);
