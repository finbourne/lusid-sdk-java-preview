...
public class AggregationApiTest {
     ...
     */
    @Test
    public void getAggregationTest() throws ApiException {
        String scope = null;
        String code = null;
        ...
        ListAggregationResponse response = api.getAggregation(scope, code, sortBy, start, limit, aggregationRequest);
    ...
    public void getAggregationByGroupTest() throws ApiException {
        ...
        Integer limit = null;
        AggregationRequest aggregationRequest = null;
        ListAggregationResponse response = api.getAggregationByGroup(scope, code, sortBy, start, limit, aggregationRequest);
    ...
    public void getAggregationByPortfolioTest() throws ApiException {
        ...
        Integer limit = null;
        AggregationRequest aggregationRequest = null;
        ListAggregationResponse response = api.getAggregationByPortfolio(scope, code, sortBy, start, limit, aggregationRequest);
    ...
    public void getAggregationByResultSetTest() throws ApiException {
        ...
        Integer limit = null;
        AggregationRequest aggregationRequest = null;
        ListAggregationResponse response = api.getAggregationByResultSet(scope, resultsKey, sortBy, start, limit, aggregationRequest);
    ...
    public void getAggregationOfWeightedInstrumentsTest() throws ApiException {
        ...
        Integer start = null;
        Integer limit = null;
        InlineAggregationRequest inlineAggregationRequest = null;
        ListAggregationResponse response = api.getAggregationOfWeightedInstruments(scope, sortBy, start, limit, inlineAggregationRequest);
     ...
     */
    @Test
    public void getNestedAggregationTest() throws ApiException {
        String scope = null;
        String code = null;
        AggregationRequest aggregationRequest = null;
        NestedAggregationResponse response = api.getNestedAggregation(scope, code, aggregationRequest);
    ...
    public void getNestedAggregationByGroupTest() throws ApiException {
        ...
        String code = null;
        AggregationRequest aggregationRequest = null;
        NestedAggregationResponse response = api.getNestedAggregationByGroup(scope, code, aggregationRequest);
    ...
    public void getNestedAggregationByPortfolioTest() throws ApiException {
        ...
        String code = null;
        AggregationRequest aggregationRequest = null;
        NestedAggregationResponse response = api.getNestedAggregationByPortfolio(scope, code, aggregationRequest);
    ...
    public void getQueryableKeysTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfAggregationQuery response = api.getQueryableKeys(page, start, limit, filter);
