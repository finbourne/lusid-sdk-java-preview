...
public class PersonsApiTest {
    ...
    public void setPersonIdentifiersTest() throws ApiException {
        ...
        String idTypeCode = null;
        String code = null;
        SetPersonIdentifiersRequest identifiers = null;
        Person response = api.setPersonIdentifiers(idTypeScope, idTypeCode, code, identifiers);
    ...
    public void setPersonPropertiesTest() throws ApiException {
        ...
        String idTypeCode = null;
        String code = null;
        SetPersonPropertiesRequest properties = null;
        Person response = api.setPersonProperties(idTypeScope, idTypeCode, code, properties);
