...
public class DataTypesApiTest {
    ...
    public void createDataTypeTest() throws ApiException {
        CreateDataTypeRequest createDataTypeRequest = null;
        DataType response = api.createDataType(createDataTypeRequest);
    ...
    public void updateDataTypeTest() throws ApiException {
        String scope = null;
        String code = null;
        UpdateDataTypeRequest updateDataTypeRequest = null;
        DataType response = api.updateDataType(scope, code, updateDataTypeRequest);
