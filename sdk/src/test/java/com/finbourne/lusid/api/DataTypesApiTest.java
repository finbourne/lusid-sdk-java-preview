...
public class DataTypesApiTest {
    ...
    public void getDataTypeTest() throws ApiException {
        String scope = null;
        String code = null;
        DataType response = api.getDataType(scope, code);
    ...
    public void getUnitsFromDataTypeTest() throws ApiException {
        ...
        String filter = null;
        ResourceListOfIUnitDefinitionDto response = api.getUnitsFromDataType(scope, code, units, filter);
    ...
    public void listDataTypesTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfDataType response = api.listDataTypes(scope, includeSystem, sortBy, start, limit, filter);
