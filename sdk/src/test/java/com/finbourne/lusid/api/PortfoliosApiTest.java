...
public class PortfoliosApiTest {
     ...
     */
    @Test
    public void getPortfolioAggregatedReturnsTest() throws ApiException {
        String scope = null;
        String code = null;
        String returnScope = null;
        String returnCode = null;
        AggregatedReturnsRequest aggregatedReturnsRequest = null;
        String fromEffectiveAt = null;
        String toEffectiveAt = null;
        OffsetDateTime asAt = null;
        ResourceListOfAggregatedReturn response = api.getPortfolioAggregatedReturns(scope, code, returnScope, returnCode, aggregatedReturnsRequest, fromEffectiveAt, toEffectiveAt, asAt);
