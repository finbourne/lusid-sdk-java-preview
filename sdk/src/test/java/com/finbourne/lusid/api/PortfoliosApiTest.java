...
public class PortfoliosApiTest {
    ...
    public void deleteKeyFromPortfolioAccessMetadataTest() throws ApiException {
        ...
        DeletedEntityResponse response = api.deleteKeyFromPortfolioAccessMetadata(scope, code, key, effectiveAt);
    ...
    public void getPortfoliosAccessMetadataByKeyTest() throws ApiException {
        ...
        String effectiveAt = null;
        OffsetDateTime asAt = null;
        List<AccessMetadataValue> response = api.getPortfoliosAccessMetadataByKey(scope, code, key, effectiveAt, asAt);
    ...
    public void upsertPortfolioAccessMetadataTest() throws ApiException {
        ...
        String effectiveAt = null;
        ResourceListOfAccessMetadataValueOf response = api.upsertPortfolioAccessMetadata(scope, code, key, request, effectiveAt);
