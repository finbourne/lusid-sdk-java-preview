...
import com.finbourne.lusid.model.ResourceListOfReturn;
...
public class PortfoliosApiTest {
    ...
    public void getPortfolioPropertyTimeSeriesTest() throws ApiException {
        ...
        String page = null;
        Integer limit = null;
        ResourceListOfPropertyInterval response = api.getPortfolioPropertyTimeSeries(scope, code, propertyKey, effectiveAt, asAt, filter, page, limit);
    ...
    public void getPortfolioReturnsTest() throws ApiException {
        ...
        String period = null;
        OffsetDateTime asAt = null;
        ResourceListOfReturn response = api.getPortfolioReturns(scope, code, returnScope, returnCode, fromEffectiveAt, toEffectiveAt, period, asAt);
    ...
    public void upsertPortfolioReturnsTest() throws ApiException {
        ...
        String returnScope = null;
        String returnCode = null;
        List<ModelReturn> modelReturn = null;
        UpsertReturnsResponse response = api.upsertPortfolioReturns(scope, code, returnScope, returnCode, modelReturn);
