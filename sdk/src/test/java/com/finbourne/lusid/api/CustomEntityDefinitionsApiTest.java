...
/**
 * API tests for CustomEntityDefinitionsApi
 */
@Ignore
public class CustomEntityDefinitionsApiTest {

    private final CustomEntityDefinitionsApi api = new CustomEntityDefinitionsApi();
     ...
     */
    @Test
    public void createCustomEntityDefinitionTest() throws ApiException {
        CustomEntityDefinitionRequest customEntityDefinitionRequest = null;
        CustomEntityDefinition response = api.createCustomEntityDefinition(customEntityDefinitionRequest);
    ...
    public void getDefinitionTest() throws ApiException {
        ...
        CustomEntityDefinition response = api.getDefinition(customEntityId, asAt);
