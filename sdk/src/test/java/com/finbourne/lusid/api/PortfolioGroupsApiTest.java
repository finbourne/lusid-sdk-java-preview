...
public class PortfolioGroupsApiTest {
    ...
    public void addPortfolioToGroupTest() throws ApiException {
        ...
        PortfolioGroup response = api.addPortfolioToGroup(scope, code, portfolioId);
    ...
    public void addSubGroupToGroupTest() throws ApiException {
        ...
        PortfolioGroup response = api.addSubGroupToGroup(scope, code, portfolioGroupId);
    ...
    public void deletePortfolioFromGroupTest() throws ApiException {
        ...
        PortfolioGroup response = api.deletePortfolioFromGroup(scope, code, portfolioScope, portfolioCode);
    ...
    public void deleteSubGroupFromGroupTest() throws ApiException {
        ...
        PortfolioGroup response = api.deleteSubGroupFromGroup(scope, code, subgroupScope, subgroupCode);
    ...
    public void getPortfolioGroupTest() throws ApiException {
        ...
        PortfolioGroup response = api.getPortfolioGroup(scope, code, asAt);
    ...
    public void getPortfolioGroupCommandsTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfProcessedCommand response = api.getPortfolioGroupCommands(scope, code, fromAsAt, toAsAt, sortBy, start, limit, filter);
    ...
    public void listPortfolioGroupsTest() throws ApiException {
        ...
        Integer limit = null;
        String filter = null;
        ResourceListOfPortfolioGroup response = api.listPortfolioGroups(scope, asAt, sortBy, start, limit, filter);
    ...
    public void updatePortfolioGroupTest() throws ApiException {
        ...
        PortfolioGroup response = api.updatePortfolioGroup(scope, code, request);
