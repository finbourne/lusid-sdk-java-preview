...
public class PortfolioGroupsApiTest {
    ...
    public void buildTransactionsForPortfolioGroupTest() throws ApiException {
        ...
        VersionedResourceListOfOutputTransaction response = api.buildTransactionsForPortfolioGroup(scope, code, transactionQueryParameters, asAt, filter, propertyKeys);
    ...
    public void getTransactionsForPortfolioGroupTest() throws ApiException {
        ...
        String filter = null;
        List<String> propertyKeys = null;
        VersionedResourceListOfTransaction response = api.getTransactionsForPortfolioGroup(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys);
     ...
     */
    @Test
    public void getTransactionsForPortfolioGroupPreviewTest() throws ApiException {
        String scope = null;
        String code = null;
        String fromTransactionDate = null;
        String toTransactionDate = null;
        ...
        String page = null;
        Integer limit = null;
        VersionedResourceListOfTransaction response = api.getTransactionsForPortfolioGroupPreview(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit);
