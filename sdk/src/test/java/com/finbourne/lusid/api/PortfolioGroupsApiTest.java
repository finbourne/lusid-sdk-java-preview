...
public class PortfolioGroupsApiTest {
    ...
    public void deleteKeyFromPortfolioGroupAccessMetadataTest() throws ApiException {
        ...
        String key = null;
        String effectiveAt = null;
        DeletedEntityResponse response = api.deleteKeyFromPortfolioGroupAccessMetadata(scope, code, key, effectiveAt);
    ...
    public void getPortfolioGroupAccessMetadataByKeyTest() throws ApiException {
        ...
        String effectiveAt = null;
        OffsetDateTime asAt = null;
        List<AccessMetadataValue> response = api.getPortfolioGroupAccessMetadataByKey(scope, code, key, effectiveAt, asAt);
    ...
    public void upsertPortfolioGroupAccessMetadataTest() throws ApiException {
        ...
        String effectiveAt = null;
        ResourceListOfAccessMetadataValueOf response = api.upsertPortfolioGroupAccessMetadata(scope, code, key, request, effectiveAt);
