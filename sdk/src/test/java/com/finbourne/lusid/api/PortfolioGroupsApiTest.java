...
public class PortfolioGroupsApiTest {
    ...
    public void buildTransactionsForPortfolioGroupTest() throws ApiException {
        ...
        VersionedResourceListOfOutputTransaction response = api.buildTransactionsForPortfolioGroup(scope, code, queryParameters, asAt, filter, propertyKeys);
    ...
    public void upsertPortfolioGroupAccessMetadataTest() throws ApiException {
        ...
        String code = null;
        String metadataKey = null;
        UpsertPortfolioGroupAccessMetadataRequest request = null;
        String effectiveAt = null;
        ResourceListOfAccessMetadataValueOf response = api.upsertPortfolioGroupAccessMetadata(scope, code, metadataKey, request, effectiveAt);
