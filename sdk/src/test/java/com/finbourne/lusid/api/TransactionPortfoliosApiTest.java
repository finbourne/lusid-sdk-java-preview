...
public class TransactionPortfoliosApiTest {
    ...
    public void resolveInstrumentTest() throws ApiException {
        ...
        String fromEffectiveAt = null;
        Map<String, String> instrumentIdentifierCollection = null;
        UpsertPortfolioTransactionsResponse response = api.resolveInstrument(scope, code, instrumentIdentifierType, instrumentIdentifierValue, fromEffectiveAt, instrumentIdentifierCollection);
