...
public class TransactionPortfoliosApiTest {
    ...
    public void getPortfolioCashFlowsTest() throws ApiException {
        ...
        ResourceListOfInstrumentCashFlow response = api.getPortfolioCashFlows(scope, code, fromEffectiveAt, toEffectiveAt, asAt, filter, recipeIdScope, recipeIdCode);
     ...
     */
    @Test
    public void getPortfolioCashStatementsTest() throws ApiException {
        String scope = null;
        String code = null;
        String fromEffectiveAt = null;
        String toEffectiveAt = null;
        ...
        String recipeIdScope = null;
        String recipeIdCode = null;
        ResourceListOfPortfolioCashFlow response = api.getPortfolioCashStatements(scope, code, fromEffectiveAt, toEffectiveAt, asAt, filter, recipeIdScope, recipeIdCode);
    ...
    public void getUpsertablePortfolioCashFlowsTest() throws ApiException {
        ...
        String recipeIdScope = null;
        String recipeIdCode = null;
        ResourceListOfTransaction response = api.getUpsertablePortfolioCashFlows(scope, code, fromEffectiveAt, toEffectiveAt, asAt, filter, recipeIdScope, recipeIdCode);
