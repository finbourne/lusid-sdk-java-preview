...
public class InstrumentsApiTest {
    ...
    public void deleteInstrumentPropertiesTest() throws ApiException {
        ...
        DeleteInstrumentPropertiesResponse response = api.deleteInstrumentProperties(identifierType, identifier, propertyKeys, effectiveAt);
    ...
    public void upsertLusidInstrumentsTest() throws ApiException {
        Map<String, LusidInstrumentDefinition> instruments = null;
        UpsertInstrumentsResponse response = api.upsertLusidInstruments(instruments);
