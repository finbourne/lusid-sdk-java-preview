...
public class InstrumentsApiTest {
     ...
     */
    @Test
    public void getLusidInstrumentsTest() throws ApiException {
        String identifierType = null;
        List<String> requestBody = null;
        String effectiveAt = null;
        OffsetDateTime asAt = null;
        List<String> propertyKeys = null;
        GetExpandedInstrumentsResponse response = api.getLusidInstruments(identifierType, requestBody, effectiveAt, asAt, propertyKeys);
     ...
     */
    @Test
    public void upsertLusidInstrumentsTest() throws ApiException {
        Map<String, LusidInstrumentDefinition> requestBody = null;
        UpsertInstrumentsResponse response = api.upsertLusidInstruments(requestBody);
