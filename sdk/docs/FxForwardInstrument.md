...
**isNdf** | **Boolean** | Is the contract an Fx-Forward of \&quot;Non-Deliverable\&quot; type, meaning a single payment in the domestic currency based on  the change in fx-rate vs  a reference rate is used. | 
**fixingDate** | [**OffsetDateTime**](OffsetDateTime.md) | The fixing date. Its presence determines the NDF status of the instrument. | 
...
**refSpotRate** | **Double** | The reference Fx Spot rate for currency pair Foreign-Domestic that was seen on the trade start date (time). | 
