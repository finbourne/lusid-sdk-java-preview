...
public class Example {
  public static void main(String[] args) {
    ...
    OffsetDateTime asAt = new OffsetDateTime(); // OffsetDateTime | The asAt datetime at which to retrieve the package. Defaults to return the latest version of the package if not specified.
...
public class Example {
  public static void main(String[] args) {
    ...
    PackagesApi apiInstance = new PackagesApi(defaultClient);
    PackageSetRequest packageSetRequest = {"requests":[{"id":{"scope":"MyScope","code":"PACK00000123"},"orderIds":[{"scope":"MyScope","code":"ORDER00000123"}],"orderInstructionIds":[{"scope":"MyScope","code":"INSTR00000123"}],"properties":{"package/MyScope/SomePackageProperty":{"key":"Package/MyScope/SomePackageProperty","value":{"labelValue":"XYZ000034567"}}}}]}; // PackageSetRequest | The collection of package requests.
    try {
