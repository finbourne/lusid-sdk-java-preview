...
<a name="getTransactionsForPortfolioGroupPreview"></a>
# **getTransactionsForPortfolioGroupPreview**
> VersionedResourceListOfTransaction getTransactionsForPortfolioGroupPreview(scope, code, fromTransactionDate, toTransactionDate, asAt, filter, propertyKeys, page, limit)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println("Exception when calling PortfolioGroupsApi#getTransactionsForPortfolioGroupPreview");
      System.err.println("Status code: " + e.getCode());
      System.err.println("Reason: " + e.getResponseBody());
      System.err.println("Response headers: " + e.getResponseHeaders());
      e.printStackTrace();
