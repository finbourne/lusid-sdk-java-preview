...
> Map&lt;String, List&lt;AccessMetadataValue&gt;&gt; patchPortfolioGroupAccessMetadata(scope, code, operation, effectiveAt)
...
public class Example {
  public static void main(String[] args) {
    ...
    try {
      Map<String, List<AccessMetadataValue>> result = apiInstance.patchPortfolioGroupAccessMetadata(scope, code, operation, effectiveAt);
      System.out.println(result);
    } catch (ApiException e) {
